...
public abstract class ConformanceSuiteCheckedExceptionBase extends Exception
{
     ...
     */
    public ConformanceSuiteCheckedExceptionBase(int    httpCode,
                                                String className,
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ConformanceSuiteCheckedExceptionBase))
        {
            return false;
        }
        ConformanceSuiteCheckedExceptionBase that = (ConformanceSuiteCheckedExceptionBase) objectToCompare;
