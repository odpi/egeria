...
public enum PerformanceProfile implements Serializable
{
    ...
    ENTITY_UPDATE        (7, "Entity update",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/entity-update",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    RELATIONSHIP_UPDATE  (8, "Relationship update",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/relationship-update",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    CLASSIFICATION_UPDATE(9, "Classification update",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/classification-update",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    ENTITY_UNDO          (10, "Entity undo",
            "Performance tests for the technology under test's ability to undo entity updates.",
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/entity-undo",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    RELATIONSHIP_UNDO    (11, "Relationship undo",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/relationship-undo",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    ENTITY_RETRIEVAL     (12, "Entity retrieval",
            "Performance tests for the technology under test's ability to retrieve entities by ID.",
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/entity-retrieval",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    ENTITY_HISTORY_RETRIEVAL(13, "Entity history retrieval",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/entity-history-retrieval",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    RELATIONSHIP_RETRIEVAL(14, "Relationship retrieval",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/relationship-retrieval",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    RELATIONSHIP_HISTORY_RETRIEVAL(15, "Relationship history retrieval",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/relationship-history-retrieval",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    ENTITY_HISTORY_SEARCH(16, "Entity history search",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/entity-historical-search",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    RELATIONSHIP_HISTORY_SEARCH(17, "Relationship history search",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/relationship-history-search",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    GRAPH_QUERIES        (18, "Graph queries",
            "Performance tests for the technology under test's ability to run graph queries.",
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/graph-queries",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    GRAPH_HISTORY_QUERIES(19, "Graph history queries",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/graph-history-queries",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    ENTITY_RE_HOME       (20, "Entity re-home",
            "Performance tests for the technology under test's ability to re-home entities.",
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/entity-re-home",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    RELATIONSHIP_RE_HOME (21, "Relationship re-home",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/relationship-re-home",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    ENTITY_DECLASSIFY    (22, "Entity declassify",
            "Performance tests for the technology under test's ability to declassify entities.",
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/entity-declassify",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    ENTITY_RETYPE        (23, "Entity retype",
            "Performance tests for the technology under test's ability to retype entities.",
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/entity-retype",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    RELATIONSHIP_RETYPE  (24, "Relationship retype",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/relationship-retype",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    ENTITY_RE_IDENTIFY   (25, "Entity re-identify",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/entity-re-identify",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    RELATIONSHIP_RE_IDENTIFY(26, "Relationship re-identify",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/relationship-re-identify",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    RELATIONSHIP_DELETE  (27, "Relationship delete",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/relationship-delete",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    ENTITY_DELETE        (28, "Entity delete",
            "Performance tests for the technology under test's ability to delete entities.",
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/entity-delete",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    ENTITY_RESTORE       (29, "Entity restore",
            "Performance tests for the technology under test's ability to restore entities.",
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/entity-restore",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    RELATIONSHIP_RESTORE (30, "Relationship restore",
            ...
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/relationship-restore",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    RELATIONSHIP_PURGE   (31, "Relationship purge",
            "Performance tests for the technology under test's ability to purge relationships.",
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/relationship-purge",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
    ENTITY_PURGE         (32, "Entity purge",
            "Performance tests for the technology under test's ability to purge entities.",
            "https://egeria.odpi.org/open-metadata-conformance-suite/docs/performance-workbench/profiles/entity-purge",
            OpenMetadataConformanceProfilePriority.OPTIONAL_PROFILE),
