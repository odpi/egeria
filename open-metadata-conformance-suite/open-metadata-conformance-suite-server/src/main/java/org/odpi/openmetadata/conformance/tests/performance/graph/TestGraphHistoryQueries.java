...
public class TestGraphHistoryQueries extends OpenMetadataPerformanceTestCase
{
    ...
    private static final String TEST_CASE_ID   = "repository-graph-history-query-performance";
    private static final String TEST_CASE_NAME = "Repository graph history query performance test case";
    ...
    private static final String A_GET_RELATIONSHIPS_MSG = "Repository performs history retrieval of relationships for instances of type: ";

    private static final String A_GET_NEIGHBORHOOD1     = TEST_CASE_ID + "-getEntityNeighborhood-1";
    private static final String A_GET_NEIGHBORHOOD1_MSG = "Repository performs history retrieval of neighborhood (level 1) for instances of type: ";

    private static final String A_GET_NEIGHBORHOOD2     = TEST_CASE_ID + "-getEntityNeighborhood-2";
    private static final String A_GET_NEIGHBORHOOD2_MSG = "Repository performs history retrieval of neighborhood (level 2) for instances of type: ";

    private static final String A_GET_NEIGHBORHOOD3     = TEST_CASE_ID + "-getEntityNeighborhood-3";
    private static final String A_GET_NEIGHBORHOOD3_MSG = "Repository performs history retrieval of neighborhood (level 3) for instances of type: ";

    private static final String A_GET_RELATED     = TEST_CASE_ID + "-getRelatedEntities";
    private static final String A_GET_RELATED_MSG = "Repository performs history retrieval of related entities for instances of type: ";

    private static final String A_GET_LINKING     = TEST_CASE_ID + "-getLinkingEntities";
    private static final String A_GET_LINKING_MSG = "Repository performs history retrieval of linking entities for instances of type: ";
     ...
     */
    public TestGraphHistoryQueries(PerformanceWorkPad workPad,
                                   EntityDef          entityDef,
                                   Date               asOfTime)
    {
        super(workPad, PerformanceProfile.GRAPH_HISTORY_QUERIES.getProfileId());
