...
public class TestSupportedEntitySearch extends RepositoryConformanceTestCase
{
    ...
    protected void run(TestPhase phase) throws Exception
    {
         ...
         *          TODO - we could do with some quality metric that assesses the depth and variety of the existing data.
    ...
    private void createInstances() throws Exception
    {
        ...
        if (knownInstances.size() >= pageSize)
            pageLimited = true;   // TODO pageLimited should be renamed as something like "unseen instances"
    ...
    private void performFinds() throws Exception
    {
        ...
        // TODO - consider adding type filtering checks - see Entity Property Search Test 7. for example.
        ...
        if (!definedAttributeNames.isEmpty()) {
            ...
            /*
             * Perform dual property findEntitiesByProperty() tests - these take a pair of attributes and ....TODO complete comment
             */
    ...
    private void performMatchPropertiesTestForAttribute(String attributeName, MatchCriteria matchCriteria) throws Exception {
        ...
        if (possibleValueIterator.hasNext()) {
            ...
            /* TODO - refresh comment in light of pageSize vs expectedCount....
            ...
            /* TODO - refresh comment in light of changes....
     ...
     * Initially this is implemented using searchCriteria tests, but TODO  expand to include matchProperties
     */
    private void performAdvancedSearchTests(String attributeName, RegexMatchType matchType) throws Exception {
        ...
        while (possibleValueIterator.hasNext()) {
            ...
            /*
             * Test search using findEntitiesByProperty
             */
