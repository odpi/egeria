...
{
    /**
     * OPEN-SURVEY-0001 - The {0} watchdog action service has been disconnected - either due to its own actions or a cancel request
     */
    ...
    /**
     * OPEN-SURVEY-0002 - The {0} Watchdog Action Service has been supplied with a resource connector of class {1} rather than class {2} for asset {3}
     */
    WRONG_TYPE_OF_CONNECTOR("OPEN-SURVEY-0002",
                            AuditLogRecordSeverityLevel.ERROR,
                            "The {0} Watchdog Action Service has been supplied with a resource connector of class {1} rather than class {2} for asset {3}",
    ...
    /**
     * OPEN-SURVEY-0003 - The watchdog action service {0} is creating log file {1}
     */
    CREATING_LOG_FILE("OPEN-SURVEY-0003",
                      AuditLogRecordSeverityLevel.INFO,
                      "The watchdog action service {0} is creating log file {1} which is catalogued as CSVFile asset {2}",
    ...
    /**
     * OPEN-SURVEY-0004 - The watchdog action service {0} is overriding log file {1}
     */
    REUSING_LOG_FILE("OPEN-SURVEY-0004",
                     AuditLogRecordSeverityLevel.INFO,
                     "The watchdog action service {0} is overriding log file {1}",
    ...
    /**
     * OPEN-SURVEY-0005 - No information about the asset {0} has been returned from the asset store for watchdog action service {1}
     */
    NO_ASSET( "OPEN-SURVEY-0005",
              AuditLogRecordSeverityLevel.ERROR,
              "No information about the asset {0} has been returned from the asset store for watchdog action framework {1}",
    ...
    /**
     * OPEN-SURVEY-0006 - Asset {0} is of type {1} but watchdog action service {2} only supports the following asset type(s): {3}
     */
    ...
    /**
     * OPEN-SURVEY-0007 - Asset {0} has a root schema of type {1} but watchdog action service {2} only supports the following root schema type(s): {3}
     */
    INVALID_ROOT_SCHEMA_TYPE( "OPEN-SURVEY-0007",
                              AuditLogRecordSeverityLevel.ERROR,
        "Asset {0} has a root schema of type {1} but watchdog action service {2} only supports the following root schema type(s): {3}",
                             "The watchdog action service terminates because it can not proceed.",
                             "The caller has requested a governance request type that is unable to process a root schema for an asset because its type is unsupported." +
                                     ...
                                     "a governance request type that is compatible with the asset's schema, or changing the watchdog action service " +
