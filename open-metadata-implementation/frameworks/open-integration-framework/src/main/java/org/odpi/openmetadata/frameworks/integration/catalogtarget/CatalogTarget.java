...
public enum CatalogTarget
{
     ...
     */
    CatalogTarget(String name, String typeName, String deployedImplementationType, Map<String, String> otherPropertyValues)
    {
        this.name                       = name;
    ...
    public static List<CatalogTargetType> getCatalogTargetTypes()
    {
        ...
        for (CatalogTarget catalogTarget : CatalogTarget.values())
        {
