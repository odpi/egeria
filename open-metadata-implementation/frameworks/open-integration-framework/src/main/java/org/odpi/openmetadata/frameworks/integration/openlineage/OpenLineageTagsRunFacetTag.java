...
/**
 * This class represents a single tag applied to a run.
 * It is part of the OpenLineage spec.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class OpenLineageTagsRunFacetTag
{
     ...
     * Default constructor
     */
    public OpenLineageTagsRunFacetTag()
    {
    }
    ...
    {
        return "OpenLineageTagsRunFacetTag{" +
                       "key='" + key + '\'' +
                       ", value='" + value + '\'' +
                       ", source='" + source + '\'' +
                       '}';
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        OpenLineageTagsRunFacetTag that = (OpenLineageTagsRunFacetTag) objectToCompare;
