...
import org.odpi.openmetadata.frameworks.governanceaction.properties.ReferenceableProperties;
...
public class IntegrationGroupProperties extends ReferenceableProperties
{
    ...
    public int hashCode()
    {
        return Objects.hash(super.hashCode(), getDisplayName(), getDescription(), getVersion(),
