                                                                                        ...
                                                                                        AuditLoggingComponent
{
    ...
    {
        throw new GovernanceServiceException(OGFErrorCode.UNEXPECTED_EXCEPTION.getMessageDefinition(governanceServiceName,
    ...
    public void validateContext(GovernanceContext governanceContext) throws ConnectorCheckedException
    {
        ...
        {
            throw new GovernanceServiceException(OGFErrorCode.NULL_GOVERNANCE_CONTEXT.getMessageDefinition(governanceServiceName),
                                                 this.getClass().getName(),
                                                 methodName);
        }
    }
