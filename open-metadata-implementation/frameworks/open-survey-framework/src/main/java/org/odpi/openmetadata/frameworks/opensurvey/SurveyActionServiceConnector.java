                                                                                    ...
                                                                                    AuditLoggingComponent
{
    ...
    public String getJSONProperties(Object properties) throws PropertyServerException
    {
        ...
        {
            throw new PropertyServerException(OSFErrorCode.UNEXPECTED_EXCEPTION.getMessageDefinition(surveyActionServiceName,
                                                                                           ...
                                                                                           ConnectionCheckedException
    {
        ...
        surveyContext.recordCompletionStatus(SurveyActionGuard.SURVEY_INVALID.getCompletionStatus(),
                                             ...
                                             null,
                                             null,
                                             OSFAuditCode.WRONG_TYPE_OF_CONNECTOR.getMessageDefinition(surveyActionServiceName,
                                                                                                       connector.getClass().getName(),
                                                                                                       expectedConnectorClass.getName(),
                                                                                                       assetStore.getAssetGUID()));

        throw new ConnectorCheckedException(OSFErrorCode.WRONG_TYPE_OF_CONNECTOR.getMessageDefinition(surveyActionServiceName,
                                                                                                      connector.getClass().getName(),
                                                                                                      expectedConnectorClass.getName(),
                                                                                                      assetStore.getAssetGUID()),
                                            this.getClass().getName(),
                                                                                  ...
                                                                                  UserNotAuthorizedException
    {
        ...
        if (assetElement == null)
        {
            surveyContext.recordCompletionStatus(SurveyActionGuard.SURVEY_INVALID.getCompletionStatus(),
                                                 ...
                                                 null,
                                                 null,
                                                 OSFAuditCode.NO_ASSET.getMessageDefinition(surveyContext.getAssetGUID(), surveyActionServiceName));
        ...
        else if (!propertyHelper.isTypeOf(assetElement.getElementHeader(), expectedAssetType))
        {
            surveyContext.recordCompletionStatus(SurveyActionGuard.SURVEY_INVALID.getCompletionStatus(),
                                                 ...
                                                 null,
                                                 null,
                                                 OSFAuditCode.WRONG_TYPE_OF_ASSET.getMessageDefinition(assetElement.getElementHeader().getGUID(),
                                                                                                       assetElement.getElementHeader().getType().getTypeName(),
                                                                                                       surveyActionServiceName,
                                                                                                       expectedAssetType));

            throw new ConnectorCheckedException(OSFErrorCode.INVALID_ASSET_TYPE.getMessageDefinition(assetElement.getElementHeader().getGUID(),
                                                                                                     assetElement.getElementHeader().getType().getTypeName(),
                                                                                                     surveyActionServiceName,
                                                                                                     expectedAssetType),
                                                this.getClass().getName(),
        ...
        if (assetElement != null)
        {
            ...
            else
            {
                surveyContext.recordCompletionStatus(SurveyActionGuard.SURVEY_INVALID.getCompletionStatus(),
                                                     ...
                                                     null,
                                                     null,
                                                     OSFAuditCode.INVALID_ROOT_SCHEMA_TYPE.getMessageDefinition(assetElement.getElementHeader().getGUID(),
                                                                                                                assetElement.getElementHeader().getType().getTypeName(),
                                                                                                                surveyActionServiceName,
                                                                                                                schemaTypeName));
                                                                   ...
                                                                   UserNotAuthorizedException
    {
        ...
        surveyContext.recordCompletionStatus(SurveyActionGuard.SURVEY_INVALID.getCompletionStatus(),
                                             ...
                                             null,
                                             null,
                                             OSFAuditCode.NO_SCHEMA.getMessageDefinition(surveyActionServiceName, assetGUID));

        throw new ConnectorCheckedException(OSFErrorCode.NO_SCHEMA.getMessageDefinition(surveyActionServiceName, assetGUID),
                                            this.getClass().getName(),
                                            methodName);
    }
        ...
        if (embeddedConnectors != null)
        {
            ...
            for (Connector embeddedConnector : embeddedConnectors)
            {
                if (embeddedConnector != null)
                {
                    ...
                    {
                        throw new ConnectorCheckedException(OSFErrorCode.INVALID_EMBEDDED_SURVEY_ACTION_SERVICE.getMessageDefinition(surveyActionServiceName),
                                                            this.getClass().getName(),
                                                            methodName);
                    }
                }
    ...
    public void start() throws ConnectorCheckedException, UserNotAuthorizedException
    {
        ...
        {
            throw new ConnectorCheckedException(OSFErrorCode.NULL_SURVEY_CONTEXT.getMessageDefinition(surveyActionServiceName),
                                                this.getClass().getName(),
                                                methodName);
        }
    }
    ...
    {
        throw new ConnectorCheckedException(OSFErrorCode.UNEXPECTED_EXCEPTION.getMessageDefinition(surveyActionServiceName,
