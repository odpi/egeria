...
public class AnnotationStore
{
                                                                       ...
                                                                       PropertyServerException
    {
        ...
        this.converter = new AnnotationConverter<>("Open Survey Framework (OSF)",
     ...
     * Open Survey Framework (OSF) Annotation.
     */
    ...
    /**
     * AnnotationConverter provides the generic methods for the Open Survey Framework Annotation beans converters.  Generic classes
