 ...
 */
public class SurveyOpenMetadataStore
{
     ...
     * describing the category and properties of a TypeDef.
     *
    ...
    public OpenMetadataElement getMetadataElementByGUID(String  elementGUID) throws InvalidParameterException,
                                                                                      ...
                                                                                      PropertyServerException
    {
        return openMetadataStore.getMetadataElementByGUID(userId, elementGUID, forLineage, forDuplicateProcessing, getEffectiveTime());
    }
    ...
    public RelatedMetadataElements getRelationshipByGUID(String  relationshipGUID) throws InvalidParameterException,
                                                                                          ...
                                                                                          PropertyServerException
    {
        return openMetadataStore.getRelationshipByGUID(userId, relationshipGUID, forLineage, forDuplicateProcessing, getEffectiveTime());
    }
    ...
    public String openToDo(String                qualifiedName,
                           ...
                           List<NewActionTarget> actionTargets) throws InvalidParameterException,
                                                                       ...
                                                                       PropertyServerException
    {
        return openMetadataStore.openToDo(userId, qualifiedName, title, instructions, todoCategory, priority, dueDate, additionalProperties, assignTo, causeGUID, actionTargets);
    }
