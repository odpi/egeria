...
public class SolutionLinkingWireRelationship implements MetadataElement
{
     ...
     * Default constructor
     */
    public SolutionLinkingWireRelationship()
    {
        super();
    }
     ...
     */
    public SolutionLinkingWireRelationship(SolutionLinkingWireRelationship template)
    {
        if (template != null)
        {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        SolutionLinkingWireRelationship that = (SolutionLinkingWireRelationship) objectToCompare;
