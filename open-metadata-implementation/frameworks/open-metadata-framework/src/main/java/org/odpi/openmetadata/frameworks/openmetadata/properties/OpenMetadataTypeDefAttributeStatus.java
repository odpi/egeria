 ...
 */
public enum OpenMetadataTypeDefAttributeStatus
{
    /**
     ...
     */
    OpenMetadataTypeDefAttributeStatus(int ordinal, String name, String description)
    {
    ...
    {
        return "OpenMetadataTypeDefAttributeStatus{" +
                "ordinal=" + ordinal +
                ", name='" + name + '\'' +
