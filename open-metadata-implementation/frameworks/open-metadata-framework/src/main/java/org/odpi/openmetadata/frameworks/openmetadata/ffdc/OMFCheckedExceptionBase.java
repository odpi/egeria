 ...
 */
public abstract class OMFCheckedExceptionBase extends Exception
{
    @Serial
    private static final long serialVersionUID = 1L;

    private static final Logger log = LoggerFactory.getLogger(OMFCheckedExceptionBase.class);
     ...
     */
    public OMFCheckedExceptionBase(ExceptionMessageDefinition messageDefinition,
                                   String                     className,
     ...
     */
    public OMFCheckedExceptionBase(String                  errorMessage,
     ...
     * @param template   object to copy
     */
    public OMFCheckedExceptionBase(OMFCheckedExceptionBase template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        OMFCheckedExceptionBase that = (OMFCheckedExceptionBase) objectToCompare;
    ...
    {
        return "OMFCheckedExceptionBase{" +
