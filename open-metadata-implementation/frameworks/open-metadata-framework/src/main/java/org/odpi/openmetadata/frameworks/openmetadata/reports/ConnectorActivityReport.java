...
public class ConnectorActivityReport
{
    private ElementHeader                     elementHeader = null;
    private ConnectorActivityReportProperties properties    = null;


    /**
     * Default constructor
     */
    public ConnectorActivityReport()
    {
        super();
    }
     ...
     */
    public ConnectorActivityReport(ConnectorActivityReport template)
    {
        if (template != null)
        {
     ...
     * @return string
     */
    public ConnectorActivityReportProperties getProperties()
    {
        return properties;
    }
     ...
     */
    public void setProperties(ConnectorActivityReportProperties properties)
    {
    ...
    {
        return "ConnectorActivityReport{" +
