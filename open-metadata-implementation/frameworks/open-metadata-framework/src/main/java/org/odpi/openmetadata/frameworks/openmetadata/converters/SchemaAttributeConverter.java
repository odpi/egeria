...
/**
 * SchemaAttributeConverter provides common methods for transferring relevant properties from an Open Metadata Element
 * object into a bean that inherits from SchemaAttributeElement.
 */
public class SchemaAttributeConverter<B> extends AttributedElementConverterBase<B>
{
    /**
     * Constructor
     *
     ...
     */
    public SchemaAttributeConverter(PropertyHelper propertyHelper,
                                    String         serviceName,
                                    String         serverName)
    {
     ...
     */
    protected SchemaAttributeProperties getSchemaAttributeProperties(Class<B>            beanClass,
                                                               OpenMetadataElement openMetadataElement,
                                                               String              methodName) throws PropertyServerException
    {
        if (openMetadataElement != null)
        {
            SchemaAttributeProperties actorProfileProperties = new SchemaAttributeProperties();
            ...
            actorProfileProperties.setDisplayName(this.removeDisplayName(elementProperties));
                        ...
                        String              methodName) throws PropertyServerException
    {
        try
        {
            ...
            if (returnBean instanceof SchemaAttributeElement bean)
            {
                ...
                bean.setSchemaAttributeProperties(getSchemaAttributeProperties(beanClass, openMetadataElement, methodName));
            }
