...
public class AuditLogProperties extends ClassificationBeanProperties
{
    ...
    {
        super();
        super.typeName = OpenMetadataType.AUDIT_LOG_CLASSIFICATION.typeName;
    }
     ...
     */
    public AuditLogProperties(AuditLogProperties template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        AuditLogProperties that = (AuditLogProperties) objectToCompare;
