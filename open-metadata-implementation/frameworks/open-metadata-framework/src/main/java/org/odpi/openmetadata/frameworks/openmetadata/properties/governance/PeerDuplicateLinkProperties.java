...
/**
 * PeerDuplicateLinkProperties provides a structure for passing the properties associated with a consolidated
 * duplicate.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class PeerDuplicateLinkProperties extends RelationshipBeanProperties
{
     ...
     */
    public PeerDuplicateLinkProperties(PeerDuplicateLinkProperties template)
    {
        super(template);
    ...
    {
        return "PeerDuplicateLinkProperties{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        PeerDuplicateLinkProperties that = (PeerDuplicateLinkProperties) objectToCompare;
