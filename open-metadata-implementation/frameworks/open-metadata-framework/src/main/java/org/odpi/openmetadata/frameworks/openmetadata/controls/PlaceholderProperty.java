...
public enum PlaceholderProperty
{
     ...
     */
    HOST_IDENTIFIER ("hostIdentifier", "The host IP address or domain name.", DataType.STRING.getDisplayName(), "coconet.com"),

    /**
     * The host IP address or domain name.
     */
    HOST_URL ("hostURL", "The host IP address or domain name of the server with the HTTP protocol prefix.", DataType.STRING.getDisplayName(), "https://coconet.com"),

    /**
     * The number of the port to use to connect to a service.
     */
    PORT_NUMBER ("portNumber", "The number of the port to use to connect to a service.", DataType.STRING.getDisplayName(), "1234"),

    /**
     * The network address of the server
     */
    SERVER_NETWORK_ADDRESS("serverNetworkAddress", "The network address of the server.", DataType.STRING.getDisplayName(), "http://localhost:8080"),

    /**
     * The name of the operation to append onto the server host name/port number, or set it to an empty string if not needed.
     */
    API_OPERATION("apiOperation", "The name of the operation to append onto the server host name/port number, or set it to an empty string if not needed.", DataType.STRING.getDisplayName(), "/api/v1/lineage"),
     ...
     */
    SERVER_NAME ("serverName", "The name of the server being catalogued.", DataType.STRING.getDisplayName(), "myServer"),

    /**
     * The name of the associated organization.
     */
    ORGANIZATION_NAME ("organizationName", "The name of the associated organization.", DataType.STRING.getDisplayName(), "Coco Pharmaceuticals"),

    /**
     * The name of the server being catalogued.
     */
    SERVER_ID ("serverId", "The local identifier of the server being catalogued.", DataType.STRING.getDisplayName(), "myServer"),

    /**
     * The name of the schema being catalogued.
     */
    SCHEMA_NAME ("schemaName", "The name of the schema being catalogued.", DataType.STRING.getDisplayName(), "MyServer.schema"),
     ...
     */
    FORMULA("formula", "The formula used to populate the data set.", DataType.STRING.getDisplayName(), null),

    /**
     * The language/format used in the data set's formula.
     */
    FORMULA_TYPE("formulaType", "The language/format used in the data set's formula.", DataType.STRING.getDisplayName(), null),

    /**
     * The full pathname of the file including the directory names, file name and file extension.
     */
    FILE_SYSTEM_NAME ("fileSystemName", "The unique name for the file system that this file/directory belongs.  It may be a machine name or a URL to a remote file store.", DataType.STRING.getDisplayName(), null),

    /**
     * The format standard used in the file system.
     */
    FORMAT ("format", "The format standard used in the file system.", DataType.STRING.getDisplayName(), "APFS"),
     ...
     */
    FILE_NAME("fileName", "The short name of the file with its extension but without the directory names.", DataType.STRING.getDisplayName(), "myFile.txt"),
     ...
     */
    RECEIVED_DATE("dateReceived", "The date/time that the data/resource was received.", DataType.STRING.getDisplayName(), "2024-07-10T16:11:09"),
    ...
    /**
     * Retrieve the placeholder properties used by an information supply chain template.
     *
     * @return list of placeholder property types
     */
    public static List<PlaceholderPropertyType> getInformationSupplyChainPlaceholderPropertyTypes()
    {
        ...
        placeholderPropertyTypes.add(PlaceholderProperty.SCOPE.getPlaceholderType());
    ...
    /**
     * Retrieve the placeholder properties used by a solution blueprint template.
     *
     * @return list of placeholder property types
     */
    public static List<PlaceholderPropertyType> getSolutionBlueprintPlaceholderPropertyTypes()
    {
        List<PlaceholderPropertyType> placeholderPropertyTypes = new ArrayList<>();
