...
public class AssociatedSecurityListProperties extends RelationshipBeanProperties
{
     ...
     * Default constructor
     */
    public AssociatedSecurityListProperties()
    {
        super();
        super.typeName = OpenMetadataType.ASSOCIATED_SECURITY_LIST_RELATIONSHIP.typeName;
    }
     ...
     */
    public AssociatedSecurityListProperties(AssociatedSecurityListProperties template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        AssociatedSecurityListProperties that = (AssociatedSecurityListProperties) objectToCompare;
