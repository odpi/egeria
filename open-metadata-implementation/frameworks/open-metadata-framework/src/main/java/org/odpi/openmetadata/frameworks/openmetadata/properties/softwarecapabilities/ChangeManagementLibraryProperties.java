...
public class ChangeManagementLibraryProperties extends ResourceManagerProperties
{
     ...
     */
    public ChangeManagementLibraryProperties(ChangeManagementLibraryProperties template)
    {
        super(template);
    ...
    {
        return "ChangeManagementLibraryProperties{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ChangeManagementLibraryProperties that = (ChangeManagementLibraryProperties) objectToCompare;
