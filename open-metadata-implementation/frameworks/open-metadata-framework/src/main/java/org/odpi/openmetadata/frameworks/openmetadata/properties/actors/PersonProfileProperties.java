...
/**
 * The PersonProfileProperties describes an individual.  Information about the
 * personal profile is stored as an Person entity in the metadata repository.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class PersonProfileProperties extends ActorProfileProperties
{
     ...
     * Default Constructor
     */
    public PersonProfileProperties()
    {
        super();
     ...
     */
    public PersonProfileProperties(PersonProfileProperties template)
    {
        super (template);
    ...
    {
        return "PersonProfileProperties{" +
                "title='" + courtesyTitle + '\'' +
                ", initials='" + initials + '\'' +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        PersonProfileProperties that = (PersonProfileProperties) objectToCompare;
