...
/**
 * SubjectAreaConverter generates a SubjectAreaElement from a SubjectAreaDefinition entity
 */
public class SubjectAreaConverter<B> extends OpenMetadataConverterBase<B>
{
    /**
     * Constructor
     *
     ...
     */
    public SubjectAreaConverter(PropertyHelper propertyHelper,
                                String         serviceName,
                                String         serverName)
    {
        ...
        try
        {
            ...
            if (returnBean instanceof SubjectAreaElement bean)
            {
                ...
                if (openMetadataElement != null)
                {
                    ...
                    properties.setSubjectAreaName(this.removeSubjectAreaName(elementProperties));
                    properties.setUsage(this.removeUsage(elementProperties));
                    properties.setScope(this.removeScope(elementProperties));
                    properties.setDomainIdentifier(this.removeDomainIdentifier(elementProperties));
