...
public class PropertyHelper
{
    ...
    /**
     * Convert a Query Options into a Search Options with the flags set to request an exact match.
     *
     * @param queryOptions supplied query options
     * @return search options
     */
    public SearchOptions getExactMatchSearchOptions(QueryOptions queryOptions)
    {
        SearchOptions searchOptions = new SearchOptions(queryOptions);

        /*
         * The default values set up the most fizzy search.  This tightens it down to an exact match.
         */
     ...
     */
    public SearchClassifications getAnchorSearchClassifications(String contextValue,
                                                                String anchorPropertyName)
    {
        ...
        PrimitiveTypePropertyValue    classificationPropertyValue      = new PrimitiveTypePropertyValue();
        ...
        classificationCondition.setSearchProperties(classificationSearchProperties);
