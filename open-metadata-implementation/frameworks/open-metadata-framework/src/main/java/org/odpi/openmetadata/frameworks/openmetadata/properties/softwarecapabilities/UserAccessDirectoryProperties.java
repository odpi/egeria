...
public class UserAccessDirectoryProperties extends ResourceManagerProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public UserAccessDirectoryProperties(UserAccessDirectoryProperties template)
    {
        super(template);
    }
