...
public class BusinessCapabilityDependencyProperties extends RelationshipBeanProperties
{
    ...
    {
        return "BusinessCapabilityDependencyProperties{" +
                "label='" + label + '\'' +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        BusinessCapabilityDependencyProperties that = (BusinessCapabilityDependencyProperties) objectToCompare;
