...
@JsonSubTypes(
        {
                ...
                @JsonSubTypes.Type(value = DataSharingHubProperties.class, name = "DataSharingHubProperties"),
                ...
                @JsonSubTypes.Type(value = ITSubsystemProperties.class, name = "ITSubsystemProperties"),
