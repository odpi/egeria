...
/**
 * GovernanceRepresentativeProperties describes a role for a person who is supporting a governance domain.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class GovernanceRepresentativeProperties extends GovernanceRoleProperties
{
    /**
     * Default constructor
     */
    ...
    {
        return "GovernanceRepresentativeProperties{} " + super.toString();
    }
}