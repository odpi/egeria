 ...
 */
public class ZoneProfileAnchoredMermaidPieChartBuilder extends PieChartBuilderBase
{
    /**
     ...
     */
    public ZoneProfileAnchoredMermaidPieChartBuilder(OpenMetadataRootElement zone)
    {
    ...
    {
        String title = "Anchored Elements of ";
    ...
    private static Map<String, Long> getProfile(OpenMetadataRootElement element)
    {
        if ((element.getElementHeader().getZoneMembershipProfile() != null) &&
                ...
                (zoneMembershipProfileProperties.getAnchoredTypeMembership() != null))
        {
            return zoneMembershipProfileProperties.getAnchoredTypeMembership();
        }
