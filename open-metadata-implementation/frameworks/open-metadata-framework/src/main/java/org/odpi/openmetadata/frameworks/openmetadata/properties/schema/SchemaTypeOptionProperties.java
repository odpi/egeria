...
public class SchemaTypeOptionProperties extends RelationshipBeanProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public SchemaTypeOptionProperties(SchemaTypeOptionProperties template)
    {
        super(template);
    }
    ...
    {
        return "SchemaTypeOptionProperties{} " + super.toString();
    }
}
