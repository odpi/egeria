...
/**
 * UserIdentityConverter generates a UserIdentityElement from a UserIdentity entity
 */
public class UserIdentityConverter<B> extends OpenMetadataConverterBase<B>
{
    /**
     * Constructor
     *
     ...
     */
    public UserIdentityConverter(PropertyHelper propertyHelper,
                                 String         serviceName,
                                 String         serverName)
    {
        ...
        try
        {
            ...
            if (returnBean instanceof UserIdentityElement bean)
            {
                ...
                if (openMetadataElement != null)
                {
                    ...
                    properties.setUserId(this.removeUserId(elementProperties));
                    properties.setDistinguishedName(this.removeDistinguishedName(elementProperties));
