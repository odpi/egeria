...
{
    private AssetElement              referenceDataAsset       = null;
    private List<ConnectionElement>   referenceDataConnections = null;
     ...
     */
    public AssetElement getReferenceDataAsset()
    {
     ...
     */
    public void setReferenceDataAsset(AssetElement referenceDataAsset)
    {
     ...
     */
    public List<ConnectionElement> getReferenceDataConnections()
    {
     ...
     */
    public void setReferenceDataConnections(List<ConnectionElement> connections)
    {
