...
public class ActorProfileClient extends ConnectorContextClientBase
{
    ...
    public void linkTeamToMembershipRole(String                   teamGUID,
                                         ...
                                         TeamMembershipProperties relationshipProperties) throws InvalidParameterException,
                                                                                                 ...
                                                                                                 UserNotAuthorizedException
    {
        actorProfileHandler.linkTeamToMembershipRole(connectorUserId, teamGUID, personRoleGUID, metadataSourceOptions, relationshipProperties);
    }
    ...
    public void detachTeamFromMembershipRole(String        teamGUID,
                                             ...
                                             DeleteOptions deleteOptions) throws InvalidParameterException,
                                                                                 ...
                                                                                 UserNotAuthorizedException
    {
        actorProfileHandler.detachTeamFromMembershipRole(connectorUserId, teamGUID, personRoleGUID, deleteOptions);
    }
    ...
    public void linkTeamToLeadershipRole(String                   teamGUID,
                                         ...
                                         TeamLeadershipProperties relationshipProperties) throws InvalidParameterException,
                                                                                                 ...
                                                                                                 UserNotAuthorizedException
    {
        actorProfileHandler.linkTeamToLeadershipRole(connectorUserId, teamGUID, personRoleGUID, metadataSourceOptions, relationshipProperties);
    }
    ...
    public void detachTeamFromLeadershipRole(String        teamGUID,
                                             ...
                                             DeleteOptions deleteOptions) throws InvalidParameterException,
                                                                                 ...
                                                                                 UserNotAuthorizedException
    {
        actorProfileHandler.detachTeamFromLeadershipRole(connectorUserId, teamGUID, personRoleGUID, deleteOptions);
    }
