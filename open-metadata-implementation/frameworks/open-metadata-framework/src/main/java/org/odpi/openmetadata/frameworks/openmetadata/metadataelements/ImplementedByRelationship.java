...
/**
 * ImplementedByRelationship contains the properties and header for an ImplementedBy relationship retrieved from the repository.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class ImplementedByRelationship implements MetadataElement
{
    private ElementHeader           elementHeader = null;
    private ImplementedByProperties properties    = null;
     ...
     * Default constructor
     */
    public ImplementedByRelationship()
    {
        super();
    }
     ...
     */
    public ImplementedByRelationship(ImplementedByRelationship template)
    {
        if (template != null)
        {
     ...
     * @return properties
     */
    public ImplementedByProperties getProperties()
    {
        return properties;
    }
     ...
     */
    public void setProperties(ImplementedByProperties properties)
    {
    ...
    {
        return "ImplementedByRelationship{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ImplementedByRelationship that = (ImplementedByRelationship) objectToCompare;
