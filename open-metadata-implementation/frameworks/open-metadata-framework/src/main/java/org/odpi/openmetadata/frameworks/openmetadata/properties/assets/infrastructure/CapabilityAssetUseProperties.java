...
/**
 * CapabilityAssetUseProperties describes the properties for the CapabilityAssetUse relationship between a software
 * server capability and an asset.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class CapabilityAssetUseProperties extends RelationshipBeanProperties
{
    private CapabilityAssetUseType useType             = null;
     ...
     */
    public CapabilityAssetUseProperties(CapabilityAssetUseProperties template)
    {
        super(template);
     ...
     *
     * @return CapabilityAssetUseType enum
     */
    public CapabilityAssetUseType getUseType()
    {
        return useType;
    }
     ...
     *
     * @param useType CapabilityAssetUseType enum
     */
    public void setUseType(CapabilityAssetUseType useType)
    {
    ...
    {
        return "CapabilityAssetUseProperties{" +
                "useType=" + useType +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        CapabilityAssetUseProperties that = (CapabilityAssetUseProperties) objectToCompare;
