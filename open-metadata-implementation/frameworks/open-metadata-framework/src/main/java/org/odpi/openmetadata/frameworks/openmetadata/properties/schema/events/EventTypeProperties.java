...
public class EventTypeProperties extends RootSchemaTypeProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public EventTypeProperties(EventTypeProperties template)
    {
        super(template);
    }
    ...
    {
        return "EventTypeProperties{} " + super.toString();
    }
}
