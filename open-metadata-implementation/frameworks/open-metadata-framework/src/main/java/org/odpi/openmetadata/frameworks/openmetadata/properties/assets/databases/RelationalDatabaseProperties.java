...
/**
 * RelationalDatabaseProperties is a class for representing a generic relational database.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class RelationalDatabaseProperties extends DatabaseProperties
{
    /**
     * Default constructor
     */
    ...
    {
        return "RelationalDatabaseProperties{} " + super.toString();
    }
}
