...
public class StewardshipManagementHandler
{
     ...
     * @throws PropertyServerException    there is a problem reported in the open metadata server(s)
     */
    public RelatedMetadataElementSummaryList getStakeholders(String       userId,
                                                             String       elementGUID,
                                                             QueryOptions queryOptions) throws InvalidParameterException,
                                                                                               UserNotAuthorizedException,
                                                                                               PropertyServerException
     ...
     * @throws PropertyServerException    there is a problem reported in the open metadata server(s)
     */
    public RelatedMetadataElementSummaryList getStakeholderElements(String              userId,
...

    {
        ...
        final String elementGUIDParameterName = "stakeholderGUID";

        propertyHelper.validateGUID(stakeholderGUID, elementGUIDParameterName, methodName);
     ...
     * @param properties role of the stakeholder
     * @param metadataSourceOptions  options to control access to open metadata
     *
     * @throws InvalidParameterException  one of the parameters is invalid
     * @throws UserNotAuthorizedException the user is not authorized to issue this request
    ...
    public void addStakeholderToElement(String                userId,
                                        ...
                                        StakeholderProperties properties) throws InvalidParameterException,
                                                                                 UserNotAuthorizedException,
                                                                                 PropertyServerException
    {
        openMetadataClient.createRelatedElementsInStore(userId,
                                                                                 ...
                                                                                 PropertyServerException
    {
        ...
        propertyHelper.validateUserId(userId, methodName);
        propertyHelper.validateGUID(elementGUID, end1GUIDParameterName, methodName);
        propertyHelper.validateGUID(stakeholderGUID, end2GUIDParameterName, methodName);
     ...
     */
    public List<MetadataElementSummary> getElementsByPropertyValue(String                      userId,
                                                                   FindPropertyNamesProperties findProperties) throws InvalidParameterException,
                                                                                                                      UserNotAuthorizedException,
                                                                                                                      PropertyServerException
    {
        final String methodName = "getElementsByPropertyValue";
        ...
        propertyHelper.validateObject(findProperties, findPropertiesProperty, methodName);
        propertyHelper.validateObject(findProperties.getPropertyValue(), propertyValueProperty, methodName);
        propertyHelper.validateObject(findProperties.getPropertyNames(), propertyNamesProperty, methodName);
                                                                                                                                  ...
                                                                                                                                  PropertyServerException
    {
        ...
        if (findProperties == null)
        {
            openMetadataRelationships = openMetadataClient.findRelationshipsBetweenMetadataElements(userId,
                                                                                                    relationshipTypeName,
                                                                                                    null,
                                                                                                    null);
        }
