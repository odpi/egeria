...
public class DigitalSupportProperties extends RelationshipBeanProperties
{
    String  label   = null;
    ...
    {
        return "DigitalSupportProperties{" +
                "label='" + label + '\'' +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        DigitalSupportProperties that = (DigitalSupportProperties) objectToCompare;
