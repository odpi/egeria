...
/**
 * DigitalProductManagementProperties describes the link between a digital product and its manager.
 */
@JsonAutoDetect(getterVisibility = PUBLIC_ONLY, setterVisibility = PUBLIC_ONLY, fieldVisibility = NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
public class DigitalProductManagementProperties extends RelationshipBeanProperties
{
    /**
     * Default constructor
     */
