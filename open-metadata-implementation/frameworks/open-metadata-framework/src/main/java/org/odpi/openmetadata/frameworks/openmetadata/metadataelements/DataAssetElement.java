...
public class DataAssetElement implements MetadataElement
{
    private DataAssetProperties properties    = null;
     ...
     * @param template object to copy
     */
    public DataAssetElement(AssetElement template)
    {
        if (template != null)
        {
            elementHeader = template.getElementHeader();
            ...
            {
                properties = new DataAssetProperties(assetProperties);
            }
        }
    }
     ...
     */
    public DataAssetProperties getProperties()
    {
        return properties;
    }
     ...
     */
    public void setProperties(DataAssetProperties properties)
    {
