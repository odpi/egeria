...
public class OrganizationalCapabilityProperties extends RelationshipProperties
{
    ...
    {
        super();
        super.setTypeName(OpenMetadataType.ORGANIZATIONAL_CAPABILITY_RELATIONSHIP.typeName);
    }
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (! (objectToCompare instanceof OrganizationalCapabilityProperties that))
        {
            return false;
        }
