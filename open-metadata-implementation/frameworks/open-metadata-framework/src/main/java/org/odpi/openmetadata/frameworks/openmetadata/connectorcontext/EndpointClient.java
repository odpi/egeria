 ...
 */
public class EndpointClient extends ConnectorContextClientBase
{
     ...
     */
    public EndpointClient(ConnectorContextBase     parentContext,
                          ...
                          int                      maxPageSize)
    {
        ...
        this.endpointHandler = new EndpointHandler(localServerName, auditLog, localServiceName, openMetadataClient);
    }
     ...
     */
    public String createEndpoint(NewElementOptions                     newElementOptions,
     ...
     * @param templateGUID the unique identifier of the existing endpoint to copy (this will copy all the attachments such as nested content, schema
     *                     connection etc)
     ...
     * @throws UserNotAuthorizedException the requesting user is not authorized to issue this request.
     */
    public void detachEndpointFromITAsset(String        itAssetGUID,
                                          String        endpointGUID,
                                          DeleteOptions deleteOptions) throws InvalidParameterException,
                                                                              PropertyServerException,
                                                                              UserNotAuthorizedException
    {
        endpointHandler.detachEndpointFromITAsset(connectorUserId, itAssetGUID, endpointGUID, deleteOptions);
    }
     ...
     * @throws UserNotAuthorizedException the requesting user is not authorized to issue this request.
     */
    public void deleteEndpoint(String        endpointGUID,
                               DeleteOptions deleteOptions) throws InvalidParameterException,
                                                                   PropertyServerException,
                                                                   UserNotAuthorizedException
    {
     ...
     * @throws UserNotAuthorizedException the requesting user is not authorized to issue this request.
     */
    public List<OpenMetadataRootElement> getEndpointsByName(String       name,
                                                            QueryOptions queryOptions) throws InvalidParameterException,
                                                                                              PropertyServerException,
                                                                                              UserNotAuthorizedException
    {
        return endpointHandler.getEndpointsByName(connectorUserId, name, queryOptions);
    }
     ...
     * @throws UserNotAuthorizedException the requesting user is not authorized to issue this request.
     */
    public OpenMetadataRootElement getEndpointByGUID(String     endpointGUID,
                                             GetOptions getOptions) throws InvalidParameterException,
                                                                           PropertyServerException,
                                                                           UserNotAuthorizedException
    {
        return endpointHandler.getEndpointByGUID(connectorUserId, endpointGUID, getOptions);
    }
     ...
     * @throws UserNotAuthorizedException the requesting user is not authorized to issue this request.
     */
    public List<OpenMetadataRootElement> getEndpointsByNetworkAddress(String       networkAddress,
                                                              QueryOptions queryOptions) throws InvalidParameterException,
                                                                                                        UserNotAuthorizedException,
                                                                                                        PropertyServerException
    {
        return endpointHandler.getEndpointsByNetworkAddress(connectorUserId, networkAddress, queryOptions);
    }
     ...
     * @throws PropertyServerException    a problem reported in the open metadata server(s)
     */
    public List<OpenMetadataRootElement> getEndpointsForInfrastructure(String       infrastructureGUID,
                                                               QueryOptions queryOptions) throws InvalidParameterException,
                                                                                                         UserNotAuthorizedException,
                                                                                                         PropertyServerException
    {
        return endpointHandler.getEndpointsForInfrastructure(connectorUserId, infrastructureGUID, queryOptions);
    }
     ...
     * The returned endpoints include a list of the components that are associated with it.
     ...
     * @throws PropertyServerException    a problem reported in the open metadata server(s)
     */
    public List<OpenMetadataRootElement> findEndpoints(String        searchString,
                                               SearchOptions searchOptions) throws InvalidParameterException,
                                                                                   UserNotAuthorizedException,
                                                                                   PropertyServerException
    {
        return endpointHandler.findEndpoints(connectorUserId, searchString, searchOptions);
    }
}
