...
/**
 * GraphStoreProperties is a class for representing a generic graph database.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class GraphStoreProperties extends DataStoreProperties
{
    /**
     * Default constructor
     */
    ...
    {
        return "GraphStoreProperties{} " + super.toString();
    }
}
