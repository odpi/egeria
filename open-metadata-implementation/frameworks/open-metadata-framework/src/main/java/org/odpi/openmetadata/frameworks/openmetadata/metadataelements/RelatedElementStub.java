...
/**
 * RelatedElementStub contains the properties and header for a relationship retrieved from the metadata repository along with the stub
...
public class RelatedElementStub
{
     ...
     */
    public RelatedElementStub(RelatedElementStub template)
    {
        if (template != null)
        {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        RelatedElementStub that = (RelatedElementStub) objectToCompare;
