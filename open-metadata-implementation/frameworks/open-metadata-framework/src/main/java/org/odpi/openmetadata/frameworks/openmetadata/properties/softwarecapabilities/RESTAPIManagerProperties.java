...
public class RESTAPIManagerProperties extends APIManagerProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public RESTAPIManagerProperties(RESTAPIManagerProperties template)
    {
        super(template);
    }
    ...
    {
        return "RESTAPIManagerProperties{} " + super.toString();
    }
}
