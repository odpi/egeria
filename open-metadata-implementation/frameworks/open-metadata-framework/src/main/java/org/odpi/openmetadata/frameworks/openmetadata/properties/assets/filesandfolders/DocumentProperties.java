...
public class DocumentProperties extends MediaFileProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public DocumentProperties(MediaFileProperties template)
    {
        super(template);
    }
    ...
    {
        return "DocumentProperties{} " + super.toString();
    }
}
