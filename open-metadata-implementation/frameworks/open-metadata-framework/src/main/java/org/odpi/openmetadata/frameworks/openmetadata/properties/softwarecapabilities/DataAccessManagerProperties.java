...
public class DataAccessManagerProperties extends DataManagerProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public DataAccessManagerProperties(DataAccessManagerProperties template)
    {
        super(template);
    }
    ...
    {
        return "DataAccessManagerProperties{} " + super.toString();
    }
}
