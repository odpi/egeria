...
/**
 * RelatedTermProperties describes a relationship between two glossary terms.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class RelatedTermProperties extends GlossaryTermRelationshipProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public RelatedTermProperties(RelatedTermProperties template)
    {
        super(template);
    }
