...
public class ContextDefinitionProperties extends ClassificationBeanProperties
{
     ...
     */
    public ContextDefinitionProperties(ContextDefinitionProperties template)
    {
        super (template);
    ...
    {
        return "ContextDefinitionProperties{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ContextDefinitionProperties that = (ContextDefinitionProperties) objectToCompare;
