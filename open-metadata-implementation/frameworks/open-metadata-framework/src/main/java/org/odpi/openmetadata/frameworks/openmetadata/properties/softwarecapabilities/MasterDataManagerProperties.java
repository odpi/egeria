...
public class MasterDataManagerProperties extends ResourceManagerProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public MasterDataManagerProperties(MasterDataManagerProperties template)
    {
        super(template);
    }
    ...
    {
        return "MasterDataManagerProperties{} " + super.toString();
    }
}
