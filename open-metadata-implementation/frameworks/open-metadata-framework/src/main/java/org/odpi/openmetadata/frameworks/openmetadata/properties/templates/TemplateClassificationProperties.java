...
public class TemplateClassificationProperties
{
     ...
     * Default constructor
     */
    public TemplateClassificationProperties()
    {
        super();
    }
     ...
     */
    public TemplateClassificationProperties(TemplateClassificationProperties template)
    {
        if (template != null)
        {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        TemplateClassificationProperties that = (TemplateClassificationProperties) objectToCompare;
