...
/**
 * ActionType provides an initial set of values for ActionType.  These can be extended as required.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public enum ActionType implements OpenMetadataRefData
{
    /**
    ...
    /**
     * Name of the action target to associate with the action.
     *
     * @return name
     */
