 ...
 */
public class ZoneProfileMermaidPieChartBuilder extends PieChartBuilderBase
{
    /**
     ...
     */
    public ZoneProfileMermaidPieChartBuilder(OpenMetadataRootElement zone)
    {
    ...
    private static Map<String, Long> getProfile(OpenMetadataRootElement element)
    {
        if ((element.getElementHeader().getZoneMembershipProfile() != null) &&
                ...
                (zoneMembershipProfileProperties.getTypeMembership() != null))
        {
            return zoneMembershipProfileProperties.getTypeMembership();
        }
