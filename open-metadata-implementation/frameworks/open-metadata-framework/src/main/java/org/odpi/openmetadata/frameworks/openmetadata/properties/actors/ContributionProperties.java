...
public class ContributionProperties extends RelationshipBeanProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public ContributionProperties(ContributionProperties template)
    {
        super(template);
    }
    ...
    {
        return "ContributionProperties{} " + super.toString();
    }
}
