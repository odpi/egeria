...
public class SubjectAreaHierarchyProperties extends RelationshipBeanProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public SubjectAreaHierarchyProperties(SubjectAreaHierarchyProperties template)
    {
        super(template);
    }
    ...
    {
        return "SubjectAreaHierarchyProperties{} " + super.toString();
    }
}
