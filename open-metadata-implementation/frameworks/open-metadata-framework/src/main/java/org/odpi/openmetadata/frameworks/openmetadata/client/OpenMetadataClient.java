                                                    ...
                                                    SpecificationPropertiesInterface
{
     ...
     */
    @Override
    public abstract String addTypeDef(String              userId,
     ...
     */
    @Override
    public abstract OpenMetadataTypeDef updateTypeDef(String                   userId,
     ...
     */
    @Override
    public abstract String addEnumDef(String              userId,
     ...
     */
    @Override
    public abstract void deleteEnumDef(String userId,
                                       String enumDefGUID,
    ...
    public long countMetadataElements(String                userId,
                                      ...
                                      QueryOptions          queryOptions) throws InvalidParameterException,
                                                                                 ...
                                                                                 PropertyServerException
    {
        return this.countMetadataElements(userId, searchProperties, matchClassifications, queryOptions, true);
    }
     ...
     */
    @Override
    public  abstract long countMetadataElements(String                userId,
                                               SearchProperties      searchProperties,
                                               SearchClassifications matchClassifications,
