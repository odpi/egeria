...
/**
 * OpenMetadataOutTopicEvent provides the structure of the OMF Services' OutTopic events.  The values for elements and their classifications
...
public class OpenMetadataOutTopicEvent
{
    private long                  eventVersionId = 1L;
    private OpenMetadataEventType eventType      = null;
    private Date                  eventTime      = null;
    private ElementHeader         elementHeader      = null;
    private ElementProperties     elementProperties  = null;

    private ElementHeader         previousElementHeader     = null;
    private ElementProperties     previousElementProperties = null;
    ...
    private ElementProperties     previousClassificationProperties = null;

    /*
     * For relationship events
     */
    private ElementHeader         endOneElementHeader      = null;
    private ElementProperties     endOneElementProperties  = null;
    private ElementHeader         endTwoElementHeader      = null;
    private ElementProperties     endTwoElementProperties  = null;


    /**
     * Default Constructor
     */
    public OpenMetadataOutTopicEvent()
    {
    }
     ...
     */
    public OpenMetadataOutTopicEvent(OpenMetadataOutTopicEvent template)
    {
        if (template != null)
        {
            ...
            endTwoElementProperties = template.getEndTwoElementProperties();
        }
    }
     ...
     */
    public OpenMetadataEventType getEventType()
    {
        return eventType;
    }
     ...
     */
    public void setEventType(OpenMetadataEventType eventType)
    {
     ...
     * @return property map
     */
    public ElementProperties getPreviousElementProperties()
    {
     ...
     */
    public void setPreviousElementProperties(ElementProperties previousElementProperties)
    {
     ...
     *
     * @param classificationProperties property map
     */
     ...
     * @return property map
     */
    public ElementProperties getPreviousClassificationProperties()
    {
     ...
     */
    public void setPreviousClassificationProperties(ElementProperties previousClassificationProperties)
    {
     ...
     * @return property map
     */
    public ElementProperties getEndOneElementProperties()
    {
     ...
     */
    public void setEndOneElementProperties(ElementProperties properties)
    {
     ...
     * @return property map
     */
    public ElementProperties getEndTwoElementProperties()
    {
        return endOneElementProperties;
    }
     ...
     * @param properties property map
     */
    public void setEndTwoElementProperties(ElementProperties properties)
    {
        this.endOneElementProperties = properties;
    }
    ...
    {
        return "OpenMetadataOutTopicEvent{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        OpenMetadataOutTopicEvent that = (OpenMetadataOutTopicEvent) objectToCompare;
    ...
    public int hashCode()
    {
        return Objects.hash(eventVersionId, eventType, eventTime, elementHeader, elementProperties, previousElementHeader, previousElementProperties,
                            classificationName, classificationProperties, previousClassificationProperties, endOneElementHeader, endOneElementProperties, endTwoElementHeader,
