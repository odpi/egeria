...
public class NotificationManagerProperties extends ResourceManagerProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public NotificationManagerProperties(NotificationManagerProperties template)
    {
        super(template);
    }
    ...
    {
        return "NotificationManagerProperties{} " + super.toString();
    }
}
