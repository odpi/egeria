...
public class NewToDoActionTargetProperties
{
     ...
     * Typical Constructor
     */
    public NewToDoActionTargetProperties()
    {
    }
     ...
     */
    public NewToDoActionTargetProperties(NewToDoActionTargetProperties template)
    {
        if (template != null)
        {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        NewToDoActionTargetProperties that = (NewToDoActionTargetProperties) objectToCompare;
