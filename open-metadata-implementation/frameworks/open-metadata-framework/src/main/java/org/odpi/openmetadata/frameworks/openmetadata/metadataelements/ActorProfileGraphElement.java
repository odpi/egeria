...
public class ActorProfileGraphElement implements MetadataElement
{
     ...
     * Default Constructor
     */
    public ActorProfileGraphElement()
    {
    }
     ...
     */
    public ActorProfileGraphElement(ActorProfileGraphElement template)
    {
        if (template != null)
        {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ActorProfileGraphElement that = (ActorProfileGraphElement) objectToCompare;
