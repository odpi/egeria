...
public class SolutionComponentPort implements MetadataElement
{
     ...
     */
    public SolutionComponentPort(SolutionComponentPort template)
    {
        if (template != null)
        {
            elementHeader = template.getElementHeader();
            properties   = template.getProperties();
            solutionPort = template.getSolutionPort();
        }
    }
     ...
     * @return header
     */
    public SolutionPortElement getSolutionPort()
    {
        return solutionPort;
    }
     ...
     *
     * @param solutionPort  header
     */
    public void setSolutionPort(SolutionPortElement solutionPort)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        SolutionComponentPort that = (SolutionComponentPort) objectToCompare;
        return Objects.equals(elementHeader, that.elementHeader) &&
                       Objects.equals(properties, that.properties) &&
                       Objects.equals(solutionPort, that.solutionPort);
    }
    ...
    public int hashCode()
    {
        return Objects.hash(elementHeader, properties, solutionPort);
    }
}
