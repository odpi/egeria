...
import org.odpi.openmetadata.frameworks.openmetadata.properties.feedback.AcceptedAnswerProperties;
...
@JsonSubTypes(
        {
                @JsonSubTypes.Type(value = PortAliasProperties.class, name = "PortAliasProperties"),
                @JsonSubTypes.Type(value = PortImplementationProperties.class, name = "PortImplementationProperties"),
        })
