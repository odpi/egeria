...
public class SolutionRoleProperties extends ActorRoleProperties
{

    /**
     * Default constructor
     */
    public SolutionRoleProperties()
    {
        super();
     ...
     */
    public SolutionRoleProperties(SolutionRoleProperties template)
    {
        super(template);
    }
    ...
    {
        return "SolutionRoleProperties{} " + super.toString();
    }
}
