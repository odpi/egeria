...
public class ReportElement implements MetadataElement
{
    private ElementHeader   elementHeader = null;
    private ReportProperties properties    = null;
     ...
     */
    public ReportElement(ReportElement template)
    {
        if (template != null)
        {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ReportElement that = (ReportElement) objectToCompare;
