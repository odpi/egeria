...
public class TeamRoleAppointmentProperties extends RelationshipBeanProperties
{
     ...
     */
    public TeamRoleAppointmentProperties(TeamRoleAppointmentProperties template)
    {
        super(template);
    ...
    {
        return "TeamRoleAppointmentProperties{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        TeamRoleAppointmentProperties that = (TeamRoleAppointmentProperties) objectToCompare;
