...
public enum OMFAuditCode implements AuditLogMessageSet
{
    ...
    /**
     * OPEN-METADATA-0018 - The {0} governance service is not yet monitoring notification type {1} because it is planned to start at {2}
     */
    NOTIFICATION_TYPE_NOT_STARTED("OPEN-METADATA-0018",
                                  AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * OPEN-METADATA-0019 - The {0} service has stopped monitoring notification type {1} because it has passed its completion date of {2}
     */
    NOTIFICATION_TYPE_COMPLETED("OPEN-METADATA-0019",
                                AuditLogRecordSeverityLevel.INFO,
