...
/**
 * OMFRuntimeException is used for all runtime exceptions generated by the OCF.  The OCFErrorCode provides
...
public class OMFRuntimeException extends RuntimeException
{
    ...
    private static final Logger log = LoggerFactory.getLogger(OMFRuntimeException.class);
     ...
     */
    public OMFRuntimeException(ExceptionMessageDefinition messageDefinition,
                               String                     className,
     ...
     * @param relatedProperties  arbitrary properties that may help with diagnosing the problem.
     */
    public OMFRuntimeException(int                 httpCode,
                               String              className,
                               String              actionDescription,
                               String              errorMessage,
     ...
     */
    public OMFRuntimeException(String              errorMessage,
                               OMFRuntimeException template)
    {
     ...
     * @param template   object to copy
     */
    public OMFRuntimeException(OMFRuntimeException template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        OMFRuntimeException that = (OMFRuntimeException) objectToCompare;
