...
public class UserAuthenticationManagerProperties extends SoftwareCapabilityProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public UserAuthenticationManagerProperties(UserAuthenticationManagerProperties template)
    {
        super(template);
    }
    ...
    {
        return "UserAuthenticationManagerProperties{} " + super.toString();
    }
}
