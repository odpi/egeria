...
public class EditingGlossaryProperties extends ClassificationBeanProperties
{
    ...
    {
        super();
        super.setTypeName(OpenMetadataType.EDITING_GLOSSARY_CLASSIFICATION.typeName);
    }
