...
public class IntegrationReportProperties
{
    ...
    /**
     * Return the date/time that the connector started.
     *
     * @return date
     */
    ...
    /**
     * Return the date/time that the connector was called to disconnect.
     *
     * @return date
     */
    ...
    public int hashCode()
    {
        return Objects.hash(serverName, connectorId, connectorName, connectorStartDate, connectorDisconnectDate,
                            refreshStartDate, refreshCompletionDate, createdElements, updatedElements,
