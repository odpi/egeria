...
/**
 * SolutionOwnerProperties describes a role for a person who is responsible for a solution.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class SolutionOwnerProperties extends GovernanceRoleProperties
{
    /**
     * Default constructor
     */
    ...
    {
        return "SolutionOwnerProperties{} " + super.toString();
    }
}