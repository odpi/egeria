...
/**
 * SurveyReportProperties describes the properties for a survey report.
 */
...
public class SurveyReportProperties extends ReportProperties
{
    ...
    /**
     * Return the parameters used to drive the survey action service's analysis.
     *
    ...
    /**
     * Set up the parameters used to drive the survey action service's analysis.
     *
