...
/**
 * SolutionPortDelegationProperties represents a SolutionPortDelegation relationship.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class SolutionPortDelegationProperties extends RoledRelationshipProperties
{
    /**
     * Default constructor
     */
    ...
    {
        super();
        super.typeName = OpenMetadataType.SOLUTION_PORT_DELEGATION_RELATIONSHIP.typeName;
    }
