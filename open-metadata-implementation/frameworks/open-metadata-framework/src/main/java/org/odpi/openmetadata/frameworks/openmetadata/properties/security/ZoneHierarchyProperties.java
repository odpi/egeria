...
public class ZoneHierarchyProperties extends RelationshipBeanProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public ZoneHierarchyProperties(ZoneHierarchyProperties template)
    {
        super(template);
    }
    ...
    {
        return "ZoneHierarchyProperties{} " + super.toString();
    }
}
