...
public class SoftwareCapabilityClient extends ConnectorContextClientBase
{
     ...
     * @throws UserNotAuthorizedException the requesting user is not authorized to issue this request.
     */
    public void updateSoftwareCapability(String             softwareCapabilityGUID,
                                         UpdateOptions      updateOptions,
                                         SoftwareCapabilityProperties properties) throws InvalidParameterException,
                                                                                         PropertyServerException,
                                                                                         UserNotAuthorizedException
    {
        softwareCapabilityHandler.updateSoftwareCapability(connectorUserId, softwareCapabilityGUID, updateOptions, properties);
