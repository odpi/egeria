...
/**
 * WorkflowEngineProperties describes the Workflow engine capability of a server
 */
@JsonAutoDetect(getterVisibility = PUBLIC_ONLY, setterVisibility = PUBLIC_ONLY, fieldVisibility = NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
public class WorkflowEngineProperties extends SoftwareCapabilityProperties
{
    /**
     * Default constructor
     */
    ...
    {
        return "WorkflowEngineProperties{} " + super.toString();
    }
}
