...
/**
 * ThreeDImageFileProperties describes a media file.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class ThreeDImageFileProperties extends MediaFileProperties
{
    /**
     * Default constructor
     */
    ...
    {
        return "ThreeDImageFileProperties{} " + super.toString();
    }
}
