 ...
 * a new iterator.
 */
public abstract class Licenses extends PropertyIteratorBase implements Iterator<License>
{
     ...
     */
    public Licenses(int totalElementCount,
                    int maxCacheSize)
    {
     ...
     */
    public Licenses(Licenses template)
    {
        super(template);
    }
    ...
    {
        if (template instanceof License)
        {
            return new License((License)template);
        }
     ...
     * @return new cloned object.
     */
    protected  abstract Licenses cloneIterator();
