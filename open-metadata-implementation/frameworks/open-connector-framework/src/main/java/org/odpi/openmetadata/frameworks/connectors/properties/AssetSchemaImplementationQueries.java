                                                       ...
                                                       implements Iterator<AssetSchemaImplementationQuery>
{
     ...
     */
    public AssetSchemaImplementationQueries(AssetDescriptor              parentAsset,
     ...
     */
    public AssetSchemaImplementationQueries(AssetDescriptor   parentAsset, AssetSchemaImplementationQueries template)
    {
    ...
    {
        return new AssetSchemaImplementationQuery(parentAsset, (AssetSchemaImplementationQuery) template);
    }
     ...
     * @return new cloned object.
     */
    protected  abstract AssetSchemaImplementationQueries cloneIterator(AssetDescriptor  parentAsset);
     ...
     */
    @Override
    public AssetSchemaImplementationQuery next()
    {
        return (AssetSchemaImplementationQuery)super.pagingIterator.next();
    }
    ...
    {
        return "AssetSchemaImplementationQueries{" +
