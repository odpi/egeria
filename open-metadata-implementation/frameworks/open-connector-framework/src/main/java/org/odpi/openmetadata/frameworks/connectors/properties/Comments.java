 ...
 * a new iterator.
 */
public abstract class Comments extends PropertyIteratorBase implements Iterator<Comment>
{
     ...
     */
    public Comments(int                          totalElementCount,
                    int                          maxCacheSize)
    {
     ...
     */
    public Comments(Comments template)
    {
        super(template);
    }
    ...
    protected ElementBase cloneElement(ElementBase template)
    {
        if (template != null)
        {
            return new Comment((Comment)template);
        }
     ...
     * @return new cloned object.
     */
    protected  abstract Comments cloneIterator();
