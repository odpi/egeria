...
public abstract class AssetInformalTags extends AssetPropertyIteratorBase implements Iterator<AssetInformalTag>
{
     ...
     */
    public AssetInformalTags(AssetDescriptor              parentAsset,
     ...
     */
    public AssetInformalTags(AssetDescriptor   parentAsset, AssetInformalTags template)
    {
     ...
     * @return new cloned object.
     */
    protected  abstract AssetInformalTags cloneIterator(AssetDescriptor  parentAsset);
    ...
    {
        return (AssetInformalTag)super.pagingIterator.next();
    }
