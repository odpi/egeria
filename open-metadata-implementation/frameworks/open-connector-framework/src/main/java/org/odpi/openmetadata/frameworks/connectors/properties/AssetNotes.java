 ...
 * a new iterator.
 */
public abstract class AssetNotes extends AssetPropertyIteratorBase implements Iterator<AssetNote>
{
     ...
     */
    public AssetNotes(AssetDescriptor parentAsset, AssetNotes template)
    {
     ...
     * @return new cloned object.
     */
    protected  abstract AssetNotes cloneIterator(AssetDescriptor parentAsset);
     ...
     */
    @Override
    public AssetNote next()
    {
        return (AssetNote)super.pagingIterator.next();
    }
