...
/**
 * RelatedAssetDetails returns detailed information about an asset that is related to an asset
 ...
 *
 * The RelatedAssetDetails returns metadata about the asset at three levels of detail:
 * <ul>
 ...
 * </ul>
 *
 * RelatedAssetDetails is a base class for the asset information that returns null,
...
public abstract class RelatedAssetDetails extends RelatedAsset
{
    ...
    /**
     * Request the values in the RelatedAssetDetails are refreshed with the current values from the
     * metadata repository.
     *
