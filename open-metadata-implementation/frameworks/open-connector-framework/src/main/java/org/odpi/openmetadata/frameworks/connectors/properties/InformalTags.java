 ...
 * a new iterator.
 */
public abstract class InformalTags extends PropertyIteratorBase implements Iterator<InformalTag>
{
    /**
     ...
     */
    public InformalTags(int maxCacheSize)
    {
        super(maxCacheSize);
    }
    ...
    {
        if (template instanceof InformalTag)
        {
            return new InformalTag((InformalTag)template);
        }
