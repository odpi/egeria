 ...
 * a new iterator.
 */
public abstract class AssetMeanings extends AssetPropertyIteratorBase implements Iterator<AssetMeaning>
{
    /**
     ...
     */
    public AssetMeanings(AssetDescriptor              parentAsset,
     ...
     */
    public AssetMeanings(AssetDescriptor   parentAsset, AssetMeanings template)
    {
     ...
     * @return new cloned object.
     */
    protected  abstract AssetMeanings cloneIterator(AssetDescriptor  parentAsset);
     ...
     */
    @Override
    public AssetMeaning next()
    {
        return (AssetMeaning)super.pagingIterator.next();
    }
