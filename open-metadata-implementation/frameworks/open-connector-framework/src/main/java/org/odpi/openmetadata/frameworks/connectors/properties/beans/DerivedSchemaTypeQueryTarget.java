...
public class DerivedSchemaTypeQueryTarget extends PropertyBase
{
     ...
     */
    public DerivedSchemaTypeQueryTarget(DerivedSchemaTypeQueryTarget template)
    {
        super(template);
    ...
    {
        return "DerivedSchemaTypeQueryTarget{" +
                "queryId=" + queryId +
                ", query='" + query + '\'' +
                ", queryType='" + queryType + '\'' +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof DerivedSchemaTypeQueryTarget))
        {
            return false;
        }
        DerivedSchemaTypeQueryTarget that = (DerivedSchemaTypeQueryTarget) objectToCompare;
