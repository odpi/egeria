 ...
 * a new iterator.
 */
public abstract class Likes extends PropertyIteratorBase implements Iterator<Like>
{
     ...
     */
    public Likes(int totalElementCount,
                 int maxCacheSize)
    {
    ...
    {
        if (template instanceof Like)
        {
            return new Like((Like)template);
        }
     ...
     * @return new cloned object.
     */
    protected  abstract Likes cloneIterator();
