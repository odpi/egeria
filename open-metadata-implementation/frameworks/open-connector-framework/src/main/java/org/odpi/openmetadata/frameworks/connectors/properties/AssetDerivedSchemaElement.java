...
public class AssetDerivedSchemaElement extends AssetPrimitiveSchemaElement
{
     ...
     */
    public AssetDerivedSchemaElement(DerivedSchemaElement             derivedSchemaElementBean,
     ...
     * @param queries queries used to create the element
     */
    public AssetDerivedSchemaElement(AssetDescriptor                  parentAsset,
     ...
     */
    public AssetDerivedSchemaElement(AssetDescriptor  parentAsset, AssetDerivedSchemaElement templateSchemaElement)
    {
    ...
    {
        return new AssetDerivedSchemaElement(parentAsset, this);
    }
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof AssetDerivedSchemaElement))
        {
            return false;
        }
        ...
        AssetDerivedSchemaElement that = (AssetDerivedSchemaElement) objectToCompare;
