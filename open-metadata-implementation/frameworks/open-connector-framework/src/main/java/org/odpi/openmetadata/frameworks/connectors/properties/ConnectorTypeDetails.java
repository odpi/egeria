 ...
 */
public class ConnectorTypeDetails extends AssetReferenceable
{
     ...
     */
    public ConnectorTypeDetails(ConnectorType   connectorTypeBean)
    {
     ...
     */
    public ConnectorTypeDetails(ConnectorTypeDetails templateConnectorType)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ConnectorTypeDetails that = (ConnectorTypeDetails) objectToCompare;
