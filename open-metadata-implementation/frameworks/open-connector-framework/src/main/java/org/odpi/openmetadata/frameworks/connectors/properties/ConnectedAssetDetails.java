...
/**
 * ConnectedAssetDetails is associated with a Connector.  Connectors provide access to
 * assets.   ConnectedAssetDetails returns properties (metadata) about the connector's asset.
 *
 ...
 *
 * The ConnectedAssetDetails returns metadata about the asset at three levels of detail:
 * <ul>
 ...
 * </ul>
 *
 * ConnectedAssetDetails is a base class for the connector's metadata API that returns null,
 ...
 */
public abstract class ConnectedAssetDetails extends PropertyBase
{
    /*
     ...
     */
    public ConnectedAssetDetails(ConnectedAssetDetails templateProperties)
    {
    ...
    /**
     * Request the values in the ConnectedAssetDetails are refreshed with the current values from the
     * metadata repository.
     *
