 ...
 * a new iterator.
 */
public abstract class AssetLocations extends AssetPropertyIteratorBase implements Iterator<AssetLocation>
{
     ...
     */
    public AssetLocations(AssetDescriptor              parentAsset,
     ...
     */
    public AssetLocations(AssetDescriptor   parentAsset, AssetLocations template)
    {
     ...
     * @return new cloned object.
     */
    protected  abstract AssetLocations cloneIterator(AssetDescriptor  parentAsset);
     ...
     */
    @Override
    public AssetLocation next()
    {
        return (AssetLocation)super.pagingIterator.next();
    }
