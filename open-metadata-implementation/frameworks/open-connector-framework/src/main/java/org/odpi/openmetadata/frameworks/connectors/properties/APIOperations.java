...
public abstract class APIOperations extends PropertyIteratorBase implements Iterator<APIOperation>
{
     ...
     */
    public APIOperations(int totalElementCount,
                         int maxCacheSize)
    {
     ...
     */
    public APIOperations(APIOperations template)
    {
        super(template);
    }
    ...
    {
        if (template instanceof APIOperation)
        {
            return new APIOperation((APIOperation) template);
        }
     ...
     * @return new cloned object.
     */
    protected  abstract APIOperations cloneIterator();
    ...
    {
        return (APIOperation) super.pagingIterator.next();
    }
