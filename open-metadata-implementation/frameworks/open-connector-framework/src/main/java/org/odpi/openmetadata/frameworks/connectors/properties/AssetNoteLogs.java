 ...
 * a new iterator.
 */
public abstract class AssetNoteLogs extends AssetPropertyIteratorBase implements Iterator<AssetNoteLog>
{
     ...
     */
    public AssetNoteLogs(AssetDescriptor              parentAsset,
     ...
     */
    public AssetNoteLogs(AssetDescriptor   parentAsset, AssetNoteLogs template)
    {
     ...
     * @return new cloned object.
     */
    protected  abstract AssetNoteLogs cloneIterator(AssetDescriptor  parentAsset);
     ...
     */
    @Override
    public AssetNoteLog next()
    {
        return (AssetNoteLog)super.pagingIterator.next();
    }
