...
public abstract class AssetRatings extends AssetPropertyIteratorBase implements Iterator<AssetRating>
{
     ...
     */
    public AssetRatings(AssetDescriptor              parentAsset,
     ...
     */
    public AssetRatings(AssetDescriptor   parentAsset, AssetRatings template)
    {
     ...
     * @return new cloned object.
     */
    protected  abstract AssetRatings cloneIterator(AssetDescriptor  parentAsset);
     ...
     */
    @Override
    public AssetRating next()
    {
        return (AssetRating)super.pagingIterator.next();
    }
