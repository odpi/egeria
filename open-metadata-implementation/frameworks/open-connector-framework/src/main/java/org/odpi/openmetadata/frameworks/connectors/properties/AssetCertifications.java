 ...
 * a new iterator.
 */
public abstract class AssetCertifications extends AssetPropertyIteratorBase implements Iterator<AssetCertification>
{
     ...
     */
    public AssetCertifications(AssetDescriptor parentAsset,
     ...
     */
    public AssetCertifications(AssetDescriptor parentAsset, AssetCertifications template)
    {
     ...
     * @return new cloned object.
     */
    protected  abstract AssetCertifications cloneIterator(AssetDescriptor parentAsset);
     ...
     */
    @Override
    public AssetCertification next()
    {
        return (AssetCertification)super.pagingIterator.next();
    }
