 ...
 */
public abstract class AssetRelatedMediaReferences extends AssetPropertyIteratorBase
                                                  implements Iterator<AssetRelatedMediaReference>
{
     ...
     */
    public AssetRelatedMediaReferences(AssetDescriptor parentAsset,
     ...
     */
    public AssetRelatedMediaReferences(AssetDescriptor parentAsset, AssetRelatedMediaReferences template)
    {
     ...
     * @return new cloned object.
     */
    protected  abstract AssetRelatedMediaReferences cloneIterator(AssetDescriptor parentAsset);
     ...
     */
    @Override
    public AssetRelatedMediaReference next()
    {
        return (AssetRelatedMediaReference)super.pagingIterator.next();
    }
    ...
    {
        return "AssetRelatedMediaReferences{" +
