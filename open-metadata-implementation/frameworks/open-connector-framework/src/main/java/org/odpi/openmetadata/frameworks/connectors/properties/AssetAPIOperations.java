...
public abstract class AssetAPIOperations extends AssetPropertyIteratorBase implements Iterator<AssetSchemaAttribute>
{
     ...
     */
    public AssetAPIOperations(AssetDescriptor              parentAsset,
     ...
     */
    public AssetAPIOperations(AssetDescriptor   parentAsset, AssetAPIOperations template)
    {
     ...
     * @return new cloned object.
     */
    protected  abstract AssetAPIOperations cloneIterator(AssetDescriptor  parentAsset);
