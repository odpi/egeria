...
public abstract class AssetComments extends AssetPropertyIteratorBase implements Iterator<AssetComment>
{
     ...
     */
    public AssetComments(AssetDescriptor              parentAsset,
     ...
     */
    public AssetComments(AssetDescriptor   parentAsset, AssetComments template)
    {
     ...
     * @return new cloned object.
     */
    protected  abstract AssetComments cloneIterator(AssetDescriptor  parentAsset);
    ...
    {
        return (AssetComment)super.pagingIterator.next();
    }
