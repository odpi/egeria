 ...
 * a new iterator.
 */
public abstract class AssetSchemaLinks extends AssetPropertyIteratorBase implements Iterator<AssetSchemaLink>
{
    /**
     ...
     */
    public AssetSchemaLinks(AssetDescriptor parentAsset,
     ...
     */
    public AssetSchemaLinks(AssetDescriptor parentAsset, AssetSchemaLinks template)
    {
    ...
    {
        return new AssetSchemaLink(parentAsset, (AssetSchemaLink)template);
    }
     ...
     * @return new cloned object.
     */
    protected  abstract AssetSchemaLinks cloneIterator(AssetDescriptor parentAsset);
     ...
     */
    @Override
    public AssetSchemaLink next()
    {
        return (AssetSchemaLink)super.pagingIterator.next();
    }
