 ...
 * a new iterator.
 */
public abstract class AssetExternalReferences extends AssetPropertyIteratorBase implements Iterator<AssetExternalReference>
{
     ...
     */
    public AssetExternalReferences(AssetDescriptor              parentAsset,
     ...
     */
    public AssetExternalReferences(AssetDescriptor   parentAsset, AssetExternalReferences template)
    {
     ...
     * @return new cloned object.
     */
    protected  abstract AssetExternalReferences cloneIterator(AssetDescriptor  parentAsset);
     ...
     */
    @Override
    public AssetExternalReference next()
    {
        return (AssetExternalReference)super.pagingIterator.next();
    }
    ...
    {
        return "AssetExternalReferences{" +
