 ...
 */
public class MockConnectionCheckedExceptionConnectorProvider extends ConnectorProviderBase
{

    /**
     * The constructor sets up the name of the connector class.
     */
    public MockConnectionCheckedExceptionConnectorProvider()
    {
        super();
    }
    ...
    {
        throw new ConnectionCheckedException(OCFErrorCode.NO_MORE_ELEMENTS.getMessageDefinition("IteratorName"),
