...
/**
 * Validate that the PrimitiveSchemaElement bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class TestPrimitiveSchemaElement
{
     ...
     * Default constructor
     */
    public TestPrimitiveSchemaElement()
    {
     ...
     */
    private PrimitiveSchemaElement getTestObject()
    {
        PrimitiveSchemaElement testObject = new PrimitiveSchemaElement();
     ...
     */
    private void validateResultObject(PrimitiveSchemaElement  resultObject)
    {
    ...
    {
        PrimitiveSchemaElement    nullObject = new PrimitiveSchemaElement();
        ...
        nullObject = new PrimitiveSchemaElement(null);
    ...
    @Test public void testEquals()
    {
        ...
        PrimitiveSchemaElement  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        PrimitiveSchemaElement  differentObject = getTestObject();
    ...
    {
        validateResultObject(new PrimitiveSchemaElement(getTestObject()));
    }
    ...
    @Test public void testAbstractClone()
    {
        ...
        validateResultObject((PrimitiveSchemaElement)schemaElement.cloneSchemaElement());
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, PrimitiveSchemaElement.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((PrimitiveSchemaElement) objectMapper.readValue(jsonString, SchemaElement.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((PrimitiveSchemaElement) objectMapper.readValue(jsonString, Referenceable.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((PrimitiveSchemaElement) objectMapper.readValue(jsonString, ElementHeader.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((PrimitiveSchemaElement) objectMapper.readValue(jsonString, PropertyBase.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
