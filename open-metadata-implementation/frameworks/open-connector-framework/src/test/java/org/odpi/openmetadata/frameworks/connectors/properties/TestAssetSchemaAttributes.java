...
/**
 * TestAssetSchemaAttributes tests the invocation of a specific property iterator.
 */
public class TestAssetSchemaAttributes
{
    /**
    ...
    {
        AssetSchemaAttributes iterator = getPropertyIterator(totalElementCount, maxCacheSize);
    ...
    {
        AssetSchemaAttributes propertyIterator = getPropertyIterator(10, 100);

        propertyIterator.next();

        AssetSchemaAttributes propertyIteratorClone = new MockAssetSchemaAttributes(null, propertyIterator);
    ...
    @Test public void testElementCount()
    {
        ...
        clonedPropertyIterator = new MockAssetSchemaAttributes(null, null);
    ...
    {
        assertTrue(getPropertyIterator(10, 100).toString().contains("AssetSchemaAttributes"));
    }
}