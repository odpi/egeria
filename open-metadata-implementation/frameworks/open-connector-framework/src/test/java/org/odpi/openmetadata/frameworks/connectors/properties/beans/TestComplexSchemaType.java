...
/**
 * Validate that the ComplexSchemaType bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class TestComplexSchemaType
{
     ...
     */
    private ComplexSchemaType getTestObject()
    {
        ComplexSchemaType testObject = new ComplexSchemaType();
        ...
        testObject.setAttributeCount(9);
     ...
     */
    private void validateResultObject(ComplexSchemaType resultObject)
    {
        ...
        assertTrue(resultObject.getAttributeCount() == 9);
    }
    ...
    {
        ComplexSchemaType nullObject = new ComplexSchemaType();
        ...
        assertTrue(nullObject.getAttributeCount() == 0);


        nullObject = new ComplexSchemaType(null);
    ...
    @Test public void testEquals()
    {
        ...
        ComplexSchemaType sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        ComplexSchemaType differentObject = getTestObject();
    ...
    {
        validateResultObject(new ComplexSchemaType(getTestObject()));
    }
    ...
    @Test public void testAbstractClone()
    {
        ...
        validateResultObject((ComplexSchemaType)schemaElement.cloneSchemaElement());
    }

    @Test public void testCloneSchemaType()
    {
        validateResultObject((ComplexSchemaType) getTestObject().cloneSchemaType());
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject((ComplexSchemaType) objectMapper.readValue(jsonString, ElementHeader.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((ComplexSchemaType) objectMapper.readValue(jsonString, PropertyBase.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
