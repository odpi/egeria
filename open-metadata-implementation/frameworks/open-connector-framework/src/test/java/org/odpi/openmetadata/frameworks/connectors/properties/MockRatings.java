...
/**
 * MockRatings implements the abstract methods for Ratings, so it can be tested.
 */
public class MockRatings extends Ratings
{
     ...
     */
    public MockRatings(int             totalElementCount,
                       int             maxCacheSize)
    {
        super(maxCacheSize);
     ...
     */
    public MockRatings(MockRatings template)
    {
        super(template);
