...
/**
 * TestLicenses tests the invocation of a specific property iterator.
 */
public class TestLicenses
{
     ...
     */
    private Licenses getPropertyIterator(int    totalElementCount, int    maxCacheSize)
    {
        return new MockLicenses( totalElementCount, maxCacheSize);
    }
    ...
    {
        Licenses iterator = getPropertyIterator(totalElementCount, maxCacheSize);
    ...
    {
        assertTrue(getPropertyIterator(10, 100).toString().contains("Licenses"));
    }
}