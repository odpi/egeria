...
/**
 * Validate that the TestAPISchemaType bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class TestAPISchemaType
{
     ...
     */
    private APISchemaType getTestObject()
    {
        APISchemaType testObject = new APISchemaType();
        ...
        testObject.setOperationCount(9);
     ...
     */
    private void validateResultObject(APISchemaType resultObject)
    {
        ...
        assertTrue(resultObject.getOperationCount() == 9);
    }
    ...
    {
        APISchemaType nullObject = new APISchemaType();
        ...
        assertTrue(nullObject.getOperationCount() == 0);


        nullObject = new APISchemaType(null);
    ...
    @Test public void testEquals()
    {
        ...
        APISchemaType sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        APISchemaType differentObject = getTestObject();
    ...
    {
        validateResultObject(new APISchemaType(getTestObject()));
    }
    ...
    @Test public void testAbstractClone()
    {
        ...
        validateResultObject((APISchemaType)schemaElement.cloneSchemaElement());
    }

    @Test public void testCloneSchemaType()
    {
        validateResultObject((APISchemaType) getTestObject().cloneSchemaType());
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, APISchemaType.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((APISchemaType) objectMapper.readValue(jsonString, SchemaElement.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((APISchemaType) objectMapper.readValue(jsonString, Referenceable.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((APISchemaType) objectMapper.readValue(jsonString, PropertyBase.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(getTestObject().toString().contains("APISchemaType"));
    }
}
