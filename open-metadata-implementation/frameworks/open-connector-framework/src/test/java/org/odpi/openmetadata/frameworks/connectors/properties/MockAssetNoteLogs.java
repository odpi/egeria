...
/**
 * MockAssetNoteLogs implements the abstract methods for AssetNoteLogs so it can be tested.
 */
public class MockAssetNoteLogs extends AssetNoteLogs
{
     ...
     */
    public MockAssetNoteLogs(AssetDescriptor parentAsset,
     ...
     */
    public MockAssetNoteLogs(AssetDescriptor   parentAsset, AssetNoteLogs template)
    {
    ...
    {
        return new MockAssetNoteLogs(parentAsset, this);
    }
                                                    ...
                                                    int  maximumSize)
    {
        ...
        {
            AssetNoteLog propertyObject = new AssetNoteLog(null, (AssetNoteLog)null);
