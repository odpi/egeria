...
/**
 * MockExternalIdentifiers implements the abstract methods for ExternalIdentifiers, so it can be tested.
 */
public class MockExternalIdentifiers extends ExternalIdentifiers
{
     ...
     */
    public MockExternalIdentifiers(int             totalElementCount,
                                   int             maxCacheSize)
    {
        super(maxCacheSize);
     ...
     */
    public MockExternalIdentifiers(MockExternalIdentifiers template)
    {
        super(template);
    ...
    {
        return new MockExternalIdentifiers(this);
    }
                                              ...
                                              int  maximumSize)
    {
        ...
        {
            propertyList.add(new ExternalIdentifier());
        }
