...
/**
 * MockAssetRatings implements the abstract methods for AssetRatings so it can be tested.
 */
public class MockAssetRatings extends AssetRatings
{
     ...
     */
    public MockAssetRatings(AssetDescriptor parentAsset,
     ...
     */
    public MockAssetRatings(AssetDescriptor   parentAsset, AssetRatings template)
    {
    ...
    {
        return new MockAssetRatings(parentAsset, this);
    }
                                                    ...
                                                    int  maximumSize)
    {
        ...
        {
            AssetRating propertyObject = new AssetRating(null);
