...
/**
 * MockAssetExternalReferences implements the abstract methods for AssetExternalReferences so it can be tested.
 */
public class MockAssetExternalReferences extends AssetExternalReferences
{
     ...
     */
    public MockAssetExternalReferences(AssetDescriptor parentAsset,
     ...
     */
    public MockAssetExternalReferences(AssetDescriptor   parentAsset, AssetExternalReferences template)
    {
    ...
    {
        return new MockAssetExternalReferences(parentAsset, this);
    }
                                                    ...
                                                    int  maximumSize)
    {
        ...
        {
            AssetExternalReference propertyObject = new AssetExternalReference(null);
