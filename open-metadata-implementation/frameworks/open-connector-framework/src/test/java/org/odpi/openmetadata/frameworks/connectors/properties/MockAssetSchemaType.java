 ...
 * </p>
 */
public class MockAssetSchemaType extends AssetSchemaType
{
     ...
     */
    public MockAssetSchemaType(SchemaElement schemaElementBean,
     ...
     * @param assetMeanings iterator for the asset assetMeanings
     */
    public MockAssetSchemaType(AssetDescriptor parentAsset,
     ...
     */
    public MockAssetSchemaType(AssetDescriptor  parentAsset, AssetSchemaType templateSchema)
    {
     ...
     */
    protected MockAssetSchemaType cloneAssetSchemaElement(AssetDescriptor  parentAsset)
    {
        return new MockAssetSchemaType(parentAsset, this);
    }
