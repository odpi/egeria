...
/**
 * MockAssetLikes implements the abstract methods for AssetLikes so it can be tested.
 */
public class MockAssetLikes extends AssetLikes
{
     ...
     */
    public MockAssetLikes(AssetDescriptor parentAsset,
     ...
     */
    public MockAssetLikes(AssetDescriptor   parentAsset, AssetLikes template)
    {
    ...
    {
        return new MockAssetLikes(parentAsset, this);
    }
                                                    ...
                                                    int  maximumSize)
    {
        ...
        {
            AssetLike propertyObject = new AssetLike(null);
