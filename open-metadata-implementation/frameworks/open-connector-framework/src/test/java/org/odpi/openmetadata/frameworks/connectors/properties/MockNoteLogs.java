...
/**
 * MockNoteLogs implements the abstract methods for NoteLogs, so it can be tested.
 */
public class MockNoteLogs extends NoteLogs
{
     ...
     */
    public MockNoteLogs(int             totalElementCount,
                        int             maxCacheSize)
    {
        super(maxCacheSize);
     ...
     */
    public MockNoteLogs(MockNoteLogs template)
    {
        super(template);
                                              ...
                                              int  maximumSize)
    {
        ...
        {
            propertyList.add(new NoteLog(null));
        }
