...
/**
 * TestLikes tests the invocation of a specific property iterator.
 */
public class TestLikes
{
     ...
     */
    private Likes getPropertyIterator(int    totalElementCount, int    maxCacheSize)
    {
        return new MockLikes( totalElementCount, maxCacheSize);
    }
    ...
    {
        Likes iterator = getPropertyIterator(totalElementCount, maxCacheSize);
    ...
    {
        assertTrue(getPropertyIterator(10, 100).toString().contains("Likes"));
    }
}