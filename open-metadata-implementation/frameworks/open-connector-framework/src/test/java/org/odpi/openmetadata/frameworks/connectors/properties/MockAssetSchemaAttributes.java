...
/**
 * MockAssetSchemaAttributes implements the abstract methods for AssetSchemaAttributes so it can be tested.
 */
public class MockAssetSchemaAttributes extends AssetSchemaAttributes
{
     ...
     */
    public MockAssetSchemaAttributes(AssetDescriptor parentAsset,
     ...
     */
    public MockAssetSchemaAttributes(AssetDescriptor   parentAsset, AssetSchemaAttributes template)
    {
    ...
    {
        return new MockAssetSchemaAttributes(parentAsset, this);
    }
                                                    ...
                                                    int  maximumSize)
    {
        ...
        {
            AssetSchemaAttribute propertyObject = new AssetSchemaAttribute(null, (AssetSchemaAttribute)null);
