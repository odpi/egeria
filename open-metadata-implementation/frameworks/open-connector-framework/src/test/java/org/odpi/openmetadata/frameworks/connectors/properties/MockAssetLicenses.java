...
/**
 * MockAssetLicenses implements the abstract methods for AssetLicenses so it can be tested.
 */
public class MockAssetLicenses extends AssetLicenses
{
     ...
     */
    public MockAssetLicenses(AssetDescriptor parentAsset,
     ...
     */
    public MockAssetLicenses(AssetDescriptor   parentAsset, AssetLicenses template)
    {
    ...
    {
        return new MockAssetLicenses(parentAsset, this);
    }
                                                    ...
                                                    int  maximumSize)
    {
        ...
        {
            AssetLicense propertyObject = new AssetLicense(null);
