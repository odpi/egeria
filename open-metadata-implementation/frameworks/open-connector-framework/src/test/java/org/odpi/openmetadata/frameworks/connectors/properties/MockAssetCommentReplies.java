...
/**
 * MockAssetCommentReplies implements the abstract methods for AssetCommentReplies so it can be tested.
 */
public class MockAssetCommentReplies extends AssetCommentReplies
{
     ...
     */
    public MockAssetCommentReplies(AssetDescriptor parentAsset,
     ...
     */
    public MockAssetCommentReplies(AssetDescriptor   parentAsset, AssetCommentReplies template)
    {
    ...
    {
        return new MockAssetCommentReplies(parentAsset, this);
    }
                                                    ...
                                                    int  maximumSize)
    {
        ...
        {
            AssetComment propertyObject = new AssetComment(null, (AssetCommentReplies)null);
