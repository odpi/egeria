 ...
 */
public class TestPrimitiveSchemaType
{
     ...
     * Default constructor
     */
    public TestPrimitiveSchemaType()
    {
     ...
     */
    private PrimitiveSchemaType getTestObject()
    {
        PrimitiveSchemaType testObject = new PrimitiveSchemaType();
     ...
     */
    private void validateResultObject(PrimitiveSchemaType resultObject)
    {
    ...
    {
        PrimitiveSchemaType nullObject = new PrimitiveSchemaType();
        ...
        nullObject = new PrimitiveSchemaType(null);
    ...
    @Test public void testEquals()
    {
        ...
        PrimitiveSchemaType sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        PrimitiveSchemaType differentObject = getTestObject();
    ...
    {
        validateResultObject(new PrimitiveSchemaType(getTestObject()));
    }
    ...
    @Test public void testAbstractClone()
    {
        ...
        validateResultObject((PrimitiveSchemaType)schemaElement.cloneSchemaElement());
    }


    @Test public void testCloneSchemaType()
    {
        validateResultObject((PrimitiveSchemaType)getTestObject().cloneSchemaType());
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject((PrimitiveSchemaType) objectMapper.readValue(jsonString, PropertyBase.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
