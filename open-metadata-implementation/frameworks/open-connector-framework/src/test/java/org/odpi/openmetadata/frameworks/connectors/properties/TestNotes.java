...
/**
 * TestNotes tests the invocation of a specific property iterator.
 */
public class TestNotes
{
     ...
     */
    private Notes getPropertyIterator(int    totalElementCount, int    maxCacheSize)
    {
        return new MockNotes( totalElementCount, maxCacheSize);
    }
    ...
    {
        Notes iterator = getPropertyIterator(totalElementCount, maxCacheSize);
    ...
    {
        assertTrue(getPropertyIterator(10, 100).toString().contains("Notes"));
    }
}