...
/**
 * MockAssetInformalTags implements the abstract methods for AssetInformalTags so it can be tested.
 */
public class MockAssetInformalTags extends AssetInformalTags
{
     ...
     */
    public MockAssetInformalTags(AssetDescriptor parentAsset,
     ...
     */
    public MockAssetInformalTags(AssetDescriptor   parentAsset, AssetInformalTags template)
    {
    ...
    {
        return new MockAssetInformalTags(parentAsset, this);
    }
                                                    ...
                                                    int  maximumSize)
    {
        ...
        {
            AssetInformalTag propertyObject = new AssetInformalTag(null);
