...
/**
 * TestAssetLikes tests the invocation of a specific property iterator.
 */
public class TestAssetLikes
{
    /**
     ...
     */
    private AssetLikes  getPropertyIterator(int    totalElementCount, int    maxCacheSize)
    {
        return new MockAssetLikes(null, totalElementCount, maxCacheSize);
    }
    ...
    {
        AssetLikes iterator = getPropertyIterator(totalElementCount, maxCacheSize);
    ...
    {
        AssetLikes propertyIterator = getPropertyIterator(10, 100);

        propertyIterator.next();

        AssetLikes propertyIteratorClone = new MockAssetLikes(null, propertyIterator);
    ...
    {
        AssetLikes  propertyIterator = getPropertyIterator(30, 10);

        assertTrue(propertyIterator.getElementCount() == 30);

        AssetLikes  clonedPropertyIterator = new MockAssetLikes(null, propertyIterator);

        assertTrue(clonedPropertyIterator.getElementCount() == 30);

        clonedPropertyIterator = new MockAssetLikes(null, null);
    ...
    {
        assertTrue(getPropertyIterator(10, 100).toString().contains("AssetLikes"));
    }
}