...
/**
 * MockAssetConnections implements the abstract methods for AssetConnections so it can be tested.
 */
public class MockAssetConnections extends AssetConnections
{
     ...
     */
    public MockAssetConnections(AssetDescriptor parentAsset,
     ...
     */
    public MockAssetConnections(AssetDescriptor   parentAsset, AssetConnections template)
    {
    ...
    {
        return new MockAssetConnections(parentAsset, this);
    }
                                                    ...
                                                    int  maximumSize)
    {
        ...
        {
            ConnectionProperties propertyObject = new ConnectionProperties((Connection)null);
