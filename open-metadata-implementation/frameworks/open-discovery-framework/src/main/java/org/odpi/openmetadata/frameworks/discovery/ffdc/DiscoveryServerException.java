...
/**
 * DiscoveryServerException indicates there is a problem communicating with a discovery server.  The
...
public class DiscoveryServerException extends ODFCheckedExceptionBase
{
    /**
     ...
     */
    public DiscoveryServerException(int    httpCode,
                                    String className,
