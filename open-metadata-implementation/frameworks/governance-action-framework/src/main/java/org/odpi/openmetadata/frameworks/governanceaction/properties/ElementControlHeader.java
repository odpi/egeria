...
@JsonSubTypes(
        {
                ...
                @JsonSubTypes.Type(value = OpenMetadataElement.class, name = "OpenMetadataElement"),
                @JsonSubTypes.Type(value = RelatedMetadataElement.class, name = "RelatedMetadataElement"),
                @JsonSubTypes.Type(value = RelatedMetadataElements.class, name = "RelatedMetadataElements")
        })
