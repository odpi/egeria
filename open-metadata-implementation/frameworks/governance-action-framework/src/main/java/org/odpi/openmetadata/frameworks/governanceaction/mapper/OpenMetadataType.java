...
public enum OpenMetadataType
{
    ...
    */
    ...
    public static final String ENGINE_ACTION_EXECUTOR_TYPE_GUID = "e690ab17-6779-46b4-a8f1-6872d88c1bbb";
    public static final String ENGINE_ACTION_EXECUTOR_TYPE_NAME = "EngineActionExecutor";
