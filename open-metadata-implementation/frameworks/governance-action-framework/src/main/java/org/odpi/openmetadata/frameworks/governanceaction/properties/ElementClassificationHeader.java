 ...
 * The ElementClassification is a generic classification.
 */
...
public class ElementClassificationHeader extends ElementControlHeader
{
    ...
    private List<String>         classificationValidProperties = null;
    ...
    public ElementClassificationHeader(ElementClassificationHeader template)
    {
        ...
        if (template != null)
        {
            ...
            classificationValidProperties = template.getClassificationValidProperties();
     ...
     *
     * @param classificationValidProperties list of property names
     */
    public void setClassificationValidProperties(List<String> classificationValidProperties)
    {
        this.classificationValidProperties = classificationValidProperties;
    }
     ...
     */
    public List<String> getClassificationValidProperties()
    {
        return classificationValidProperties;
    }
    ...
    public String toString()
    {
        return "ElementClassificationHeader{" +
                       ...
                       ", classificationTypeDescription='" + classificationTypeDescription + '\'' +
                       ", classificationValidProperties=" + classificationValidProperties +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        return classificationTypeVersion == that.classificationTypeVersion &&
                       ...
                       Objects.equals(classificationValidProperties, that.classificationValidProperties) &&
    ...
    public int hashCode()
    {
        return Objects.hash(super.hashCode(), classificationTypeId, classificationTypeVersion, classificationTypeDescription, classificationOrigin,
                            classificationOriginGUID, classificationValidProperties);
    }
}
