...
import org.odpi.openmetadata.engineservices.assetanalysis.properties.DiscoveryEngineStatus;
...
public class DiscoveryEngineHandler
{
    ...
    public DiscoveryEngineHandler(EngineConfig                 engineConfig,
                                  ...
                                  int                          maxPageSize)
    {
        this.discoveryEngineName = engineConfig.getEngineQualifiedName();
                                       ...
                                       PropertyServerException
    {
        ...
        {
            throw new PropertyServerException(AssetAnalysisErrorCode.UNKNOWN_DISCOVERY_ENGINE_CONFIG.getMessageDefinition(discoveryEngineName,
                                                  ...
                                                  PropertyServerException
    {
        ...
        auditLog.logMessage(actionDescription,
                            AssetAnalysisAuditCode.CLEARING_ALL_DISCOVERY_SERVICE_CONFIG.getMessageDefinition(discoveryEngineName));
        ...
        auditLog.logMessage(actionDescription,
                            AssetAnalysisAuditCode.FINISHED_ALL_DISCOVERY_SERVICE_CONFIG.getMessageDefinition(discoveryEngineName));
    }
    ...
    public void terminate()
    {
        ...
        auditLog.logMessage(actionDescription,
                            AssetAnalysisAuditCode.ENGINE_SHUTDOWN.getMessageDefinition(discoveryEngineName, serverName));
    ...
    private void validateDiscoveryEngineInitialized(String methodName) throws DiscoveryEngineException
    {
        if (discoveryEngineProperties == null)
        {
            throw new DiscoveryEngineException(AssetAnalysisErrorCode.DISCOVERY_ENGINE_NOT_INITIALIZED.getMessageDefinition(serverName,
                                                                                                                            discoveryEngineName),
                                               this.getClass().getName(),
                                               methodName);
        }
    ...
    static private class  DiscoveryServiceCache
    {
                                                                             ...
                                                                             PropertyServerException
        {
            ...
            {
                throw new PropertyServerException(AssetAnalysisErrorCode.NULL_DISCOVERY_SERVICE.getMessageDefinition(methodName,
                                                                                                                     discoveryEngineName,
                                                                                                                     discoveryServerName),
                                                  this.getClass().getName(),
                                                  methodName);
