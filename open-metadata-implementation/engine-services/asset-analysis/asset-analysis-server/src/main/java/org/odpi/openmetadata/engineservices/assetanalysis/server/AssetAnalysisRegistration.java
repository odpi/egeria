...
import org.odpi.openmetadata.engineservices.assetanalysis.handlers.DiscoveryEngineHandlerFactory;
...
/**
 * AssetAnalysisRegistration registers the engine service with the OMAG Server administration services.
...
class AssetAnalysisRegistration
{
    ...
    static void registerEngineService()
    {
        ...
        OMAGEngineServiceRegistration.registerEngineService(myRegistration, new DiscoveryEngineHandlerFactory());
    }
}
