        ...
        if (event != null)
        {
                ...
                if (discoveryEngineHandler != null)
                {
                    ...
                    catch (Exception error)
                    {
                        auditLog.logException(actionDescription,
                                              AssetAnalysisAuditCode.DISCOVERY_SERVICE_NO_CONFIG.getMessageDefinition(discoveryServiceEvent.getRegisteredDiscoveryServiceGUID(),
            ...
            else if (event instanceof DiscoveryEngineConfigurationEvent)
            {
                ...
                if (discoveryEngineHandler != null)
                {
                    ...
                    {
                        auditLog.logException(actionDescription,
                                              AssetAnalysisAuditCode.DISCOVERY_ENGINE_NO_CONFIG.getMessageDefinition(discoveryEngineEvent.getDiscoveryEngineName(),
                                                                                                                     error.getClass().getName(),
                                                                                                                     error.getMessage()),
