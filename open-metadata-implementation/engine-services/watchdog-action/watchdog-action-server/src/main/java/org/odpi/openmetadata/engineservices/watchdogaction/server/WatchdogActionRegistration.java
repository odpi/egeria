...
import org.odpi.openmetadata.engineservices.watchdogaction.admin.WatchdogActionAdmin;
import org.odpi.openmetadata.engineservices.watchdogaction.handlers.WatchdogActionEngineHandlerFactory;
...
/**
 * WatchdogActionRegistration registers the engine service with the OMAG Server administration services.
 ...
 */
class WatchdogActionRegistration
{
    /**
    ...
    {
        EngineServiceDescription myDescription = EngineServiceDescription.WATCHDOG_ACTION_OMES;

        EngineServiceRegistrationEntry myRegistration = new EngineServiceRegistrationEntry(myDescription,
                                                                                           ServiceOperationalStatus.ENABLED,
                                                                                           WatchdogActionAdmin.class.getName());
        OMAGEngineServiceRegistration.registerEngineService(myRegistration, new WatchdogActionEngineHandlerFactory());
    }
}
