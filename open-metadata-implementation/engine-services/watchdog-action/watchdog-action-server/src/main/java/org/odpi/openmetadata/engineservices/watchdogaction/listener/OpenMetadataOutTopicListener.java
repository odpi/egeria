...
package org.odpi.openmetadata.engineservices.watchdogaction.listener;

import org.odpi.openmetadata.engineservices.watchdogaction.handlers.WatchdogActionEngineHandler;
...
public class OpenMetadataOutTopicListener implements OpenMetadataEventListener
{
    ...
    public void processEvent(OpenMetadataOutTopicEvent event)
    {
        ...
        if (event != null)
        {
            ...
            {
                if (governanceEngineHandler instanceof WatchdogActionEngineHandler governanceActionEngineHandler)
                {
                    try
                    {
                    ...
                    catch (Exception error)
                    {
                        auditLog.logException(actionDescription,
                                              WatchdogActionAuditCode.UNEXPECTED_EXCEPTION.getMessageDefinition(
