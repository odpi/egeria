...
import org.odpi.openmetadata.engineservices.archivemanager.admin.ArchiveManagerAdmin;
 ...
 */
class ArchiveManagerRegistration
{
    /**
    ...
    {
        EngineServiceDescription myDescription = EngineServiceDescription.ARCHIVE_MANAGER_OMES;

        EngineServiceRegistration myRegistration = new EngineServiceRegistration(myDescription,
                                                                                 ServiceOperationalStatus.ENABLED,
                                                                                 ArchiveManagerAdmin.class.getName());
