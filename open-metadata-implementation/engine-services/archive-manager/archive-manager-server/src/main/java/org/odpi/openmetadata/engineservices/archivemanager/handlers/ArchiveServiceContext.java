...
/**
 * ArchiveContext provides the archive service with access to information about
 * the archive request along with the open metadata repository interfaces.
 */
public class ArchiveServiceContext extends ArchiveContext
{
    private volatile CompletionStatus  completionStatus = null;

    private ArchiveServiceHandler              archiveServiceHandler = null;
    private String                             archiveServiceName;
     ...
     * @param archiveServiceName name os service using this context - for error messages.
     ...
     */
    public ArchiveServiceContext(String                             userId,
     ...
     */
    public void setArchiveServiceHandler(ArchiveServiceHandler archiveServiceHandler)
    {
        this.archiveServiceHandler = archiveServiceHandler;
    }
                                                     ...
                                                     List<NewActionTarget> newActionTargets) throws PropertyServerException
    {
        ...
        {
            repositoryServicesClient.disconnectFromEnterpriseTopic();
            archiveServiceHandler.recordCompletionStatus(status, outputGuards, combinedRequestParameters, newActionTargets);
        }
        catch (Exception error)
        {
            throw new PropertyServerException(ArchiveManagerErrorCode.UNEXPECTED_EXCEPTION.getMessageDefinition(archiveServiceName,
    ...
    {
        return "ArchiveServiceContext{" +
                       "completionStatus=" + completionStatus +
                       ", repositoryServicesClient=" + repositoryServicesClient +
                       ", archiveServiceHandler=" + archiveServiceHandler +
                       ", userId='" + userId + '\'' +
