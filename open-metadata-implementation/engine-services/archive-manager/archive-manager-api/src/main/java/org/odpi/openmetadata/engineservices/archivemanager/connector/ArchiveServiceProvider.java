 ...
 */
public abstract class ArchiveServiceProvider extends GovernanceActionServiceProviderBase
{
    ...
    public ArchiveServiceProvider()
    {
        ...
        super.setConnectorComponentDescription(OMRSAuditingComponent.ARCHIVE_SERVICE_CONNECTOR);
    }
}
