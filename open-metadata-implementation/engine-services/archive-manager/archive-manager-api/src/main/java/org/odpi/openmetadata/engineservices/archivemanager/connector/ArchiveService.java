 ...
 */
public abstract class ArchiveService extends ConnectorBase implements AuditLoggingComponent, VirtualConnectorExtension
{
    /*
     ...
     *
     * @param archiveContext interface to the enterprise repository services and the ability to register a listener to the enterprise
     *                       OMRS topic.
     */
     ...
     */
    protected void validateContext(ArchiveContext governanceContext) throws ConnectorCheckedException
    {
