...
public class LineageGraphJob implements Job {
    ...
    public void execute(JobExecutionContext context) {
        ...
        LineageWarehouseGraphConnector lineageGraph = (LineageWarehouseGraphConnector) dataMap.get(JobConstants.OPEN_LINEAGE_GRAPH_STORE);
     ...
     *
     */
    private void performTask(LineageWarehouseGraphConnector lineageGraph){
