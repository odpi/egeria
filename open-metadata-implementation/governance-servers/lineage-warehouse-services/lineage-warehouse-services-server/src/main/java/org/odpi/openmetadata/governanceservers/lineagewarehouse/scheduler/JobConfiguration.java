...
public class JobConfiguration {
    ...
    private final LineageWarehouseGraphConnector lineageWarehouseGraphConnector;
     ...
     */
    public JobConfiguration(LineageWarehouseGraphConnector lineageWarehouseGraphConnector, String jobName, Class <? extends Job> jobClass, int jobInterval) {
