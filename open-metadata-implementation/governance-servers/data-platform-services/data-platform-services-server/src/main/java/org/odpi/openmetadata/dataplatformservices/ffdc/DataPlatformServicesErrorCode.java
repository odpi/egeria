...
package org.odpi.openmetadata.dataplatformservices.ffdc;
 ...
 * </ul>
 */
public enum DataPlatformServicesErrorCode implements ExceptionMessageSet
{

    NULL_TOPIC_CONNECTOR(400, "DATA-PLATFORM-SERVICES-400-001",
     ...
     */
    DataPlatformServicesErrorCode(int  httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
