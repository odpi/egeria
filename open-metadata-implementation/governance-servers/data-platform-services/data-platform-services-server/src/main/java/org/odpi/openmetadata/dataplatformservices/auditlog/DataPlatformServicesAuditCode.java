...
public enum DataPlatformServicesAuditCode {
    ...
    SERVICE_SHUTDOWN("DATA-PLATFORM-SERVICES-0003",
            ...
            "No action is required.  This is part of the normal operation of the service."),
    INBOUND_TOPIC_CONNECTOR_INITIALIZED("DATA-PLATFORM-SERVICES-0004",
            OMRSAuditLogRecordSeverity.INFO,
            "The DATA-PLATFORM-SERVICES has initialized an event bus connector for Inbound Topic",
            "The local server has completed initialization of a new event bus connector.",
            "No action is required.  This is part of the normal operation of the service."),
    ERROR_INITIALIZING_DP_OUT_TOPIC_CONNECTION("DATA-PLATFORM-SERVICES-0005",
            OMRSAuditLogRecordSeverity.EXCEPTION,
            "Unable to initialize the Data Platform Out Topic connection",
            "The connection could not be initialized.",
            "Review the exception and resolve the configuration. "),
    OUTBOUND_TOPIC_CONNECTOR_INITIALIZED("DATA-PLATFORM-SERVICES-0006",
            OMRSAuditLogRecordSeverity.INFO,
            "The DATA-PLATFORM-SERVICES has initialized an event bus connector for outbound Topic",
            "The local server has completed initialization of a new event bus connector.",
            "No action is required.  This is part of the normal operation of the service."),
    ERROR_INITIALIZING_DP_IN_TOPIC_CONNECTION("DATA-PLATFORM-SERVICES-0007",
            OMRSAuditLogRecordSeverity.ERROR,
            "Unable to initialize the Data Platform In Topic connection",
            "The connection could not be initialized.",
            "Review the exception and resolve the configuration. "),
    ERROR_SHUTDOWN("DATA-PLATFORM-SERVICES-008",
            OMRSAuditLogRecordSeverity.ERROR,
            "The service is not shutdown properly.",
            "The connection could not be shutdown.",
            "Try again. "),
    PUBLISH_EVENT_EXCEPTION("DATA-PLATFORM-SERVICES-009",
            OMRSAuditLogRecordSeverity.EXCEPTION,
