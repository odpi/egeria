...
import org.odpi.openmetadata.adminservices.LocalRepositoryMode;
import org.odpi.openmetadata.adminservices.OMAGServerCategory;
import org.odpi.openmetadata.adminservices.OMAGServiceMode;
 ...
 */
@RestController
@RequestMapping("/admin-services/users/{userId}/servers/{serverName}")
public class OMAGServerAdminResource
{
     ...
     */
    private final OMAGServerCategory   serverCategory = OMAGServerCategory.OMAG_SERVER;

    /**
     * Return the category of server this is.
     *
     * @return OMAGServerCategory
     */
    @RequestMapping(method = RequestMethod.GET, path = "/server-category")
    public OMAGServerCategory   getServerCategory()
    {
    ...
    {
        return adminAPI.setMaxPageSize(userId, serverName, maxPageSize);
    }
    ...
    public VoidResponse setAccessServicesMode(@PathVariable String          userId,
                                              @PathVariable String          serverName,
                                              @RequestParam OMAGServiceMode serviceMode)
    {
        return adminAPI.setAccessServicesMode(userId, serverName, serviceMode);
    }
    ...
    public VoidResponse setInMemLocalRepository(@PathVariable String userId,
                                                @PathVariable String serverName)
    {
        return adminAPI.setLocalRepositoryMode(userId, serverName, LocalRepositoryMode.IN_MEMORY_REPOSITORY);
    }


    /**
     * Set up a graph store as the local repository.  This repository uses hashmaps to store content.  It is useful
     * for demos, testing and POCs.
     *
     * @param userId - user that is issuing the request.
     * @param serverName - local server name.
    ...
    public VoidResponse setGraphLocalRepository(@PathVariable String userId,
                                                @PathVariable String serverName)
    {
        return adminAPI.setLocalRepositoryMode(userId, serverName, LocalRepositoryMode.LOCAL_GRAPH_REPOSITORY);
    }
     ...
     * OMAGInvalidParameterException invalid serverName or localRepositoryMode parameter.
     */
    @RequestMapping(method = RequestMethod.POST, path = "/local-repository/mode/no-repository")
    public VoidResponse setNoRepositoryMode(@PathVariable String userId,
                                            @PathVariable String serverName)
    {
        return adminAPI.setLocalRepositoryMode(userId, serverName, LocalRepositoryMode.NO_LOCAL_REPOSITORY);
    }
    ...
    public VoidResponse setRepositoryProxyConnection(@PathVariable String     userId,
                                                     @PathVariable String     serverName,
                                                     @RequestParam Connection connection)
    {
    ...
    public VoidResponse setRepositoryProxyConnection(@PathVariable String userId,
                                                     ...
                                                     @RequestParam String url)
    {
        return adminAPI.setRepositoryProxyConnection(userId, serverName, connectorProvider, url);
    }
    ...
    {
        return adminAPI.setLocalRepositoryEventMapper(userId, serverName, connectorProvider, eventSource);
    }
     ...
     */
    @RequestMapping(method = RequestMethod.POST, path = "/cohorts/{cohortName}/mode")
    public VoidResponse setCohortMode(@PathVariable String          userId,
                                      @PathVariable String          serverName,
                                      @PathVariable String          cohortName,
                                      @RequestParam OMAGServiceMode serviceMode)
    {
        return adminAPI.setCohortMode(userId, serverName, cohortName, serviceMode);
    }
    ...
    public VoidResponse setAccessServicesConfig(@PathVariable String                    userId,
                                                @PathVariable String                    serverName,
                                                @RequestParam List<AccessServiceConfig> accessServicesConfig)
    {
    ...
    public VoidResponse setLocalRepositoryConfig(@PathVariable String                userId,
                                                 @PathVariable String                serverName,
                                                 @RequestParam LocalRepositoryConfig localRepositoryConfig)
    {
    ...
    public VoidResponse setEnterpriseAccessConfig(@PathVariable String                 userId,
                                                  @PathVariable String                 serverName,
                                                  @RequestParam EnterpriseAccessConfig enterpriseAccessConfig)
    {
    ...
    public VoidResponse setCohortConfig(@PathVariable String       userId,
                                        @PathVariable String       serverName,
                                        @PathVariable String       cohortName,
                                        @RequestParam CohortConfig cohortConfig)
    {
    ...
    public VoidResponse initialize(@PathVariable String userId,
                                   @PathVariable String serverName)
    {
        return adminAPI.initialize(userId, serverName);
    }
    ...
    {
        return adminAPI.initialize(userId, serverName, configuration);
    }
    ...
    public VoidResponse terminate(@PathVariable String  userId,
                                  @PathVariable String  serverName,
                                  @RequestParam boolean permanent)
    {
        return adminAPI.terminate(userId, serverName, permanent);
    }
