 ...
 */
public class NodeNotFoundException extends OpenLineageException {
     ...
     */
    public NodeNotFoundException(int httpCode,
                                 String className,
     ...
     */
    public NodeNotFoundException(int httpCode, String className, String actionDescription, String errorMessage, String systemAction, String userAction, Throwable caughtError) {
