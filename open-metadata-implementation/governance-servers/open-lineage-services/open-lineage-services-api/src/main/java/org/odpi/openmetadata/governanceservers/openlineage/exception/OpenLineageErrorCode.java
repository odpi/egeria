...
/**
 * The OpenLineageErrorCode is used to define first failure data capture (FFDC) for errors that occur when working with
 * the Open Lineage Services.  It is used in conjunction with both Checked and Runtime (unchecked) exceptions.
 * <p>
 ...
 * <li>UserAction - describes how a OpenLineage should correct the error</li>
 * </ul>
 */
public enum OpenLineageErrorCode {

    NO_SEARCH_RESULTS(204, "OPEN-LINEAGE-SERVICES-204-001 ",
    ...
    SERVER_URL_NOT_SPECIFIED(400, "OPEN-LINEAGE-SERVICES-400-001 ",
    ...
    PARAMETER_NULL(400, "OPEN-LINEAGE-SERVICES-400-002 ",
    ...
    NULL_USER_ID(400, "OPEN-LINEAGE-SERVICES-400-003 ",
    ...
    OMRS_NOT_INITIALIZED(404, "OPEN-LINEAGE-SERVICES-404-001 ",
    ...
    OMRS_NOT_AVAILABLE(404, "OPEN-LINEAGE-SERVICES-404-002 ",
            "The open metadata repository services are not available for the {0} operation",
            "The system is unable to connect to the open metadata property server.",
            "Check that the server where the Open Lineage OMAS is running initialized correctly and is not in the process of shutting down.  " +
                    "Correct any errors discovered and retry the request when the open metadata services are available."),

    NO_METADATA_COLLECTION(404, "OPEN-LINEAGE-SERVICES-404-003 ",
    ...
    RELATIONSHIP_NOT_FOUND(404, "OPEN-LINEAGE-SERVICES-404-004 ",
    ...
    RELATIONSHIPS_WITH_PROPERTY_NOT_FOUND(404, "OPEN-LINEAGE-SERVICES-404-005 ",
    ...
    RELATIONSHIPS_NOT_FOUND(404, "OPEN-LINEAGE-SERVICES-404-006 ",
    ...
    ASSET_NOT_FOUND(404, "OPEN-LINEAGE-SERVICES-404-007 ",
    ...
    CLASSIFICATION_NOT_FOUND(404, "OPEN-LINEAGE-SERVICES-404-008 ",
    ...
    ASSET_WITH_CLASSIFICATION_NOT_FOUND(404, "OPEN-LINEAGE-SERVICES-404-009 ",
    ...
    ASSET_WITH_PROPERTY_NOT_FOUND(404, "OPEN-LINEAGE-SERVICES-404-010 ",
    ...
    ASSET_NEIGHBORHOOD_NOT_FOUND(404, "OPEN-LINEAGE-SERVICES-404-011 ",
    ...
    NO_ASSET_FROM_NEIGHBORHOOD_NOT_FOUND(404, "OPEN-LINEAGE-SERVICES-404-012 ",
    ...
    NO_RELATIONSHIPS_FROM_NEIGHBORHOOD_NOT_FOUND(404, "OPEN-LINEAGE-SERVICES-404-013 ",
    ...
    NO_RELATED_ASSETS(404, "OPEN-LINEAGE-SERVICES-404-014 ",
            "There is no assets that are connected directly or indirectly to the asset identified {0} in OMAS Server {1}",
            "The system is unable to retrieve the classifications for the given asset.",
            "Check that the unique identifier for the asset is correct."),

    LINKING_RELATIONSHIPS_NOT_FOUND(404, "OPEN-LINEAGE-SERVICES-404-015 ",
            "There is no intermediate relationships that connect the {0} with the {1} in OMAS Server {2}",
            "The system is unable to retrieve the classifications for the given asset.",
            "Check that the unique identifier for the asset is correct."),

    LINKING_ASSETS_NOT_FOUND(404, "OPEN-LINEAGE-SERVICES-404-016 ",
            "There is no intermediate assets that connect the {0} with the {1} in OMAS Server {2}",
            "The system is unable to retrieve the classifications for the given asset.",
            "Check that the unique identifier for the asset is correct."),

    METHOD_NOT_IMPLEMENTED(501, "OPEN-LINEAGE-SERVICES-501-001 ",
            "The Open Lineage OMAS method {0}({1}) is not implemented for server {2}",
            "A method in Open Lineage OMAS does not have a complete implementation.",
            "Raise a Github issue to get this fixed."),

    SERVICE_NOT_INITIALIZED(503, "OPEN-LINEAGE-SERVICES-503-001 ",
    ...
    OpenLineageErrorCode(int newHTTPErrorCode, String newErrorMessageId, String newErrorMessage, String newSystemAction, String newUserAction) {
