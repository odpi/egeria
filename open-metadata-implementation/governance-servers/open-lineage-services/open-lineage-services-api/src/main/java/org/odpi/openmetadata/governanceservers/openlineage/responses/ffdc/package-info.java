...
/**
 * This package provides the first failure data capture support for the Open Lineage Services module.
 ...
 *
 * The error code enum (OpenLineageErrorCode) has an entry for each unique situation
