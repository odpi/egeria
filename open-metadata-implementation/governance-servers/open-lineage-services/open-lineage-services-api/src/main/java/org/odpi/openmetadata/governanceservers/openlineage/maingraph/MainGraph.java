...
public interface MainGraph extends OpenLineageGraph {
     ...
     */
    LineageResponse lineage(GraphName graphName, Scope scope, View view, String guid, String subStringFilter, boolean includeProcesses) throws OpenLineageException;
