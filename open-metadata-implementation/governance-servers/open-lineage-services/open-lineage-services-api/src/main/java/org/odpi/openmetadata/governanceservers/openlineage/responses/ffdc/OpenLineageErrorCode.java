...
public enum OpenLineageErrorCode {
    ...
    ENTITY_NOT_CREATED( "OMRS-GRAPH-REPOSITORY-400-003 ",
    ...
    ENTITY_PROPERTIES_ERROR("OPEN-LINEAGE-SERVICES-006",
            ...
            "Correct the caller's code and retry the request."),
    RELATIONSHIP_NOT_CREATED( "OMRS-GRAPH-REPOSITORY-400-005 ",
            ...
            "Correct the caller's code and retry the request."),
    RELATIONSHIP_NOT_FOUND( "OMRS-GRAPH-REPOSITORY-400-006 ",
            ...
            "Correct the caller's code and retry the request."),
    RELATIONSHIP_ALREADY_EXISTS( "OMRS-GRAPH-REPOSITORY-400-023 ",
            ...
            "Correct the caller's code and retry the request."),
    RELATIONSHIP_TYPE_NAME_NOT_KNOWN( "OMRS-GRAPH-REPOSITORY-400-019 ",
            ...
            "Correct the caller's code and retry the request."),
    RELATIONSHIP_PROPERTIES_ERROR("OMRS-GRAPH-REPOSITORY-400-010 ",
            ...
            "Correct the caller's code and retry the request."),
    BUFFER_GRAPH_NOT_STARTED( "OMRS-GRAPH-REPOSITORY-400-019 ",
