...
3. Configure the Open Lineage Service, by POSTing a payload like the following
    ...
    - `assetLineageTopicConnectionOverride` - specifies the Connection object of the Asset Lineage topic. Optional, if present it will override the topic connection
