...
public class OpenLineageCheckedExceptionBase extends Exception {
     ...
     */
    public OpenLineageCheckedExceptionBase(String reportingClassName, String reportingActionDescription, String reportedErrorMessage, String reportedSystemAction, String reportedUserAction) {
     ...
     */
    public OpenLineageCheckedExceptionBase(
            String className,
