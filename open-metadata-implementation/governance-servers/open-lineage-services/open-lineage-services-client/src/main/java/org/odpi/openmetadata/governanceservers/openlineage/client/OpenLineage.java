...
public class OpenLineage  {
    ...
    /**
     * Returns the graphName that the user will initially see when querying lineage. In the future, this method will be
    ...
    /**
     * Write an entire graphName to disc in the Egeria root folder, in the .GraphMl format.
     *
     * @param userId calling user.
     * @param graphName MAIN, BUFFER, MOCK, HISTORY.
     * @return Voidresponse.
    ...
    /**
     * Return an entire graphName, in GraphSon format.
     *
     * @param userId calling user.
     * @param graphName MAIN, BUFFER, MOCK, HISTORY.
     * @return The queried graphName, in graphSON format.
     * @throws InvalidParameterException one of the parameters is null or invalid.
     */
