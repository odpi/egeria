...
public class DiscoveryServerResource
{
     ...
     *  DiscoveryEngineException there was a problem detected by the discovery engine.
     */
    @PostMapping(path = "/asset-discovery-types/{discoveryRequestType}/assets")
    ...
    {
        return restAPI.getDiscoveryAnalysisReport(serverName, discoveryEngineGUID, userId, discoveryRequestGUID);
    }
