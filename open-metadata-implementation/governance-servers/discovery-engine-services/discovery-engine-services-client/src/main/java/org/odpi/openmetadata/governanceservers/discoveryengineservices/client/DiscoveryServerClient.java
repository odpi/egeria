...
public class DiscoveryServerClient extends DiscoveryEngine
{
                                                                             ...
                                                                             DiscoveryEngineException
    {
        ...
        final String urlTemplate
                = "/servers/{0}/open-metadata/discovery-server/users/{1}/discovery-engine/{2}/discovery-request-types/{3}/assets/{4}";
                                                                          ...
                                                                          DiscoveryEngineException
    {
        ...
        final String discoveryRequestTypeParameterName = "discoveryRequestType";
        final String urlTemplate = "/servers/{0}/open-metadata/discovery-server/users/{1}/discovery-engine/{2}/discovery-request-types/{3}/assets";
