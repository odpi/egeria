...
public class DiscoveryServerEngineClient extends DiscoveryEngine
{
                                                                             ...
                                                                             DiscoveryEngineException
    {
        ...
        final String urlTemplate
                = "/servers/{0}/open-metadata/discovery-server/users/{1}/discovery-engines/{2}/discovery-request-types/{3}/assets/{4}";
                                                                          ...
                                                                          DiscoveryEngineException
    {
        ...
        final String discoveryRequestTypeParameterName = "discoveryRequestType";
        final String urlTemplate = "/servers/{0}/open-metadata/discovery-server/users/{1}/discovery-engines/{2}/discovery-request-types/{3}/assets";
                                                                                            ...
                                                                                            DiscoveryEngineException
    {
        ...
        final String   urlTemplate = "/servers/{0}/open-metadata/discovery-server/users/{1}/discovery-engines/{2}/discovery-analysis-reports/{3}";
