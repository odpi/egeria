...
package org.odpi.openmetadata.securitysyncservices.ffdc;
 ...
 * </ul>
 */
public enum SecuritySyncErrorCode implements ExceptionMessageSet
{

    NULL_TOPIC_CONNECTOR(400, "SECURITY-SYNC-400-001",
     ...
     */
    SecuritySyncErrorCode(int  httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
