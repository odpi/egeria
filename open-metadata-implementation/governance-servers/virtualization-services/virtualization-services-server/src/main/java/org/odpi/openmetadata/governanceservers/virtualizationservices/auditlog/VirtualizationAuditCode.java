...
public enum VirtualizationAuditCode {
    ...
    SERVICE_SHUTDOWN("VIRTUALIZER-0003",
            ...
            "No action is required.  This is part of the normal operation of the service."),
    INBOUND_TOPIC_CONNECTOR_INITIALIZED("VIRTUALIZER-0004",
            OMRSAuditLogRecordSeverity.INFO,
            "The Virtualizer has initialized an event bus connector for Inbound Topic",
    ...
    OUTBOUND_TOPIC_CONNECTOR_INITIALIZED("VIRTUALIZER-0006",
            OMRSAuditLogRecordSeverity.INFO,
            "The Virtualizer has initialized an event bus connector for outbound Topic",
            "The local server has completed initialization of a new event bus connector.",
            "No action is required.  This is part of the normal operation of the service."),
