...
public enum VirtualizationAuditCode {
    ...
    IV_OUT_TOPIC_CONNECTOR_INITIALIZED("VIRTUALIZER-0004",
            OMRSAuditLogRecordSeverity.INFO,
            "The Virtualizer has initialized an event bus connector for Information View Out Topic",
    ...
    IV_IN_TOPIC_CONNECTOR_INITIALIZED("VIRTUALIZER-0006",
            OMRSAuditLogRecordSeverity.INFO,
            "The Virtualizer has initialized an event bus connector for Information View In Topic",
            "The local server has completed initialization of a new event bus connector.",
            "No action is required.  This is part of the normal operation of the service."),
