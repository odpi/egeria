 ...
 * </ul>
 */
public enum SchemaMakerErrorCode implements ExceptionMessageSet
{
    /**
     * OMVS-SCHEMA-MAKER-400-001 - The URL marker {0} is not recognized
     */
    INVALID_URL_MARKER(400, "OMVS-SCHEMA-MAKER-400-001",
     ...
     */
    SchemaMakerErrorCode(int httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
