...
/**
 * The MetadataExpertErrorCode is used to define first failure data capture (FFDC) for errors that occur within the OMAG Server
 ...
 * </ul>
 */
public enum MetadataExpertErrorCode implements ExceptionMessageSet
{
    /**
     * OMVS-METADATA-EXPERT-400-001 - The URL marker {0} is not recognized
     */
    INVALID_URL_MARKER(400, "OMVS-METADATA-EXPERT-400-001",
     ...
     */
    MetadataExpertErrorCode(int httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
