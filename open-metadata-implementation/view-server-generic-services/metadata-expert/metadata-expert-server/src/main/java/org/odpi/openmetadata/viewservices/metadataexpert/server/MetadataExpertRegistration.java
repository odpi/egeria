...
import org.odpi.openmetadata.viewservices.metadataexpert.admin.MetadataExpertAdmin;
 ...
 */
public class MetadataExpertRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.METADATA_EXPERT;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       MetadataExpertAdmin.class.getName());
