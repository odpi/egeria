...
public class ValidMetadataInstanceHandler extends OMVSServiceInstanceHandler
{
     ...
     * @throws PropertyServerException internal error
     */
    public ValidValueDefinitionHandler getValidValueDefinitionHandler(String userId,
                                                                       String serverName,
                                                                       String urlMarker,
                                                                       String serviceOperationName) throws InvalidParameterException,
                                                                                                           PropertyServerException,
                                                                                                           UserNotAuthorizedException
    {
        ...
        if (instance != null)
        {
            return instance.getValidValueDefinitionHandler(urlMarker, serviceOperationName);
        }
