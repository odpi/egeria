 ...
 * </ul>
 */
public enum ValidMetadataAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-VALID-METADATA-0001 The Valid Metadata Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-VALID-METADATA-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-VALID-METADATA-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-VALID-METADATA-0003",
    ...
    /**
     * OMVS-VALID-METADATA-0004 The Valid Metadata Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-VALID-METADATA-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-VALID-METADATA-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-VALID-METADATA-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-VALID-METADATA-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   ValidMetadataAuditCode(String                      messageId,
