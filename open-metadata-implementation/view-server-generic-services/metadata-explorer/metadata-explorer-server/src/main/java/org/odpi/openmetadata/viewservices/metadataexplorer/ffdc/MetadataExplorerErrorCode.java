...
/**
 * The MetadataExplorerErrorCode is used to define first failure data capture (FFDC) for errors that occur within the OMAG Server
 ...
 * </ul>
 */
public enum MetadataExplorerErrorCode implements ExceptionMessageSet
{
    /**
     ...
     */
    MetadataExplorerErrorCode(int httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
