...
package org.odpi.openmetadata.viewservices.assetmaker.ffdc;
 ...
 * </ul>
 */
public enum AssetMakerAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-ASSET-MAKER-0001 The Asset Maker Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-ASSET-MAKER-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-ASSET-MAKER-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-ASSET-MAKER-0003",
    ...
    /**
     * OMVS-ASSET-MAKER-0004 The Asset Maker Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-ASSET-MAKER-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-ASSET-MAKER-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-ASSET-MAKER-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-ASSET-MAKER-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   AssetMakerAuditCode(String                      messageId,
