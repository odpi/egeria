 ...
 * </ul>
 */
public enum AssetMakerErrorCode implements ExceptionMessageSet
{
    /**
     * OMVS-ASSET-MAKER-400-001 - The URL marker {0} is not recognized
     */
    INVALID_URL_MARKER(400, "OMVS-ASSET-MAKER-400-001",
     ...
     */
    AssetMakerErrorCode(int httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
