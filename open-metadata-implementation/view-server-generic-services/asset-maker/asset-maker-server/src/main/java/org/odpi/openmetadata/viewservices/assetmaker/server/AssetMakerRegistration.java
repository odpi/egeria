...
import org.odpi.openmetadata.viewservices.assetmaker.admin.AssetMakerAdmin;
 ...
 */
public class AssetMakerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.ASSET_MAKER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       AssetMakerAdmin.class.getName());
