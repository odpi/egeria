...
package org.odpi.openmetadata.viewservices.externalreferences.ffdc;
 ...
 * </ul>
 */
public enum ExternalReferencesErrorCode implements ExceptionMessageSet
{
    /**
     * OMVS-EXTERNAL-REFERENCES-400-001 - The URL marker {0} is not recognized
     */
    INVALID_URL_MARKER(400, "OMVS-EXTERNAL-REFERENCES-400-001",
     ...
     */
    ExternalReferencesErrorCode(int httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
