 ...
 * </ul>
 */
public enum GovernanceOfficerErrorCode implements ExceptionMessageSet
{
    /**
     * OMVS-GOVERNANCE-OFFICER-400-001 - The URL marker {0} is not recognized
     */
    INVALID_URL_MARKER(400, "OMVS-GOVERNANCE-OFFICER-400-001",
     ...
     */
    GovernanceOfficerErrorCode(int httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
