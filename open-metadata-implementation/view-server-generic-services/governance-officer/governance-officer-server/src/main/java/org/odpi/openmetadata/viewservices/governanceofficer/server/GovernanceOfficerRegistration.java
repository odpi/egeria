...
import org.odpi.openmetadata.viewservices.governanceofficer.admin.GovernanceOfficerAdmin;
 ...
 */
public class GovernanceOfficerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.GOVERNANCE_OFFICER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       GovernanceOfficerAdmin.class.getName());
