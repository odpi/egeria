...
package org.odpi.openmetadata.viewservices.governanceofficer.ffdc;
 ...
 * </ul>
 */
public enum GovernanceOfficerAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-GOVERNANCE-OFFICER-0001 The Governance Officer Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-GOVERNANCE-OFFICER-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-GOVERNANCE-OFFICER-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-GOVERNANCE-OFFICER-0003",
    ...
    /**
     * OMVS-GOVERNANCE-OFFICER-0004 The Governance Officer Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-GOVERNANCE-OFFICER-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-GOVERNANCE-OFFICER-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-GOVERNANCE-OFFICER-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-GOVERNANCE-OFFICER-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   GovernanceOfficerAuditCode(String                      messageId,
    ...
    {
        return "GovernanceOfficerAuditCode{" +
