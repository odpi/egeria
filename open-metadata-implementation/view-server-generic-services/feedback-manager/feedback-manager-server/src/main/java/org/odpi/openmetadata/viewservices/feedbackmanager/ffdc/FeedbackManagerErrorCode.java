...
/**
 * The FeedbackManagerErrorCode is used to define first failure data capture (FFDC) for errors that occur within the OMAG Server
 ...
 * </ul>
 */
public enum FeedbackManagerErrorCode implements ExceptionMessageSet
{
    /**
     * OMVS-FEEDBACK-MANAGER-400-001 - The URL marker {0} is not recognized
     */
    INVALID_URL_MARKER(400, "OMVS-FEEDBACK-MANAGER-400-001",
     ...
     */
    FeedbackManagerErrorCode(int httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
