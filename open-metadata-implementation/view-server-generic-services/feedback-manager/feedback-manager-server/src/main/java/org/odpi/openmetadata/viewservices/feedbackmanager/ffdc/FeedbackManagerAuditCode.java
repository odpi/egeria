 ...
 * </ul>
 */
public enum FeedbackManagerAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-FEEDBACK-MANAGER-0001 The Feedback Manager Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-FEEDBACK-MANAGER-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-FEEDBACK-MANAGER-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-FEEDBACK-MANAGER-0003",
     ...
     */
    SERVICE_TERMINATING("OMVS-FEEDBACK-MANAGER-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-FEEDBACK-MANAGER-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-FEEDBACK-MANAGER-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   FeedbackManagerAuditCode(String                      messageId,
    ...
    {
        return "FeedbackManagerAuditCode{" +
