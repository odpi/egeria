...
public class RatingElementsResponse extends OMAGGAFAPIResponse
{

    private List<RatingElement> elementList = null;


    /**
     * Default constructor
     */
    public RatingElementsResponse()
    {
    }
     ...
     */
    public RatingElementsResponse(RatingElementsResponse template)
    {
        super(template);
     ...
     */
    public List<RatingElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<RatingElement> elementList)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        RatingElementsResponse that = (RatingElementsResponse) objectToCompare;
