...
public class RatingsResponse extends OMAGGAFAPIResponse
{
    private List<Rating> elementList = null;
     ...
     */
    public List<Rating> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<Rating> elementList)
    {
