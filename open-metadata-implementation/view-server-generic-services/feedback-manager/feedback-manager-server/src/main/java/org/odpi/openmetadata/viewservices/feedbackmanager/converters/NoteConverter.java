 ...
 */
public class NoteConverter<B> extends FeedbackManagerConverterBase<B>
{
    /**
     * Constructor
     *
     ...
     */
    public NoteConverter(PropertyHelper propertyHelper,
                         String         serviceName,
                         String         serverName)
    {
                        ...
                        String              methodName) throws PropertyServerException
    {
        try
        {
            ...
            if (returnBean instanceof NoteElement bean)
            {
