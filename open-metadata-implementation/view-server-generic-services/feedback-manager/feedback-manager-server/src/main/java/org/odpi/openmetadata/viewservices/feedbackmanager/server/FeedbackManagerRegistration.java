...
import org.odpi.openmetadata.viewservices.feedbackmanager.admin.FeedbackManagerAdmin;
 ...
 */
public class FeedbackManagerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.FEEDBACK_MANAGER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       FeedbackManagerAdmin.class.getName());
