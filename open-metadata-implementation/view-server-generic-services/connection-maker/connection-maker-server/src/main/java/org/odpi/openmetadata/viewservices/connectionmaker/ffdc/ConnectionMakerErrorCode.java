...
package org.odpi.openmetadata.viewservices.connectionmaker.ffdc;
 ...
 * </ul>
 */
public enum ConnectionMakerErrorCode implements ExceptionMessageSet
{
    /**
     * OMVS-CONNECTION-MAKER-400-001 - The URL marker {0} is not recognized
     */
    INVALID_URL_MARKER(400, "OMVS-CONNECTION-MAKER-400-001",
     ...
     */
    ConnectionMakerErrorCode(int httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
