 ...
 * </ul>
 */
public enum ConnectionMakerAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-CONNECTION-MAKER-0001 The Connection Maker Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-CONNECTION-MAKER-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-CONNECTION-MAKER-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-CONNECTION-MAKER-0003",
    ...
    /**
     * OMVS-CONNECTION-MAKER-0004 The Connection Maker Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-CONNECTION-MAKER-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-CONNECTION-MAKER-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-CONNECTION-MAKER-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-CONNECTION-MAKER-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   ConnectionMakerAuditCode(String                      messageId,
    ...
    {
        return "ConnectionMakerAuditCode{" +
