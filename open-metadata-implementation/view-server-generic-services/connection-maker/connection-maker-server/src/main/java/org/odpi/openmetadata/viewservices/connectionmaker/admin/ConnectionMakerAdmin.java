...
package org.odpi.openmetadata.viewservices.connectionmaker.admin;
...
import org.odpi.openmetadata.viewservices.connectionmaker.ffdc.ConnectionMakerAuditCode;
import org.odpi.openmetadata.viewservices.connectionmaker.server.ConnectionMakerInstance;

import java.util.List;

/**
 * ConnectionMakerAdmin is the class that is called by the View Server to initialize and terminate
 * the Connection Maker OMVS.  The initialization call provides this OMVS with the Audit log and configuration.
 */
public class ConnectionMakerAdmin extends ViewServerGenericServiceAdmin
{
...

    {
        ...
        auditLog.logMessage(actionDescription, ConnectionMakerAuditCode.SERVICE_INITIALIZING.getMessageDefinition());
        ...
        try
        {
             ...
             */
            this.instance = new ConnectionMakerInstance(serverName,
                                                          auditLog,
                                                          serverUserName,
                                                          serverUserPassword,
                                                          maxPageSize,
            ...
            auditLog.logMessage(actionDescription,
                                ConnectionMakerAuditCode.SERVICE_INITIALIZED.getMessageDefinition(),
        ...
        catch (Exception error)
        {
            auditLog.logException(actionDescription,
                                  ConnectionMakerAuditCode.SERVICE_INSTANCE_FAILURE.getMessageDefinition(error.getMessage()),
                                  viewServiceConfig.toString(),
                                  error);
    ...
    public void shutdown()
    {
        ...
        auditLog.logMessage(actionDescription, ConnectionMakerAuditCode.SERVICE_TERMINATING.getMessageDefinition(serverName));
        ...
        auditLog.logMessage(actionDescription, ConnectionMakerAuditCode.SERVICE_SHUTDOWN.getMessageDefinition(serverName));
    }
}