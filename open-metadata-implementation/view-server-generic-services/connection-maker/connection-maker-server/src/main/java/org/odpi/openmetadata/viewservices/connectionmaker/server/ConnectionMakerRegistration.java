...
import org.odpi.openmetadata.viewservices.connectionmaker.admin.ConnectionMakerAdmin;
 ...
 */
public class ConnectionMakerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.CONNECTION_MAKER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       ConnectionMakerAdmin.class.getName());
