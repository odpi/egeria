...
The Connection Maker OMVS enables the caller to manage the definitions of connections, connector types and endpoints.
...
----
Sample REST API requests can be found in [Egeria-api-connection-maker.http](Egeria-api-connection-maker.http).
