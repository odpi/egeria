...
/**
 * ExternalLinksInstance caches references to the objects it needs for a specific server.
 * It is also responsible for registering itself in the instance map.
 */

public class ExternalLinksInstance extends OMVSServiceInstance
{
    private static final ViewServiceDescription myDescription = ViewServiceDescription.EXTERNAL_LINKS;
    ...
    /**
     * Set up the External Links OMVS instance
     *
     ...
     * @throws PropertyServerException bad client handler class
     */
    public ExternalIdHandler getExternalIdHandler(String urlMarker,
                                                  String methodName) throws InvalidParameterException,
                                                                            PropertyServerException
    {
        return externalIdHandlerMap.getClient(urlMarker, methodName);
    }
