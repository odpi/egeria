...
import org.odpi.openmetadata.viewservices.externallinks.admin.ExternalLinksAdmin;
 ...
 */
public class ExternalLinksRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.EXTERNAL_LINKS;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       ExternalLinksAdmin.class.getName());
