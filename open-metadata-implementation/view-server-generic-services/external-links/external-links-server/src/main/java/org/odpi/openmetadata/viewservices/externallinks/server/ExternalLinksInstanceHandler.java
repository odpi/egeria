 ...
 */
public class ExternalLinksInstanceHandler extends OMVSServiceInstanceHandler
{
    /**
     * Default constructor registers the view service
     */
    public ExternalLinksInstanceHandler()
    {
        super(ViewServiceDescription.EXTERNAL_LINKS.getViewServiceFullName());

        ExternalLinksRegistration.registerViewService();
    }
    ...
    {
        ExternalLinksInstance instance = (ExternalLinksInstance) getServerServiceInstance(userId, serverName, serviceOperationName);
     ...
     * @throws PropertyServerException internal error
     */
    public ExternalIdHandler getExternalIdHandler(String userId,
                                                  String serverName,
                                                  String urlMarker,
                                                  String serviceOperationName) throws InvalidParameterException,
                                                                                      PropertyServerException,
                                                                                      UserNotAuthorizedException
    {
        ...
        if (instance != null)
        {
            return instance.getExternalIdHandler(urlMarker, serviceOperationName);
        }
