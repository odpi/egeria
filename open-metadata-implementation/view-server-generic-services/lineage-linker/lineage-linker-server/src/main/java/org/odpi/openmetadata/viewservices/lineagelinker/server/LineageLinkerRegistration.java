...
import org.odpi.openmetadata.viewservices.lineagelinker.admin.LineageLinkerAdmin;
 ...
 */
public class LineageLinkerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.LINEAGE_LINKER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       LineageLinkerAdmin.class.getName());
