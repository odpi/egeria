 ...
 * </ul>
 */
public enum LineageLinkerErrorCode implements ExceptionMessageSet
{
    /**
     * OMVS-LINEAGE-LINKER-400-001 - The URL marker {0} is not recognized
     */
    INVALID_URL_MARKER(400, "OMVS-LINEAGE-LINKER-400-001",
     ...
     */
    LineageLinkerErrorCode(int httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
