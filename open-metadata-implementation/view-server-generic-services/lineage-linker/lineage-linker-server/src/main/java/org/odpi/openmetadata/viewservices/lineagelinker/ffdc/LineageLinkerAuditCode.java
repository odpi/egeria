 ...
 * </ul>
 */
public enum LineageLinkerAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-LINEAGE-LINKER-0001 The Lineage Linker Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-LINEAGE-LINKER-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-LINEAGE-LINKER-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-LINEAGE-LINKER-0003",
    ...
    /**
     * OMVS-LINEAGE-LINKER-0004 The Lineage Linker Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-LINEAGE-LINKER-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-LINEAGE-LINKER-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-LINEAGE-LINKER-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-LINEAGE-LINKER-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   LineageLinkerAuditCode(String                      messageId,
