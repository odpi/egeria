 ...
 * </ul>
 */
public enum TimeKeeperAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-TIME-KEEPER-0001 The Time Keeper Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-TIME-KEEPER-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-TIME-KEEPER-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-TIME-KEEPER-0003",
    ...
    /**
     * OMVS-TIME-KEEPER-0004 The Time Keeper Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-TIME-KEEPER-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-TIME-KEEPER-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-TIME-KEEPER-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-TIME-KEEPER-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   TimeKeeperAuditCode(String                      messageId,
