 ...
 * </ul>
 */
public enum ActorManagerErrorCode implements ExceptionMessageSet
{
    /**
     * OMVS-ACTOR-MANAGER-400-001 - The URL marker {0} is not recognized
     */
    INVALID_URL_MARKER(400, "OMVS-ACTOR-MANAGER-400-001",
     ...
     */
    ActorManagerErrorCode(int httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
