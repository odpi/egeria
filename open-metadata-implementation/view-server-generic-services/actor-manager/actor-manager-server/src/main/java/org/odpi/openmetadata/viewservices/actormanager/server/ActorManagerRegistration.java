...
import org.odpi.openmetadata.viewservices.actormanager.admin.ActorManagerAdmin;
 ...
 */
public class ActorManagerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.ACTOR_MANAGER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       ActorManagerAdmin.class.getName());
