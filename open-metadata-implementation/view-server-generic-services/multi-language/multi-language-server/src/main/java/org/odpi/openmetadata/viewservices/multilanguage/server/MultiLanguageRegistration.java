...
import org.odpi.openmetadata.viewservices.multilanguage.admin.MultiLanguageAdmin;
 ...
 */
public class MultiLanguageRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.MULTI_LANGUAGE;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       MultiLanguageAdmin.class.getName());
