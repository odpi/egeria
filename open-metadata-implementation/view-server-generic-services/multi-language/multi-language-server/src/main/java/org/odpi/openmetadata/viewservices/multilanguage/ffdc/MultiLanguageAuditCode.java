 ...
 * </ul>
 */
public enum MultiLanguageAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-MULTI-LANGUAGE-0001 The Multi Language Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-MULTI-LANGUAGE-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-MULTI-LANGUAGE-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-MULTI-LANGUAGE-0003",
     ...
     */
    SERVICE_INSTANCE_FAILURE("OMVS-MULTI-LANGUAGE-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-MULTI-LANGUAGE-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
