...
package org.odpi.openmetadata.viewservices.classificationexplorer.ffdc;
 ...
 * </ul>
 */
public enum ClassificationExplorerAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-CLASSIFICATION-EXPLORER-0001 The Classification Explorer Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-CLASSIFICATION-EXPLORER-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-CLASSIFICATION-EXPLORER-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-CLASSIFICATION-EXPLORER-0003",
     ...
     */
    SERVICE_INSTANCE_FAILURE("OMVS-CLASSIFICATION-EXPLORER-0004",
                             AuditLogRecordSeverityLevel.EXCEPTION,
                             "The Classification Explorer Open Metadata View Service (OMVS) is unable to initialize a new instance; error message is {0}",
     ...
     */
    SERVICE_TERMINATING("OMVS-CLASSIFICATION-EXPLORER-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
   ...
   ClassificationExplorerAuditCode(String                      messageId,
    ...
    {
        return "ClassificationExplorerAuditCode{" +
