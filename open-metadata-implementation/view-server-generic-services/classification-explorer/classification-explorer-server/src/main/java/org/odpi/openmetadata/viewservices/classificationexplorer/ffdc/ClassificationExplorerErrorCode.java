...
/**
 * The ClassificationExplorerErrorCode is used to define first failure data capture (FFDC) for errors that occur within the OMAG Server
 ...
 * </ul>
 */
public enum ClassificationExplorerErrorCode implements ExceptionMessageSet
{
    /**
     * OMVS-CLASSIFICATION-EXPLORER-400-001 - The URL marker {0} is not recognized
     */
    INVALID_URL_MARKER(400, "OMVS-CLASSIFICATION-EXPLORER-400-001",
     ...
     */
    ClassificationExplorerErrorCode(int httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
