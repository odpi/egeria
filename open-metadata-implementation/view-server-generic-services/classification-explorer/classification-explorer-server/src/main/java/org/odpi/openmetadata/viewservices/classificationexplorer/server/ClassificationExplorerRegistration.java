...
import org.odpi.openmetadata.viewservices.classificationexplorer.admin.ClassificationExplorerAdmin;
 ...
 */
public class ClassificationExplorerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.CLASSIFICATION_EXPLORER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       ClassificationExplorerAdmin.class.getName());
