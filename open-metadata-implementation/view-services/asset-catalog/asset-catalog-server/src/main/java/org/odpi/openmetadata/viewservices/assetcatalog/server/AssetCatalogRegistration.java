...
import org.odpi.openmetadata.viewservices.assetcatalog.admin.AssetCatalogAdmin;
...
public class AssetCatalogRegistration
{
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.ASSET_CATALOG;
