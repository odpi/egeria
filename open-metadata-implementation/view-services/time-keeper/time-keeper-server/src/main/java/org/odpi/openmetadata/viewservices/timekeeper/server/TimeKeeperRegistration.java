...
import org.odpi.openmetadata.viewservices.timekeeper.admin.TimeKeeperAdmin;
 ...
 */
public class TimeKeeperRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.TIME_KEEPER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       TimeKeeperAdmin.class.getName());
