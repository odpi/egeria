...
import org.odpi.openmetadata.viewservices.peopleorganizer.admin.PeopleOrganizerAdmin;
 ...
 */
public class PeopleOrganizerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.PEOPLE_ORGANIZER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       PeopleOrganizerAdmin.class.getName());
