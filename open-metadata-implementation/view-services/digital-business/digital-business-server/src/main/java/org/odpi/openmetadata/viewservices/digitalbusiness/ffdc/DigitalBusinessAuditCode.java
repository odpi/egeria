...
package org.odpi.openmetadata.viewservices.digitalbusiness.ffdc;
 ...
 * </ul>
 */
public enum DigitalBusinessAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-DIGITAL-BUSINESS-0001 The Digital Business Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-DIGITAL-BUSINESS-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-DIGITAL-BUSINESS-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-DIGITAL-BUSINESS-0003",
    ...
    /**
     * OMVS-DIGITAL-BUSINESS-0004 The Digital Business Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-DIGITAL-BUSINESS-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-DIGITAL-BUSINESS-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-DIGITAL-BUSINESS-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-DIGITAL-BUSINESS-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   DigitalBusinessAuditCode(String                      messageId,
    ...
    {
        return "DigitalBusinessAuditCode{" +
