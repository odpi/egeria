...
import org.odpi.openmetadata.viewservices.digitalbusiness.admin.DigitalBusinessAdmin;
 ...
 */
public class DigitalBusinessRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.DIGITAL_BUSINESS;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       DigitalBusinessAdmin.class.getName());
