...
import org.odpi.openmetadata.viewservices.productcatalog.admin.ProductCatalogAdmin;
 ...
 */
public class ProductCatalogRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.PRODUCT_CATALOG;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       ProductCatalogAdmin.class.getName());
