 ...
 * </ul>
 */
public enum ProductCatalogAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-PRODUCT-CATALOG-0001 The Product Catalog Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-PRODUCT-CATALOG-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-PRODUCT-CATALOG-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-PRODUCT-CATALOG-0003",
    ...
    /**
     * OMVS-PRODUCT-CATALOG-0004 The Product Catalog Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-PRODUCT-CATALOG-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-PRODUCT-CATALOG-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-PRODUCT-CATALOG-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-PRODUCT-CATALOG-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   ProductCatalogAuditCode(String                      messageId,
    ...
    {
        return "ProductCatalogAuditCode{" +
