...
import org.odpi.openmetadata.viewservices.glossarymanager.admin.GlossaryManagerAdmin;
 ...
 */
public class GlossaryManagerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.GLOSSARY_MANAGER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       GlossaryManagerAdmin.class.getName());
