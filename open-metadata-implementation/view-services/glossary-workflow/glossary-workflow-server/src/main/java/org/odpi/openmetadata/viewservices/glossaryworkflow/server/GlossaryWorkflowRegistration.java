...
import org.odpi.openmetadata.viewservices.glossaryworkflow.admin.GlossaryWorkflowAdmin;
 ...
 */
public class GlossaryWorkflowRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.GLOSSARY_WORKFLOW;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       GlossaryWorkflowAdmin.class.getName());
