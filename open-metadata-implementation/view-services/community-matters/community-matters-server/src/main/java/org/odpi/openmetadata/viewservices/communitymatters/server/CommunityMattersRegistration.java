...
import org.odpi.openmetadata.viewservices.communitymatters.admin.CommunityMattersAdmin;
 ...
 */
public class CommunityMattersRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.COMMUNITY_MATTERS;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       CommunityMattersAdmin.class.getName());
