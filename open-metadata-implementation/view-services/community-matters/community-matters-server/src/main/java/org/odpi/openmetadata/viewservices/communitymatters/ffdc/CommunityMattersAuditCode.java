 ...
 * </ul>
 */
public enum CommunityMattersAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-COMMUNITY-MATTERS-0001 The Community Matters Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-COMMUNITY-MATTERS-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-COMMUNITY-MATTERS-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-COMMUNITY-MATTERS-0003",
    ...
    /**
     * OMVS-COMMUNITY-MATTERS-0004 The Community Matters Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-COMMUNITY-MATTERS-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-COMMUNITY-MATTERS-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-COMMUNITY-MATTERS-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-COMMUNITY-MATTERS-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   CommunityMattersAuditCode(String                      messageId,
    ...
    {
        return "CommunityMattersAuditCode{" +
