...
public enum SubjectAreaAuditCode implements AuditLogMessageSet
{
     ...
     */
    SERVICE_INITIALIZED("OMVS-SUBJECT-AREA-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-SUBJECT-AREA-0003",
    ...
    /**
     * OMVS-SUBJECT-AREA-0004 The Subject Area Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-SUBJECT-AREA-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-SUBJECT-AREA-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-SUBJECT-AREA-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-SUBJECT-AREA-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
