...
import org.odpi.openmetadata.viewservices.collectionmanager.admin.CollectionManagerAdmin;
 ...
 */
public class CollectionManagerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.COLLECTION_MANAGER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       CollectionManagerAdmin.class.getName());
