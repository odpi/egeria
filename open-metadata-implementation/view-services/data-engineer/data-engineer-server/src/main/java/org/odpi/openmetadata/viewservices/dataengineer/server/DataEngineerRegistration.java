...
import org.odpi.openmetadata.viewservices.dataengineer.admin.DataEngineerAdmin;
 ...
 */
public class DataEngineerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.DATA_ENGINEER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       DataEngineerAdmin.class.getName());
