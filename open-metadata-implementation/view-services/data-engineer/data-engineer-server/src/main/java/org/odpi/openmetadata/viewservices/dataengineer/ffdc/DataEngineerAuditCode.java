 ...
 * </ul>
 */
public enum DataEngineerAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-DATA-ENGINEER-0001 The Data Engineer Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-DATA-ENGINEER-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-DATA-ENGINEER-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-DATA-ENGINEER-0003",
    ...
    /**
     * OMVS-DATA-ENGINEER-0004 The Data Engineer Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-DATA-ENGINEER-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-DATA-ENGINEER-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-DATA-ENGINEER-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-DATA-ENGINEER-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   DataEngineerAuditCode(String                      messageId,
