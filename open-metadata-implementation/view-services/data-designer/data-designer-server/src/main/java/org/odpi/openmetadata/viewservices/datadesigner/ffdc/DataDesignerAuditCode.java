 ...
 * </ul>
 */
public enum DataDesignerAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-DATA-DESIGNER-0001 The Data Designer Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-DATA-DESIGNER-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-DATA-DESIGNER-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-DATA-DESIGNER-0003",
    ...
    /**
     * OMVS-DATA-DESIGNER-0004 The Data Designer Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-DATA-DESIGNER-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-DATA-DESIGNER-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-DATA-DESIGNER-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-DATA-DESIGNER-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   DataDesignerAuditCode(String                      messageId,
