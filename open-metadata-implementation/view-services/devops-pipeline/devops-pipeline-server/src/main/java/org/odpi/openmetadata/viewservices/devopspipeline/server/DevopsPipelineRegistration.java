...
import org.odpi.openmetadata.viewservices.devopspipeline.admin.DevopsPipelineAdmin;
 ...
 */
public class DevopsPipelineRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.DEVOPS_PIPELINE;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       DevopsPipelineAdmin.class.getName());
