...
public enum DevopsPipelineAuditCode implements AuditLogMessageSet
{
     ...
     */
    SERVICE_INITIALIZING("OMVS-DEVOPS-PIPELINE-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-DEVOPS-PIPELINE-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-DEVOPS-PIPELINE-0003",
    ...
    /**
     * OMVS-DEVOPS-PIPELINE-0004 The Devops Pipeline Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-DEVOPS-PIPELINE-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-DEVOPS-PIPELINE-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-DEVOPS-PIPELINE-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-DEVOPS-PIPELINE-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   DevopsPipelineAuditCode(String                      messageId,
    ...
    {
        return "DevopsPipelineAuditCode{" +
