...
public class ReferenceDataRESTServices extends TokenController
{
     ...
     *  UserNotAuthorizedException the requesting user is not authorized to issue this request.
     */
    public GUIDResponse linkValidValueImplementation(String                     serverName,
                                                     String                     validValueDefinitionGUID,
                                                     String                     elementGUID,
                                                     NewRelationshipRequestBody requestBody)
    {
        ...
        try
        {
            ...
            if (requestBody != null)
            {
                ...
                {
                    response.setGUID(handler.linkValidValueImplementation(userId,
                                                         validValueDefinitionGUID,
                                                         elementGUID,
                                                         requestBody,
                                                         properties));
     ...
     * PropertyServerException    a problem reported in the open metadata server(s)
     */
    public VoidResponse updateValidValueImplementation(String                        serverName,
                                                       ...
                                                       UpdateRelationshipRequestBody requestBody)
    {
        ...
        try
        {
            ...
            if (requestBody != null)
            {
                if (requestBody.getProperties() instanceof ValidValuesImplementationProperties properties)
                {
                    handler.updateValidValueImplementation(userId, validValuesImplementationRelationshipGUID, requestBody, properties);
                }
                else
                {
                    restExceptionHandler.handleInvalidPropertiesObject(ValidValuesImplementationProperties.class.getName(), methodName);
                                                       ...
                                                       DeleteRelationshipRequestBody requestBody)
    {
        ...
        try
        {
            ...
            handler.detachValidValueImplementation(userId, validValuesImplementationRelationshipGUID, requestBody);
        }
        catch (Throwable error)
        {
            restExceptionHandler.captureRuntimeExceptions(response, error, methodName, auditLog);
