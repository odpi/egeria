...
public class ReferenceDataInstanceHandler extends OMVSServiceInstanceHandler
{
    ...
    {
        ReferenceDataInstance instance = (ReferenceDataInstance) getServerServiceInstance(userId, serverName, serviceOperationName);

        if (instance != null)
        {
            return instance.getValidValueDefinitionHandler();
        }
