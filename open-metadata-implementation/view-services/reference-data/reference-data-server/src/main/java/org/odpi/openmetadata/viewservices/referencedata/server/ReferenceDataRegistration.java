...
import org.odpi.openmetadata.viewservices.referencedata.admin.ReferenceDataAdmin;
 ...
 */
public class ReferenceDataRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.REFERENCE_DATA;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       ReferenceDataAdmin.class.getName());
