...
public enum ReferenceDataAuditCode implements AuditLogMessageSet
{
     ...
     */
    SERVICE_INITIALIZING("OMVS-REFERENCE-DATA-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-REFERENCE-DATA-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-REFERENCE-DATA-0003",
    ...
    /**
     * OMVS-REFERENCE-DATA-0004 The Reference Data Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-REFERENCE-DATA-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-REFERENCE-DATA-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-REFERENCE-DATA-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-REFERENCE-DATA-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
