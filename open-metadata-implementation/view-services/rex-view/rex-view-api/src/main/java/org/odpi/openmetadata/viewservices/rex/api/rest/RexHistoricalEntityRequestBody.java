...
public class RexHistoricalEntityRequestBody extends RexEntityRequestBody{
    ...
    public RexHistoricalEntityRequestBody() {
        super();
    }
    ...
    {
        return "RexHistoricalEntityRequestBody{" +
                "asOfTime=" + asOfTime + "," +
               super.toString() +
                '}';
    }
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof RexHistoricalEntityRequestBody))
        {
            return false;
        }
        ...
        RexHistoricalEntityRequestBody
                that = (RexHistoricalEntityRequestBody) objectToCompare;
