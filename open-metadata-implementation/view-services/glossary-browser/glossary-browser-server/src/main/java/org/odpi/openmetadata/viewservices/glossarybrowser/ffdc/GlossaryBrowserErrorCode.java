...
/**
 * The GlossaryBrowserErrorCode is used to define first failure data capture (FFDC) for errors that occur within the OMVS
 ...
 * </ul>
 */
public enum GlossaryBrowserErrorCode implements ExceptionMessageSet
{
    SERVICE_NOT_INITIALIZED
            (404, "OMVS-GLOSSARY-BROWSER-400-001",
             "The Glossary Browser Open Metadata View Service (OMVS) has not been initialized.",
    ...
    INVALID_CONFIG_PROPERTY
            (404, "OMVS-GLOSSARY-BROWSER-400-002",
             "The Glossary Browser Open Metadata View Service (OMVS) configuration has an invalid or missing property, property name {0}.",
    ...
    VIEW_SERVICE_NULL_PLATFORM_NAME
            (400, "OMVS-GLOSSARY-BROWSER-400-003",
             "The Glossary Browser Open Metadata View Service (OMVS) has been called with a null platform name",
    ...
    VIEW_SERVICE_NULL_SERVER_NAME
            (400, "OMVS-GLOSSARY-BROWSER-400-004",
             "The Glossary Browser Open Metadata View Service (OMVS) has been called with a null server name",
    ...
    VIEW_SERVICE_UNKNOWN_SERVER_NAME
            (400, "OMVS-GLOSSARY-BROWSER-400-005",
             "The Glossary Browser Open Metadata View Service (OMVS)'s {0} method has been called with an unknown server name of {1}",
    ...
    USER_NOT_AUTHORIZED
            (400, "OMVS-REPOSITORY-EXPLORER-400-004",
             "The Glossary Browser OMVS could not perform the requested operation {0} on behalf of user {1}",
    ...
    REPOSITORY_NOT_AVAILABLE
            (400, "OMVS-GLOSSARY-BROWSER-400-005",
             "The Glossary Browser OMVS operation {0} found that server {1} is not available",
    ...
    PLATFORM_NOT_AVAILABLE
            (400, "OMVS-GLOSSARY-BROWSER-400-006",
             "The Glossary Browser OMVS operation {0} could not reach platform {1}",
    ...
    REPOSITORY_ERROR
            (400, "OMVS-GLOSSARY-BROWSER-400-007",
             "The Glossary Browser OMVS operation {0} encountered a problem connecting to the repository, the message is {1}",
    ...
    INVALID_PARAMETER
            (400, "OMVS-GLOSSARY-BROWSER-400-008",
             "The Glossary Browser OMVS operation {0} could not proceed with the setting of parameter {1}",
    ...
    ENTITY_NOT_KNOWN_IN_REPOSITORY
            (400, "OMVS-GLOSSARY-BROWSER-400-009",
             "The Glossary Browser OMVS operation {0} found no entity with guid {1} in repository {2}",
    ...
    ENTITY_NOT_KNOWN_IN_ENTERPRISE
            (400, "OMVS-GLOSSARY-BROWSER-400-010",
             "The Glossary Browser OMVS operation {0} found no entity with guid {1} at enterprise scope for repository {2}",
    ...
    ENTITY_PROXY_ONLY
            (400, "OMVS-GLOSSARY-BROWSER-400-011",
             "The Glossary Browser OMVS operation {0} reported that an entity is only available as a proxy - {1}",
    ...
    RELATIONSHIP_NOT_KNOWN_IN_REPOSITORY
            (400, "OMVS-GLOSSARY-BROWSER-400-012",
             "The Glossary Browser OMVS operation {0} found no relationship with guid {1} in repository {2}",
    ...
    RELATIONSHIP_NOT_KNOWN_IN_ENTERPRISE
            (400, "OMVS-GLOSSARY-BROWSER-400-013",
             "The Glossary Browser OMVS operation {0} found no relationship with guid {1} at enterprise scope for repository {2}",
    ...
    VIEW_SERVICE_REQUEST_BODY_MISSING
            (400, "OMVS-GLOSSARY-BROWSER-400-014",
             "The Glossary Browser OMVS could not perform the requested operation {0} because te requestBody was missing",
    ...
    TYPE_ERROR
            (400, "OMVS-GLOSSARY-BROWSER-400-015",
             "The Glossary Browser OMVS operation {0} reported a type error - {1}",
             "The system could not perform the requested action.",
             "Check the calling code to make sure that a valid type is passed to the view service API."),

    PROPERTY_ERROR
            (400, "OMVS-GLOSSARY-BROWSER-400-016",
             "The Glossary Browser OMVS operation {0} reported a property error - {1}",
    ...
    PAGING_ERROR
            (400, "OMVS-GLOSSARY-BROWSER-400-017",
             "The Glossary Browser OMVS operation {0} reported a paging error - {1}",
             "The system could not perform the requested action.",
             "Check the calling code to make sure that the requested operation is valid."),

    FUNCTION_NOT_SUPPORTED_ERROR
            (400, "OMVS-GLOSSARY-BROWSER-400-018",
             "The Glossary Browser OMVS could not perform the requested operation {0} because it is not supported by repository {1}",
             "The system could not perform the requested action.",
             "Check the conformance of the target repository and retry with a supported operation."),

    COULD_NOT_CREATE_HANDLER
            (400, "OMVS-GLOSSARY-BROWSER-400-019",
             "The Glossary Browser OMVS could not instantiate its handler",
             "The system could not perform the requested action.",
             "Check the configuration of the view service and its platform."),

    COULD_NOT_RETRIEVE_SERVER_CONFIGURATION
            (400, "OMVS-GLOSSARY-BROWSER-400-020",
             "The Glossary Browser OMVS operation {0} could not retrieve the configuration for server {1}",
             "The system could not perform the requested action.",
             "Check the configuration of the view service and its platform."),

    COULD_NOT_RETRIEVE_SERVICE_CONFIGURATION
            (400, "OMVS-GLOSSARY-BROWSER-400-021",
             "The Glossary Browser OMVS operation {0} could not retrieve the configuration for service {1}",
             "The system could not perform the requested action.",
             "Check the configuration of the view service and its platform."),

    COULD_NOT_RETRIEVE_GOVERNANCE_ENGINE
            (400, "OMVS-GLOSSARY-BROWSER-400-022",
             "The Glossary Browser OMVS operation {0} could not find a governance engine with qualified name {1}",
             "The system could not perform the requested action.",
     ...
     */
    UNKNOWN_ERROR
            (400, "OMVS-GLOSSARY-BROWSER-400-099",
             "The Glossary Browser OMVS caught an unknown error during operation {0}. The detailed message is {1}",
             "The system could not perform the requested action.",
    ...
    /**
     * The constructor for GlossaryBrowserErrorCode expects to be passed one of the enumeration rows defined in
     * GlossaryBrowserErrorCode above.   For example:
     *
     *     GlossaryBrowserErrorCode   errorCode = GlossaryBrowserErrorCode.SERVICE_NOT_INITIALIZED;
     *
     ...
     */
    GlossaryBrowserErrorCode(int  httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
    ...
    {
        return "GlossaryBrowserErrorCode{" +
