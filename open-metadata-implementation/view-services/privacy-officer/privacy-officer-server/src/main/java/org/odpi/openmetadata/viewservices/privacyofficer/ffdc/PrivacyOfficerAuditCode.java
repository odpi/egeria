 ...
 * </ul>
 */
public enum PrivacyOfficerAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-PRIVACY-OFFICER-0001 The Privacy Officer Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-PRIVACY-OFFICER-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-PRIVACY-OFFICER-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-PRIVACY-OFFICER-0003",
    ...
    /**
     * OMVS-PRIVACY-OFFICER-0004 The Privacy Officer Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-PRIVACY-OFFICER-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-PRIVACY-OFFICER-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-PRIVACY-OFFICER-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-PRIVACY-OFFICER-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   PrivacyOfficerAuditCode(String                      messageId,
    ...
    {
        return "PrivacyOfficerAuditCode{" +
