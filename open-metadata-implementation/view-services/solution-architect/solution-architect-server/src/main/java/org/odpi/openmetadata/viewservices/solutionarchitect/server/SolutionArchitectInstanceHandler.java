...
public class SolutionArchitectInstanceHandler extends OMVSServiceInstanceHandler
{
     ...
     * @throws PropertyServerException internal error
     */
    public SolutionPortHandler getSolutionPortHandler(String userId,
                                                      String serverName,
                                                      String serviceOperationName) throws InvalidParameterException,
                                                                                          PropertyServerException,
                                                                                          UserNotAuthorizedException
    {
        ...
        if (instance != null)
        {
            return instance.getSolutionPortHandler();
        }
     ...
     * @throws PropertyServerException internal error
     */
    public ConceptModelElementHandler getConceptModelElementHandler(String userId,
                                                                    String serverName,
                                                                    String serviceOperationName) throws InvalidParameterException,
                                                                                                        PropertyServerException,
                                                                                                        UserNotAuthorizedException
    {
        ...
        if (instance != null)
        {
            return instance.getConceptModelElementHandler();
        }
