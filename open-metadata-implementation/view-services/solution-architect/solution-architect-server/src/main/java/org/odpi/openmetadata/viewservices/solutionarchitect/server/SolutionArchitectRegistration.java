...
import org.odpi.openmetadata.viewservices.solutionarchitect.admin.SolutionArchitectAdmin;
 ...
 */
public class SolutionArchitectRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.SOLUTION_ARCHITECT;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       SolutionArchitectAdmin.class.getName());
