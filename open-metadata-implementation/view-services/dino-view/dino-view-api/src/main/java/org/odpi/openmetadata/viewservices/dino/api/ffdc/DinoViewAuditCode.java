...
public enum DinoViewAuditCode implements AuditLogMessageSet
{
    SERVICE_INITIALIZING("OMVS-DINO-0001",
                         ...
                         "No action is required. This is part of the normal operation of the Dino OMVS."),
    ...
    SERVICE_INITIALIZED("OMVS-DINO-0002",
                         ...
                         "No action is required.  This is part of the normal operation of the Repository Explorer OMVS. Once the OMRS is configured and the server is started, Dino view service requests can be accepted."),
