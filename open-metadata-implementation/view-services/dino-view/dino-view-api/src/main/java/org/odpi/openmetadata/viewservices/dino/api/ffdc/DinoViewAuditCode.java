...
{
    /**
     * OMVS-DINO-0001 - The Dino View Service (OMVS) is initializing
     */
    ...
    /**
     * OMVS-DINO-0002 - The Dino View Service (OMVS) is initialized
     */
    ...
    /**
     * OMVS-DINO-0003 - The Dino View Service (OMVS) is shutting down
     */
    ...
    /**
     * OMVS-DINO-0004 - The Dino View Service (OMVS) is unable to initialize a new instance; error message is {0}
     */
    ...
    /**
     * OMVS-DINO-0005 - The Dino View Service (OMVS) is shutting down server instance {0}
     */
    ...
    /**
     * OMVS-DINO-0006 - The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    ...
    /**
     * The constructor for DinoAuditCode expects to be passed one of the enumeration rows defined in
     * DinoAuditCode above.   For example:
     *     DinoAuditCode   auditCode = DinoAuditCode.SERVER_NOT_AVAILABLE;
