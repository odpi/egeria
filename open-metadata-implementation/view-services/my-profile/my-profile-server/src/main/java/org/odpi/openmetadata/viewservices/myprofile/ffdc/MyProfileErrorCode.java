 ...
 * </ul>
 */
public enum MyProfileErrorCode implements ExceptionMessageSet
{
    /**
     * OMVS-MY-PROFILE-400-001 - The personal profile for user {0} already exists
     */
