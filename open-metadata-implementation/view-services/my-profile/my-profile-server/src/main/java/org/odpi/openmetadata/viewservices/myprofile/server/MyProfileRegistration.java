...
import org.odpi.openmetadata.viewservices.myprofile.admin.MyProfileAdmin;
...
public class MyProfileRegistration
{
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.MY_PROFILE;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       MyProfileAdmin.class.getName());
