...
/**
 * ToDoListResponse is the response structure used on the OMAS REST API calls that return
 * a list of to do objects.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class ToDoListResponse extends CommunityProfileOMASAPIResponse
{
    private List<ToDoElement> toDoElements = null;
     ...
     */
    public ToDoListResponse(ToDoListResponse template)
    {
        super(template);

        if (template != null)
        {
            this.toDoElements = template.getToDoElements();
        }
    }
     ...
     *
     * @param toDoElements - unique identifier
     */
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ToDoListResponse that))
        {
            return false;
        }
        ...
        return Objects.equals(getToDoElements(), that.getToDoElements());
    }
    ...
    public int hashCode()
    {
        return Objects.hash(super.hashCode(), toDoElements);
    }
}
