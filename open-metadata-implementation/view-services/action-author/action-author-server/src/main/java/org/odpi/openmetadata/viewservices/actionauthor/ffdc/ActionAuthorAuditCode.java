 ...
 * </ul>
 */
public enum ActionAuthorAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-ACTION-AUTHOR-0001 The Action Author Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-ACTION-AUTHOR-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-ACTION-AUTHOR-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-ACTION-AUTHOR-0003",
    ...
    /**
     * OMVS-ACTION-AUTHOR-0004 The Action Author Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-ACTION-AUTHOR-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-ACTION-AUTHOR-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-ACTION-AUTHOR-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-ACTION-AUTHOR-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
    ...
    /**
     * The constructor for ActionAuthorAuditCode expects to be passed one of the enumeration rows defined in
     * ActionAuthorAuditCode above.   For example:
     *     ActionAuthorAuditCode   auditCode = ActionAuthorAuditCode.SERVER_NOT_AVAILABLE;
     ...
     */
   ActionAuthorAuditCode(String                      messageId,
