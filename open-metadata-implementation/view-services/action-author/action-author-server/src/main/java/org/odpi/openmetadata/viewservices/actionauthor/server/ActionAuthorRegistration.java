...
import org.odpi.openmetadata.viewservices.actionauthor.admin.ActionAuthorAdmin;
 ...
 */
public class ActionAuthorRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.ACTION_AUTHOR;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       ActionAuthorAdmin.class.getName());
