...
public enum SecurityOfficerAuditCode implements AuditLogMessageSet
{
     ...
     */
    SERVICE_INITIALIZING("OMVS-SECURITY-OFFICER-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-SECURITY-OFFICER-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-SECURITY-OFFICER-0003",
    ...
    /**
     * OMVS-SECURITY-OFFICER-0004 The Security Officer Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-SECURITY-OFFICER-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-SECURITY-OFFICER-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-SECURITY-OFFICER-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-SECURITY-OFFICER-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
