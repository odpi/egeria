...
import org.odpi.openmetadata.viewservices.securityofficer.admin.SecurityOfficerAdmin;
...
public class SecurityOfficerRegistration
{
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.SECURITY_OFFICER;
