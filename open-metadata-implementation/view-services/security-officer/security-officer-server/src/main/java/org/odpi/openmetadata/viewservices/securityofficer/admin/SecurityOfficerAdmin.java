...
import org.odpi.openmetadata.viewservices.securityofficer.ffdc.SecurityOfficerAuditCode;
import org.odpi.openmetadata.viewservices.securityofficer.server.SecurityOfficerInstance;
 ...
 */
public class SecurityOfficerAdmin extends ViewServiceAdmin
{
    private AuditLog              auditLog   = null;
    private SecurityOfficerInstance instance   = null;
    private String                serverName = null;

    /**
     * Default constructor
     */
    public SecurityOfficerAdmin()
    {
    }


    /**
     * Initialize the Security Officer view service.
     *
...

    {
        ...
        catch (Exception error)
        {
            auditLog.logException(actionDescription,
                                  SecurityOfficerAuditCode.SERVICE_INSTANCE_FAILURE.getMessageDefinition(error.getMessage()),
                                  viewServiceConfig.toString(),
                                  error);

            super.throwUnexpectedInitializationException(actionDescription,
                                                         ViewServiceDescription.SECURITY_OFFICER.getViewServiceFullName(),
                                                         error);
        }
    }
    ...
    public void shutdown()
    {
        ...
        auditLog.logMessage(actionDescription, SecurityOfficerAuditCode.SERVICE_TERMINATING.getMessageDefinition(serverName));
