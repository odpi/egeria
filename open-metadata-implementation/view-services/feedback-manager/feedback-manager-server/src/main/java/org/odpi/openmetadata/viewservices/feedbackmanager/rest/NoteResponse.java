...
public class NoteResponse extends OMAGGAFAPIResponse
{
    private Note element = null;
     ...
     */
    public NoteResponse(NoteResponse template)
    {
        super(template);
     ...
     * @param element  bean
     */
    public void setElement(Note element)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof NoteResponse))
        {
            return false;
        }
        ...
        NoteResponse that = (NoteResponse) objectToCompare;
