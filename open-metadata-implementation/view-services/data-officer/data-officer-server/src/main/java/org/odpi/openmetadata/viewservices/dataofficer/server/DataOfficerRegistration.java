...
import org.odpi.openmetadata.viewservices.dataofficer.admin.DataOfficerAdmin;
 ...
 */
public class DataOfficerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.DATA_OFFICER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       DataOfficerAdmin.class.getName());
