 ...
 * </ul>
 */
public enum DataOfficerAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-DATA-OFFICER-0001 The Data Officer Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-DATA-OFFICER-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-DATA-OFFICER-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-DATA-OFFICER-0003",
    ...
    /**
     * OMVS-DATA-OFFICER-0004 The Data Officer Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}
     */
    SERVICE_INSTANCE_FAILURE("OMVS-DATA-OFFICER-0004",
     ...
     */
    SERVICE_TERMINATING("OMVS-DATA-OFFICER-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-DATA-OFFICER-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-DATA-OFFICER-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   DataOfficerAuditCode(String                      messageId,
