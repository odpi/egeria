...
import org.odpi.openmetadata.viewservices.productmanager.admin.ProductManagerAdmin;
 ...
 */
public class ProductManagerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.PRODUCT_MANAGER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       ProductManagerAdmin.class.getName());
