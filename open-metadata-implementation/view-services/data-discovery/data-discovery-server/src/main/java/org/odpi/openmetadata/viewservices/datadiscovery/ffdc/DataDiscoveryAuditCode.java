...
package org.odpi.openmetadata.viewservices.datadiscovery.ffdc;
 ...
 * </ul>
 */
public enum DataDiscoveryAuditCode implements AuditLogMessageSet
{
    /**
     * OMVS-DATA-DISCOVERY-0001 The Data Discovery Open Metadata View Service (OMVS) is initializing
     */
    SERVICE_INITIALIZING("OMVS-DATA-DISCOVERY-0001",
     ...
     */
    SERVICE_INITIALIZED("OMVS-DATA-DISCOVERY-0002",
                        AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    SERVICE_SHUTDOWN("OMVS-DATA-DISCOVERY-0003",
     ...
     */
    SERVICE_TERMINATING("OMVS-DATA-DISCOVERY-0005",
                        AuditLogRecordSeverityLevel.SHUTDOWN,
    ...
    /**
     * OMVS-DATA-DISCOVERY-0006 The Open Metadata Service has generated an unexpected {0} exception during method {1}.  The message was: {2}
     */
    UNEXPECTED_EXCEPTION("OMVS-DATA-DISCOVERY-0006",
                         AuditLogRecordSeverityLevel.EXCEPTION,
     ...
     */
   DataDiscoveryAuditCode(String                      messageId,
