...
import org.odpi.openmetadata.viewservices.notificationmanager.admin.NotificationManagerAdmin;
 ...
 */
public class NotificationManagerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.NOTIFICATION_MANAGER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       NotificationManagerAdmin.class.getName());
