...
import org.odpi.openmetadata.viewservices.runtimemanager.admin.RuntimeManagerAdmin;
 ...
 */
public class RuntimeManagerRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.RUNTIME_MANAGER;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       RuntimeManagerAdmin.class.getName());
