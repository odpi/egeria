...
public enum TexViewAuditCode implements AuditLogMessageSet
{
    ...
    /**
     * The constructor for TexViewAuditCode expects to be passed one of the enumeration rows defined in
     * TexViewAuditCode above.   For example:
     *     TexViewAuditCode   auditCode = TexViewAuditCode.SERVER_NOT_AVAILABLE;
