...
public abstract class TexViewOMVSAPIResponse extends FFDCResponseBase
{
     ...
     */
    public TexViewOMVSAPIResponse(TexViewOMVSAPIResponse  template)
    {
        super(template);
    }
