...
public class GlossaryAuthorViewRelationshipRESTServices extends BaseGlossaryAuthorView {
     ...
     * or to recreate the TermAnchorRelationship relationship.
     * <p>
     *
     * @param serverName serverName under which this request is performed, this is used in multi tenanting to identify the tenant
     * @param userId     userId under which the request is performed
     ...
     * </ul>
     */
    public SubjectAreaOMASAPIResponse<TermAnchor> deleteTermAnchor(String serverName, String userId, String guid) {
     ...
     * or to recreate the CategoryAnchorRelationship relationship.
     * <p>
     *
     * @param serverName     serverName under which this request is performed, this is used in multi tenanting to identify the tenant
     * @param userId         userId under which the request is performed
     ...
     * </ul>
     */
    public SubjectAreaOMASAPIResponse<CategoryAnchor> deleteCategoryAnchor(String serverName, String userId, String guid) {
