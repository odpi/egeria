...
import org.odpi.openmetadata.viewservices.locationarena.admin.LocationArenaAdmin;
 ...
 */
public class LocationArenaRegistration
{
    /**
    ...
    {
        ViewServiceDescription myDescription = ViewServiceDescription.LOCATION_ARENA;
        ViewServiceRegistrationEntry myRegistration = new ViewServiceRegistrationEntry(myDescription,
                                                                                       ServiceOperationalStatus.ENABLED,
                                                                                       LocationArenaAdmin.class.getName());
