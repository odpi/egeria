 ...
 */
public class TestOpenMetadataExchangeRule
{
    ...
    @Test public void testStarRatingValues()
    {
        ...
        OpenMetadataExchangeRule  testValue;

        testValue = OpenMetadataExchangeRule.REGISTRATION_ONLY;

        assertTrue(isUniqueOrdinal(testValue.getOrdinal()));
        assertTrue(testValue.getName() != null);
        assertTrue(testValue.getDescription() != null);

        testValue = OpenMetadataExchangeRule.JUST_TYPEDEFS;

        assertTrue(isUniqueOrdinal(testValue.getOrdinal()));
        assertTrue(testValue.getName() != null);
        assertTrue(testValue.getDescription() != null);

        testValue = OpenMetadataExchangeRule.SELECTED_TYPES;

        assertTrue(isUniqueOrdinal(testValue.getOrdinal()));
        assertTrue(testValue.getName() != null);
        assertTrue(testValue.getDescription() != null);

        testValue = OpenMetadataExchangeRule.LEARNED_TYPES;

        assertTrue(isUniqueOrdinal(testValue.getOrdinal()));
        assertTrue(testValue.getName() != null);
        assertTrue(testValue.getDescription() != null);

        testValue = OpenMetadataExchangeRule.ALL;
    ...
    {
        assertTrue(OpenMetadataExchangeRule.ALL.toString().contains("OpenMetadataExchangeRule"));
    }
}
