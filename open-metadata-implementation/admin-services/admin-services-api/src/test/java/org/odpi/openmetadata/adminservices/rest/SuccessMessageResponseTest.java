 ...
 */
public class SuccessMessageResponseTest
{
     ...
     * Default constructor
     */
    public SuccessMessageResponseTest()
    {
     ...
     */
    private SuccessMessageResponse getTestObject()
    {
    ...
    {
        SuccessMessageResponse    nullObject = new SuccessMessageResponse();
        ...
        nullObject = new SuccessMessageResponse(null);
    ...
    @Test public void testExceptionProperties()
    {
        ...
        propertyMap = null;
        testObject = new SuccessMessageResponse();
    ...
    @Test public void testEquals()
    {
        ...
        SuccessMessageResponse  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        SuccessMessageResponse  differentObject = getTestObject();
    ...
    {
        validateResultObject(new SuccessMessageResponse(getTestObject()));
    }
    ...
    {
        assertTrue(getTestObject().toString().contains("SuccessMessageResponse"));
    }
}
