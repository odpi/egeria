...
public enum AccessServiceDescription implements Serializable
{
    ...
    ASSET_LINEAGE_OMAS               (1023,   "Asset Lineage", "Store asset lineage",
    ...
    DIGITAL_ARCHITECTURE_OMAS        (1013,   "Digital Architecture", "Design of the digital services for an organization",
