...
public enum OMAGAuditCode
{
    ALL_ZONES("OMAG-ADMIN-0001",
             ...
             "The {0} Open Metadata Access Service (OMAS) is supporting all governance zones",
    ...
    PLATEAU_THRESHOLD("OMAG-ADMIN-0004",
             OMRSAuditLogRecordSeverity.INFO,
             "The {0} Open Metadata Access Service (OMAS) is using the following threshold for reporting Karma Point Plateaus: {1}",
             "The access service was passed this value in the KarmaPointThreshold property of the access services options.",
             "No action is required.  This is part of the normal operation of the service."),

    DEFAULT_PLATEAU_THRESHOLD("OMAG-ADMIN-0005",
             OMRSAuditLogRecordSeverity.INFO,
             "The {0} Open Metadata Access Service (OMAS) is using the default threshold for reporting Karma Point Plateaus: {1}",
             "This default value can be overridden with the KarmaPointThreshold property of the access services options.",
             "No action is required.  This is part of the normal operation of the service."),

    BAD_CONFIG_PROPERTY("OMAG-ADMIN-0006",
    ...
    SERVICE_REGISTERED_WITH_ENTERPRISE_TOPIC("OMAG-ADMIN-0007",
             OMRSAuditLogRecordSeverity.INFO,
    ...
    NO_ENTERPRISE_TOPIC("OMAG-ADMIN-0008",
             OMRSAuditLogRecordSeverity.ERROR,
