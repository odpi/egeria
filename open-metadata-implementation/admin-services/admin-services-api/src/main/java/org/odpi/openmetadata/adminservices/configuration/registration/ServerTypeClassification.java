...
public enum ServerTypeClassification
{
    ...
    GOVERNANCE_SERVER("Governance Server",
                      ...
                      ServerTypeClassification.OMAG_SERVER),
    GOVERNANCE_DAEMON("Governance Daemon",
                      "Governance server without external API",
                      ServerTypeClassification.OMAG_SERVER),
    ...
    DATA_PLATFORM_SERVER("Data Platform Server",
                        "Server that manages the extraction of metadata from data platforms",
                        ServerTypeClassification.GOVERNANCE_DAEMON),
    DATA_ENGINE_PROXY("Data Engine Proxy",
                         "Server that manages the extraction of metadata from a sing data engine",
                         ServerTypeClassification.GOVERNANCE_DAEMON),
    SECURITY_SYNC_SERVER("Security Sync Server",
                      "Server that manages the configuration for a service service",
                      ServerTypeClassification.GOVERNANCE_DAEMON),
