...
public class OMAGServerAdminServices
{
                                         ...
                                         String url)
    {
        ...
        try
        {
            ...
            {
                configAuditTrail.add(new Date() + " " + userId + " updated configuration for local server's URL root to " + url + ".");
            }
     ...
     */
    @SuppressWarnings(value = "unused")
    public VoidResponse setXTDBInMemRepository(String          userId,
                                               String          serverName,
                                               NullRequestBody requestBody)
    {
        ...
        try
        {
            ...
            this.setLocalRepositoryConfig(userId,
                                          serverName,
                                          configurationFactory.getXTDBInMemLocalRepository(serverConfig.getLocalServerName(),
                                                                                           serverConfig.getLocalServerURL()));
        }
        catch (OMAGInvalidParameterException error)
        {
     ...
     */
    @SuppressWarnings(value = "unused")
    public VoidResponse setXTDBLocalKVRepository(String          userId,
                                                 String          serverName,
                                                 NullRequestBody requestBody)
    {
        ...
        try
        {
            ...
            this.setLocalRepositoryConfig(userId,
                                          serverName,
                                          configurationFactory.getXTDBKVLocalRepository(serverConfig.getLocalServerName(),
                                                                                        serverConfig.getLocalServerURL()));
        }
        catch (OMAGInvalidParameterException error)
        {
     ...
     * OMAGInvalidParameterException invalid serverName or localRepositoryMode parameter.
     */
    public VoidResponse setXTDBLocalRepository(String              userId,
                                               String              serverName,
                                               Map<String, Object> storageProperties)
    {
        ...
        try
        {
            ...
            this.setLocalRepositoryConfig(userId,
                                          serverName,
                                          configurationFactory.XTDBLocalRepository(serverConfig.getLocalServerName(),
                                                                                   serverConfig.getLocalServerURL(),
                                                                                   storageProperties));
        }
        catch (OMAGInvalidParameterException error)
