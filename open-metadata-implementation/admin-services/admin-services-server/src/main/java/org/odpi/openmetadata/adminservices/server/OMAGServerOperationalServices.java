...
public class OMAGServerOperationalServices
{
     ...
     * OMAGConfigurationErrorException there is a problem using the supplied configuration.
     */
    public SuccessMessageResponse activateServerWithSuppliedConfig(String           userId,
                                                             OMAGServerConfig configuration)
    {
        final String methodName        = "activateServerWithSuppliedConfig";
        final String actionDescription = "Initialize OMAG standalone Server subsystems";
        RESTCallToken token = null;
        ...
        String serverName =configuration.getLocalServerName();
        ...
        try
        {
             ...
             */
            token = restCallLogger.logRESTCall(serverName, userId, methodName);
            errorHandler.validateServerName(serverName, methodName);
            errorHandler.validateUserId(userId, serverName, methodName);
