...
public class ConfigViewServicesResource {
     ...
     * @param serviceURLMarker   string indicating which view service it is calling
     ...
     */
    @PostMapping(path = "")
    public VoidResponse enableViewServices(@PathVariable String userId,
                                           @PathVariable String serverName,
                                           @RequestBody(required = false) Map<String, Object> viewServiceOptions) {
        return adminAPI.enableViewServices(userId, serverName, viewServiceOptions);
    }
     ...
     */
    @DeleteMapping(path = "")
    public VoidResponse disableViewServices(@PathVariable String userId,
                                            @PathVariable String serverName) {
        return adminAPI.disableViewServices(userId, serverName);
    }
