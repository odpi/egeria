...
/**
 * IntegrationDaemonConfigurationClient provides the common configuration services needed by
 * all integration daemons.
 */
abstract class IntegrationDaemonConfigurationClient extends GovernanceServerConfigurationClient
{
    /**
