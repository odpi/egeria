...
/**
 * The ApacheKafkaErrorCode is used to define first failure data capture (FFDC) for errors that occur when working with
 ...
 * </ul>
 */
public enum ApacheKafkaErrorCode implements ExceptionMessageSet
{
    /**
