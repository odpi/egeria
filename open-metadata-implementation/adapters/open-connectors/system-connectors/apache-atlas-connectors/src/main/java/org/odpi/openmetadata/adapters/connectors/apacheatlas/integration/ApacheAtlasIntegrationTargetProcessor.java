 ...
 */
public class ApacheAtlasIntegrationTargetProcessor extends CatalogTargetProcessorBase implements OpenMetadataEventListener
{
    private String                                         targetRootURL                             = null;
    private ApacheAtlasRESTConnector                       atlasClient                               = null;
    private Connection                                     connectionBean                            = null;
     ...
     */
    public ApacheAtlasIntegrationTargetProcessor(CatalogTarget        catalogTarget,
    ...
    public void start() throws ConnectorCheckedException, UserNotAuthorizedException
    {
        ...
        try
        {
             ...
             */
            if (connectorToTarget instanceof ApacheAtlasRESTConnector apacheAtlasRESTConnector)
            {
    ...
    /**
     * Process an event that was published by the Open Metadata Framework Manager.  This connector is only interested in
     * glossaries, glossary folders, and glossary terms.   The listener is only registered if metadata is flowing
    ...
    public void processEvent(OpenMetadataOutTopicEvent event)
    {
        ...
        if (integrationContext.noRefreshInProgress())
        {
            ...
            {
                if (integrationContext.isTypeOf(elementHeader, supportedType))
                {
                    List<RegisteredIntegrationModule> modulesForTypeName = moduleMap.get(supportedType);
