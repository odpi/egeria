 ...
 */
public enum ApacheAtlasConfigurationProperty
{
    /**
     ...
     */
    ApacheAtlasConfigurationProperty(String  name,
                                     String  description,
                                     String  dataType,
                                     String  example,
     ...
     */
    public static List<String> getConfigPropertyNames()
    {
        List<String> recognizedConfigurationProperties = new ArrayList<>();

        for (ApacheAtlasConfigurationProperty configurationProperty : ApacheAtlasConfigurationProperty.values())
        {
