...
package org.odpi.openmetadata.adapters.connectors.csvfile.ffdc;
...
public enum CSVFileConnectorErrorCode
{
    ...
    private static final Logger log = LoggerFactory.getLogger(CSVFileConnectorErrorCode.class);


    /**
     * The constructor for CSVFileConnectorErrorCode expects to be passed one of the enumeration rows defined in
     * AssetConsumerErrorCode above.   For example:
     *
     *     CSVFileConnectorErrorCode   errorCode = CSVFileConnectorErrorCode.FILE_NOT_FOUND;
     *
     ...
     */
    CSVFileConnectorErrorCode(int  newHTTPErrorCode, String newErrorMessageId, String newErrorMessage, String newSystemAction, String newUserAction)
    {
    ...
    {
        return "CSVFileConnectorErrorCode{" +
