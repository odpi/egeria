...
public enum EgeriaOpenConnectorDefinition implements OpenConnectorDefinition
{
    ...
    DATA_SHARING_HUB_MANAGER_INTEGRATION_CONNECTOR(325,
                                                   "0ced349c-9a49-45db-a751-4973db83ebb0",
                                                   "Egeria::IntegrationConnector::DataSharingHubManager",
                                                   "Data Sharing Hub Manager Integration Connector",
                                                   "This connector builds out a data dictionary for the data stores that are members of a Data Sharing Hub.",
                                                   "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/nanny-connectors",
                                                   "org.odpi.openmetadata.adapters.connectors.liskov.DataSharingHubManagerProvider",
                                                   ComponentDevelopmentStatus.STABLE,
    ...
    MSSQL_SERVER_INTEGRATION_CONNECTOR(335,
                                       "f4c90a95-5031-403c-9187-2cfbd19fb29a",
                                       "Egeria::IntegrationConnector::DataManagerCatalog::MSSQLServer",
                                       "Catalog databases in Microsoft SQL Server",
                                       "Catalogs the databases found in a Microsoft SQL Server.  This includes the RelationalDatabase asset element plus a connection with the JDBC Resource connector type.",
                                       "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/mssql-server-connectors",
                                       "org.odpi.openmetadata.adapters.connectors.mssql.catalog.MSSQLServerIntegrationProvider",
                                       ComponentDevelopmentStatus.STABLE,
                                       DeployedImplementationType.INTEGRATION_CONNECTOR.getAssociatedTypeName(),
                                       DeployedImplementationType.INTEGRATION_CONNECTOR.getDeployedImplementationType()),

    MSSQL_SERVER_SURVEY_ACTION_SERVICE(336,
                                       "42b13517-cb44-479f-a704-bb55bb77c743",
                                       "Egeria::SurveyActionService::DataManagerCatalog::MSSQLServer",
                                       "Survey for a Microsoft SQL Server",
                                       "Surveys the databases, their tables and columns, found in a Microsoft SQL Server",
                                       "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/mssql-server-connectors",
                                       "org.odpi.openmetadata.adapters.connectors.mssql.survey.MSSQLServerSurveyActionProvider",
                                       ComponentDevelopmentStatus.STABLE,
                                       DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getAssociatedTypeName(),
                                       DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getDeployedImplementationType()),

    MSSQL_DATABASE_SURVEY_ACTION_SERVICE(337,
                                         "b4f4884c-993f-4c52-b1eb-8c225e1d1cb9",
                                         "Egeria::SurveyActionService::DataManagerCatalog::MSSQLDatabase",
                                         "Survey for a Microsoft SQL Server Database",
                                         "Surveys the tables and columns found in a Microsoft SQL Server database",
                                         "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/mssql-server-connectors",
                                         "org.odpi.openmetadata.adapters.connectors.mssql.survey.MSSQLDatabaseSurveyActionProvider",
                                         ComponentDevelopmentStatus.STABLE,
                                         DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getAssociatedTypeName(),
                                         DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getDeployedImplementationType()),


    ORACLE_SERVER_INTEGRATION_CONNECTOR(536,
                                        "fc2a99c5-a4f5-4180-94a6-5f1d98d1a7d0",
                                        "Egeria::IntegrationConnector::DataManagerCatalog::OracleServer",
                                        "Catalog databases in Oracle Database Server",
                                        "Catalogs the pluggable databases found in an Oracle Database Server.  This includes the RelationalDatabase asset element plus a connection with the JDBC Resource connector type.",
                                        "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/oracle-server-connectors",
                                        "org.odpi.openmetadata.adapters.connectors.oracle.catalog.OracleServerIntegrationProvider",
                                        ComponentDevelopmentStatus.STABLE,
                                        DeployedImplementationType.INTEGRATION_CONNECTOR.getAssociatedTypeName(),
                                        DeployedImplementationType.INTEGRATION_CONNECTOR.getDeployedImplementationType()),

    ORACLE_SERVER_SURVEY_ACTION_SERVICE(537,
                                        "84d95dc0-548c-49d1-9029-1854a209cb72",
                                        "Egeria::SurveyActionService::DataManagerCatalog::OracleServer",
                                        "Survey for an Oracle Database Server",
                                        "Surveys the pluggable databases, their tables and columns, found in an Oracle Database Server",
                                        "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/oracle-server-connectors",
                                        "org.odpi.openmetadata.adapters.connectors.oracle.survey.OracleServerSurveyActionProvider",
                                        ComponentDevelopmentStatus.STABLE,
                                        DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getAssociatedTypeName(),
                                        DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getDeployedImplementationType()),

    ORACLE_DATABASE_SURVEY_ACTION_SERVICE(538,
                                          "9a00a6e7-8f0c-494f-8313-98c72382f5a3",
                                          "Egeria::SurveyActionService::DataManagerCatalog::OracleDatabase",
                                          "Survey for an Oracle Pluggable Database",
                                          "Surveys the tables and columns found in an Oracle pluggable database",
                                          "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/oracle-server-connectors",
                                          "org.odpi.openmetadata.adapters.connectors.oracle.survey.OracleDatabaseSurveyActionProvider",
                                          ComponentDevelopmentStatus.STABLE,
                                          DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getAssociatedTypeName(),
                                          DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getDeployedImplementationType()),
    ...
    MSSQL_TABULAR_DATA_SET_CONNECTOR(534,
                                     "5c06a56e-91dd-43a9-b5fa-0206520ddd91",
                                     "Egeria::ResourceConnector::TabularDataSet::MSSQL",
                                     "Microsoft SQL Server Tabular Data Set Connector",
                                     "Connector supports reading/writing of data to a Microsoft SQL Server table.",
                                     "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/mssql-server-connectors",
                                     "org.odpi.openmetadata.adapters.connectors.mssql.tabulardatasource.MSSQLTabularDataSetProvider",
                                     ComponentDevelopmentStatus.STABLE,
                                     MSSQLDeployedImplementationType.MSSQL_TABULAR_DATA_SET.getAssociatedTypeName(),
                                     MSSQLDeployedImplementationType.MSSQL_TABULAR_DATA_SET.getDeployedImplementationType()),

    MSSQL_TABULAR_DATA_SET_COLLECTION_CONNECTOR(535,
                                                "5d1fb875-256d-46a2-85ea-39380267936d",
                                                "Egeria::ResourceConnector::TabularDataSetCollection::MSSQL",
                                                "Microsoft SQL Server Tabular Data Set Collection Connector",
                                                "Connector manages a collection of tabular data sets from a Microsoft SQL Server database.",
                                                "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/mssql-server-connectors",
                                                "org.odpi.openmetadata.adapters.connectors.mssql.tabulardatasource.MSSQLTabularDataSetCollectionProvider",
                                                ComponentDevelopmentStatus.STABLE,
                                                MSSQLDeployedImplementationType.MSSQL_TABULAR_DATA_SET_COLLECTION.getAssociatedTypeName(),
                                                MSSQLDeployedImplementationType.MSSQL_TABULAR_DATA_SET_COLLECTION.getDeployedImplementationType()),

    ORACLE_TABULAR_DATA_SET_CONNECTOR(539,
                                      "f84434a1-447c-446d-aca4-54be1eb76798",
                                      "Egeria::ResourceConnector::TabularDataSet::Oracle",
                                      "Oracle Tabular Data Set Connector",
                                      "Connector supports reading/writing of data to an Oracle Database table.",
                                      "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/oracle-server-connectors",
                                      "org.odpi.openmetadata.adapters.connectors.oracle.tabulardatasource.OracleTabularDataSetProvider",
                                      ComponentDevelopmentStatus.STABLE,
                                      OracleDeployedImplementationType.ORACLE_TABULAR_DATA_SET.getAssociatedTypeName(),
                                      OracleDeployedImplementationType.ORACLE_TABULAR_DATA_SET.getDeployedImplementationType()),

    ORACLE_TABULAR_DATA_SET_COLLECTION_CONNECTOR(540,
                                                 "6ba0af12-ec97-4af1-8b39-37223f72f207",
                                                 "Egeria::ResourceConnector::TabularDataSetCollection::Oracle",
                                                 "Oracle Tabular Data Set Collection Connector",
                                                 "Connector manages a collection of tabular data sets from an Oracle pluggable database.",
                                                 "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/oracle-server-connectors",
                                                 "org.odpi.openmetadata.adapters.connectors.oracle.tabulardatasource.OracleTabularDataSetCollectionProvider",
                                                 ComponentDevelopmentStatus.STABLE,
                                                 OracleDeployedImplementationType.ORACLE_TABULAR_DATA_SET_COLLECTION.getAssociatedTypeName(),
                                                 OracleDeployedImplementationType.ORACLE_TABULAR_DATA_SET_COLLECTION.getDeployedImplementationType()),


    DB2LUW_SERVER_INTEGRATION_CONNECTOR(560,
                                        "56ff3489-dbac-4cc5-8d37-e285e7f6ec03",
                                        "Egeria::IntegrationConnector::DataManagerCatalog::DB2LUWServer",
                                        "Catalog databases in a Db2 for Linux, UNIX and Windows Server",
                                        "Catalogs the databases found in an IBM Db2 for Linux, UNIX and Windows (LUW) Server.  This includes the RelationalDatabase asset element plus a connection with the JDBC Resource connector type.",
                                        "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/db2luw-server-connectors",
                                        "org.odpi.openmetadata.adapters.connectors.db2luw.catalog.DB2LUWServerIntegrationProvider",
                                        ComponentDevelopmentStatus.STABLE,
                                        DeployedImplementationType.INTEGRATION_CONNECTOR.getAssociatedTypeName(),
                                        DeployedImplementationType.INTEGRATION_CONNECTOR.getDeployedImplementationType()),

    DB2LUW_SERVER_SURVEY_ACTION_SERVICE(561,
                                        "c79dcf0b-f245-4653-9979-558655d9fcf3",
                                        "Egeria::SurveyActionService::DataManagerCatalog::DB2LUWServer",
                                        "Survey for a Db2 for Linux, UNIX and Windows Server",
                                        "Surveys the databases, their tables and columns, found in an IBM Db2 for Linux, UNIX and Windows (LUW) Server",
                                        "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/db2luw-server-connectors",
                                        "org.odpi.openmetadata.adapters.connectors.db2luw.survey.DB2LUWServerSurveyActionProvider",
                                        ComponentDevelopmentStatus.STABLE,
                                        DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getAssociatedTypeName(),
                                        DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getDeployedImplementationType()),

    DB2LUW_DATABASE_SURVEY_ACTION_SERVICE(562,
                                          "b623dcec-beec-41d4-91c7-07e33c6fac91",
                                          "Egeria::SurveyActionService::DataManagerCatalog::DB2LUWDatabase",
                                          "Survey for a Db2 for Linux, UNIX and Windows Database",
                                          "Surveys the tables and columns found in an IBM Db2 for Linux, UNIX and Windows (LUW) database",
                                          "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/db2luw-server-connectors",
                                          "org.odpi.openmetadata.adapters.connectors.db2luw.survey.DB2LUWDatabaseSurveyActionProvider",
                                          ComponentDevelopmentStatus.STABLE,
                                          DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getAssociatedTypeName(),
                                          DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getDeployedImplementationType()),

    DB2LUW_TABULAR_DATA_SET_CONNECTOR(563,
                                      "df99a846-823e-421f-ba76-2a77988ccb3c",
                                      "Egeria::ResourceConnector::TabularDataSet::DB2LUW",
                                      "Db2 for Linux, UNIX and Windows Tabular Data Set Connector",
                                      "Connector supports reading/writing of data to an IBM Db2 for Linux, UNIX and Windows database table.",
                                      "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/db2luw-server-connectors",
                                      "org.odpi.openmetadata.adapters.connectors.db2luw.tabulardatasource.DB2LUWTabularDataSetProvider",
                                      ComponentDevelopmentStatus.STABLE,
                                      DB2LUWDeployedImplementationType.DB2LUW_TABULAR_DATA_SET.getAssociatedTypeName(),
                                      DB2LUWDeployedImplementationType.DB2LUW_TABULAR_DATA_SET.getDeployedImplementationType()),

    DB2LUW_TABULAR_DATA_SET_COLLECTION_CONNECTOR(564,
                                                 "e362b35a-e542-402d-9d3a-27c6fac0f787",
                                                 "Egeria::ResourceConnector::TabularDataSetCollection::DB2LUW",
                                                 "Db2 for Linux, UNIX and Windows Tabular Data Set Collection Connector",
                                                 "Connector manages a collection of tabular data sets from an IBM Db2 for Linux, UNIX and Windows database.",
                                                 "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/db2luw-server-connectors",
                                                 "org.odpi.openmetadata.adapters.connectors.db2luw.tabulardatasource.DB2LUWTabularDataSetCollectionProvider",
                                                 ComponentDevelopmentStatus.STABLE,
                                                 DB2LUWDeployedImplementationType.DB2LUW_TABULAR_DATA_SET_COLLECTION.getAssociatedTypeName(),
                                                 DB2LUWDeployedImplementationType.DB2LUW_TABULAR_DATA_SET_COLLECTION.getDeployedImplementationType()),

    DUCKDB_DATABASE_INTEGRATION_CONNECTOR(570,
                                          "deb2dae1-7426-442e-a6cb-ea1bb7f4646c",
                                          "Egeria::IntegrationConnector::DataManagerCatalog::DuckDBDatabase",
                                          "Catalog a DuckDB database",
                                          "Catalogs a DuckDB embedded/file-based database.  This includes the RelationalDatabase asset element plus a connection with the JDBC Resource connector type, and the federation relationships to any databases and files attached to, or scanned by, the DuckDB database.",
                                          "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/duckdb-connectors",
                                          "org.odpi.openmetadata.adapters.connectors.duckdb.catalog.DuckDBDatabaseIntegrationProvider",
                                          ComponentDevelopmentStatus.STABLE,
                                          DeployedImplementationType.INTEGRATION_CONNECTOR.getAssociatedTypeName(),
                                          DeployedImplementationType.INTEGRATION_CONNECTOR.getDeployedImplementationType()),

    DUCKDB_DATABASE_SURVEY_ACTION_SERVICE(571,
                                          "d91195df-4e2a-4bdc-a9da-fbaf49b62e51",
                                          "Egeria::SurveyActionService::DataManagerCatalog::DuckDBDatabase",
                                          "Survey for a DuckDB Database",
                                          "Surveys the schemas, tables and columns found in a DuckDB database, along with any federation relationships (attached databases and external file scans) that it makes use of.",
                                          "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/duckdb-connectors",
                                          "org.odpi.openmetadata.adapters.connectors.duckdb.survey.DuckDBDatabaseSurveyActionProvider",
                                          ComponentDevelopmentStatus.STABLE,
                                          DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getAssociatedTypeName(),
                                          DeployedImplementationType.SURVEY_ACTION_SERVICE_CONNECTOR.getDeployedImplementationType()),
    ...
    OPEN_LINEAGE_RUN_PROFILER_LOVELACE_SERVICE(575,
                                              "08d794ae-25e1-41cf-925e-e3617c3b9603",
                                              "Egeria::GovernanceService::Insight::Lovelace::OpenLineageRunProfilerService",
                                              "OpenLineage Run Profiler Lovelace Service",
                                              "A Governance Action Service that analyses the runs of each job in an OpenLineage log store and records the run profile (frequency, regularity, duration, failure rate, data volume) in the RunMetrics classification of the job's process.",
                                              "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/lovelace-insights",
                                              "org.odpi.openmetadata.adapters.connectors.lineageinsight.openlineage.LovelaceOpenLineageRunProfilerServiceProvider",
                                              ComponentDevelopmentStatus.TECHNICAL_PREVIEW,
                                              DeployedImplementationType.GOVERNANCE_ACTION_SERVICE_CONNECTOR.getAssociatedTypeName(),
                                              DeployedImplementationType.GOVERNANCE_ACTION_SERVICE_CONNECTOR.getDeployedImplementationType()),

    OPEN_LINEAGE_DATA_SCOPE_LOVELACE_SERVICE(576,
                                              "3b933387-b4ba-4ae5-8fdb-3ca191b0bf84",
                                              "Egeria::GovernanceService::Insight::Lovelace::OpenLineageDataScopeService",
                                              "OpenLineage Data Scope Lovelace Service",
                                              "A Governance Action Service that analyses the writes and reads of each dataset in an OpenLineage log store and refines the DataScope classification of the dataset's asset with the write pattern and data collection window.",
                                              "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/lovelace-insights",
                                              "org.odpi.openmetadata.adapters.connectors.lineageinsight.openlineage.LovelaceOpenLineageDataScopeServiceProvider",
                                              ComponentDevelopmentStatus.TECHNICAL_PREVIEW,
                                              DeployedImplementationType.GOVERNANCE_ACTION_SERVICE_CONNECTOR.getAssociatedTypeName(),
                                              DeployedImplementationType.GOVERNANCE_ACTION_SERVICE_CONNECTOR.getDeployedImplementationType()),

    OPEN_LINEAGE_DATA_QUALITY_SUMMARY_LOVELACE_SERVICE(577,
                                              "d8a89012-544b-4a92-8ea0-e35a0dcf9c6c",
                                              "Egeria::GovernanceService::Insight::Lovelace::OpenLineageDataQualitySummaryService",
                                              "OpenLineage Data Quality Summary Lovelace Service",
                                              "A Governance Action Service that summarises the data quality assertions and tests in an OpenLineage log store into a survey report per dataset (and per job) with the pass rate of each quality dimension.",
                                              "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/lovelace-insights",
                                              "org.odpi.openmetadata.adapters.connectors.lineageinsight.openlineage.LovelaceOpenLineageDataQualitySummaryServiceProvider",
                                              ComponentDevelopmentStatus.TECHNICAL_PREVIEW,
                                              DeployedImplementationType.GOVERNANCE_ACTION_SERVICE_CONNECTOR.getAssociatedTypeName(),
                                              DeployedImplementationType.GOVERNANCE_ACTION_SERVICE_CONNECTOR.getDeployedImplementationType()),
    ...
    BITOL_FILES_RECEIVER_INTEGRATION_CONNECTOR(580,
                                               "fb78d822-706b-4ded-94df-b6ecf990e126",
                                               "Egeria::IntegrationConnector::Bitol::FilesReceiver",
                                               "Bitol Files Receiver Integration Connector",
                                               "Connector that monitors file directories (such as a git checkout) for Bitol Open Data Contract Standard (ODCS) and Open Data Product Standard (ODPS) documents and " +
                                                       "publishes new and changed documents to the Bitol listeners registered in the same instance of the integration daemon.",
                                               "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/integration-connectors/bitol-integration-connectors",
                                               "org.odpi.openmetadata.adapters.connectors.integration.bitol.BitolFilesReceiverIntegrationProvider",
                                               ComponentDevelopmentStatus.TECHNICAL_PREVIEW,
                                               DeployedImplementationType.INTEGRATION_CONNECTOR.getAssociatedTypeName(),
                                               DeployedImplementationType.INTEGRATION_CONNECTOR.getDeployedImplementationType()),

    BITOL_EVENT_RECEIVER_INTEGRATION_CONNECTOR(581,
                                               "559a8c3b-ff83-4069-8e58-e4fa42aaa44c",
                                               "Egeria::IntegrationConnector::Bitol::EventReceiver",
                                               "Bitol Event Receiver Integration Connector",
                                               "Connector that receives Bitol Open Data Contract Standard (ODCS) and Open Data Product Standard (ODPS) documents from an event broker topic and " +
                                                       "publishes them to the Bitol listeners registered in the same instance of the integration daemon.",
                                               "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/integration-connectors/bitol-integration-connectors",
                                               "org.odpi.openmetadata.adapters.connectors.integration.bitol.BitolEventReceiverIntegrationProvider",
                                               ComponentDevelopmentStatus.TECHNICAL_PREVIEW,
                                               DeployedImplementationType.INTEGRATION_CONNECTOR.getAssociatedTypeName(),
                                               DeployedImplementationType.INTEGRATION_CONNECTOR.getDeployedImplementationType()),

    FILE_BASED_BITOL_STORE(582,
                           "9bd70a8b-385d-4ec2-a402-0edf5bc43cef",
                           "Egeria::IntegrationConnector::Bitol::FileBasedBitolStore",
                           "File-based Bitol Store Integration Connector",
                           "Connector that stores the Bitol Open Data Contract Standard (ODCS) and Open Data Product Standard (ODPS) documents published in the integration daemon to the file system.",
                           "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/integration-connectors/bitol-integration-connectors",
                           "org.odpi.openmetadata.adapters.connectors.integration.bitol.FileBasedBitolStoreProvider",
                           ComponentDevelopmentStatus.TECHNICAL_PREVIEW,
                           DeployedImplementationType.INTEGRATION_CONNECTOR.getAssociatedTypeName(),
                           DeployedImplementationType.INTEGRATION_CONNECTOR.getDeployedImplementationType()),

    DATA_PRODUCT_CATALOGUER_INTEGRATION_CONNECTOR(583,
                                                  "a86d3c28-336f-4b2a-95ee-cb665166410c",
                                                  "Egeria::IntegrationConnector::Bitol::DataProductCataloguer",
                                                  "Bitol Data Product Cataloguer Integration Connector",
                                                  "Connector that catalogues the Bitol Open Data Product Standard (ODPS) documents published in the integration daemon as digital products, " +
                                                          "with their ports, team, support channels and references.",
                                                  "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/integration-connectors/bitol-integration-connectors",
                                                  "org.odpi.openmetadata.adapters.connectors.integration.bitol.DataProductCataloguerIntegrationProvider",
                                                  ComponentDevelopmentStatus.TECHNICAL_PREVIEW,
                                                  DeployedImplementationType.INTEGRATION_CONNECTOR.getAssociatedTypeName(),
                                                  DeployedImplementationType.INTEGRATION_CONNECTOR.getDeployedImplementationType()),

    DATA_CONTRACT_CATALOGUER_INTEGRATION_CONNECTOR(584,
                                                   "84daf861-d925-4571-9093-bb4709dbefa0",
                                                   "Egeria::IntegrationConnector::Bitol::DataContractCataloguer",
                                                   "Bitol Data Contract Cataloguer Integration Connector",
                                                   "Connector that catalogues the Bitol Open Data Contract Standard (ODCS) documents published in the integration daemon as data sharing agreements, " +
                                                           "with their schema, data quality rules, service level objective, servers, roles, team, support channels and references.",
                                                   "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/integration-connectors/bitol-integration-connectors",
                                                   "org.odpi.openmetadata.adapters.connectors.integration.bitol.DataContractCataloguerIntegrationProvider",
                                                   ComponentDevelopmentStatus.TECHNICAL_PREVIEW,
                                                   DeployedImplementationType.INTEGRATION_CONNECTOR.getAssociatedTypeName(),
                                                   DeployedImplementationType.INTEGRATION_CONNECTOR.getDeployedImplementationType()),

    BITOL_DOCUMENT_PUBLISHER_INTEGRATION_CONNECTOR(585,
                                                   "0a399415-4ba4-4670-8ff0-dd7587e0d003",
                                                   "Egeria::IntegrationConnector::Bitol::DocumentPublisher",
                                                   "Bitol Document Publisher Integration Connector",
                                                   "Connector that generates Bitol Open Data Product Standard (ODPS) documents from digital products, and Open Data Contract Standard (ODCS) documents " +
                                                           "from data sharing agreements, and publishes them to the Bitol listeners registered in the same instance of the integration daemon " +
                                                           "whenever the metadata changes, and for every product in the digital product catalogs attached as catalog targets.",
                                                   "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/integration-connectors/bitol-integration-connectors",
                                                   "org.odpi.openmetadata.adapters.connectors.integration.bitol.BitolDocumentPublisherIntegrationProvider",
                                                   ComponentDevelopmentStatus.TECHNICAL_PREVIEW,
                                                   DeployedImplementationType.INTEGRATION_CONNECTOR.getAssociatedTypeName(),
                                                   DeployedImplementationType.INTEGRATION_CONNECTOR.getDeployedImplementationType()),
    ...
    WSO2MI_RESOURCE_CONNECTOR(575,
                              "e285c3b8-6a00-4856-8ea3-86b3e91c8ca2",
                              "Egeria::ResourceConnector::DataManagerCatalog::WSO2MicroIntegrator",
                              "WSO2 Micro Integrator REST Connector",
                              "Connector that provides access to a WSO2 Micro Integrator instance through its Management API.",
                              ...
                              "org.odpi.openmetadata.adapters.connectors.wso2mi.resource.WSO2MIResourceProvider",
                              ComponentDevelopmentStatus.IN_DEVELOPMENT,
                              DeployedImplementationType.REST_API.getAssociatedTypeName(),
                              DeployedImplementationType.REST_API.getDeployedImplementationType()),

    WSO2MI_INTEGRATION_CONNECTOR(576,
                                 "ffc4fbaf-4d50-48ea-9362-e5bedc0da6a6",
                                 "Egeria::IntegrationConnector::DataManagerCatalog::WSO2MicroIntegrator",
                                 "Catalog APIs deployed on a WSO2 Micro Integrator",
                                 "Catalogs the REST APIs deployed on a WSO2 Micro Integrator instance as open metadata assets.",
                                 "https://github.com/odpi/egeria/tree/main/open-metadata-implementation/adapters/open-connectors/data-manager-connectors/wso2mi-connectors",
                                 "org.odpi.openmetadata.adapters.connectors.wso2mi.catalog.WSO2MIIntegrationProvider",
                                 ComponentDevelopmentStatus.IN_DEVELOPMENT,
                                 DeployedImplementationType.INTEGRATION_CONNECTOR.getAssociatedTypeName(),
                                 DeployedImplementationType.INTEGRATION_CONNECTOR.getDeployedImplementationType()),
