...
/**
 * OracleServerIntegrationConnector retrieves details of the pluggable databases hosted on an Oracle Database Server
 * and creates associated data assets/server capabilities/connections for them.
 */
public class OracleServerIntegrationConnector extends DynamicIntegrationConnectorBase
{
                                                                       ...
                                                                       Connector            connectorToTarget) throws ConnectorCheckedException
    {
        ...
        try
        {
            return new OracleServerCatalogTargetProcessor(retrievedCatalogTarget,
        ...
        {
            throw new ConnectorCheckedException(OracleErrorCode.UNEXPECTED_EXCEPTION.getMessageDefinition(connectorName,
    ...
    private String getFriendshipGUID(Map<String, Object> configurationProperties)
    {
        ...
        {
            friendshipGUID = connectionBean.getConfigurationProperties().get(OracleConfigurationProperty.FRIENDSHIP_GUID.getName()).toString();
        }
