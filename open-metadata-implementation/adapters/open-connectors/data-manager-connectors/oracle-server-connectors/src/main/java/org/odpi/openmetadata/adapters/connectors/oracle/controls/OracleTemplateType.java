 ...
 */
public enum OracleTemplateType implements TemplateDefinition
{
    ORACLE_SERVER_TEMPLATE(OracleDeployedImplementationType.ORACLE_SERVER.getDeployedImplementationType(),
                           "Create a " + OracleDeployedImplementationType.ORACLE_SERVER.getAssociatedTypeName() + " asset.",
                           OracleDeployedImplementationType.ORACLE_SERVER.getAssociatedTypeName(),
                           false,
                           "ca6e739f-7e6c-4939-9f1c-3b51f0108833",
                           OracleDeployedImplementationType.ORACLE_SERVER,
                           OraclePlaceholderProperty.getOracleServerPlaceholderPropertyTypes(),
                           null),

    ORACLE_DATABASE_TEMPLATE(OracleDeployedImplementationType.ORACLE_DATABASE.getDeployedImplementationType(),
                             "Create a " + OracleDeployedImplementationType.ORACLE_DATABASE.getAssociatedTypeName() + " asset.",
                             OracleDeployedImplementationType.ORACLE_DATABASE.getAssociatedTypeName(),
                             false,
                             "e603d30c-e216-4cb5-832e-a57014ebeddb",
    ...
    ORACLE_TABULAR_DATA_SET_TEMPLATE(OracleDeployedImplementationType.ORACLE_TABULAR_DATA_SET.getDeployedImplementationType(),
                                     ...
                                     false,
                                     "1027955e-dd27-474c-995d-30794ea3a147",
                                     OracleDeployedImplementationType.ORACLE_TABULAR_DATA_SET,
                                     OraclePlaceholderProperty.getOracleTablePlaceholderPropertyTypes(),
                                     null),

    ORACLE_TABULAR_DATA_SET_COLLECTION_TEMPLATE(OracleDeployedImplementationType.ORACLE_TABULAR_DATA_SET_COLLECTION.getDeployedImplementationType(),
                                                "Create a " + OracleDeployedImplementationType.ORACLE_TABULAR_DATA_SET_COLLECTION.getAssociatedTypeName() + " asset.",
                                                OracleDeployedImplementationType.ORACLE_TABULAR_DATA_SET_COLLECTION.getAssociatedTypeName(),
                                                false,
                                                "0cbd78a6-162b-49c6-8283-b5d10ba95889",
    ...
    private final OracleDeployedImplementationType deployedImplementationType;
     ...
     */
    OracleTemplateType(String                             templateName,
                       String                             templateDescription,
                       String                             typeName,
                       boolean                            required,
                       String                             defaultTemplateGUID,
                       OracleDeployedImplementationType deployedImplementationType,
    ...
    public static List<TemplateType> getTemplateTypes()
    {
        ...
        for (OracleTemplateType templateTypeEnum : OracleTemplateType.values())
        {
