...
/**
 * OracleServerCatalogTargetProcessor retrieves details of the pluggable databases (PDBs) hosted on an Oracle
 * Database Server and creates associated data assets/server capabilities/connections for them.
 */
public class OracleServerCatalogTargetProcessor extends CatalogTargetProcessorBase
{
     ...
     */
    public OracleServerCatalogTargetProcessor(CatalogTarget        catalogTarget,
    ...
    public void start() throws ConnectorCheckedException, UserNotAuthorizedException
    {
        ...
        defaultExcludeDatabases = super.getArrayConfigurationProperty(OracleConfigurationProperty.EXCLUDE_DATABASE_LIST.getName(),
                                                                       this.getConfigurationProperties(),
                                                                       Collections.emptyList());

        defaultIncludeDatabases = super.getArrayConfigurationProperty(OracleConfigurationProperty.INCLUDE_DATABASE_LIST.getName(),
                                                                       this.getConfigurationProperties());
    ...
    public void refresh() throws ConnectorCheckedException
    {
        ...
        if (propertyHelper.isTypeOf(this.getCatalogTargetElement().getElementHeader(), OracleDeployedImplementationType.ORACLE_SERVER.getAssociatedTypeName()))
        {
            try
            {
            ...
            catch (Exception exception)
            {
                auditLog.logException(methodName,
                                      OracleAuditCode.UNEXPECTED_EXCEPTION.getMessageDefinition(connectorName,
        ...
        {
            super.throwWrongTypeOfCatalogTarget(OracleDeployedImplementationType.ORACLE_SERVER.getAssociatedTypeName(),
                                                methodName);
        }
    }
    ...
    /**
     * Retrieve or recreate the database manager for this Oracle Database Server.
     *
    ...
    /**
     * Catalog a pluggable database retrieved from the requested database server.
     *
     * @param databaseServerGUID unique identifier of the entity representing the Oracle Database Server
     * @param databaseManager associated database manager
     * @param configuredTemplates list of templates
     * @param configurationProperties configuration properties
     * @param assetConnector connector to the CDB root of the database server
                                  ...
                                  JDBCResourceConnector   assetConnector) throws ConnectorCheckedException
    {
        ...
        try
        {
             ...
             * a template for creating new PDBs.
             */
            ...
            {
                /*
                 * This first test removes PDBs that are not currently open for read/write connections.
                 */
     ...
     * Catalog a pluggable database retrieved from the requested database server.
     *
     * @param databaseName name of the retrieved pluggable database
     * @param databaseServerGUID unique identifier of the entity representing the Oracle Database Server
     * @param databaseManager associated database manager
                                                                                           ...
                                                                                           ConnectorCheckedException
    {
        ...
        String databaseTemplateGUID = templates.get(OracleTemplateType.ORACLE_DATABASE_TEMPLATE.getTemplateGUID());

        if (databaseTemplateGUID == null)
        {
            databaseTemplateGUID = OracleTemplateType.ORACLE_DATABASE_TEMPLATE.getTemplateGUID();
        }
        ...
        placeholderProperties.put(OraclePlaceholderProperty.DATABASE_NAME.getName(), databaseName);
        placeholderProperties.put(OraclePlaceholderProperty.DATABASE_DESCRIPTION.getName(), null);
        ...
        {
            auditLog.logMessage(methodName, OracleAuditCode.SKIPPING_DATABASE.getMessageDefinition(connectorName,
        ...
        else if (databaseManager.getProperties() instanceof DatabaseManagerProperties databaseManagerProperties)
        {
            ...
            auditLog.logMessage(methodName, OracleAuditCode.CATALOGED_DATABASE.getMessageDefinition(connectorName,
                                                                                                      qualifiedName,
                                                                                                      databaseGUID));
    ...
    private String getFriendshipGUID(Map<String, Object> configurationProperties)
    {
        ...
        if ((configurationProperties != null) &&
                (configurationProperties.get(OracleConfigurationProperty.FRIENDSHIP_GUID.getName()) != null))
        {
            friendshipGUID = this.getConfigurationProperties().get(OracleConfigurationProperty.FRIENDSHIP_GUID.getName()).toString();
        }
    ...
    /**
     * Add a catalog target relationship between the Oracle Database Server's asset and the connector that is able to
     * catalog inside an Oracle pluggable database.  This will start the cataloging of the schemas tables and columns within the database.
     *
                                                                                      ...
                                                                                      UserNotAuthorizedException
    {
        ...
        if (databaseGUID != null)
        {
            if (friendshipConnectorGUID != null)
            {
                ...
                targetConfigurationProperties.put(OracleConfigurationProperty.DATABASE_NAME.getName(), databaseName);
                ...
                auditLog.logMessage(methodName,
                                    OracleAuditCode.NEW_CATALOG_TARGET.getMessageDefinition(connectorName,
                                                                                           relationshipGUID,
