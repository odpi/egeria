 ...
 */
public class OracleTabularDataSetCollectionProvider extends OpenConnectorProviderBase
{
    private static final String  connectorClass = OracleTabularDataSetCollectionConnector.class.getName();
     ...
     */
    public OracleTabularDataSetCollectionProvider()
    {
        super(EgeriaOpenConnectorDefinition.ORACLE_TABULAR_DATA_SET_COLLECTION_CONNECTOR,
              connectorClass,
        ...
        super.supportedTechnologyTypes = SupportedTechnologyType.getSupportedTechnologyTypes(new DeployedImplementationTypeDefinition[]{OracleDeployedImplementationType.ORACLE_TABULAR_DATA_SET_COLLECTION});
    }
}
