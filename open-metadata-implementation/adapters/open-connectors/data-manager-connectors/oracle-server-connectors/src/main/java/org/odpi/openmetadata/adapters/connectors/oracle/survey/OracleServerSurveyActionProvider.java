 ...
 */
public class OracleServerSurveyActionProvider extends SurveyActionServiceProvider
{
    private static final String connectorClassName = OracleServerSurveyActionService.class.getName();
