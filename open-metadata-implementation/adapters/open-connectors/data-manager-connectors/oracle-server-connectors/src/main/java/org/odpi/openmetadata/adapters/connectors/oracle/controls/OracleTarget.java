...
{
    SERVER("oracleServer",
           OracleDeployedImplementationType.ORACLE_SERVER.getDescription(),
           OracleDeployedImplementationType.ORACLE_SERVER.getAssociatedTypeName(),
           OracleDeployedImplementationType.ORACLE_SERVER.getDeployedImplementationType(),
           null),
    ...
    DATABASE("oracleDatabase",
             OracleDeployedImplementationType.ORACLE_DATABASE.getDescription(),
             OracleDeployedImplementationType.ORACLE_DATABASE.getAssociatedTypeName(),
             OracleDeployedImplementationType.ORACLE_DATABASE.getDeployedImplementationType(),
             null),
     ...
     */
    public static List<CatalogTargetType> getOracleServerCatalogTargetTypes()
    {
    ...
    /**
     * Return the targets defined in this enum for an Oracle Database Server.
     *
     * @return list
     */
    public static List<ActionTargetType> getOracleServerActionTargetTypes()
    {
    ...
    /**
     * Return the targets defined in this enum for an Oracle pluggable database.
     *
     * @return list
     */
    public static List<ActionTargetType> getOracleDatabaseActionTargetTypes()
    {
        List<ActionTargetType> actionTargetTypes = new ArrayList<>();
