 ...
 */
public enum OraclePlaceholderProperty
{
    /**
    ...
    /**
     * The description of the pluggable database being catalogued.
     */
    ...
    /**
     * The name of the schema (Oracle user) being catalogued.
     */
    SCHEMA_NAME ("schemaName", "The name of the database schema (Oracle user) being catalogued.", "string", "MyServer.schema"),
     ...
     */
    OraclePlaceholderProperty(String name,
                              String description,
                              String dataType,
                              String example)
    {
     ...
     */
    public static List<PlaceholderPropertyType> getOracleServerPlaceholderPropertyTypes()
    {
        ...
        /*
         * Unlike PostgreSQL/Microsoft SQL Server, Oracle's EZCONNECT JDBC URL syntax always requires a service
         * name after host:port - there is no "no database" form - so the CDB root's service name is supplied
         * here via the same databaseName placeholder used for individual pluggable databases.
         */
        placeholderPropertyTypes.add(OraclePlaceholderProperty.DATABASE_NAME.getPlaceholderType());
     ...
     * @return list of placeholder property types
     */
    public static List<PlaceholderPropertyType> getOracleDatabasePlaceholderPropertyTypes()
    {
        List<PlaceholderPropertyType> placeholderPropertyTypes = new ArrayList<>();
        ...
        placeholderPropertyTypes.add(PlaceholderProperty.VERSION_IDENTIFIER.getPlaceholderType());
        placeholderPropertyTypes.add(OraclePlaceholderProperty.DATABASE_NAME.getPlaceholderType());
        placeholderPropertyTypes.add(OraclePlaceholderProperty.DATABASE_DESCRIPTION.getPlaceholderType());
        placeholderPropertyTypes.add(PlaceholderProperty.SECRETS_STORE.getPlaceholderType());
        placeholderPropertyTypes.add(PlaceholderProperty.SECRETS_COLLECTION_NAME.getPlaceholderType());
     ...
     * @return list of placeholder property types
     */
    public static List<PlaceholderPropertyType> getOracleSchemaPlaceholderPropertyTypes()
    {
        List<PlaceholderPropertyType> placeholderPropertyTypes = new ArrayList<>();
        ...
        placeholderPropertyTypes.add(PlaceholderProperty.VERSION_IDENTIFIER.getPlaceholderType());
        placeholderPropertyTypes.add(OraclePlaceholderProperty.DATABASE_NAME.getPlaceholderType());
        placeholderPropertyTypes.add(OraclePlaceholderProperty.SCHEMA_NAME.getPlaceholderType());
        placeholderPropertyTypes.add(OraclePlaceholderProperty.SCHEMA_DESCRIPTION.getPlaceholderType());
        placeholderPropertyTypes.add(PlaceholderProperty.SECRETS_STORE.getPlaceholderType());
        placeholderPropertyTypes.add(PlaceholderProperty.SECRETS_COLLECTION_NAME.getPlaceholderType());
     ...
     * @return list of placeholder property types
     */
    public static List<PlaceholderPropertyType> getOracleTablePlaceholderPropertyTypes()
    {
        List<PlaceholderPropertyType> placeholderPropertyTypes = new ArrayList<>();
        ...
        placeholderPropertyTypes.add(OraclePlaceholderProperty.SCHEMA_NAME.getPlaceholderType());
        placeholderPropertyTypes.add(OraclePlaceholderProperty.SCHEMA_DESCRIPTION.getPlaceholderType());
        placeholderPropertyTypes.add(OraclePlaceholderProperty.TABLE_NAME.getPlaceholderType());
        placeholderPropertyTypes.add(OraclePlaceholderProperty.TABLE_DESCRIPTION.getPlaceholderType());
        placeholderPropertyTypes.add(PlaceholderProperty.SECRETS_STORE.getPlaceholderType());
        placeholderPropertyTypes.add(PlaceholderProperty.SECRETS_COLLECTION_NAME.getPlaceholderType());
