 ...
 * that it works with.
 */
public enum MSSQLTarget
{
    SERVER("mssqlServer",
           MSSQLDeployedImplementationType.MSSQL_SERVER.getDescription(),
           MSSQLDeployedImplementationType.MSSQL_SERVER.getAssociatedTypeName(),
           MSSQLDeployedImplementationType.MSSQL_SERVER.getDeployedImplementationType(),
           null),
    ...
    DATABASE("mssqlDatabase",
             MSSQLDeployedImplementationType.MSSQL_DATABASE.getDescription(),
             MSSQLDeployedImplementationType.MSSQL_DATABASE.getAssociatedTypeName(),
             MSSQLDeployedImplementationType.MSSQL_DATABASE.getDeployedImplementationType(),
             null),
     ...
     */
    public static List<CatalogTargetType> getMSSQLServerCatalogTargetTypes()
    {
    ...
    /**
     * Return the targets defined in this enum for a Microsoft SQL Server.
     *
     * @return list
     */
    public static List<ActionTargetType> getMSSQLServerActionTargetTypes()
    {
    ...
    /**
     * Return the targets defined in this enum for a Microsoft SQL Server database.
     *
     * @return list
     */
    public static List<ActionTargetType> getMSSQLDatabaseActionTargetTypes()
    {
        List<ActionTargetType> actionTargetTypes = new ArrayList<>();
