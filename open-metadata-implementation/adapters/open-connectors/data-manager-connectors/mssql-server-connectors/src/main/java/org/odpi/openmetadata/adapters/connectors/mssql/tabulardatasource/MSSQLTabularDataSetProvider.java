 ...
 */
public class MSSQLTabularDataSetProvider extends OpenConnectorProviderBase
{
    private static final String  connectorClass = MSSQLTabularDataSetConnector.class.getName();
     ...
     */
    public MSSQLTabularDataSetProvider()
    {
        super(EgeriaOpenConnectorDefinition.MSSQL_TABULAR_DATA_SET_CONNECTOR,
              connectorClass,
        ...
        super.supportedTechnologyTypes = SupportedTechnologyType.getSupportedTechnologyTypes(new DeployedImplementationTypeDefinition[]{MSSQLDeployedImplementationType.MSSQL_TABULAR_DATA_SET});
    }
}
