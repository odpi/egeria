...
import org.odpi.openmetadata.adapters.connectors.mssql.ffdc.MSSQLErrorCode;
 ...
 */
public class MSSQLServerIntegrationConnector extends DynamicIntegrationConnectorBase
{
                                                                       ...
                                                                       Connector            connectorToTarget) throws ConnectorCheckedException
    {
        ...
        try
        {
            return new MSSQLServerCatalogTargetProcessor(retrievedCatalogTarget,
        ...
        {
            throw new ConnectorCheckedException(MSSQLErrorCode.UNEXPECTED_EXCEPTION.getMessageDefinition(connectorName,
    ...
    private String getFriendshipGUID(Map<String, Object> configurationProperties)
    {
        ...
        {
            friendshipGUID = connectionBean.getConfigurationProperties().get(MSSQLConfigurationProperty.FRIENDSHIP_GUID.getName()).toString();
        }
