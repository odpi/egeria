 ...
 */
public enum MSSQLPlaceholderProperty
{
    /**
     ...
     */
    MSSQLPlaceholderProperty(String name,
                             String description,
                             String dataType,
                             String example)
    {
     ...
     */
    public static List<PlaceholderPropertyType> getMSSQLServerPlaceholderPropertyTypes()
    {
     ...
     * @return list of placeholder property types
     */
    public static List<PlaceholderPropertyType> getMSSQLDatabasePlaceholderPropertyTypes()
    {
        List<PlaceholderPropertyType> placeholderPropertyTypes = new ArrayList<>();
