 ...
 */
public enum MSSQLTemplateType implements TemplateDefinition
{
    MSSQL_SERVER_TEMPLATE(MSSQLDeployedImplementationType.MSSQL_SERVER.getDeployedImplementationType(),
                          "Create a " + MSSQLDeployedImplementationType.MSSQL_SERVER.getAssociatedTypeName() + " asset.",
                          MSSQLDeployedImplementationType.MSSQL_SERVER.getAssociatedTypeName(),
                          false,
                          "1036e934-5a29-4ceb-a556-94c41b969ed3",
                          MSSQLDeployedImplementationType.MSSQL_SERVER,
                          MSSQLPlaceholderProperty.getMSSQLServerPlaceholderPropertyTypes(),
                          null),

    MSSQL_DATABASE_TEMPLATE(MSSQLDeployedImplementationType.MSSQL_DATABASE.getDeployedImplementationType(),
                            "Create a " + MSSQLDeployedImplementationType.MSSQL_DATABASE.getAssociatedTypeName() + " asset.",
                            MSSQLDeployedImplementationType.MSSQL_DATABASE.getAssociatedTypeName(),
                            false,
                            "2bb754f4-c670-4357-bc44-759572d51f1e",
                            MSSQLDeployedImplementationType.MSSQL_DATABASE,
                            MSSQLPlaceholderProperty.getMSSQLDatabasePlaceholderPropertyTypes(),
                            null),

    MSSQL_SCHEMA_TEMPLATE(MSSQLDeployedImplementationType.MSSQL_DATABASE_SCHEMA.getDeployedImplementationType(),
                          "Create a " + MSSQLDeployedImplementationType.MSSQL_DATABASE_SCHEMA.getAssociatedTypeName() + " asset.",
                          MSSQLDeployedImplementationType.MSSQL_DATABASE_SCHEMA.getAssociatedTypeName(),
                          false,
                          "b4d9fa70-d47a-46a5-935c-19612a69255c",
    ...
    private final MSSQLDeployedImplementationType deployedImplementationType;
     ...
     */
    MSSQLTemplateType(String                             templateName,
                      String                             templateDescription,
                      String                             typeName,
                      boolean                            required,
                      String                             defaultTemplateGUID,
                      MSSQLDeployedImplementationType deployedImplementationType,
    ...
    public static List<TemplateType> getTemplateTypes()
    {
        ...
        for (MSSQLTemplateType templateTypeEnum : MSSQLTemplateType.values())
        {
