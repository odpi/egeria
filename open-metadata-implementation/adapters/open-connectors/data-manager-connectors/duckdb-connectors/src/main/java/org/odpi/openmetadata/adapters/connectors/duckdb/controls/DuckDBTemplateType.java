...
{
    DUCKDB_DATABASE_TEMPLATE(DuckDBDeployedImplementationType.DUCKDB_DATABASE.getDeployedImplementationType(),
                             "Create a " + DuckDBDeployedImplementationType.DUCKDB_DATABASE.getAssociatedTypeName() + " asset.",
                             DuckDBDeployedImplementationType.DUCKDB_DATABASE.getAssociatedTypeName(),
                             false,
                             "ce06dc9b-cee0-44df-bc97-92c500eb8a9f",
    ...
    private final DuckDBDeployedImplementationType   deployedImplementationType;
     ...
     */
    DuckDBTemplateType(String                           templateName,
                       String                           templateDescription,
                       String                           typeName,
                       boolean                          required,
                       String                           defaultTemplateGUID,
                       DuckDBDeployedImplementationType deployedImplementationType,
    ...
    public static List<TemplateType> getTemplateTypes()
    {
        ...
        for (DuckDBTemplateType templateTypeEnum : DuckDBTemplateType.values())
        {
