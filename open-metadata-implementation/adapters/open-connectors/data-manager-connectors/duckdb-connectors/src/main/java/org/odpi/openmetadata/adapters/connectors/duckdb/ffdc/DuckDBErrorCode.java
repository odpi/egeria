...
/**
 * The DuckDBErrorCode is used to define first failure data capture (FFDC) for errors that occur when working with
 * the DuckDB connectors.  It is used in conjunction with both Checked and Runtime (unchecked) exceptions.
