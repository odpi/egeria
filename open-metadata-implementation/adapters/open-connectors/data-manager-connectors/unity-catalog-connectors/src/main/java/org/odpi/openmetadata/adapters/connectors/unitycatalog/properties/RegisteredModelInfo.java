...
public class RegisteredModelInfo extends RegisteredModelProperties implements ElementBase
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        RegisteredModelInfo that = (RegisteredModelInfo) objectToCompare;
    ...
    public int hashCode()
    {
        return Objects.hash(super.hashCode(), created_at, created_by, updated_at, updated_by, id, full_name);
    }
}
