...
{
    OSS_UC_SERVER_TEMPLATE(org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UNITY_CATALOG_SERVER.getDeployedImplementationType(),
                           ...
                           org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UNITY_CATALOG_SERVER,
                           UnityCatalogPlaceholderProperty.getServerPlaceholderPropertyTypes(),
                           null),

    DB_UC_SERVER_TEMPLATE(org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.DB_UNITY_CATALOG_SERVER.getDeployedImplementationType(),
                          ...
                          org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.DB_UNITY_CATALOG_SERVER.getAssociatedTypeName(),
                          false,
                          "3f7f62f6-4abc-424e-9f92-523306e7d5d5",
                          org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.DB_UNITY_CATALOG_SERVER,
                          UnityCatalogPlaceholderProperty.getServerPlaceholderPropertyTypes(),
                          null),

    OSS_UC_CATALOG_TEMPLATE(org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_CATALOG.getDeployedImplementationType(),
                            "Create a " + org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_CATALOG.getAssociatedTypeName() + " SoftwareCapability.",
                            ...
                            org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_CATALOG,
                            UnityCatalogPlaceholderProperty.getCatalogPlaceholderPropertyTypes(),
                            null),

    OSS_UC_SCHEMA_TEMPLATE(org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_SCHEMA.getDeployedImplementationType(),
                           "Create a DeployedDatabaseSchema to represent a schema from the Unity Catalog (UC).",
                           org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_SCHEMA.getAssociatedTypeName(),
                           false,
                           "5bf92b0f-3970-41ea-b0a3-aacfbf6fd92e",
                           org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_SCHEMA,
                           UnityCatalogPlaceholderProperty.getSchemaPlaceholderPropertyTypes(),
                           null),

    OSS_UC_VOLUME_TEMPLATE(org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_VOLUME.getDeployedImplementationType(),
                           "Create a DataFolder asset to represent a volume from the Unity Catalog (UC).",
                           org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_VOLUME.getAssociatedTypeName(),
                           false,
                           "92d2d2dc-0798-41f0-9512-b10548d312b7",
                           org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_VOLUME,
                           UnityCatalogPlaceholderProperty.getVolumePlaceholderPropertyTypes(),
                           null),

    OSS_UC_TABLE_TEMPLATE(org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_TABLE.getDeployedImplementationType(),
                          "Create a VirtualTableAsset asset to represent a table from the Unity Catalog (UC).",
                          org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_TABLE.getAssociatedTypeName(),
                          false,
                          "6cc1e5f5-4c1e-4290-a80e-e06643ffb13d",
                          org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_TABLE,
                          UnityCatalogPlaceholderProperty.getTablePlaceholderPropertyTypes(),
                          null),

    OSS_UC_FUNCTION_TEMPLATE(org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_FUNCTION.getDeployedImplementationType(),
                             "Create a DeployedSoftwareComponent asset to represent a function from the Unity Catalog (UC).",
                             org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_FUNCTION.getAssociatedTypeName(),
                             false,
                             "a490ba65-6104-4213-9be9-524e16fed8aa",
                             org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_FUNCTION,
                             UnityCatalogPlaceholderProperty.getFunctionPlaceholderPropertyTypes(),
                             null),

    OSS_UC_REGISTERED_MODEL_TEMPLATE(org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_REGISTERED_MODEL.getDeployedImplementationType(),
                                     "Create a DeployedAnalyticsModel asset to represent an analytics model deployed to the Unity Catalog (UC).",
                                     org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_REGISTERED_MODEL.getAssociatedTypeName(),
                                     false,
                                     "0d762ec5-c1f5-4364-aa64-e7e00d27f837",
                                     org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_REGISTERED_MODEL,
                                     UnityCatalogPlaceholderProperty.getRegisteredModelPlaceholderPropertyTypes(),
                                     null),

    OSS_UC_MODEL_VERSION_TEMPLATE(org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_REGISTERED_MODEL_VERSION.getDeployedImplementationType(),
                                  "Create an AnalyticsModelRun asset to represent a version of an analytics model deployed to the Unity Catalog (UC).",
                                  org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_REGISTERED_MODEL_VERSION.getAssociatedTypeName(),
                                  false,
                                  "1364bfe7-8295-4e99-9243-8840aeac4cf1",
                                  org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType.OSS_UC_REGISTERED_MODEL_VERSION,
     ...
     */
    private final org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType deployedImplementationType;
    ...
    UnityCatalogTemplateType(String                                 templateName,
                             ...
                             org.odpi.openmetadata.adapters.connectors.controls.UnityCatalogDeployedImplementationType deployedImplementationType,
