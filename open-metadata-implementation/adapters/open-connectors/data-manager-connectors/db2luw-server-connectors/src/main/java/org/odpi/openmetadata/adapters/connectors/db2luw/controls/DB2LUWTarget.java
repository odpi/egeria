 ...
 * that it works with.
 */
public enum DB2LUWTarget
{
    SERVER("db2luwServer",
           DB2LUWDeployedImplementationType.DB2LUW_SERVER.getDescription(),
           DB2LUWDeployedImplementationType.DB2LUW_SERVER.getAssociatedTypeName(),
           DB2LUWDeployedImplementationType.DB2LUW_SERVER.getDeployedImplementationType(),
           null),

    /**
     * Db2 for Linux, UNIX and Windows database.
     */
    DATABASE("db2luwDatabase",
             DB2LUWDeployedImplementationType.DB2LUW_DATABASE.getDescription(),
             DB2LUWDeployedImplementationType.DB2LUW_DATABASE.getAssociatedTypeName(),
             DB2LUWDeployedImplementationType.DB2LUW_DATABASE.getDeployedImplementationType(),
             null),
     ...
     */
    public static List<CatalogTargetType> getDB2LUWServerCatalogTargetTypes()
    {
    ...
    /**
     * Return the targets defined in this enum for a Db2 for Linux, UNIX and Windows server.
     *
     * @return list
     */
    public static List<ActionTargetType> getDB2LUWServerActionTargetTypes()
    {
    ...
    /**
     * Return the targets defined in this enum for a Db2 for Linux, UNIX and Windows database.
     *
     * @return list
     */
    public static List<ActionTargetType> getDB2LUWDatabaseActionTargetTypes()
    {
        List<ActionTargetType> actionTargetTypes = new ArrayList<>();
