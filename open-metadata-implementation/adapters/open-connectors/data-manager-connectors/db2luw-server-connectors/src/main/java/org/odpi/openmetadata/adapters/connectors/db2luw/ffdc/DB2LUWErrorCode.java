...
/**
 * The DB2LUWErrorCode is used to define first failure data capture (FFDC) for errors that occur when working with
 * the Db2 for Linux, UNIX and Windows connectors.  It is used in conjunction with both Checked and Runtime (unchecked) exceptions.
