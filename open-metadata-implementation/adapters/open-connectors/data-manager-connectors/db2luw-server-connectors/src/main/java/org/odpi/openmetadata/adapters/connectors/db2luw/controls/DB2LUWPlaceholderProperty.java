 ...
 */
public enum DB2LUWPlaceholderProperty
{
    /**
     * The name of the database being catalogued.  Unlike PostgreSQL (which can connect without naming a specific
     * database, defaulting to a system database), Db2 for Linux, UNIX and Windows always requires a database name
     * in its JDBC URL, and there is no cross-database catalog view visible from a single connection (unlike Oracle's
     * CDB root or PostgreSQL's pg_database) - so this placeholder is also used to identify the database the
     * server-level connection itself connects through.
     */
     ...
     */
    DB2LUWPlaceholderProperty(String name,
                              String description,
                              String dataType,
                              String example)
    {
    ...
    public static List<PlaceholderPropertyType> getDB2LUWServerPlaceholderPropertyTypes()
    {
        ...
        /*
         * Unlike PostgreSQL, Db2 for Linux, UNIX and Windows always requires a database name in its JDBC URL -
         * there is no "no database" form - so the initial connection database is supplied here via the same
         * databaseName placeholder used for individual databases.
         */
        placeholderPropertyTypes.add(DB2LUWPlaceholderProperty.DATABASE_NAME.getPlaceholderType());
    ...
    public static List<PlaceholderPropertyType> getDB2LUWDatabasePlaceholderPropertyTypes()
    {
        ...
        placeholderPropertyTypes.add(PlaceholderProperty.VERSION_IDENTIFIER.getPlaceholderType());
        placeholderPropertyTypes.add(DB2LUWPlaceholderProperty.DATABASE_NAME.getPlaceholderType());
        placeholderPropertyTypes.add(DB2LUWPlaceholderProperty.DATABASE_DESCRIPTION.getPlaceholderType());
        placeholderPropertyTypes.add(PlaceholderProperty.SECRETS_STORE.getPlaceholderType());
        placeholderPropertyTypes.add(PlaceholderProperty.SECRETS_COLLECTION_NAME.getPlaceholderType());
    ...
    public static List<PlaceholderPropertyType> getDB2LUWSchemaPlaceholderPropertyTypes()
    {
        ...
        placeholderPropertyTypes.add(PlaceholderProperty.VERSION_IDENTIFIER.getPlaceholderType());
        placeholderPropertyTypes.add(DB2LUWPlaceholderProperty.DATABASE_NAME.getPlaceholderType());
        placeholderPropertyTypes.add(DB2LUWPlaceholderProperty.SCHEMA_NAME.getPlaceholderType());
        placeholderPropertyTypes.add(DB2LUWPlaceholderProperty.SCHEMA_DESCRIPTION.getPlaceholderType());
        placeholderPropertyTypes.add(PlaceholderProperty.SECRETS_STORE.getPlaceholderType());
        placeholderPropertyTypes.add(PlaceholderProperty.SECRETS_COLLECTION_NAME.getPlaceholderType());
    ...
    public static List<PlaceholderPropertyType> getDB2LUWTablePlaceholderPropertyTypes()
    {
        ...
        placeholderPropertyTypes.add(DB2LUWPlaceholderProperty.SCHEMA_NAME.getPlaceholderType());
        placeholderPropertyTypes.add(DB2LUWPlaceholderProperty.SCHEMA_DESCRIPTION.getPlaceholderType());
        placeholderPropertyTypes.add(DB2LUWPlaceholderProperty.TABLE_NAME.getPlaceholderType());
        placeholderPropertyTypes.add(DB2LUWPlaceholderProperty.TABLE_DESCRIPTION.getPlaceholderType());
        placeholderPropertyTypes.add(PlaceholderProperty.SECRETS_STORE.getPlaceholderType());
        placeholderPropertyTypes.add(PlaceholderProperty.SECRETS_COLLECTION_NAME.getPlaceholderType());
