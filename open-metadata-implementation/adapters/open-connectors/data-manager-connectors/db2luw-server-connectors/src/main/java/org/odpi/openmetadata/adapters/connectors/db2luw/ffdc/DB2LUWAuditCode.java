 ...
 * </ul>
 */
public enum DB2LUWAuditCode implements AuditLogMessageSet
{
    /**
     * DB2LUW-CONNECTOR-0001 - The Db2 for Linux, UNIX and Windows connector {0} received an unexpected {1} exception during method {2}; the error message was: {3}
     */
    UNEXPECTED_EXCEPTION("DB2LUW-CONNECTOR-0001",
    ...
    /**
     * DB2LUW-CONNECTOR-0002 - The {0} survey action service cannot retrieve details of any databases for Db2 for Linux, UNIX and Windows Server {1}
     */
    NO_DATABASES( "DB2LUW-CONNECTOR-0002",
    ...
    /**
     * DB2LUW-CONNECTOR-0003 - The {0} integration connector has catalogued Db2 for Linux, UNIX and Windows Database {1} ({2})
     */
    CATALOGED_DATABASE( "DB2LUW-CONNECTOR-0003",
                  AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * DB2LUW-CONNECTOR-0004 - The {0} integration connector is skipping Db2 for Linux, UNIX and Windows Database {1} ({2}) because it is already catalogued
     */
    SKIPPING_DATABASE( "DB2LUW-CONNECTOR-0004",
                        AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * DB2LUW-CONNECTOR-0007 - The {0} Db2 for Linux, UNIX and Windows Connector has been supplied with a friendship connector with GUID {1}
     */
    FRIENDSHIP_GUID("DB2LUW-CONNECTOR-0007",
                    AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * DB2LUW-CONNECTOR-0009 - The {0} Connector has added a catalog target relationship {1} from friendship connector {2} to Db2 for Linux, UNIX and Windows Database Asset {3} for Database {4}
     */
    NEW_CATALOG_TARGET("DB2LUW-CONNECTOR-0009",
                       AuditLogRecordSeverityLevel.INFO,
     ...
     */
    DB2LUWAuditCode(String                      messageId,
