 ...
 */
public class DB2LUWTabularDataSetCollectionProvider extends OpenConnectorProviderBase
{
    private static final String  connectorClass = DB2LUWTabularDataSetCollectionConnector.class.getName();
     ...
     */
    public DB2LUWTabularDataSetCollectionProvider()
    {
        super(EgeriaOpenConnectorDefinition.DB2LUW_TABULAR_DATA_SET_COLLECTION_CONNECTOR,
              connectorClass,
        ...
        super.supportedTechnologyTypes = SupportedTechnologyType.getSupportedTechnologyTypes(new DeployedImplementationTypeDefinition[]{DB2LUWDeployedImplementationType.DB2LUW_TABULAR_DATA_SET_COLLECTION});
    }
}
