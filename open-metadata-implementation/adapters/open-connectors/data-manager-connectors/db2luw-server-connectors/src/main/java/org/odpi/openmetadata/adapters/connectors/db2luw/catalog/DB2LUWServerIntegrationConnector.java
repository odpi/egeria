...
import org.odpi.openmetadata.adapters.connectors.db2luw.ffdc.DB2LUWErrorCode;
...
/**
 * DB2LUWServerIntegrationConnector retrieves details of the databases hosted on a Db2 for Linux, UNIX and Windows
 * Server and creates associated data assets/server capabilities/connections for them.
 */
public class DB2LUWServerIntegrationConnector extends DynamicIntegrationConnectorBase
{
                                                                       ...
                                                                       Connector            connectorToTarget) throws ConnectorCheckedException
    {
        ...
        try
        {
            return new DB2LUWServerCatalogTargetProcessor(retrievedCatalogTarget,
        ...
        {
            throw new ConnectorCheckedException(DB2LUWErrorCode.UNEXPECTED_EXCEPTION.getMessageDefinition(connectorName,
    ...
    private String getFriendshipGUID(Map<String, Object> configurationProperties)
    {
        ...
        {
            friendshipGUID = connectionBean.getConfigurationProperties().get(DB2LUWConfigurationProperty.FRIENDSHIP_GUID.getName()).toString();
        }
