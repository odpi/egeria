 ...
 * descriptions used by the Jacquard tabular data set connectors.  TabularDataAuditCode contains the
 * messages for the audit log and the TabularDataErrorCode contains the messages for any exceptions
