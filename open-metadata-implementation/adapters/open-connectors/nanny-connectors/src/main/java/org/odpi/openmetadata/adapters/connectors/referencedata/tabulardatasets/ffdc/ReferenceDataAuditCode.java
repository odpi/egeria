...
package org.odpi.openmetadata.adapters.connectors.referencedata.tabulardatasets.ffdc;
 ...
 * </ul>
 */
public enum ReferenceDataAuditCode implements AuditLogMessageSet
{
    /**
     * The {0} Reference Data Connector received an unexpected exception {1} during method {2}; the error message was: {3}
     */
    UNEXPECTED_EXCEPTION("REFERENCE-DATA-CONNECTORS-0001",
     ...
     */
    EGERIA_CONNECTOR_START("REFERENCE-DATA-CONNECTORS-0002",
                           AuditLogRecordSeverityLevel.INFO,
                           "The {0} Reference Data Connector has been started and will call the platforms with userId {1}.  The monitored platforms are: {2}",
     ...
     */
    UNKNOWN_PLATFORM("REFERENCE-DATA-CONNECTORS-0003",
                     AuditLogRecordSeverityLevel.ERROR,
                     "The {0} Reference Data Connector is not able to retrieve platform {1} ({2}) from the catalog",
     ...
     */
    CONNECTOR_STOPPING("REFERENCE-DATA-CONNECTORS-0004",
                       AuditLogRecordSeverityLevel.INFO,
                       "The {0} integration connector has stopped its platform monitoring and is shutting down",
     ...
     */
    NEW_SERVER("REFERENCE-DATA-CONNECTORS-0005",
                       AuditLogRecordSeverityLevel.INFO,
                       "The {0} integration connector has created a new {1} server element {2} for server {3} on platform {4}",
     ...
     */
    ReferenceDataAuditCode(String                      messageId,
