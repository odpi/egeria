...
public enum HarvestOpenMetadataAuditCode implements AuditLogMessageSet
{
    ...
    /**
     * The constructor for HarvestOpenMetadataAuditCode expects to be passed one of the enumeration rows defined in
     * HarvestOpenMetadataAuditCode above.   For example:
     * <br>
     *     HarvestOpenMetadataAuditCode   auditCode = HarvestOpenMetadataAuditCode.UNEXPECTED_EXCEPTION;
     * <br>
    ...
    {
        return "HarvestOpenMetadataAuditCode{" +
