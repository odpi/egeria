 ...
 */
public class LocationsTabularDataSetProvider extends OpenConnectorProviderBase
{
    /*
     * Class of the connector.
     */
    private static final String connectorClassName = LocationsTabularDataSetConnector.class.getName();
     ...
     */
    public LocationsTabularDataSetProvider()
    {
        super(EgeriaOpenConnectorDefinition.LOCATIONS_TABULAR_DATA_SET,
              connectorClassName,
