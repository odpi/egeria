 ...
 * </ul>
 */
public enum BabbageErrorCode implements ExceptionMessageSet
{
    /**
     * BABBAGE-ANALYTICAL-ENGINE-500-001 - The {0} integration connector received an unexpected exception {1} during method {2}; the error message was: {3}
     */
