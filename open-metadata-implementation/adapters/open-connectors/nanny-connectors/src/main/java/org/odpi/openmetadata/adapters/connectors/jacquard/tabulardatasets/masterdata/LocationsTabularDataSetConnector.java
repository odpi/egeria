 ...
 */
public class LocationsTabularDataSetConnector extends OpenMetadataRootDataSetConnectorBase
{
    private static final String myConnectorName = LocationsTabularDataSetConnector.class.getName();

    /**
     * Default constructor
     */
    public LocationsTabularDataSetConnector()
    {
        super(myConnectorName, ProductDefinitionEnum.LOCATIONS);
    }
    ...
    {
        refreshCache(OpenMetadataType.LOCATION.typeName);
    }
}