 ...
 * </ul>
 */
public enum ReferenceDataErrorCode implements ExceptionMessageSet
{
    /**
     ...
     */
    ReferenceDataErrorCode(int httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
