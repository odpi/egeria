...
/**
 * ValidValuesInsightProvider is the connector provider for the HarvestValidValuesConnector connector that publishes insights
 * about valid values managed in open metadata.
 */
public class ValidValuesInsightProvider extends IntegrationConnectorProvider
{
    /*
     ...
     */
    public ValidValuesInsightProvider()
    {
        super();
