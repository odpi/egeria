...
/**
 * TabularDataSetConfigurationProperty defines the configuration properties used with Jacquard's tabular
 * data set connectors.
 */
public enum TabularDataSetConfigurationProperty
{
    /**
     ...
     */
    TabularDataSetConfigurationProperty(String  name,
                                        String  description,
                                        String  dataType,
                                        String  example,
    ...
    public static List<String> getRecognizedConfigurationProperties()
    {
        ...
        for (TabularDataSetConfigurationProperty configurationProperty : TabularDataSetConfigurationProperty.values())
        {
