 ...
 * </ul>
 */
public enum LoadObservationsAuditCode implements AuditLogMessageSet
{
    /**
     * LOAD-OBSERVATIONS-BY-EGERIA-0001 - The {0} integration connector received an unexpected exception {1} during method {2}; the error message was: {3}
     */
    UNEXPECTED_EXCEPTION("LOAD-OBSERVATIONS-BY-EGERIA-0001",
    ...
    /**
     * LOAD-OBSERVATIONS-BY-EGERIA-0005 - The {0} integration connector encountered an {1} exception when connecting to {2} during the {3} method.  The exception message included was {4}
     */
    BAD_CONFIGURATION("LOAD-OBSERVATIONS-BY-EGERIA-0005",
                          OMRSAuditLogRecordSeverity.EXCEPTION,
    ...
    /**
     * LOAD-OBSERVATIONS-BY-EGERIA-0009 - The {0} integration connector has stopped its monitoring of Apache Atlas at {1} and is shutting down
     */
    CONNECTOR_STOPPING("LOAD-OBSERVATIONS-BY-EGERIA-0009",
    ...
    /**
     * LOAD-OBSERVATIONS-BY-EGERIA-0032 - The {0} integration connector encountered an {1} exception when registering a listener to the open metadata ecosystem.  The exception message included was {2}
     */
    UNABLE_TO_REGISTER_LISTENER("LOAD-OBSERVATIONS-BY-EGERIA-0032",
                      OMRSAuditLogRecordSeverity.EXCEPTION,
     ...
     */
    LoadObservationsAuditCode(String                     messageId,
