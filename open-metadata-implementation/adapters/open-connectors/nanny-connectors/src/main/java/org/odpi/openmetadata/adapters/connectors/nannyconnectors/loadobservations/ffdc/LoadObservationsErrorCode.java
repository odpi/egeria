 ...
 * </ul>
 */
public enum LoadObservationsErrorCode implements ExceptionMessageSet
{
    /**
     * LOAD-OBSERVATIONS-BY-EGERIA-400-001 - Integration connector {0} has been configured without the URL to the database
     */
    NULL_URL(400, "LOAD-OBSERVATIONS-BY-EGERIA-400-001",
    ...
    /**
     * LOAD-OBSERVATIONS-BY-EGERIA-400-002 - Integration connector {0} has been configured with either a null userId or password for connecting to the database
     */
    NULL_USER(400, "LOAD-OBSERVATIONS-BY-EGERIA-400-002",
    ...
    /**
     * LOAD-OBSERVATIONS-BY-EGERIA-400-003 - Integration connector {0} has been configured with a metadataSourceQualifiedName value
     */
    NOT_NULL_ASSET_MANAGER(400, "LOAD-OBSERVATIONS-BY-EGERIA-400-003",
    ...
    /**
     * LOAD-OBSERVATIONS-BY-EGERIA-500-001 - The {0} integration connector received an unexpected exception {1} during method {2}; the error message was: {3}
     */
    UNEXPECTED_EXCEPTION(500, "LOAD-OBSERVATIONS-BY-EGERIA-500-001",
    ...
    /**
     * The constructor for LoadObservationsErrorCode expects to be passed one of the enumeration rows defined in
     * LoadObservationsErrorCode above.   For example:
     * <br><br>
     *     LoadObservationsErrorCode   errorCode = LoadObservationsErrorCode.ERROR_SENDING_EVENT;
     * <br><br>
     ...
     */
    LoadObservationsErrorCode(int  httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
