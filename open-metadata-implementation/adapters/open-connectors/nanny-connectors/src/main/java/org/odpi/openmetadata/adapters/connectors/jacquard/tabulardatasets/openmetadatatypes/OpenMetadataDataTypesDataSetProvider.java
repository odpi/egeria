 ...
 */
public class OpenMetadataDataTypesDataSetProvider extends OpenConnectorProviderBase
{
    /*
     ...
     */
    public OpenMetadataDataTypesDataSetProvider()
    {
        super(EgeriaOpenConnectorDefinition.DATA_TYPES_LIST_TABULAR_DATA_SET, connectorClassName, null);
    }
}
