...
public enum HarvestSurveysColumn implements PostgreSQLColumn
{
    ...
    ANNOTATION_TYPE              ("annotation_guid", ColumnType.STRING, "The unique identifier of the annotation.", false),
    ...
    ACTION_REQUEST_NAME          ("action_request_name", ColumnType.STRING, "The type of action requested.", true),
    ...
    PATHNAME                     ("pathname", ColumnType.STRING, FileMetric.PATH_NAME.getDescription(), true),
    ...
    TABLE_COUNT                 ("schema_count", ColumnType.INT, RelationalDatabaseMetric.TABLE_COUNT.getDescription(), false),
    COLUMN_COUNT                ("schema_count", ColumnType.INT, RelationalDatabaseMetric.COLUMN_COUNT.getDescription(), false),
