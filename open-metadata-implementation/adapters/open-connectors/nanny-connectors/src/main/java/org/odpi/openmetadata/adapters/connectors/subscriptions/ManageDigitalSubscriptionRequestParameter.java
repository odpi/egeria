...
public enum ManageDigitalSubscriptionRequestParameter
{
     ...
     */
    ManageDigitalSubscriptionRequestParameter(String name,
                                              String description,
                                              String dataType,
                                              String example)
    {
    ...
    public static List<RequestParameterType> getRequestParameterTypes()
    {
        ...
        for (ManageDigitalSubscriptionRequestParameter requestParameter : ManageDigitalSubscriptionRequestParameter.values())
        {
