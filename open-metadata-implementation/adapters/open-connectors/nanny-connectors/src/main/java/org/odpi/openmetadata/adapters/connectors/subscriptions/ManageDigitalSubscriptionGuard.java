 ...
 */
public enum ManageDigitalSubscriptionGuard
{
     ...
     */
    ManageDigitalSubscriptionGuard(String name, CompletionStatus completionStatus, String description)
    {
        this.name             = name;
    ...
    public static List<GuardType> getGuardTypes()
    {
        ...
        for (ManageDigitalSubscriptionGuard guard : ManageDigitalSubscriptionGuard.values())
        {
