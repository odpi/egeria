...
public enum AtlasDiscoveryErrorCode implements ExceptionMessageSet
{
    ...
    /**
     * The constructor for AtlasDiscoveryErrorCode expects to be passed one of the enumeration rows defined in
     * AtlasDiscoveryErrorCode above.   For example:
     * <br><br>
     *     AtlasDiscoveryErrorCode   errorCode = AtlasDiscoveryErrorCode.UNEXPECTED_EXCEPTION;
     * <br><br>
    ...
    {
        return "AtlasDiscoveryErrorCode{" +
