...
public class KafkaOpenMetadataEventConsumer implements Runnable
{
                                          ...
                                          OMRSAuditLog                    auditLog)
    {
        ...
        auditLog.logRecord(actionDescription,
                           ...
                           auditCode.getFormattedLogMessage(topicName, connector.getPrintableProperties(kafkaConsumerProperties)),
                           null,
        ...
        while (isRunning())
        {
            try
            {
            	...
            	if (! pollRequired && nUnprocessedEvents > maxQueueSize) {
            		//The connector queue is too big.  Wait until the size goes down before 
