...
/**
 * The YAMLErrorCode is used to define first failure data capture (FFDC) for errors that occur when working with
 ...
 * </ul>
 */
public enum YAMLErrorCode implements ExceptionMessageSet
{
    /**
     * YAML-SECRETS-STORE-CONNECTOR-500-002 - The connector received an unexpected IO exception when reading the file named {0}; the error message was: {1}
     */
