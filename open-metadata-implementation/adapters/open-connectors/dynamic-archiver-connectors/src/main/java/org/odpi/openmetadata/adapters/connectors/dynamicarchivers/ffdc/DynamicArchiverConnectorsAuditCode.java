...
public enum DynamicArchiverConnectorsAuditCode implements AuditLogMessageSet
{
    ...
    MOVE_FILE("DYNAMIC-ARCHIVER-SERVICES-0002",
              OMRSAuditLogRecordSeverity.INFO,
    ...
    DELETE_FILE("DYNAMIC-ARCHIVER-SERVICES-0003",
              OMRSAuditLogRecordSeverity.INFO,
    ...
    CREATED_LINEAGE("DYNAMIC-ARCHIVER-SERVICES-0004",
                        OMRSAuditLogRecordSeverity.INFO,
    ...
    NO_SOURCE_FILE_NAME("DYNAMIC-ARCHIVER-SERVICES-0005",
    ...
    PROVISIONING_FAILURE("DYNAMIC-ARCHIVER-SERVICES-0006",
                              OMRSAuditLogRecordSeverity.ERROR,
    ...
    PROVISIONING_EXCEPTION("DYNAMIC-ARCHIVER-SERVICES-0007",
    ...
    ENDPOINT_EXCEPTION("DYNAMIC-ARCHIVER-SERVICES-0008",
                           OMRSAuditLogRecordSeverity.EXCEPTION,
    ...
    QUALIFIED_NAME_PATH_NAME("DYNAMIC-ARCHIVER-SERVICES-0009",
                       OMRSAuditLogRecordSeverity.INFO,
    ...
    NO_LINKED_CONNECTION("DYNAMIC-ARCHIVER-SERVICES-0010",
                             OMRSAuditLogRecordSeverity.INFO,
                             ...
                             "The governance action service will next produce the DYNAMIC-ARCHIVER-SERVICES-0006 message with the " +
                                     "qualified name.  Follow the instructions for this message."),

    TOO_MANY_CONNECTIONS("DYNAMIC-ARCHIVER-SERVICES-0011",
                         OMRSAuditLogRecordSeverity.INFO,
    ...
    NO_RELATED_ASSET("DYNAMIC-ARCHIVER-SERVICES-0012",
                     OMRSAuditLogRecordSeverity.ERROR,
                     ...
                     "The governance action service stops attempting extract the path name from the connection and " +
                                 "will use the qualified name of the asset as the path name to work with.",
                     "The governance action service will write the DYNAMIC-ARCHIVER-SERVICES-0006 message with the " +
    ...
    NO_LINKED_ENDPOINT("DYNAMIC-ARCHIVER-SERVICES-0013",
                         OMRSAuditLogRecordSeverity.INFO,
                         ...
                         "Since the asset's connection has no endpoint, the governance action connector will use the qualified name of the " +
                                 "asset as the path name to work with.",
                         "The governance action service will next write out the DYNAMIC-ARCHIVER-SERVICES-0006 message with the " +
                                 "qualified name.  Follow the instructions for this message."),

    TOO_MANY_ENDPOINTS("DYNAMIC-ARCHIVER-SERVICES-0014",
                         OMRSAuditLogRecordSeverity.ERROR,
    ...
    NO_NETWORK_ADDRESS("DYNAMIC-ARCHIVER-SERVICES-0015",
                       OMRSAuditLogRecordSeverity.INFO,
                       ...
                       "Since the asset's connection has no networkAddress in its endpoint, the governance action connector will use the qualified name of the " +
                               "asset as the path name to work with.",
                       "The governance action service will log the DYNAMIC-ARCHIVER-SERVICES-0006 message with the " +
                               "qualified name.  Follow the instructions for this message."),

    UNABLE_TO_SET_COMPLETION_STATUS("DYNAMIC-ARCHIVER-SERVICES-0016",
                       OMRSAuditLogRecordSeverity.INFO,
    ...
    UNABLE_TO_REGISTER_LISTENER("DYNAMIC-ARCHIVER-SERVICES-0017",
                                    OMRSAuditLogRecordSeverity.INFO,
    ...
    NO_TARGETS("DYNAMIC-ARCHIVER-SERVICES-0018",
                                OMRSAuditLogRecordSeverity.ERROR,
    ...
    NO_ZONES("DYNAMIC-ARCHIVER-SERVICES-0019",
                                OMRSAuditLogRecordSeverity.ERROR,
    ...
    SETTING_ZONES("DYNAMIC-ARCHIVER-SERVICES-0020",
                                OMRSAuditLogRecordSeverity.INFO,
    ...
    INITIATE_PROCESS("DYNAMIC-ARCHIVER-SERVICES-0021",
                     OMRSAuditLogRecordSeverity.INFO,
    ...
    INITIATE_PROCESS_EXCEPTION("DYNAMIC-ARCHIVER-SERVICES-0022",
                           OMRSAuditLogRecordSeverity.EXCEPTION,
