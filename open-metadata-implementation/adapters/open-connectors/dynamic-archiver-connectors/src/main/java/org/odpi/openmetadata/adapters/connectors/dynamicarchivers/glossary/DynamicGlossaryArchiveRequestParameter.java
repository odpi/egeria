 ...
 */
public enum DynamicGlossaryArchiveRequestParameter
{
    ...
    GLOSSARY_NAME("glossaryName", "Qualified name of the glossary to archive", "string", "myGlossary"),
     ...
     */
    DynamicGlossaryArchiveRequestParameter(String name,
                                           String description,
                                           String dataType,
                                           String example)
    {
    ...
    public static List<RequestParameterType> getRequestParameterTypes()
    {
        ...
        for (DynamicGlossaryArchiveRequestParameter requestParameter : DynamicGlossaryArchiveRequestParameter.values())
        {
