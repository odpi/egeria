...
/**
 * The DynamicArchiverConnectorsErrorCode is used to define first failure data capture (FFDC) for errors that occur when working with
 ...
 * </ul>
 */
public enum DynamicArchiverConnectorsErrorCode implements ExceptionMessageSet
{
    ...
    UNEXPECTED_EXC_DATA_FILE_UPDATE(400,"DYNAMIC-ARCHIVER-SERVICES-400-005",
    ...
    UNEXPECTED_EXCEPTION(500, "DYNAMIC-ARCHIVER-SERVICES-500-004",
    ...
    /**
     * The constructor for DynamicArchiverConnectorsErrorCode expects to be passed one of the enumeration rows defined in
     * DynamicArchiverConnectorsErrorCode above.   For example:
     *
     *     DynamicArchiverConnectorsErrorCode   errorCode = DynamicArchiverConnectorsErrorCode.ERROR_SENDING_EVENT;
     *
     ...
     */
    DynamicArchiverConnectorsErrorCode(int  httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
    ...
    {
        return "DynamicArchiverConnectorsErrorCode{" +
