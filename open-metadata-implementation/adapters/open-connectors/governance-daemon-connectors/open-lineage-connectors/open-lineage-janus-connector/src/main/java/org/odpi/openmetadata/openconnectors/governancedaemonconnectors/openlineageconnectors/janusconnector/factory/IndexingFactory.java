...
public class IndexingFactory <C extends Element> {
     ...
     * @param type - type
     */
    protected void createCompositeIndexForProperty(String propertyName, String propertyKeyName, boolean unique,
                                                   JanusGraph graph, Class<C> type) {
    ...
    private void createIndex(JanusGraphManagement management, String indexName, String propertyName, String propertyKeyName,
                             boolean unique, Class<C> type) {
    ...
    private void buildIndex(JanusGraphManagement management, String indexName, PropertyKey propertyKey, boolean unique,
                            boolean oldKey, Class<C> type) {
    ...
    private void enableIndex(JanusGraphManagement management, String indexName, boolean oldKey) {
        ...
        try {
            ...
            if (auditLog != null) {
                auditLog.logMessage(CAUGHT_INTERRUPTED_EXCEPTION_MESSAGE, INDEX_NOT_ENABLED.getMessageDefinition());
            }
            management.rollback();
        }
    }
