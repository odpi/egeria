...
/**
 * The LovelaceInsightErrorCode is used to define first failure data capture (FFDC) for errors that occur when working with
 * the Lovelace services.  It is used in conjunction with both Checked and Runtime (unchecked) exceptions.
 *
 ...
 * </ul>
 */
public enum LovelaceInsightErrorCode implements ExceptionMessageSet
{
    ...
    {
        return "LovelaceInsightErrorCode{" +
