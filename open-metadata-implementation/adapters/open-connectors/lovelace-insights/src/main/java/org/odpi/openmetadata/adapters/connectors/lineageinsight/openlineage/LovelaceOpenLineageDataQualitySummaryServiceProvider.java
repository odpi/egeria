...
/**
 * LovelaceOpenLineageDataQualitySummaryServiceProvider is the connector provider for the LovelaceOpenLineageDataQualitySummaryService
 ...
 */
public class LovelaceOpenLineageDataQualitySummaryServiceProvider extends GovernanceActionServiceProviderBase
{
    /**
     * Constructor used to initialize the connector provider with the Java class name of the specific
     * store implementation.
     */
    public LovelaceOpenLineageDataQualitySummaryServiceProvider()
    {
        super(EgeriaOpenConnectorDefinition.OPEN_LINEAGE_DATA_QUALITY_SUMMARY_LOVELACE_SERVICE,
              LovelaceOpenLineageDataQualitySummaryService.class.getName(),
              null);
