...
{
    CONNECTOR_CONFIGURATION("CSV-LINEAGE-IMPORTER-0001",
    ...
    BAD_FOLDER_ELEMENT("CSV-LINEAGE-IMPORTER-0003",
                       AuditLogRecordSeverityLevel.ERROR,
    ...
    DIRECTORY_MONITORING_STARTING("CSV-LINEAGE-IMPORTER-0005",
                                  AuditLogRecordSeverityLevel.INFO,
    ...
    UNEXPECTED_EXC_MONITOR_START("CSV-LINEAGE-IMPORTER-0006",
                                 AuditLogRecordSeverityLevel.ERROR,
    ...
    DIRECTORY_MONITORING_STOPPING("CSV-LINEAGE-IMPORTER-0007",
                                  AuditLogRecordSeverityLevel.INFO,
    ...
    UNEXPECTED_EXC_MONITOR_STOP("CSV-LINEAGE-IMPORTER-0008",
                                AuditLogRecordSeverityLevel.ERROR,
                                 "An unexpected {0} exception was returned to the {1} integration connector by the Apache Commons " +
    ...
    DATA_FOLDER_UPDATED_FOR_FILE("CSV-LINEAGE-IMPORTER-0011",
                                 AuditLogRecordSeverityLevel.INFO,
    ...
    UNEXPECTED_EXC_FOLDER_UPDATE("CSV-LINEAGE-IMPORTER-0012",
                                 AuditLogRecordSeverityLevel.ERROR,
    ...
    BAD_FILE_ELEMENT("CSV-LINEAGE-IMPORTER-0013",
                     AuditLogRecordSeverityLevel.ERROR,
    ...
    DATA_FILE_CREATED("CSV-LINEAGE-IMPORTER-0016",
                      AuditLogRecordSeverityLevel.INFO,
    ...
    DATA_FILE_CREATED_FROM_TEMPLATE("CSV-LINEAGE-IMPORTER-0017",
                                    AuditLogRecordSeverityLevel.INFO,
    ...
    DATA_FILE_UPDATED("CSV-LINEAGE-IMPORTER-0018",
                      AuditLogRecordSeverityLevel.INFO,
    ...
    DATA_FILE_DELETED("CSV-LINEAGE-IMPORTER-0019",
                      AuditLogRecordSeverityLevel.INFO,
    ...
    DATA_FILE_ARCHIVED("CSV-LINEAGE-IMPORTER-0020",
                       AuditLogRecordSeverityLevel.INFO,
