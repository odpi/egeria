...
import org.odpi.openmetadata.adapters.connectors.integration.apacheatlas.properties.AtlasBusinessMetadataDef;
import org.odpi.openmetadata.adapters.connectors.integration.apacheatlas.properties.AtlasClassificationDef;
...
import org.odpi.openmetadata.adapters.connectors.integration.apacheatlas.properties.AtlasEntityOperation;
...
import org.odpi.openmetadata.adapters.connectors.integration.apacheatlas.properties.AtlasSearchResult;
...
public class ApacheAtlasRESTClient
{
     ...
     * REST API calls.
     */
    ApacheAtlasRESTClient(String   connectorName,
                          String   serverName,
                          String   baseURL,
                          String   userId,
                          String   password,
    ...
    public AtlasTypesDef getAllTypes() throws PropertyServerException
    {
        ...
        final String url = baseURL + "/api/atlas/v2/types/typedefs";
    ...
    public AtlasEntityDef getEntityType(String typeName) throws PropertyServerException
    {
        ...
        final String url = baseURL + "/api/atlas/v2/types/entitydef/name/" + typeName;
    ...
    public AtlasRelationshipDef getRelationshipType(String typeName) throws PropertyServerException
    {
        ...
        final String url = baseURL + "/api/atlas/v2/types/relationshipdef/name/" + typeName;
    ...
    public AtlasClassificationDef getClassificationType(String typeName) throws PropertyServerException
    {
        ...
        final String url = baseURL + "/api/atlas/v2/types/classificationdef/name/" + typeName;
    ...
    public AtlasBusinessMetadataDef getBusinessMetadataType(String typeName) throws PropertyServerException
    {
        ...
        final String url = baseURL + "/api/atlas/v2/types/businessmetadatadef/name/" + typeName;
    ...
    public String addEntity(AtlasEntity entity) throws PropertyServerException
    {
        ...
        final String url = baseURL + "/api/atlas/v2/entity";
    ...
    public AtlasEntityMutationResponse deleteEntity(String entityGUID) throws PropertyServerException
    {
        ...
        final String url = baseURL + "/api/atlas/v2/entity/guid/{0}";
    ...
    public AtlasRelationship addRelationship(AtlasRelationship  atlasRelationship) throws PropertyServerException
    {
        ...
        final String url = baseURL + "/api/atlas/v2/relationship";
    ...
    public void clearRelationship(String  atlasRelationshipGUID) throws PropertyServerException
    {
        ...
        final String url = baseURL + "/api/atlas/v2/relationship/" + atlasRelationshipGUID;
    ...
    public AtlasEntityWithExtInfo getEntityByGUID(String guid) throws PropertyServerException
    {
        ...
        final String url = baseURL + "/api/atlas/v2/entity/guid/" + guid;
                                                           ...
                                                           int    pageSize) throws PropertyServerException
    {
        ...
        final String url = baseURL + "/api/atlas/v2/search/dsl?typeName=" + typeName + "&offset=" + startFrom + "&limit=" + pageSize;
     ...
     * @throws PropertyServerException something went wrong with the REST call stack.
     */
    protected <T> T callNoLogGetRESTCallNoParams(String    methodName,
                                                 Class<T>  returnClass,
                                                 String    urlTemplate) throws PropertyServerException
    {
        try
     ...
     * @throws PropertyServerException something went wrong with the REST call stack.
     */
    protected  <T> T callNoLogGetRESTCall(String                        methodName,
                                          ParameterizedTypeReference<T> responseType,
                                          String                        urlTemplate,
                                          Object...                     params) throws PropertyServerException
    {
     ...
     * @throws PropertyServerException something went wrong with the REST call stack.
     */
    protected <T> T callNoLogPostRESTCallNoParams(String    methodName,
                                                   Class<T>  returnClass,
                                                   String    urlTemplate,
                                                   Object    requestBody) throws PropertyServerException
    {
