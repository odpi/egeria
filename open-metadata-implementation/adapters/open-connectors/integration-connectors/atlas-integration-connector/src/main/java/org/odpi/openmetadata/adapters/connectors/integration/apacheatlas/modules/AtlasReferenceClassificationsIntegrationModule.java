    ...
    public Map<String, ValidValueElement> synchronizeClassificationDefinitions()
    {
        ...
        if (classificationReferenceSetName != null)
        {
                ...
                catch (Exception error)
                {
                    if (auditLog != null)
                    {
                        auditLog.logException(methodName,
                                              ApacheAtlasAuditCode.UNABLE_TO_SET_UP_CLASSIFICATION_REFERENCE_SET.getMessageDefinition(connectorName,
            ...
            catch (Exception error)
            {
                ...
                {
                    auditLog.logException(methodName,
                                          ApacheAtlasAuditCode.UNABLE_TO_GET_CLASSIFICATION_REFERENCE_SET_MEMBERS.getMessageDefinition(connectorName,
                                                                                                                                  error.getClass().getName(),
                                                                                                                                  classificationReferenceSetName,
                                                                                                                                  error.getMessage()),
                                          error);
                ...
                (classificationReferenceSetPolicy.equals(ApacheAtlasIntegrationProvider.CLASSIFICATION_REFERENCE_SET_BOTH_WAYS_CONFIGURATION_PROPERTY_VALUE)))
            {
                ...
                catch (Exception error)
                {
                    ...
                    {
                        auditLog.logException(methodName,
                                              ApacheAtlasAuditCode.UNABLE_TO_BUILD_CLASSIFICATION_REFERENCE_SET_FROM_ATLAS.getMessageDefinition(connectorName,
                                                                                                                                                error.getClass().getName(),
                                                                                                                                                classificationReferenceSetName,
                                                                                                                                                error.getMessage()),
                                              error);
                ...
                (classificationReferenceSetPolicy.equals(ApacheAtlasIntegrationProvider.CLASSIFICATION_REFERENCE_SET_BOTH_WAYS_CONFIGURATION_PROPERTY_VALUE)))
            {
                ...
                catch (Exception error)
                {
                    ...
                    {
                        auditLog.logException(methodName,
                                              ApacheAtlasAuditCode.UNABLE_TO_ADD_CLASSIFICATION_REFERENCE_SET_TO_ATLAS.getMessageDefinition(connectorName,
                                                                                                                                            error.getClass().getName(),
                                                                                                                                            classificationReferenceSetName,
                                                                                                                                            error.getMessage()),
                                              error);
