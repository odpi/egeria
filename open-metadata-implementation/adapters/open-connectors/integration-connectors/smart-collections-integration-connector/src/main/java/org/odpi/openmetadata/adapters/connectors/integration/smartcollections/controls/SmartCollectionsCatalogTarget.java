...
package org.odpi.openmetadata.adapters.connectors.integration.smartcollections.controls;
...
/**
 * SmartCollectionsCatalogTarget characterises the type of element that the Smart Collections Integration Connector works with.
 */
public enum SmartCollectionsCatalogTarget
{
    CATALOG_TARGET("resultsSetToMaintain",
                   OpenMetadataType.RESULTS_SET.typeName,
                   null,
                   null);
     ...
     */
    SmartCollectionsCatalogTarget(String name, String typeName, String deployedImplementationType, Map<String, String> otherPropertyValues)
    {
        this.name                       = name;
    ...
    public static List<CatalogTargetType> getCatalogTargetTypes()
    {
        ...
        for (SmartCollectionsCatalogTarget catalogTarget : SmartCollectionsCatalogTarget.values())
        {
    ...
    {
        return "SmartCollectionsCatalogTarget{catalogTargetName='" + name + "'}";
    }
}
