...
/**
 * The SmartCollectionsErrorCode is used to define first failure data capture (FFDC) for errors that occur when working with
 * the Smart Collections integration connector.  It is used in conjunction with both Checked and Runtime (unchecked) exceptions.
 ...
 * </ul>
 */
public enum SmartCollectionsErrorCode implements ExceptionMessageSet
{
    /**
     * SMART-COLLECTIONS-INTEGRATION-CONNECTOR-400-001 - Connector {0} has not been supplied with a secret that can be used to authenticate the REST calls it makes to run saved queries
     */
    ...
    {
        return "SmartCollectionsErrorCode{" +
