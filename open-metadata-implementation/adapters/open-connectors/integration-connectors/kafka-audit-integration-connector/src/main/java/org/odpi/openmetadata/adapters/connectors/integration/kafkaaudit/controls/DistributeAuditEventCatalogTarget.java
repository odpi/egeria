...
{
    INCOMING_TOPIC("kafkaTopicToMonitor",
     ...
     */
    DistributeAuditEventCatalogTarget(String name, String typeName, String deployedImplementationType, Map<String, String> otherPropertyValues)
    {
        this.name                       = name;
