...
/**
 * Verify the BitolIntegrationConnectorErrorCode enum contains unique message ids, non-null names
...
public class ErrorCodeTest extends ExceptionMessageSetTest
{
    ...
    {
        for (BitolIntegrationConnectorErrorCode errorCode : BitolIntegrationConnectorErrorCode.values())
        {
