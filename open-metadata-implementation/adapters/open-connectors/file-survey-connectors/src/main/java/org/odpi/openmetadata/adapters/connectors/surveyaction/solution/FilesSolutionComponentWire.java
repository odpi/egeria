 ...
 */
public enum  FilesSolutionComponentWire implements SolutionComponentWireDefinition
{
    TABULAR_DATA_SET_TO_POSTGRES(FilesSolutionComponent.POSTGRES_TABULAR_DATA_SET,
    ...
    SURVEY_SERVER_TO_POSTGRES(FilesSolutionComponent.SURVEY_POSTGRES_SERVER,
                              EgeriaSolutionComponent.POSTGRES_SERVER,
    ...
    SURVEY_SERVER_TO_METADATA_STORE(FilesSolutionComponent.SURVEY_POSTGRES_SERVER,
    ...
    SURVEY_DATABASE_TO_POSTGRES(FilesSolutionComponent.SURVEY_POSTGRES_DATABASE,
                                EgeriaSolutionComponent.POSTGRES_SERVER,
                                "reads postgres database catalog",
                                "The PostgreSQL database surveyor reads the database catalog to discover details of a database in the PostgreSQL server."),

    SURVEY_DATABASE_TO_METADATA_STORE(FilesSolutionComponent.SURVEY_POSTGRES_DATABASE,
                                      EgeriaSolutionComponent.METADATA_ACCESS_STORE,
                                      "writes survey results",
    ...
    CATALOG_SERVER_TO_POSTGRES(FilesSolutionComponent.CATALOG_POSTGRES_SERVER,
                               EgeriaSolutionComponent.POSTGRES_SERVER,
                               "reads postgres database catalog",
                               "The PostgreSQL server cataloger reads the database catalog to discover details of the databases on the PostgreSQL server."),

    CATALOG_SERVER_TO_METADATA_STORE(FilesSolutionComponent.CATALOG_POSTGRES_SERVER,
                                     EgeriaSolutionComponent.METADATA_ACCESS_STORE,
    ...
    CATALOG_DATABASE_TO_POSTGRES(FilesSolutionComponent.CATALOG_POSTGRES_DATABASE,
                                 EgeriaSolutionComponent.POSTGRES_SERVER,
                                 "reads postgres database catalog",
                                 "The PostgreSQL database cataloguer reads the database catalog to discover details of a database in the PostgreSQL server."),

    CATALOG_DATABASE_TO_METADATA_STORE(FilesSolutionComponent.CATALOG_POSTGRES_DATABASE,
                                       EgeriaSolutionComponent.METADATA_ACCESS_STORE,
                                       "writes catalog entries",
    ...
    FilesSolutionComponentWire(SolutionComponentDefinition component1,
