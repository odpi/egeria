 ...
 */
public enum ZonePublisherRequestParameter
{
     ...
     */
    ZonePublisherRequestParameter(String name,
                                  String description,
                                  String dataType,
                                  String example)
    {
    ...
    public static List<RequestParameterType> getRequestParameterTypes()
    {
        ...
        for (ZonePublisherRequestParameter requestParameter : ZonePublisherRequestParameter.values())
        {
