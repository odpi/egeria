...
/**
 * PeriodicRefreshRequestParameter provides some standard definitions for request parameters used to pass properties
 ...
 */
public enum PeriodicRefreshRequestParameter
{
    REFRESH_INTERVAL ("refreshInterval", "The number of milliseconds between refresh notifications.", DataType.INT.getName(), "86400000"),
    ;
     ...
     */
    PeriodicRefreshRequestParameter(String name,
                                    String description,
                                    String dataType,
                                    String example)
    {
    ...
    public static List<RequestParameterType> getRequestParameterTypes()
    {
        ...
        for (PeriodicRefreshRequestParameter requestParameter : PeriodicRefreshRequestParameter.values())
        {
