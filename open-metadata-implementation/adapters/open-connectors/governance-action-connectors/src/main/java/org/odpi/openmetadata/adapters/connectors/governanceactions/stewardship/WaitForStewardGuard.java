 ...
 */
public enum WaitForStewardGuard
{
     ...
     */
    WaitForStewardGuard(String name, CompletionStatus completionStatus, String description)
    {
        this.name             = name;
    ...
    public static List<GuardType> getGuardTypes()
    {
        ...
        for (WaitForStewardGuard guard : WaitForStewardGuard.values())
        {
