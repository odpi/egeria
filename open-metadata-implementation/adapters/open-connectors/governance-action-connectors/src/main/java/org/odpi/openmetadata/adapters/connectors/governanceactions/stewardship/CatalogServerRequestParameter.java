 ...
 */
public enum CatalogServerRequestParameter
{
     ...
     */
    CatalogServerRequestParameter(String name,
                                  String description,
                                  String dataType,
                                  String example)
    {
    ...
    public static List<RequestParameterType> getRequestParameterTypes()
    {
        ...
        for (CatalogServerRequestParameter requestParameter : CatalogServerRequestParameter.values())
        {
