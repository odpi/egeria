 ...
 */
public enum ProvisionTabularDataSetGuard
{
     ...
     */
    ProvisionTabularDataSetGuard(String name, CompletionStatus completionStatus, String description)
    {
        this.name             = name;
    ...
    public static List<GuardType> getGuardTypes()
    {
        ...
        for (ProvisionTabularDataSetGuard guard : ProvisionTabularDataSetGuard.values())
        {
