...
{
    CONNECTOR_CONFIGURATION("GOVERNANCE-ACTION-CONNECTORS-0001",
    ...
    BAD_CONFIGURATION("GOVERNANCE-ACTION-CONNECTORS-0002",
    ...
    BAD_FOLDER_ELEMENT("GOVERNANCE-ACTION-CONNECTORS-0003",
    ...
    UNEXPECTED_EXC_RETRIEVING_FOLDER("GOVERNANCE-ACTION-CONNECTORS-0004",
                            OMRSAuditLogRecordSeverity.EXCEPTION,
    ...
    DIRECTORY_MONITORING_STARTING("GOVERNANCE-ACTION-CONNECTORS-0005",
                              OMRSAuditLogRecordSeverity.INFO,
    ...
    UNEXPECTED_EXC_MONITOR_START("GOVERNANCE-ACTION-CONNECTORS-0006",
                                     OMRSAuditLogRecordSeverity.EXCEPTION,
    ...
    DIRECTORY_MONITORING_STOPPING("GOVERNANCE-ACTION-CONNECTORS-0007",
                                  OMRSAuditLogRecordSeverity.INFO,
    ...
    UNEXPECTED_EXC_MONITOR_STOP("GOVERNANCE-ACTION-CONNECTORS-0008",
                                 OMRSAuditLogRecordSeverity.EXCEPTION,
                                 "An unexpected {0} exception was returned to the {1} integration connector by the Apache Commons " +
    ...
    DATA_FOLDER_UPDATED_FOR_FILE("GOVERNANCE-ACTION-CONNECTORS-0011",
                        OMRSAuditLogRecordSeverity.INFO,
    ...
    UNEXPECTED_EXC_FOLDER_UPDATE("GOVERNANCE-ACTION-CONNECTORS-0012",
                                OMRSAuditLogRecordSeverity.EXCEPTION,
    ...
    BAD_FILE_ELEMENT("GOVERNANCE-ACTION-CONNECTORS-0013",
                       OMRSAuditLogRecordSeverity.ERROR,
    ...
    UNEXPECTED_EXC_DATA_FILE_UPDATE("GOVERNANCE-ACTION-CONNECTORS-0014",
                                 OMRSAuditLogRecordSeverity.EXCEPTION,
                                 "An unexpected {0} exception was returned to the {1} integration connector when it tried to update the " +
    ...
    MISSING_TEMPLATE("GOVERNANCE-ACTION-CONNECTORS-0015",
                     OMRSAuditLogRecordSeverity.ERROR,
    ...
    DATA_FILE_CREATED("GOVERNANCE-ACTION-CONNECTORS-0016",
                      OMRSAuditLogRecordSeverity.INFO,
    ...
    DATA_FILE_CREATED_FROM_TEMPLATE("GOVERNANCE-ACTION-CONNECTORS-0017",
                      OMRSAuditLogRecordSeverity.INFO,
    ...
    DATA_FILE_UPDATED("GOVERNANCE-ACTION-CONNECTORS-0018",
                      OMRSAuditLogRecordSeverity.INFO,
    ...
    DATA_FILE_DELETED("GOVERNANCE-ACTION-CONNECTORS-0019",
                      OMRSAuditLogRecordSeverity.INFO,
    ...
    DATA_FILE_ARCHIVED("GOVERNANCE-ACTION-CONNECTORS-0020",
                      OMRSAuditLogRecordSeverity.INFO,
