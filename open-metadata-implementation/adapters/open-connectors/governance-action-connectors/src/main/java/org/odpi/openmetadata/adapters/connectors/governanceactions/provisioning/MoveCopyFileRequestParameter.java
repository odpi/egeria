...
public enum MoveCopyFileRequestParameter
{
    ...
    DESTINATION_FILE_SYSTEM ("destinationFileSystem", "The name of the file system where the destination files will be created.", "string", "egeria-deployment"),
    DESTINATION_LOCAL_MOUNT_POINT ("destinationLocalMountPoint", "The parent directory where the that is the local mount point.", "string", "."),
    DESTINATION_CANONICAL_MOUNT_POINT ("destinationCanonicalMountPoint", "The directory lat to use to represent the  directories above the local mount point.", "string", "/deployments"),
