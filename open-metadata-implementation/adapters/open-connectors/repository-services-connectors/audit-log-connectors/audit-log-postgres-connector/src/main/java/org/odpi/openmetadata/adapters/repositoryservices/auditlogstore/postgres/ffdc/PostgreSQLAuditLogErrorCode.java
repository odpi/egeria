...
/**
 * The PostgreSQLAuditLogErrorCode is used to define first failure data capture (FFDC) for errors that occur when working with
 * the JDBC audit log destination connector.  It is used in conjunction with both Checked and Runtime (unchecked) exceptions.
...
public enum PostgreSQLAuditLogErrorCode implements ExceptionMessageSet
{
    ...
    /**
     * The constructor for PostgreSQLAuditLogErrorCode expects to be passed one of the enumeration rows defined in
     * PostgreSQLAuditLogErrorCode above.   For example:
     * <br><br>
     *     PostgreSQLAuditLogErrorCode   errorCode = PostgreSQLAuditLogErrorCode.ERROR_SENDING_EVENT;
     * <br><br>
    ...
    {
        return "PostgreSQLAuditLogErrorCode{" +
