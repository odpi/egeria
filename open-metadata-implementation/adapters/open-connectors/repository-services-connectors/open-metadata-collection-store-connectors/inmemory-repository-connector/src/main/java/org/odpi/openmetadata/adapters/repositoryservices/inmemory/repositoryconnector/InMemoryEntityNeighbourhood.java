...
public class InMemoryEntityNeighbourhood
{
    ...
    Set<String> graphRelationships = new HashSet<>();
    ...
    public InMemoryEntityNeighbourhood(
                                       ...
                                       int                  level) throws RepositoryErrorException, InvalidParameterException
    {
        ...
        if (relationship != null)
        {
            ...
            if (repositoryValidator.verifyInstanceHasRightStatus(limitResultsByStatus, relationship))
            {
                if (limitResultsByClassification ==null ||
                            ...
                            && (repositoryValidator.verifyEntityIsClassified(limitResultsByClassification, entity1)
                            && (repositoryValidator.verifyEntityIsClassified(limitResultsByClassification, entity2))))
                {
