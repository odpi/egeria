...
# Data Type:  String
# Mutability: LOCAL
storage.directory=../../../egeria-install/egeria-omag-3.16-SNAPSHOT/data/servers/Metadata_Server/repository/graph/berkeley
...
# Data Type:  String
# Mutability: MASKABLE
index.search.directory=../../../egeria-install/egeria-omag-3.16-SNAPSHOT/data/servers/Metadata_Server/repository/graph/searchindex
```
----
