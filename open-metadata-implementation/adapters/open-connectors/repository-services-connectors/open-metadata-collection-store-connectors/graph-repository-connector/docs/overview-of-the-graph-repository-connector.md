...
that used in the Egeria 2.7-SNAPSHOT build, so I am unable to use the index. I would need to build a JanusGraph assembly with a later 
...
# Data Type:  String
# Mutability: LOCAL
storage.directory=../../../egeria-install/egeria-omag-2.7-SNAPSHOT/data/servers/Metadata_Server/repository/graph/berkeley
...
# Data Type:  String
# Mutability: MASKABLE
index.search.directory=../../../egeria-install/egeria-omag-2.7-SNAPSHOT/data/servers/Metadata_Server/repository/graph/searchindex
```
----
