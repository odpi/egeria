...
that used in the Egeria 3.5 build, so I am unable to use the index. I would need to build a JanusGraph assembly with a later 
...
# Data Type:  String
# Mutability: LOCAL
storage.directory=../../../egeria-install/egeria-omag-3.5/data/servers/Metadata_Server/repository/graph/berkeley
...
# Data Type:  String
# Mutability: MASKABLE
index.search.directory=../../../egeria-install/egeria-omag-3.5/data/servers/Metadata_Server/repository/graph/searchindex
```
----
