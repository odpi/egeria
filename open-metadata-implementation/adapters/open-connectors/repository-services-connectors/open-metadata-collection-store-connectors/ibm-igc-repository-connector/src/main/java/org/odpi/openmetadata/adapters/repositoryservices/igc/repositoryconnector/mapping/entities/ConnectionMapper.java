...
public class ConnectionMapper extends ReferenceableMapper {
    ...
    private void addConnectionEndpointRelationships() {
        ...
        IGCSearchCondition igcSearchCondition = new IGCSearchCondition("data_connections", "=", igcEntity.getId());
    ...
    private void addConnectionToAssetRelationships() {
        ...
        IGCSearchCondition igcSearchCondition = new IGCSearchCondition("data_connection", "=", igcEntity.getId());
        IGCSearchConditionSet igcSearchConditionSet = new IGCSearchConditionSet(igcSearchCondition);
