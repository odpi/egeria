...
public class PhysicalObject extends Reference {

    public static String getIgcTypeId() { return "physical_object"; }
    public static String getIgcTypeDisplayName() { return "Physical Object"; }
    ...
    /**
     * The {@code mdm_model} property, displayed as '{@literal MDM Model}' in the IGC UI.
     * <br><br>
    ...
    /**
     * The {@code physical_object} property, displayed as '{@literal Physical Object}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link PhysicalObject} objects.
     */
    protected ReferenceList physical_object;
    ...
    /**
     * The {@code contains_physical_objects} property, displayed as '{@literal Contains Physical Objects}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link PhysicalObject} objects.
     */
    protected ReferenceList contains_physical_objects;

    /**
     * The {@code contains_physical_object_attributes} property, displayed as '{@literal Contains Physical Object Attributes}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link PhysicalObjectAttribute} objects.
     */
    protected ReferenceList contains_physical_object_attributes;
    ...
    /**
     * The {@code maps_database_tables_or_views} property, displayed as '{@literal Maps Database Tables or Views}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link Datagroup} objects.
     */
    protected ReferenceList maps_database_tables_or_views;
    ...
    /** @see #physical_object */ @JsonProperty("physical_object")  public ReferenceList getPhysicalObject() { return this.physical_object; }
    /** @see #physical_object */ @JsonProperty("physical_object")  public void setPhysicalObject(ReferenceList physical_object) { this.physical_object = physical_object; }
    ...
    /** @see #contains_physical_objects */ @JsonProperty("contains_physical_objects")  public ReferenceList getContainsPhysicalObjects() { return this.contains_physical_objects; }
    /** @see #contains_physical_objects */ @JsonProperty("contains_physical_objects")  public void setContainsPhysicalObjects(ReferenceList contains_physical_objects) { this.contains_physical_objects = contains_physical_objects; }

    /** @see #contains_physical_object_attributes */ @JsonProperty("contains_physical_object_attributes")  public ReferenceList getContainsPhysicalObjectAttributes() { return this.contains_physical_object_attributes; }
    /** @see #contains_physical_object_attributes */ @JsonProperty("contains_physical_object_attributes")  public void setContainsPhysicalObjectAttributes(ReferenceList contains_physical_object_attributes) { this.contains_physical_object_attributes = contains_physical_object_attributes; }
    ...
    /** @see #maps_database_tables_or_views */ @JsonProperty("maps_database_tables_or_views")  public ReferenceList getMapsDatabaseTablesOrViews() { return this.maps_database_tables_or_views; }
    /** @see #maps_database_tables_or_views */ @JsonProperty("maps_database_tables_or_views")  public void setMapsDatabaseTablesOrViews(ReferenceList maps_database_tables_or_views) { this.maps_database_tables_or_views = maps_database_tables_or_views; }
    ...
    private static final List<String> PAGED_RELATIONAL_PROPERTIES = Arrays.asList(
        ...
        "implements_rules",
        "governed_by_rules",
        "contains_physical_objects",
        "contains_physical_object_attributes",
        "maps_database_tables_or_views",
        "read_by_(static)",
        "written_by_(static)",
        "read_by_(design)",
        "written_by_(design)",
    ...
    public static Boolean isPhysicalObject(Object obj) { return (obj.getClass() == PhysicalObject.class); }
