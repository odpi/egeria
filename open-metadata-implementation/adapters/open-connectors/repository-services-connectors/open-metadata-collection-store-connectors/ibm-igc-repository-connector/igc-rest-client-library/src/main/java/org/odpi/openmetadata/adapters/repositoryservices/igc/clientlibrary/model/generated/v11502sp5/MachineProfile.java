...
public class MachineProfile extends Reference {

    public static String getIgcTypeId() { return "machine_profile"; }
    public static String getIgcTypeDisplayName() { return "Machine Profile"; }
    ...
    /**
     * The {@code port_number} property, displayed as '{@literal Port Number}' in the IGC UI.
     */
    protected Number port_number;

    /**
     * The {@code transfer_type} property, displayed as '{@literal Transfer Type}' in the IGC UI.
     */
    ...
    public static Boolean isMachineProfile(Object obj) { return (obj.getClass() == MachineProfile.class); }
