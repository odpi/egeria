...
/**
 * POJO for the {@code information_server_report_param_(job)} asset type in IGC, displayed as '{@literal Information Server Report (Job)}' in the IGC UI.
 * <br><br>
...
public class InformationServerReportParamJob extends Reference {

    public static String getIgcTypeId() { return "information_server_report_param_(job)"; }
    ...
    public static Boolean isInformationServerReportParamJob(Object obj) { return (obj.getClass() == InformationServerReportParamJob.class); }
