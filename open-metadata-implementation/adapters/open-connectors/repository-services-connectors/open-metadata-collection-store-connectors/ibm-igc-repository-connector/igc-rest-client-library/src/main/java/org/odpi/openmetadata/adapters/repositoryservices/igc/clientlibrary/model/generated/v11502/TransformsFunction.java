...
public class TransformsFunction extends Reference {
    ...
    public static String getIgcTypeId() { return "transforms_function"; }
    public static String getIgcTypeDisplayName() { return "Transforms Function"; }
    ...
    /**
     * The {@code source_code} property, displayed as '{@literal Definition}' in the IGC UI.
     */
    protected String source_code;

    /**
     * The {@code arguments} property, displayed as '{@literal Arguments}' in the IGC UI.
     * <br><br>
    ...
    public static Boolean isTransformsFunction(Object obj) { return (obj.getClass() == TransformsFunction.class); }
