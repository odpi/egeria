...
public class Attribute extends Reference {
    ...
    public static String getIgcTypeId() { return "attribute"; }
    public static String getIgcTypeDisplayName() { return "Attribute"; }
    ...
    /**
     * The {@code member_type_for_query} property, displayed as '{@literal Member Type}' in the IGC UI.
     * <br><br>
     * Will be a single {@link Reference} to a {@link MemberType} object.
     */
    ...
    /**
     * The {@code references_attribute_types} property, displayed as '{@literal References Attribute Types}' in the IGC UI.
     * <br><br>
    ...
    /**
     * The {@code attribute_label} property, displayed as '{@literal Attribute Label}' in the IGC UI.
     */
    ...
    private static final List<String> ALL_PROPERTIES = Arrays.asList(
        ...
        "long_description",
        "member_type",
        "member_type_for_query",
        "labels",
        "stewards",
        "assigned_to_terms",
        "implements_rules",
        "governed_by_rules",
        "references_attribute_types",
        "alias_(business_name)",
        "attribute_label",
        "code",
        "read_by_(static)",
    ...
    public static Boolean isAttribute(Object obj) { return (obj.getClass() == Attribute.class); }
