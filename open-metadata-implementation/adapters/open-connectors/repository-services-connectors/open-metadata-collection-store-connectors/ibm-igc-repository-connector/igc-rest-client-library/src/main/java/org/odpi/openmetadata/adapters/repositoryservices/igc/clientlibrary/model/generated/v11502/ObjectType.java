...
public class ObjectType extends Reference {

    public static String getIgcTypeId() { return "object_type"; }
    public static String getIgcTypeDisplayName() { return "Object Type"; }
    ...
    /**
     * The {@code application} property, displayed as '{@literal Application}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link Application} objects.
     */
    protected ReferenceList application;
    ...
    /**
     * The {@code methods} property, displayed as '{@literal Methods}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link Method} objects.
     */
    protected ReferenceList methods;
    ...
    /** @see #application */ @JsonProperty("application")  public ReferenceList getApplication() { return this.application; }
    /** @see #application */ @JsonProperty("application")  public void setApplication(ReferenceList application) { this.application = application; }
    ...
    /** @see #methods */ @JsonProperty("methods")  public ReferenceList getMethods() { return this.methods; }
    /** @see #methods */ @JsonProperty("methods")  public void setMethods(ReferenceList methods) { this.methods = methods; }
    ...
    public static Boolean isObjectType(Object obj) { return (obj.getClass() == ObjectType.class); }
