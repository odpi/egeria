...
public class TupleAttribute extends Reference {

    public static String getIgcTypeId() { return "tuple_attribute"; }
    public static String getIgcTypeDisplayName() { return "Tuple Attribute"; }
    ...
    /**
     * The {@code tuple_or_tuple_attribute} property, displayed as '{@literal Tuple or Tuple Attribute}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link MainObject} objects.
     */
    protected ReferenceList tuple_or_tuple_attribute;

    /**
     * The {@code tuple_attribute} property, displayed as '{@literal Tuple Attribute}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link TupleAttribute} objects.
     */
    protected ReferenceList tuple_attribute;

    /**
     * The {@code tuple} property, displayed as '{@literal Tuple}' in the IGC UI.
     * <br><br>
     * Will be a single {@link Reference} to a {@link RootTuple} object.
     */
    protected Reference tuple;
    ...
    /**
     * The {@code contains_tuple_attributes} property, displayed as '{@literal Contains Tuple Attributes}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link TupleAttribute} objects.
     */
    protected ReferenceList contains_tuple_attributes;
    ...
    /**
     * The {@code collection_type} property, displayed as '{@literal Collection Type}' in the IGC UI.
     * <br><br>
     * Can be one of the following values:
     * <ul>
     *     <li>boolean (displayed in the UI as 'boolean')</li>
    ...
    /** @see #tuple_or_tuple_attribute */ @JsonProperty("tuple_or_tuple_attribute")  public ReferenceList getTupleOrTupleAttribute() { return this.tuple_or_tuple_attribute; }
    /** @see #tuple_or_tuple_attribute */ @JsonProperty("tuple_or_tuple_attribute")  public void setTupleOrTupleAttribute(ReferenceList tuple_or_tuple_attribute) { this.tuple_or_tuple_attribute = tuple_or_tuple_attribute; }

    /** @see #tuple_attribute */ @JsonProperty("tuple_attribute")  public ReferenceList getTupleAttribute() { return this.tuple_attribute; }
    /** @see #tuple_attribute */ @JsonProperty("tuple_attribute")  public void setTupleAttribute(ReferenceList tuple_attribute) { this.tuple_attribute = tuple_attribute; }

    /** @see #tuple */ @JsonProperty("tuple")  public Reference getTuple() { return this.tuple; }
    /** @see #tuple */ @JsonProperty("tuple")  public void setTuple(Reference tuple) { this.tuple = tuple; }
    ...
    /** @see #contains_tuple_attributes */ @JsonProperty("contains_tuple_attributes")  public ReferenceList getContainsTupleAttributes() { return this.contains_tuple_attributes; }
    /** @see #contains_tuple_attributes */ @JsonProperty("contains_tuple_attributes")  public void setContainsTupleAttributes(ReferenceList contains_tuple_attributes) { this.contains_tuple_attributes = contains_tuple_attributes; }
    ...
    /** @see #collection_type */ @JsonProperty("collection_type")  public String getCollectionType() { return this.collection_type; }
    /** @see #collection_type */ @JsonProperty("collection_type")  public void setCollectionType(String collection_type) { this.collection_type = collection_type; }
    ...
    public static Boolean isTupleAttribute(Object obj) { return (obj.getClass() == TupleAttribute.class); }
