...
/**
 * POJO for the {@code information_server_report_(database)} asset type in IGC, displayed as '{@literal Information Server Report (Database)}' in the IGC UI.
 * <br><br>
...
public class InformationServerReportDatabase extends Reference {

    public static String getIgcTypeId() { return "information_server_report_(database)"; }
    public static String getIgcTypeDisplayName() { return "Information Server Report (Database)"; }
    ...
    /**
     * The {@code data_source} property, displayed as '{@literal Data Source}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link MainObject} objects.
     */
    protected ReferenceList data_source;
    ...
    /** @see #data_source */ @JsonProperty("data_source")  public ReferenceList getDataSource() { return this.data_source; }
    /** @see #data_source */ @JsonProperty("data_source")  public void setDataSource(ReferenceList data_source) { this.data_source = data_source; }
    ...
    public static Boolean isInformationServerReportDatabase(Object obj) { return (obj.getClass() == InformationServerReportDatabase.class); }
