...
/**
 * POJO for the {@code job_parameter} asset type in IGC, displayed as '{@literal Job Parameter}' in the IGC UI.
 * <br><br>
...
public class JobParameter extends Reference {
    ...
    public static String getIgcTypeId() { return "job_parameter"; }
    public static String getIgcTypeDisplayName() { return "Job Parameter"; }
    ...
    public static Boolean isJobParameter(Object obj) { return (obj.getClass() == JobParameter.class); }
