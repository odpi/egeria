...
public class BiModel extends Reference {
    ...
    /**
     * The {@code bi_joins} property, displayed as '{@literal BI Joins}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link OlapJoin} objects.
     */
    protected ReferenceList bi_joins;
    ...
    /** @see #bi_joins */ @JsonProperty("bi_joins")  public ReferenceList getBiJoins() { return this.bi_joins; }
    /** @see #bi_joins */ @JsonProperty("bi_joins")  public void setBiJoins(ReferenceList bi_joins) { this.bi_joins = bi_joins; }
