...
public class PublishedDataRuleDefinition extends Reference {
    ...
    /**
     * The {@code copied_into_data_rule_stages} property, displayed as '{@literal Copied Into Data Rule Stages}' in the IGC UI.
     * <br><br>
    ...
    /**
     * The {@code is_valid} property, displayed as '{@literal Is Valid}' in the IGC UI.
     */
    protected Boolean is_valid;

    /**
     * The {@code root_folder} property, displayed as '{@literal Root Folder}' in the IGC UI.
     */
    protected String root_folder;

    /**
     * The {@code rule_logic} property, displayed as '{@literal Rule Logic}' in the IGC UI.
     */
    ...
    /** @see #is_valid */ @JsonProperty("is_valid")  public Boolean getIsValid() { return this.is_valid; }
    /** @see #is_valid */ @JsonProperty("is_valid")  public void setIsValid(Boolean is_valid) { this.is_valid = is_valid; }

    /** @see #root_folder */ @JsonProperty("root_folder")  public String getRootFolder() { return this.root_folder; }
    /** @see #root_folder */ @JsonProperty("root_folder")  public void setRootFolder(String root_folder) { this.root_folder = root_folder; }
    ...
    public static Boolean isPublishedDataRuleDefinition(Object obj) { return (obj.getClass() == PublishedDataRuleDefinition.class); }
