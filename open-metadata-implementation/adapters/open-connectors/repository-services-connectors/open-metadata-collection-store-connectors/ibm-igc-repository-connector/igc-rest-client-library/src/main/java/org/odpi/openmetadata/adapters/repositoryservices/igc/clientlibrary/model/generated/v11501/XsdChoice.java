...
/**
 * POJO for the {@code xsd_choice} asset type in IGC, displayed as '{@literal XSD Choice}' in the IGC UI.
 * <br><br>
...
public class XsdChoice extends Reference {
    ...
    /** @see #is_minimum_range_inclusive_string */ @JsonProperty("is_minimum_range_inclusive_string")  public ArrayList<String> getIsMinimumRangeInclusiveString() { return this.is_minimum_range_inclusive_string; }
    /** @see #is_minimum_range_inclusive_string */ @JsonProperty("is_minimum_range_inclusive_string")  public void setIsMinimumRangeInclusiveString(ArrayList<String> is_minimum_range_inclusive_string) { this.is_minimum_range_inclusive_string = is_minimum_range_inclusive_string; }
    ...
    /** @see #is_maximum_range_inclusive_string */ @JsonProperty("is_maximum_range_inclusive_string")  public ArrayList<String> getIsMaximumRangeInclusiveString() { return this.is_maximum_range_inclusive_string; }
    /** @see #is_maximum_range_inclusive_string */ @JsonProperty("is_maximum_range_inclusive_string")  public void setIsMaximumRangeInclusiveString(ArrayList<String> is_maximum_range_inclusive_string) { this.is_maximum_range_inclusive_string = is_maximum_range_inclusive_string; }
