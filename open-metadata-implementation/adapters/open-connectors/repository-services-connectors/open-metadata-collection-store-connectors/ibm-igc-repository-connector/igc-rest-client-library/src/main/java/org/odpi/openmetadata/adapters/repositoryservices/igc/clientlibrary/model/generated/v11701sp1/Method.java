...
/**
 * POJO for the {@code method} asset type in IGC, displayed as '{@literal Method}' in the IGC UI.
 * <br><br>
...
public class Method extends Reference {

    public static String getIgcTypeId() { return "method"; }
    public static String getIgcTypeDisplayName() { return "Method"; }
    ...
    /**
     * The {@code object_type} property, displayed as '{@literal Object Type}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link ObjectType} objects.
     */
    protected ReferenceList object_type;
    ...
    /**
     * The {@code input_parameters} property, displayed as '{@literal Input Parameters}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link InputParameter} objects.
     */
    protected ReferenceList input_parameters;

    /**
     * The {@code output_values} property, displayed as '{@literal Output Values}' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link OutputValue} objects.
     */
    protected ReferenceList output_values;
    ...
    /** @see #object_type */ @JsonProperty("object_type")  public ReferenceList getObjectType() { return this.object_type; }
    /** @see #object_type */ @JsonProperty("object_type")  public void setObjectType(ReferenceList object_type) { this.object_type = object_type; }
    ...
    /** @see #input_parameters */ @JsonProperty("input_parameters")  public ReferenceList getInputParameters() { return this.input_parameters; }
    /** @see #input_parameters */ @JsonProperty("input_parameters")  public void setInputParameters(ReferenceList input_parameters) { this.input_parameters = input_parameters; }

    /** @see #output_values */ @JsonProperty("output_values")  public ReferenceList getOutputValues() { return this.output_values; }
    /** @see #output_values */ @JsonProperty("output_values")  public void setOutputValues(ReferenceList output_values) { this.output_values = output_values; }
    ...
    public static Boolean isMethod(Object obj) { return (obj.getClass() == Method.class); }
