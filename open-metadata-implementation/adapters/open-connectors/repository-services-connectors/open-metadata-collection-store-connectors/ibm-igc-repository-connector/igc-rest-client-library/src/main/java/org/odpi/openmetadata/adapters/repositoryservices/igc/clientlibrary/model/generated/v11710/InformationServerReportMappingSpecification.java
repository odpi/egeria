...
/**
 * POJO for the {@code information_server_report_(mapping_specification)} asset type in IGC, displayed as '{@literal Information Server Report (Mapping Specification)}' in the IGC UI.
 * <br><br>
...
public class InformationServerReportMappingSpecification extends Reference {

    public static String getIgcTypeId() { return "information_server_report_(mapping_specification)"; }
    public static String getIgcTypeDisplayName() { return "Information Server Report (Mapping Specification)"; }
    ...
    /**
     * The {@code report_links} property, displayed as '{@literal Report Links}' in the IGC UI.
     */
    protected ArrayList<String> report_links;
    ...
    /**
     * The {@code report_on_object} property, displayed as '{@literal Report On Object}' in the IGC UI.
     * <br><br>
    ...
    /** @see #report_links */ @JsonProperty("report_links")  public ArrayList<String> getReportLinks() { return this.report_links; }
    /** @see #report_links */ @JsonProperty("report_links")  public void setReportLinks(ArrayList<String> report_links) { this.report_links = report_links; }
    ...
    public static Boolean isInformationServerReportMappingSpecification(Object obj) { return (obj.getClass() == InformationServerReportMappingSpecification.class); }
