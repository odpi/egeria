...
/**
 * POJO for the {@code column_analysis} asset type in IGC, displayed as '{@literal Column Analysis}' in the IGC UI.
 * <br><br>
...
public class ColumnAnalysis extends Reference {
    ...
    /**
     * The {@code database_column} property, displayed as '{@literal Database Column}' in the IGC UI.
     * <br><br>
     * Will be a single {@link Reference} to a {@link DatabaseColumn} object.
     */
    protected Reference database_column;
    ...
    /**
     * The {@code quality_score} property, displayed as '{@literal Quality Score}' in the IGC UI.
     */
    protected Number quality_score;

    /**
     * The {@code nb_records_tested} property, displayed as '{@literal Number of Record Tested}' in the IGC UI.
     */
    ...
    /** @see #database_column */ @JsonProperty("database_column")  public Reference getDatabaseColumn() { return this.database_column; }
    /** @see #database_column */ @JsonProperty("database_column")  public void setDatabaseColumn(Reference database_column) { this.database_column = database_column; }
    ...
    /** @see #quality_score */ @JsonProperty("quality_score")  public Number getQualityScore() { return this.quality_score; }
    /** @see #quality_score */ @JsonProperty("quality_score")  public void setQualityScore(Number quality_score) { this.quality_score = quality_score; }
    ...
    public static Boolean isColumnAnalysis(Object obj) { return (obj.getClass() == ColumnAnalysis.class); }
