...
/**
 * POJO for the 'exception_filter_operation' asset type in IGC, displayed as 'Exception Filter Operation' in the IGC UI.
 * <br><br>
...
public class ExceptionFilterOperation extends Reference {
    ...
    public static String getIgcTypeId() { return "exception_filter_operation"; }
    public static String getIgcTypeDisplayName() { return "Exception Filter Operation"; }
    ...
    public static Boolean isExceptionFilterOperation(Object obj) { return (obj.getClass() == ExceptionFilterOperation.class); }
