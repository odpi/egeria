...
/**
 * POJO for the 'physical_object_attribute' asset type in IGC, displayed as 'Physical Object Attribute' in the IGC UI.
 * <br><br>
...
public class PhysicalObjectAttribute extends Reference {

    public static String getIgcTypeId() { return "physical_object_attribute"; }
    public static String getIgcTypeDisplayName() { return "Physical Object Attribute"; }
     ...
     * <br><br>
     * Will be a single {@link Reference} to a {@link PhysicalObject} object.
     */
    protected Reference physical_object;

    /**
     * The 'physical_object_for_query' property, displayed as 'Physical Object' in the IGC UI.
     * <br><br>
     * Will be a single {@link Reference} to a {@link PhysicalObject} object.
     */
    protected Reference physical_object_for_query;
    ...
    /**
     * The 'maps_database_fields' property, displayed as 'Maps Database Fields' in the IGC UI.
     * <br><br>
     * Will be a single {@link Reference} to a {@link DatabaseColumn} object.
     */
    protected Reference maps_database_fields;
    ...
    /** @see #physical_object */ @JsonProperty("physical_object")  public Reference getPhysicalObject() { return this.physical_object; }
    /** @see #physical_object */ @JsonProperty("physical_object")  public void setPhysicalObject(Reference physical_object) { this.physical_object = physical_object; }

    /** @see #physical_object_for_query */ @JsonProperty("physical_object_for_query")  public Reference getPhysicalObjectForQuery() { return this.physical_object_for_query; }
    /** @see #physical_object_for_query */ @JsonProperty("physical_object_for_query")  public void setPhysicalObjectForQuery(Reference physical_object_for_query) { this.physical_object_for_query = physical_object_for_query; }
    ...
    /** @see #maps_database_fields */ @JsonProperty("maps_database_fields")  public Reference getMapsDatabaseFields() { return this.maps_database_fields; }
    /** @see #maps_database_fields */ @JsonProperty("maps_database_fields")  public void setMapsDatabaseFields(Reference maps_database_fields) { this.maps_database_fields = maps_database_fields; }
    ...
    public static final Boolean isPhysicalObjectAttribute(Object obj) { return (obj.getClass() == PhysicalObjectAttribute.class); }
