...
/**
 * POJO for the 'mdm_model' asset type in IGC, displayed as 'MDM Model' in the IGC UI.
 * <br><br>
...
public class MdmModel extends Reference {

    public static String getIgcTypeId() { return "mdm_model"; }
    public static String getIgcTypeDisplayName() { return "MDM Model"; }
    ...
    /**
     * The 'contains_member_types' property, displayed as 'Contains Member Types' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link MemberType} objects.
     */
    protected ReferenceList contains_member_types;

    /**
     * The 'contains_attributes_types' property, displayed as 'Contains Attributes Types' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link AttributeType} objects.
     */
    protected ReferenceList contains_attributes_types;
    ...
    /** @see #contains_member_types */ @JsonProperty("contains_member_types")  public ReferenceList getContainsMemberTypes() { return this.contains_member_types; }
    /** @see #contains_member_types */ @JsonProperty("contains_member_types")  public void setContainsMemberTypes(ReferenceList contains_member_types) { this.contains_member_types = contains_member_types; }

    /** @see #contains_attributes_types */ @JsonProperty("contains_attributes_types")  public ReferenceList getContainsAttributesTypes() { return this.contains_attributes_types; }
    /** @see #contains_attributes_types */ @JsonProperty("contains_attributes_types")  public void setContainsAttributesTypes(ReferenceList contains_attributes_types) { this.contains_attributes_types = contains_attributes_types; }
    ...
    private static final List<String> PAGED_RELATIONAL_PROPERTIES = Arrays.asList(
        ...
        "contains_member_types",
        "contains_attributes_types",
        "read_by_(static)",
        "written_by_(static)",
        "read_by_(design)",
        "written_by_(design)",
    ...
    public static Boolean isMdmModel(Object obj) { return (obj.getClass() == MdmModel.class); }
