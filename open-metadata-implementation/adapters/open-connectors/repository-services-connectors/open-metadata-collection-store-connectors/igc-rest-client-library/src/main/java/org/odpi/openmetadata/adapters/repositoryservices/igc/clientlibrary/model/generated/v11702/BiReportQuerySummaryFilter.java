...
/**
 * POJO for the 'bi_report_query_summary_filter' asset type in IGC, displayed as 'Summary Filter' in the IGC UI.
 * <br><br>
...
public class BiReportQuerySummaryFilter extends Reference {

    public static String getIgcTypeId() { return "bi_report_query_summary_filter"; }
    public static String getIgcTypeDisplayName() { return "Summary Filter"; }
