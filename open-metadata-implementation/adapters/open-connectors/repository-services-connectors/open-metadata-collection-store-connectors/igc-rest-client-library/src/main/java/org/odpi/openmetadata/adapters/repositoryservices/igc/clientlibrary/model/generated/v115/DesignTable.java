...
/**
 * POJO for the 'design_table' asset type in IGC, displayed as 'Design Table' in the IGC UI.
 * <br><br>
...
public class DesignTable extends Reference {
    ...
    public static String getIgcTypeId() { return "design_table"; }
    ...
    /**
     * The 'design_foreign_keys' property, displayed as 'Parent Design Foreign Keys' in the IGC UI.
     * <br><br>
    ...
    public static final ArrayList<String> PAGED_RELATIONAL_PROPERTIES = new ArrayList<String>() {{
        ...
        add("implemented_by_data_file_elements");
        add("implemented_by_database_tables_views");
        add("design_columns");
        add("design_keys");
        add("design_foreign_keys");
        add("referenced_by_design_foreign_keys");
    ...
    public static final Boolean isDesignTable(Object obj) { return (obj.getClass() == DesignTable.class); }
