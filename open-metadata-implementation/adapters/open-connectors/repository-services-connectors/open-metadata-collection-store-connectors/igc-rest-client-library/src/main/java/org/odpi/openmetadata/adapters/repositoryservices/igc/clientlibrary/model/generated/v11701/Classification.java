...
public class Classification extends Reference {
    ...
    /** @see #value_frequency */ @JsonProperty("value_frequency")  public Number getValueFrequency() { return this.value_frequency; }
    /** @see #value_frequency */ @JsonProperty("value_frequency")  public void setValueFrequency(Number value_frequency) { this.value_frequency = value_frequency; }
