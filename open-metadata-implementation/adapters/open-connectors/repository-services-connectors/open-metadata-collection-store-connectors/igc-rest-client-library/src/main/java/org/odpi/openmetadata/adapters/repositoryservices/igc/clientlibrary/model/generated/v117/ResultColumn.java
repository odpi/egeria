...
/**
 * POJO for the 'result_column' asset type in IGC, displayed as 'Result Column' in the IGC UI.
 * <br><br>
...
public class ResultColumn extends Reference {

    public static String getIgcTypeId() { return "result_column"; }
    public static String getIgcTypeDisplayName() { return "Result Column"; }
    ...
    /**
     * The 'stored_procedure_definition' property, displayed as 'Stored Procedure Definition' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link StoredProcedureDefinition} objects.
     */
    protected ReferenceList stored_procedure_definition;
    ...
    /** @see #stored_procedure_definition */ @JsonProperty("stored_procedure_definition")  public ReferenceList getStoredProcedureDefinition() { return this.stored_procedure_definition; }
    /** @see #stored_procedure_definition */ @JsonProperty("stored_procedure_definition")  public void setStoredProcedureDefinition(ReferenceList stored_procedure_definition) { this.stored_procedure_definition = stored_procedure_definition; }
    ...
    public static final ArrayList<String> PAGED_RELATIONAL_PROPERTIES = new ArrayList<String>() {{
        add("stored_procedure_definition");
        add("labels");
        add("stewards");
    ...
    public static final Boolean isResultColumn(Object obj) { return (obj.getClass() == ResultColumn.class); }
