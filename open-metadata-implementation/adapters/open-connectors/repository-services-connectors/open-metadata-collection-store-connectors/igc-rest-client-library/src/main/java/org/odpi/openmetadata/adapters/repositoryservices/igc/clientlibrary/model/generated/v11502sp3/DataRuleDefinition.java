...
public class DataRuleDefinition extends Reference {
    ...
    /**
     * The {@code non_published_data_rule_definitions} property, displayed as '{@literal Non Published Data Rule Definitions}' in the IGC UI.
     * <br><br>
    ...
    /**
     * The {@code published_data_rule_definitions} property, displayed as '{@literal Published Data Rule Definitions}' in the IGC UI.
     * <br><br>
    ...
    private static final List<String> ALL_PROPERTIES = Arrays.asList(
        ...
        "modified_by",
        "modified_on",
        "non_published_data_rule_definitions",
        "published_data_rule_definitions"
    );
    public static List<String> getNonRelationshipProperties() { return NON_RELATIONAL_PROPERTIES; }
    public static List<String> getStringProperties() { return STRING_PROPERTIES; }
    public static List<String> getPagedRelationshipProperties() { return PAGED_RELATIONAL_PROPERTIES; }
    public static List<String> getAllProperties() { return ALL_PROPERTIES; }
    public static Boolean isDataRuleDefinition(Object obj) { return (obj.getClass() == DataRuleDefinition.class); }
