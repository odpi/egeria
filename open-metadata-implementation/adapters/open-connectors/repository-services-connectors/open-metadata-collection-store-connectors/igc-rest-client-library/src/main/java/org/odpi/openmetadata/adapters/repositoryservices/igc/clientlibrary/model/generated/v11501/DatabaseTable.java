...
public class DatabaseTable extends Reference {
    ...
    /**
     * The 'same_as_database_tables' property, displayed as 'Same as Database Tables' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link DatabaseTable} objects.
     */
    protected ReferenceList same_as_database_tables;
    ...
    /** @see #same_as_database_tables */ @JsonProperty("same_as_database_tables")  public ReferenceList getSameAsDatabaseTables() { return this.same_as_database_tables; }
    /** @see #same_as_database_tables */ @JsonProperty("same_as_database_tables")  public void setSameAsDatabaseTables(ReferenceList same_as_database_tables) { this.same_as_database_tables = same_as_database_tables; }
