...
public class XsdSimpleType extends Reference {
    ...
    /**
     * The 'restriction_minimum_inclusive_string' property, displayed as 'Minimum Range Inclusive' in the IGC UI.
     */
    protected ArrayList<String> restriction_minimum_inclusive_string;
    ...
    /**
     * The 'restriction_maximum_inclusive_string' property, displayed as 'Maximum Range Inclusive' in the IGC UI.
     */
    protected ArrayList<String> restriction_maximum_inclusive_string;
    ...
    /** @see #restriction_minimum_inclusive_string */ @JsonProperty("restriction_minimum_inclusive_string")  public ArrayList<String> getRestrictionMinimumInclusiveString() { return this.restriction_minimum_inclusive_string; }
    /** @see #restriction_minimum_inclusive_string */ @JsonProperty("restriction_minimum_inclusive_string")  public void setRestrictionMinimumInclusiveString(ArrayList<String> restriction_minimum_inclusive_string) { this.restriction_minimum_inclusive_string = restriction_minimum_inclusive_string; }
    ...
    /** @see #restriction_maximum_inclusive_string */ @JsonProperty("restriction_maximum_inclusive_string")  public ArrayList<String> getRestrictionMaximumInclusiveString() { return this.restriction_maximum_inclusive_string; }
    /** @see #restriction_maximum_inclusive_string */ @JsonProperty("restriction_maximum_inclusive_string")  public void setRestrictionMaximumInclusiveString(ArrayList<String> restriction_maximum_inclusive_string) { this.restriction_maximum_inclusive_string = restriction_maximum_inclusive_string; }
    ...
    private static final List<String> NON_RELATIONAL_PROPERTIES = Arrays.asList(
        ...
        "restriction_minimum_inclusive_string",
        "restriction_maximum_value",
        "restriction_maximum_inclusive_string",
