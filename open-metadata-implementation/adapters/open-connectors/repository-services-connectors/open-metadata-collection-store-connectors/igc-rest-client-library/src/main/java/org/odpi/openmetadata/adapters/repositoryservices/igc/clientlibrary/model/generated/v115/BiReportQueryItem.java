...
/**
 * POJO for the 'bi_report_query_item' asset type in IGC, displayed as 'BI Report Query Item' in the IGC UI.
 * <br><br>
...
public class BiReportQueryItem extends MainObject {

    public static final String IGC_TYPE_ID = "bi_report_query_item";
    ...
    public static final Boolean isBiReportQueryItem(Object obj) { return (obj.getClass() == BiReportQueryItem.class); }
