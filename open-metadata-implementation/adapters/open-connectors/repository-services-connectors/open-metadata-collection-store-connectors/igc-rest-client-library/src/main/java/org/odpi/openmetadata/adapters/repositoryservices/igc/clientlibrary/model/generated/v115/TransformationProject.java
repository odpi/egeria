...
public class TransformationProject extends Reference {
    ...
    public static String getIgcTypeId() { return "transformation_project"; }
    ...
    /**
     * The 'machine_profiles' property, displayed as 'Machine Profiles' in the IGC UI.
     * <br><br>
     * Will be a {@link ReferenceList} of {@link MachineProfile} objects.
     */
    protected ReferenceList machine_profiles;
    ...
    /** @see #machine_profiles */ @JsonProperty("machine_profiles")  public ReferenceList getMachineProfiles() { return this.machine_profiles; }
    /** @see #machine_profiles */ @JsonProperty("machine_profiles")  public void setMachineProfiles(ReferenceList machine_profiles) { this.machine_profiles = machine_profiles; }
    ...
    public static final ArrayList<String> PAGED_RELATIONAL_PROPERTIES = new ArrayList<String>() {{
        ...
        add("standardization_rule_sets");
        add("match_specifications");
        add("parameter_sets");
        add("transforms");
        add("routines");
        add("machine_profiles");
        add("in_collections");
    }};
