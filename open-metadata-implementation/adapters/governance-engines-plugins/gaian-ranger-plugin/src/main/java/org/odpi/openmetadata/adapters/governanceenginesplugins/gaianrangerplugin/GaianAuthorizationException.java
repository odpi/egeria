...
public class GaianAuthorizationException extends Exception {
    ...
    public GaianAuthorizationException(String message) {
        super(message);
    }
    ...
    public GaianAuthorizationException(String message, Throwable exception, boolean enableSuppression, boolean writableStackTrace) {
