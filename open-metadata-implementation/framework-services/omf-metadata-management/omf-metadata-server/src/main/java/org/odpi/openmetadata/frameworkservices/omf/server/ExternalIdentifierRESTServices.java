...
{
    private static final OMFMetadataManagementInstanceHandler instanceHandler = new OMFMetadataManagementInstanceHandler();
        ...
        try
        {
            ...
            if ((requestBody != null) && (requestBody.getMetadataCorrelationProperties() != null))
            {
                ...
                handler.setUpExternalIdentifier(userId,
                                                ...
                                                requestBody.getMetadataCorrelationProperties().getExternalInstanceTypeName(),
