...
public class StewardshipManagementHandler
{
...

    {
        ...
        invalidParameterHandler.validateGUID(stakeholderGUID, elementGUIDParameterName, methodName);
...

    {
        ...
        invalidParameterHandler.validateGUID(scopeGUID, elementGUIDParameterName, methodName);
