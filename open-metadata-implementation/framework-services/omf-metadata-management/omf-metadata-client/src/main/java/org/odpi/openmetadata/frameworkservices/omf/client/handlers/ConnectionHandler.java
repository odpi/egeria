...
import org.odpi.openmetadata.frameworks.openmetadata.converters.ConnectionConverter;
...
public class ConnectionHandler
{
                                                                                      ...
                                                                                      UserNotAuthorizedException
    {
        ...
        invalidParameterHandler.validateUserId(userId, methodName);
        invalidParameterHandler.validateGUID(connectionGUID, end1GUIDParameterName, methodName);
     ...
     * @param cascadedDelete         can the connection be deleted if it has nested components linked to it?
     * @param forLineage             the query is to support lineage retrieval
     * @param forDuplicateProcessing the query is for duplicate processing and so must not deduplicate
     * @param effectiveTime          the time that the retrieved elements must be effective for (null for any time, new Date() for now)
     * @throws InvalidParameterException  one of the parameters is null or invalid.
                                                                                                      ...
                                                                                                      UserNotAuthorizedException
    {
        ...
        return convertConnections(userId,
                                                                                   ...
                                                                                   UserNotAuthorizedException
    {
        ...
        {
            return convertConnection(userId,
                                       openMetadataElement,
                                       asOfTime,
                                       forLineage,
                                       forDuplicateProcessing,
    ...
    /**
     * Return the properties of a specific connection retrieved using an associated userId.
     *
     * @param userId                 userId of user making request
     ...
     * @throws UserNotAuthorizedException the requesting user is not authorized to issue this request.
     */
    public ConnectionElement getConnectionByUserId(String  userId,
                                                       ...
                                                       Date    effectiveTime) throws InvalidParameterException,
                                                                                   ...
                                                                                   UserNotAuthorizedException
    {
        final String methodName        = "getConnectionByUserId";
    ...
    /**
     * Convert the open metadata elements retrieve into connection elements.
     *
     * @param userId                 calling user
     ...
     * @return list of connections (or null)
     * @throws PropertyServerException problem with the conversion process
     */
    private List<ConnectionElement> convertConnections(String                    userId,
                                                           ...
                                                           String                    methodName) throws PropertyServerException
    {
        ...
        {
            List<ConnectionElement> connectionElements = new ArrayList<>();

            for (OpenMetadataElement openMetadataElement : openMetadataElements)
            {
                if (openMetadataElement != null)
                {
                    ConnectionElement connectionElement = convertConnection(userId,
                                                                                  openMetadataElement,
                                                                                  asOfTime,
                                                                                  forLineage,
                                                                                  forDuplicateProcessing,
    ...
    /**
     * Return the connection extracted from the open metadata element plus linked solution components.
     * Only convert the roles that either inherit from SolutionConnection or are linked to solution components.
     *
     * @param userId                 calling user
     ...
     * @throws PropertyServerException problem with the conversion process
     */
    private ConnectionElement convertConnection(String              userId,
                                                    ...
                                                    String              methodName) throws PropertyServerException
    {
        try
        {
            ...
            ConnectionConverter<ConnectionElement> converter = new ConnectionConverter<>(propertyHelper, serviceName, serverName);
            ConnectionElement connectionElement = converter.getNewComplexBean(ConnectionElement.class,
                                                                                  openMetadataElement,
     ...
     */
    private ElementProperties getElementProperties(ConnectionProperties properties)
    {
        if (properties != null)
        {
            ...
            elementProperties = propertyHelper.addStringProperty(elementProperties,
                                                                 ...
                                                                 properties.getEncryptedPassword());

            elementProperties = propertyHelper.addStringProperty(elementProperties,
                                                                 OpenMetadataProperty.CLEAR_PASSWORD.name,
                                                                 properties.getClearPassword());
