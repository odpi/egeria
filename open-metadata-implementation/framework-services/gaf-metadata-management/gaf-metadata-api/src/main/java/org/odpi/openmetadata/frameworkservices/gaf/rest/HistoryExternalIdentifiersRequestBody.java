...
public class HistoryExternalIdentifiersRequestBody extends EffectiveTimeQueryRequestBody
{
     ...
     * Default constructor
     */
    public HistoryExternalIdentifiersRequestBody()
    {
        super();
    }
     ...
     */
    public HistoryExternalIdentifiersRequestBody(HistoryExternalIdentifiersRequestBody template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        HistoryExternalIdentifiersRequestBody that = (HistoryExternalIdentifiersRequestBody) objectToCompare;
