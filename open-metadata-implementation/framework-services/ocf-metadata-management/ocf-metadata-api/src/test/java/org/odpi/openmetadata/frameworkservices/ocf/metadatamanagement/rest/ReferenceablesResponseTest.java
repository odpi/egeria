...
/**
 * Validate that the ReferenceablesResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class ReferenceablesResponseTest
{
    private Map<String, Object> exceptionProperties = new HashMap<>();
    private List<Referenceable> responseList        = new ArrayList<>();
    private Referenceable       responseObject      = new Referenceable();


    /**
     * Default constructor
     */
    public ReferenceablesResponseTest()
    {
     ...
     */
    private ReferenceablesResponse getTestObject()
    {
        ReferenceablesResponse testObject = new ReferenceablesResponse();
        ...
        testObject.setReferenceables(responseList);
     ...
     */
    private void validateResultObject(ReferenceablesResponse  resultObject)
    {
        ...
        assertTrue(resultObject.getReferenceables().equals(responseList));
    ...
    {
        ReferenceablesResponse    nullObject = new ReferenceablesResponse();
        ...
        assertTrue(nullObject.getReferenceables() == null);

        nullObject = new ReferenceablesResponse(null);
        ...
        nullObject.setReferenceables(new ArrayList<>());
    ...
    @Test public void testExceptionProperties()
    {
        ...
        propertyMap = null;
        testObject = new ReferenceablesResponse();
    ...
    @Test public void testEquals()
    {
        ...
        ReferenceablesResponse  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        ReferenceablesResponse  differentObject = getTestObject();
    ...
    {
        validateResultObject(new ReferenceablesResponse(getTestObject()));
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, ReferenceablesResponse.class));
        }
        catch (Exception  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((ReferenceablesResponse) objectMapper.readValue(jsonString, OCFOMASAPIResponse.class));
        }
        catch (Exception  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(getTestObject().toString().contains("ReferenceablesResponse"));
    }
}
