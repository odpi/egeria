...
/**
 * Validate that the NotesResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class NotesResponseTest
{
    private Map<String, Object> exceptionProperties = new HashMap<>();
    private List<Note>          responseList        = new ArrayList<>();
    private Note                responseObject      = new Note();


    /**
     * Default constructor
     */
    public NotesResponseTest()
    {
     ...
     */
    private NotesResponse getTestObject()
    {
        NotesResponse testObject = new NotesResponse();
     ...
     */
    private void validateResultObject(NotesResponse  resultObject)
    {
    ...
    {
        NotesResponse    nullObject = new NotesResponse();
        ...
        nullObject = new NotesResponse(null);
    ...
    @Test public void testEquals()
    {
        ...
        NotesResponse  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        NotesResponse  differentObject = getTestObject();
    ...
    {
        validateResultObject(new NotesResponse(getTestObject()));
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, NotesResponse.class));
        }
        catch (Exception  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((NotesResponse) objectMapper.readValue(jsonString, OCFOMASAPIResponse.class));
        }
        catch (Exception  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(getTestObject().toString().contains("NotesResponse"));
    }
}
