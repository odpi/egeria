...
/**
 * Validate that the ValidValuesResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class ValidValuesResponseTest
{
    private Map<String, Object> exceptionProperties = new HashMap<>();
    private List<ValidValue>    responseList        = new ArrayList<>();
    private ValidValue          responseObject      = new ValidValue();


    /**
     * Default constructor
     */
    public ValidValuesResponseTest()
    {
     ...
     */
    private ValidValuesResponse getTestObject()
    {
        ValidValuesResponse testObject = new ValidValuesResponse();
        ...
        testObject.setValidValues(responseList);
     ...
     */
    private void validateResultObject(ValidValuesResponse  resultObject)
    {
        ...
        assertTrue(resultObject.getValidValues().equals(responseList));
    ...
    {
        ValidValuesResponse    nullObject = new ValidValuesResponse();
        ...
        assertTrue(nullObject.getValidValues() == null);

        nullObject = new ValidValuesResponse(null);
        ...
        nullObject.setValidValues(new ArrayList<>());
    ...
    @Test public void testExceptionProperties()
    {
        ...
        propertyMap = null;
        testObject = new ValidValuesResponse();
    ...
    @Test public void testEquals()
    {
        ...
        ValidValuesResponse  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        ValidValuesResponse  differentObject = getTestObject();
    ...
    {
        validateResultObject(new ValidValuesResponse(getTestObject()));
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, ValidValuesResponse.class));
        }
        catch (Exception  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((ValidValuesResponse) objectMapper.readValue(jsonString, OCFOMASAPIResponse.class));
        }
        catch (Exception  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(getTestObject().toString().contains("ValidValuesResponse"));
    }
}
