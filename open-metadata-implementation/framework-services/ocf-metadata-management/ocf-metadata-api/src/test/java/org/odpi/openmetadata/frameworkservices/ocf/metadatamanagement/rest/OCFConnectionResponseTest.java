...
/**
 * Validate that the OCFConnectionResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class OCFConnectionResponseTest
{
     ...
     * Default constructor
     */
    public OCFConnectionResponseTest()
    {
