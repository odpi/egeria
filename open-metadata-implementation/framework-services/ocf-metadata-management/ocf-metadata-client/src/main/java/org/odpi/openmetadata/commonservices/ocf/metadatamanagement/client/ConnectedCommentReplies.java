 ...
 */
public class ConnectedCommentReplies extends CommentReplies
{
     ...
     */
    private ConnectedCommentReplies(ConnectedCommentReplies template)
    {
        super(template);
     ...
     */
    @Override
    protected CommentReplies cloneIterator()
    {
        return new ConnectedCommentReplies(this);
    }
    ...
    {
        final String   methodName = "CommentReplies.getCachedList";
