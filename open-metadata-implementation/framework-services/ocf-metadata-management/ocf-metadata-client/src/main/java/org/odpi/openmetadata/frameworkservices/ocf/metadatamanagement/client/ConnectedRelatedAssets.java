...
import org.odpi.openmetadata.frameworkservices.ocf.metadatamanagement.rest.RelatedAssetsResponse;
 ...
 */
public class ConnectedRelatedAssets extends RelatedAssets
{
     ...
     */
    private ConnectedRelatedAssets(ConnectedRelatedAssets template)
    {
        super(template);
    ...
    {
        return new ConnectedRelatedAssets(this);
    }
                                               ...
                                               int  maximumSize) throws PropertyServerException
    {
        ...
        final String   urlTemplate = "/servers/{0}/open-metadata/framework-services/{1}/connected-asset/users/{2}/assets/{3}/related-assets?elementStart={4}&maxElements={5}";
