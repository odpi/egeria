...
public class ConnectedRelatedMediaReferences extends RelatedMediaReferences
{
                                               ...
                                               int  maximumSize) throws PropertyServerException
    {
        ...
        final String   urlTemplate = "/servers/{0}/open-metadata/framework-services/{1}/connected-asset/users/{2}/assets/{3}/related-media-references?elementStart={4}&maxElements={5}";
