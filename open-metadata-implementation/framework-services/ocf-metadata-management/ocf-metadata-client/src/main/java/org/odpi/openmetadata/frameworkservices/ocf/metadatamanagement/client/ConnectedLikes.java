...
import org.odpi.openmetadata.frameworkservices.ocf.metadatamanagement.rest.LikesResponse;
...
public class ConnectedLikes extends Likes
{
                                               ...
                                               int  maximumSize) throws PropertyServerException
    {
        ...
        final String   urlTemplate = "/servers/{0}/open-metadata/framework-services/{1}/connected-asset/users/{2}/assets/{3}/likes?elementStart={4}&maxElements={5}";
