...
/**
 * ConnectedLocations provides the open metadata concrete implementation of the
 * Open Connector Framework (OCF) Locations abstract class.
 ...
 */
public class ConnectedLocations extends Locations
{
     ...
     */
    private ConnectedLocations(ConnectedLocations template)
    {
        super(template);
     ...
     */
    @Override
    protected Locations cloneIterator()
    {
        return new ConnectedLocations(this);
    }
    ...
    {
        final String   methodName = "Locations.getCachedList";
        final String   urlTemplate = "/servers/{0}/open-metadata/framework-services/{1}/connected-asset/users/{2}/assets/{3}/known-locations?elementStart={4}&maxElements={5}";
