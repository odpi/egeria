...
import org.odpi.openmetadata.frameworkservices.ocf.metadatamanagement.rest.LicensesResponse;
 ...
 */
public class ConnectedLicenses extends Licenses
{
     ...
     */
    ConnectedLicenses(String                 serviceName,
                      String                 serverName,
                      String                 userId,
     ...
     */
    private ConnectedLicenses(ConnectedLicenses template)
    {
        super(template);
    ...
    {
        return new ConnectedLicenses(this);
    }
