 ...
 */
public class ConnectedExternalIdentifiers extends ExternalIdentifiers
{
    ...
    {
        final String   methodName = "ExternalIdentifiers.getCachedList";
        final String   urlTemplate = "/servers/{0}/open-metadata/framework-services/{1}/connected-asset/users/{2}/assets/{3}/external-identifiers?elementStart={4}&maxElements={5}";
