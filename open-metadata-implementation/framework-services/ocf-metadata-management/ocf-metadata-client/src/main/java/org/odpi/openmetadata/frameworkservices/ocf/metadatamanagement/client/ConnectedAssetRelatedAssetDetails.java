...
/**
 * RelatedAssetDetails is associated a related asset for a connector's EgeriaConnectedAssetDetails.  Connectors provide access to
 * assets.   EgeriaConnectedAssetDetails returns properties (metadata) about the connector's asset.  RelatedAssetDetails
 ...
 * </ul>
 * RelatedAssetDetails is a base class for the connector's metadata API that returns null,
 ...
 */
public class ConnectedAssetRelatedAssetDetails extends RelatedAssetDetails
{
     ...
     */
    public ConnectedAssetRelatedAssetDetails(RelatedAsset         bean,
                                             String               serviceName,
                                             String               serverName,
                                             String               userId,
    ...
    public void refresh() throws PropertyServerException, UserNotAuthorizedException
    {
        ...
        final  String  serviceName = "ConnectedAssetRelatedAssetDetails";
    ...
    {
        return "ConnectedAssetRelatedAssetDetails{" +
                "userId='" + userId + '\'' +
