...
/**
 * ConnectedExternalReferences provides the open metadata concrete implementation of the
 * Open Connector Framework (OCF) ExternalReferences abstract class.
 ...
 */
public class ConnectedExternalReferences extends ExternalReferences
{
     ...
     */
    ConnectedExternalReferences(String                 serviceName,
                                String                 serverName,
                                String                 userId,
    ...
    {
        final String   methodName = "ExternalReferences.getCachedList";
        final String   urlTemplate = "/servers/{0}/open-metadata/framework-services/{1}/connected-asset/users/{2}/assets/{3}/external-references?elementStart={4}&maxElements={5}";
