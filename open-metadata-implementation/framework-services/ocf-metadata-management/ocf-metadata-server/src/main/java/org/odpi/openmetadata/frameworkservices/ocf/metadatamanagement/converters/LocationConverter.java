...
/**
 * LocationConverter transfers the relevant properties from an Open Metadata Repository Services (OMRS)
 * EntityDetail object into a Referenceable bean.
 */
public class LocationConverter<B> extends OCFConverter<B>
{
    /**
     * Constructor
     *
                        ...
                        String       methodName) throws PropertyServerException
    {
        try
        {
            ...
            if (returnBean instanceof Location)
            {
                Location bean = (Location) returnBean;

                /*
                 * Check that the entity is of the correct type.
                 */
                this.setUpElementHeader(bean, entity, OpenMetadataAPIMapper.LOCATION_TYPE_NAME, methodName);
