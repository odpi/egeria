...
/**
 * SearchKeywordConverter transfers the relevant properties from an Open Metadata Repository Services (OMRS)
 * EntityDetail object into a Referenceable bean.
 */
public class SearchKeywordConverter<B> extends OCFConverter<B>
{
    /**
     * Constructor
     *
     ...
     */
    public SearchKeywordConverter(OMRSRepositoryHelper repositoryHelper,
                                  String               serviceName,
                                  String               serverName)
    {
                        ...
                        String       methodName) throws PropertyServerException
    {
        try
        {
            ...
            if (returnBean instanceof SearchKeyword)
            {
                SearchKeyword bean = (SearchKeyword) returnBean;

                /*
                 * Check that the entity is of the correct type.
                 */
                this.setUpElementHeader(bean, entity, OpenMetadataAPIMapper.SEARCH_KEYWORD_TYPE_NAME, methodName);
