 ...
 */
public class ExternalReferenceConverter<B> extends OMFConverter<B>
{
    /**
     * Constructor
     *
                        ...
                        String       methodName) throws PropertyServerException
    {
        try
        {
            ...
            if (returnBean instanceof ExternalReference bean)
            {
                 ...
                 */
                this.setUpElementHeader(bean, entity, OpenMetadataType.EXTERNAL_REFERENCE.typeName, methodName);
