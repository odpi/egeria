...
package org.odpi.openmetadata.integrationservices.catalog.client;
 ...
 */
public class CatalogIntegrator implements CatalogIntegratorAPI
{
     ...
     * REST API calls.
     */
    public CatalogIntegrator(String   serverName,
                                                                                       ...
                                                                                       PropertyServerException
    {
        ...
        final String   urlTemplate = "/servers/{0}/open-metadata/integration-services/catalog-integrator/users/{1}/validate-connector";
