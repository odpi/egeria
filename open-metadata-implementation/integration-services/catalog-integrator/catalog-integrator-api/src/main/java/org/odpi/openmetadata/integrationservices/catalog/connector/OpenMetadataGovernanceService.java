...
public class OpenMetadataGovernanceService
{
    ...
    public String registerContextEvent(String                                       anchorGUID,
                                       ...
                                       ContextEventProperties contextEventProperties) throws InvalidParameterException,
                                                                                             ...
                                                                                             PropertyServerException
    {
        return openMetadataStoreClient.registerContextEvent(userId, anchorGUID, parentContextEvents, childContextEvents, relatedContextEvents, impactedElements, effectedDataResourceGUIDs, contextEventEvidenceGUIDs, contextEventProperties);
    }
