...
/**
 * ConnectionExchangeService is the context for managing connections and associated elements such as connector types and
 * endpoints.
 */
public class ConnectionExchangeService
{
     ...
     * @param connectionExternalIdentifier unique identifier of the connection in the external external source
     * @param connectionExternalIdentifierName name of property for the external identifier in the external external source
     * @param connectionExternalIdentifierUsage optional usage description for the external identifier when calling the external external source
     * @param connectionExternalIdentifierKeyPattern  pattern for the external identifier within the external external source (default is LOCAL_KEY)
     * @param mappingProperties additional properties to help with the mapping of the elements in the external external source and open metadata
    ...
    /**
     * Remove the metadata element representing an connection.  This will delete the connection and all anchored
                                                                             ...
                                                                             PropertyServerException
    {
        ...
        if (synchronizationDirection != SynchronizationDirection.TO_THIRD_PARTY)
        {
            connectionExchangeClient.removeConnection(userId, externalSourceGUID, externalSourceName, connectionGUID, connectionExternalIdentifier);
        }
        else
        {
            throw new UserNotAuthorizedException(CatalogIntegratorErrorCode.NOT_PERMITTED_SYNCHRONIZATION.getMessageDefinition(
    ...
    public List<ConnectionElement> findConnections(String searchString,
                                                   ...
                                                   int    pageSize) throws InvalidParameterException,
                                                                           ...
                                                                           PropertyServerException
    {
        return connectionExchangeClient.findConnections(userId, externalSourceGUID, externalSourceName, searchString, startFrom, pageSize);
    }
    ...
    public List<ConnectionElement> getConnectionsByName(String name,
                                                        ...
                                                        int    pageSize) throws InvalidParameterException,
                                                                                ...
                                                                                PropertyServerException
    {
        return connectionExchangeClient.getConnectionsByName(userId, externalSourceGUID, externalSourceName, name, startFrom, pageSize);
    }
    ...
    public List<ConnectionElement> getConnectionsForAssetManager(int startFrom,
                                                                 int pageSize) throws InvalidParameterException,
                                                                                      ...
                                                                                      PropertyServerException
    {
        return connectionExchangeClient.getConnectionsForAssetManager(userId, externalSourceGUID, externalSourceName, startFrom, pageSize);
    }
    ...
    public ConnectionElement getConnectionByGUID(String userId,
                                                 ...
                                                 String connectionGUID) throws InvalidParameterException,
                                                                               ...
                                                                               PropertyServerException
    {
        return connectionExchangeClient.getConnectionByGUID(userId, externalSourceGUID, externalSourceName, connectionGUID);
    }
     ...
     * @param endpointExternalIdentifier unique identifier of the endpoint in the external external source
     * @param endpointExternalIdentifierName name of property for the external identifier in the external external source
     * @param endpointExternalIdentifierUsage optional usage description for the external identifier when calling the external external source
     * @param endpointExternalIdentifierKeyPattern  pattern for the external identifier within the external external source (default is LOCAL_KEY)
     * @param mappingProperties additional properties to help with the mapping of the elements in the external external source and open metadata
                                                                         ...
                                                                         PropertyServerException
    {
        ...
        if (synchronizationDirection != SynchronizationDirection.TO_THIRD_PARTY)
        {
            connectionExchangeClient.removeEndpoint(userId, externalSourceGUID, externalSourceName, connectorTypeGUID, endpointExternalIdentifier);
        }
        else
        {
            throw new UserNotAuthorizedException(CatalogIntegratorErrorCode.NOT_PERMITTED_SYNCHRONIZATION.getMessageDefinition(
    ...
    public List<EndpointElement> findEndpoints(String searchString,
                                               ...
                                               int    pageSize) throws InvalidParameterException,
                                                                       ...
                                                                       PropertyServerException
    {
        return connectionExchangeClient.findEndpoints(userId, externalSourceGUID, externalSourceName, searchString, startFrom, pageSize);
    }
    ...
    public List<EndpointElement> getEndpointsByName(String name,
                                                    ...
                                                    int    pageSize) throws InvalidParameterException,
                                                                            ...
                                                                            PropertyServerException
    {
        return connectionExchangeClient.getEndpointsByName(userId, externalSourceGUID, externalSourceName, name, startFrom, pageSize);
    }
    ...
    public List<EndpointElement> getEndpointsForAssetManager(int startFrom,
                                                             int pageSize) throws InvalidParameterException,
                                                                                  ...
                                                                                  PropertyServerException
    {
        return connectionExchangeClient.getEndpointsForAssetManager(userId, externalSourceGUID, externalSourceName, startFrom, pageSize);
    }
    ...
    public EndpointElement getEndpointByGUID(String userId,
                                             ...
                                             String endpointGUID) throws InvalidParameterException,
                                                                         ...
                                                                         PropertyServerException
    {
        return connectionExchangeClient.getEndpointByGUID(userId, externalSourceGUID, externalSourceName, endpointGUID);
    }
     ...
     * @param connectorTypeExternalIdentifierName name of property for the external identifier in the external connectorType manager
     * @param connectorTypeExternalIdentifierUsage optional usage description for the external identifier when calling the external connectorType manager
     * @param connectorTypeExternalIdentifierKeyPattern  pattern for the external identifier within the external connectorType manager (default is LOCAL_KEY)
     * @param mappingProperties additional properties to help with the mapping of the elements in the external connectorType manager and open metadata
                                                                                   ...
                                                                                   PropertyServerException
    {
        ...
        if (synchronizationDirection != SynchronizationDirection.TO_THIRD_PARTY)
        {
            connectionExchangeClient.removeConnectorType(userId, externalSourceGUID, externalSourceName, connectorTypeGUID, connectorTypeExternalIdentifier);
        }
        else
        {
            throw new UserNotAuthorizedException(CatalogIntegratorErrorCode.NOT_PERMITTED_SYNCHRONIZATION.getMessageDefinition(
    ...
    public List<ConnectorTypeElement> findConnectorTypes(String searchString,
                                                         ...
                                                         int    pageSize) throws InvalidParameterException,
                                                                                 ...
                                                                                 PropertyServerException
    {
        return connectionExchangeClient.findConnectorTypes(userId, externalSourceGUID, externalSourceName, searchString, startFrom, pageSize);
    }
    ...
    public List<ConnectorTypeElement> getConnectorTypesByName(String name,
                                                              ...
                                                              int    pageSize) throws InvalidParameterException,
                                                                                      ...
                                                                                      PropertyServerException
    {
        return connectionExchangeClient.getConnectorTypesByName(userId, externalSourceGUID, externalSourceName, name, startFrom, pageSize);
    }
    ...
    public List<ConnectorTypeElement> getConnectorTypesForAssetManager(int startFrom,
                                                                       int pageSize) throws InvalidParameterException,
                                                                                            ...
                                                                                            PropertyServerException
    {
        return connectionExchangeClient.getConnectorTypesForAssetManager(userId, externalSourceGUID, externalSourceName, startFrom, pageSize);
    }
    ...
    public ConnectorTypeElement getConnectorTypeByGUID(String userId,
                                                       ...
                                                       String dataAssetGUID) throws InvalidParameterException,
                                                                                    ...
                                                                                    PropertyServerException
    {
        return connectionExchangeClient.getConnectorTypeByGUID(userId, externalSourceGUID, externalSourceName, dataAssetGUID);
    }
}
