...
package org.odpi.openmetadata.integrationservices.files.client;
 ...
 */
public class FilesIntegrator implements FilesIntegratorAPI
{
     ...
     * REST API calls.
     */
    public FilesIntegrator(String   serverName,
                                                                                       ...
                                                                                       PropertyServerException
    {
        ...
        final String   urlTemplate = "/servers/{0}/open-metadata/integration-services/files-integrator/users/{1}/validate-connector";
