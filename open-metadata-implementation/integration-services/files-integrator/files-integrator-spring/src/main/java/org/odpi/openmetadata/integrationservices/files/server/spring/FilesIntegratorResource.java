...
@Tag(name="Integration Daemon: Files Integrator OMIS", description="Supports the detection and creation of metadata for file systems and file servers.",
        externalDocs=@ExternalDocumentation(description="Further Information",
                url="https://egeria-project.org/services/omis/files-integrator/overview"))

public class FilesIntegratorResource
{
    private final FilesIntegratorRESTServices restAPI = new FilesIntegratorRESTServices();
