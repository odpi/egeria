...
@Tag(name="Integration Daemon: Database Integrator OMIS", description="Supports the detection and creation of metadata for database management systems (DBMSs).",
...
public class DatabaseIntegratorResource
{
     ...
     * be running in the integration daemon in order for this call to be successful.  The integration service only needs to be registered with the
     * integration daemon.
     *
