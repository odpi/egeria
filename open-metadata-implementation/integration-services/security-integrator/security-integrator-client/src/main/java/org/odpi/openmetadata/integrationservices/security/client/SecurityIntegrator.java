...
package org.odpi.openmetadata.integrationservices.security.client;
 ...
 */
public class SecurityIntegrator implements SecurityIntegratorAPI
{
     ...
     * REST API calls.
     */
    public SecurityIntegrator(String   serverName,
                                                                                       ...
                                                                                       PropertyServerException
    {
        ...
        final String   urlTemplate = "/servers/{0}/open-metadata/integration-services/security-integrator/users/{1}/validate-connector";
