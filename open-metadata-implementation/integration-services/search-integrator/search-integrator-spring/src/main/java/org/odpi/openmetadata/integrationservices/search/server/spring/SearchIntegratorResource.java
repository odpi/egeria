...
@Tag(name="Integration Daemon: Search Integrator OMIS", description="Supports the detection and creation of metadata for file systems and file servers.",
        externalDocs=@ExternalDocumentation(description="Further Information",
                url="https://egeria-project.org/services/omis/search-integrator/overview/"))

public class SearchIntegratorResource
{
    private final SearchIntegratorRESTServices restAPI = new SearchIntegratorRESTServices();
