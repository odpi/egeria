...
import org.odpi.openmetadata.integrationservices.search.connector.SearchIntegratorOMISConnector;
...
public class SearchIntegratorRESTServices
{
    ...
    private static final RESTCallLogger restCallLogger = new RESTCallLogger(LoggerFactory.getLogger(SearchIntegratorRESTServices.class),
    ...
    public SearchIntegratorRESTServices()
    {
        IntegrationServiceRegistry.registerIntegrationService(IntegrationServiceDescription.SEARCH_INTEGRATOR_OMIS,
                                                              ...
                                                              SearchIntegratorOMISConnector.class.getName());
    }
                                                     ...
                                                     String connectorProviderClassName)
    {
        ...
        try
        {
            ...
            ConnectorReport connectorReport = instanceHandler.validateConnector(connectorProviderClassName,
                                                                                SearchIntegratorConnector.class,
