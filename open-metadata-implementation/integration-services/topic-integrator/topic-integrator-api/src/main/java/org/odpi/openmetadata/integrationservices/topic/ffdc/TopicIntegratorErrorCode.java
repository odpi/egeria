...
package org.odpi.openmetadata.integrationservices.topic.ffdc;
...
public enum TopicIntegratorErrorCode implements ExceptionMessageSet
{
     ...
     */
    TopicIntegratorErrorCode(int  httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
    ...
    {
        return "TopicIntegratorErrorCode{" +
