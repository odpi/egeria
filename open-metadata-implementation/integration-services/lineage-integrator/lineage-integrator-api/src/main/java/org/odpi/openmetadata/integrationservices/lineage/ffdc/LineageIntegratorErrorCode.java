...
public enum LineageIntegratorErrorCode implements ExceptionMessageSet
{
     ...
     */
    LineageIntegratorErrorCode(int  httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
    ...
    {
        return "LineageIntegratorErrorCode{" +
