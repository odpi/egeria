 ...
 */
public class InfrastructureIntegrator implements InfrastructureIntegratorAPI
{
     ...
     * REST API calls.
     */
    public InfrastructureIntegrator(String   serverName,
                                                                                       ...
                                                                                       PropertyServerException
    {
        ...
        final String   urlTemplate = "/servers/{0}/open-metadata/integration-services/infrastructure-integrator/users/{1}/validate-connector";
