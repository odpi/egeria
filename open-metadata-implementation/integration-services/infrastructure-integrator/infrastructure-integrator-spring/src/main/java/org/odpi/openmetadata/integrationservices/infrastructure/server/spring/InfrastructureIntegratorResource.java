...
@Tag(name="Integration Daemon: Infrastructure Integrator OMIS", description="Supports the detection and creation of metadata for file systems and file servers.",
...
{
    private final InfrastructureIntegratorRESTServices restAPI = new InfrastructureIntegratorRESTServices();
