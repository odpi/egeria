...
/**
 * The InfrastructureIntegratorErrorCode error code is used to define first failure data capture (FFDC) for errors that
 ...
 * </ul>
 */
public enum InfrastructureIntegratorErrorCode implements ExceptionMessageSet
{
    /**
     * OMIS-INFRASTRUCTURE-INTEGRATOR-400-001 - Integration connector {0} is not of the correct type to run in the {1} integration service.  It must inherit from {2}
     */
    INVALID_CONNECTOR(400,"OMIS-INFRASTRUCTURE-INTEGRATOR-400-001",
    ...
    /**
     * OMIS-INFRASTRUCTURE-INTEGRATOR-500-001 - Integration connector {0} has a null context
     */
    NULL_CONTEXT(400,"OMIS-INFRASTRUCTURE-INTEGRATOR-500-001",
    ...
    /**
     * The constructor for InfrastructureIntegratorErrorCode expects to be passed one of the enumeration rows defined in
     * InfrastructureIntegratorErrorCode above.   For example:
     * <br><br>
     *     InfrastructureIntegratorErrorCode   errorCode = InfrastructureIntegratorErrorCode.UNKNOWN_ENDPOINT;
     * <br><br>
     ...
     */
    InfrastructureIntegratorErrorCode(int  httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
    ...
    {
        return "InfrastructureIntegratorErrorCode{" +
