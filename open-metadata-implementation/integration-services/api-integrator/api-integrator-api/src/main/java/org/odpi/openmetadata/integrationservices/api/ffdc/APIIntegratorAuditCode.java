...
package org.odpi.openmetadata.integrationservices.api.ffdc;
 ...
 * </ul>
 */
public enum APIIntegratorAuditCode implements AuditLogMessageSet
{
    /**
     * OMIS-API-INTEGRATOR-0001 - The API integrator context manager is being initialized for calls to server {0} on platform {1}
     */
    CONTEXT_INITIALIZING("OMIS-API-INTEGRATOR-0001",
                         OMRSAuditLogRecordSeverity.STARTUP,
                         "The API integrator context manager is being initialized for calls to server {0} on platform {1}",
                         "The API Integrator OMIS is initializing its context manager.",
     ...
     */
    CONNECTOR_CONTEXT_INITIALIZING("OMIS-API-INTEGRATOR-0002",
                                   OMRSAuditLogRecordSeverity.STARTUP,
     ...
     */
    NULL_CONTEXT("OMIS-API-INTEGRATOR-0003",
    ...
    /**
     * The constructor for APIIntegratorAuditCode expects to be passed one of the enumeration rows defined in
     * APIIntegratorAuditCode above.   For example:
     * <br><br>
     *     APIIntegratorAuditCode   auditCode = APIIntegratorAuditCode.SERVER_SHUTDOWN;
     * <br><br>
     ...
     */
    APIIntegratorAuditCode(String                     messageId,
