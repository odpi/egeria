...
package org.odpi.openmetadata.integrationservices.api.client;
 ...
 */
public class APIIntegrator implements APIIntegratorAPI
{
     ...
     * REST API calls.
     */
    public APIIntegrator(String   serverName,
                                                                                       ...
                                                                                       PropertyServerException
    {
        ...
        final String   urlTemplate = "/servers/{0}/open-metadata/integration-services/api-integrator/users/{1}/validate-connector";
