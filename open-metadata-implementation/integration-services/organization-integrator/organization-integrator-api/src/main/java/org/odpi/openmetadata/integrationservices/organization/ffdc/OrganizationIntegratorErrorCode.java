...
{
    /**
     * OMIS-ORGANIZATION-INTEGRATOR-400-001 - Integration connector {0} is not of the correct type to run in the {1} integration service.  It must inherit from {2}
     */
    ...
    /**
     * OMIS-ORGANIZATION-INTEGRATOR-500-001 - Integration connector {0} has a null context
     */
    NULL_CONTEXT(400,"OMIS-ORGANIZATION-INTEGRATOR-500-001",
