...
package org.odpi.openmetadata.integrationservices.organization.rest;
...
import org.odpi.openmetadata.integrationservices.organization.connector.OrganizationIntegratorOMISConnector;
import org.odpi.openmetadata.integrationservices.organization.contextmanager.OrganizationIntegratorContextManager;
 ...
 */
public class OrganizationIntegratorRESTServices
{
    private static final IntegrationDaemonInstanceHandler instanceHandler = new IntegrationDaemonInstanceHandler();

    private static final RESTCallLogger restCallLogger = new RESTCallLogger(LoggerFactory.getLogger(OrganizationIntegratorRESTServices.class),
     ...
     */
    public OrganizationIntegratorRESTServices()
    {
        IntegrationServiceRegistry.registerIntegrationService(IntegrationServiceDescription.ORGANIZATION_INTEGRATOR_OMIS,
                                                              ...
                                                              OrganizationIntegratorOMISConnector.class.getName());
    }
