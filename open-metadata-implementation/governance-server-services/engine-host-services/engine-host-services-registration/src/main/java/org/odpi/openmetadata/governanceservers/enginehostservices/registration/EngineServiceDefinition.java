 ...
 * The engine service runs one or more engines of a specific type.  The configuration for each of these engines is
 * extracted from the partner metadata access store using
 * the engine name as the qualified name.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class EngineServiceDefinition
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        EngineServiceDefinition that = (EngineServiceDefinition) objectToCompare;
    ...
    public int hashCode()
    {
        return Objects.hash(engineServiceId, engineServiceDevelopmentStatus, engineServiceName, engineServiceFullName,
                            engineServiceURLMarker, engineServiceDescription, engineServiceWiki,
                            engineServicePartnerOMAS, engineServiceOperationalStatus, engineServiceAdminClass);
    }
}
