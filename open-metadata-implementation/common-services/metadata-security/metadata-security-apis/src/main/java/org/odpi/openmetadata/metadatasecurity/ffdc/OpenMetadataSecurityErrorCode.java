...
public enum OpenMetadataSecurityErrorCode implements ExceptionMessageSet
{
    ...
    MULTIPLE_CONNECTIONS_FOUND(403, "OMAG-SERVER-SECURITY-403-015",
                               ...
                               "The system cannot process a request because multiple connections have been discovered and it is unsure which connection to return.",
    ...
    UNKNOWN_CONNECTION_RETURNED(500, "OMAG-PLATFORM-SECURITY-500-001",
                           ...
                           "The system cannot process a request because the security connector is behaving strangely.",
