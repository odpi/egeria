...
public class ConnectedAssetComments extends AssetComments
{
     ...
     */
    ConnectedAssetComments(String                 serviceName,
                           String                 serverName,
                           String                 userId,
     ...
     */
    @Override
    protected  AssetComments cloneIterator(AssetDescriptor parentAsset)
    {
        return new ConnectedAssetComments(connectedAsset, this);
    }
    ...
    {
        final String   methodName = "AssetComments.getCachedList";
