...
public class ConnectedAssetExternalReferences extends AssetExternalReferences
{
                                                     ...
                                                     int  maximumSize) throws PropertyServerException
    {
        ...
        final String   urlTemplate = "/servers/{0}/open-metadata/common-services/ocf/connected-asset/users/{1}/assets/{2}/external-references?elementStart={3}&maxElements={4}";
