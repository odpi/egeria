...
/**
 * Validate that the RelatedMediaReferencesResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class RelatedMediaReferencesResponseTest
{
    private Map<String, Object>         exceptionProperties = new HashMap<>();
    private List<RelatedMediaReference> responseList        = new ArrayList<>();
    private RelatedMediaReference       responseObject      = new RelatedMediaReference();


    /**
     * Default constructor
     */
    public RelatedMediaReferencesResponseTest()
    {
     ...
     */
    private RelatedMediaReferencesResponse getTestObject()
    {
        RelatedMediaReferencesResponse testObject = new RelatedMediaReferencesResponse();
     ...
     */
    private void validateResultObject(RelatedMediaReferencesResponse  resultObject)
    {
    ...
    {
        RelatedMediaReferencesResponse    nullObject = new RelatedMediaReferencesResponse();
        ...
        nullObject = new RelatedMediaReferencesResponse(null);
    ...
    @Test public void testExceptionProperties()
    {
        ...
        propertyMap = null;
        testObject = new RelatedMediaReferencesResponse();
    ...
    @Test public void testEquals()
    {
        ...
        RelatedMediaReferencesResponse  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        RelatedMediaReferencesResponse  differentObject = getTestObject();
    ...
    {
        validateResultObject(new RelatedMediaReferencesResponse(getTestObject()));
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, RelatedMediaReferencesResponse.class));
        }
        catch (Exception  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((RelatedMediaReferencesResponse) objectMapper.readValue(jsonString, OCFOMASAPIResponse.class));
        }
        catch (Exception  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(getTestObject().toString().contains("RelatedMediaReferencesResponse"));
    }
}
