...
/**
 * LikesResponse is the response structure used on the OMAS REST API calls that return a
 * list of Like objects as a response.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class LikesResponse extends OCFOMASAPIResponse
{
    private List<Like> responseObjects = null;
     ...
     */
    public LikesResponse(LikesResponse template)
    {
        super(template);
     ...
     */
    public void setList(List<Like> responseObjects)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof LikesResponse))
        {
            return false;
        }
        ...
        LikesResponse that = (LikesResponse) objectToCompare;
