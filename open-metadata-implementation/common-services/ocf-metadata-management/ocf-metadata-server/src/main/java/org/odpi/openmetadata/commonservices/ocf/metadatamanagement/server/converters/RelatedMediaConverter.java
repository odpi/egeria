...
/**
 * RelatedMediaConverter transfers the relevant properties from an Open Metadata Repository Services (OMRS)
 * EntityDetail object into a RelatedMediaReference bean.
 */
public class RelatedMediaConverter<B> extends OCFConverter<B>
{
    /**
     * Constructor
     *
     ...
     */
    public RelatedMediaConverter(OMRSRepositoryHelper repositoryHelper,
                                 String               serviceName,
                                 String               serverName)
    {
                        ...
                        String       methodName) throws PropertyServerException
    {
        try
        {
            ...
            if (returnBean instanceof RelatedMediaReference)
            {
                RelatedMediaReference bean = (RelatedMediaReference) returnBean;

                /*
                 * Check that the entity is of the correct type.
                 */
                this.setUpElementHeader(bean, entity, OpenMetadataAPIMapper.RELATED_MEDIA_TYPE_NAME, methodName);
