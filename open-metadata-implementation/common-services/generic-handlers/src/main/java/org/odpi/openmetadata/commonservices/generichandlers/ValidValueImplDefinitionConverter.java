...
import org.odpi.openmetadata.frameworks.openmetadata.metadataelements.ValidValueImplDefinitionElement;
...
/**
 * ValidValueImplDefinitionConverter provides common methods for transferring relevant properties from an Open Metadata Repository Services (OMRS)
 * Relationship and linked EntityDetail object into a bean that inherits from ValidValueImplDefinitionElement.
 */
public class ValidValueImplDefinitionConverter<B> extends ValidValueConverter<B>
{
    /**
     * Constructor
     *
     ...
     */
    public ValidValueImplDefinitionConverter(OMRSRepositoryHelper repositoryHelper,
                                             String serviceName,
                                             String serverName)
    {
                        ...
                        String       methodName) throws PropertyServerException
    {
        try
        {
            ...
            if (returnBean instanceof ValidValueImplDefinitionElement bean)
            {
