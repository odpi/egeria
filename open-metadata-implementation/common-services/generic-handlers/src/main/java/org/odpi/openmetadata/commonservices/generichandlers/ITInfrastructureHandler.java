...
public class ITInfrastructureHandler<B> extends AssetHandler<B>
{
                                                                                 ...
                                                                                 PropertyServerException
    {
        ...
        this.linkElementToElement(userId,
                                  ...
                                  forDuplicateProcessing,
                                  supportedZones,
                                  OpenMetadataType.SOFTWARE_SERVER_PLATFORM_DEPLOYMENT_TYPE_GUID,
                                  OpenMetadataType.SOFTWARE_SERVER_PLATFORM_DEPLOYMENT_TYPE_NAME,
                                                                                 ...
                                                                                 PropertyServerException
    {
        this.unlinkElementFromElement(userId,
                                      ...
                                      softwareServerPlatformGUID,
                                      softwareServerPlatformGUIDParameterName,
                                      OpenMetadataType.SOFTWARE_SERVER_PLATFORM_TYPE_GUID,
                                      OpenMetadataType.SOFTWARE_SERVER_PLATFORM_TYPE_NAME,
                                      forLineage,
                                      forDuplicateProcessing,
                                      OpenMetadataType.SOFTWARE_SERVER_PLATFORM_DEPLOYMENT_TYPE_GUID,
                                                                         ...
                                                                         PropertyServerException
    {
        ...
        this.linkElementToElement(userId,
                                  ...
                                  forDuplicateProcessing,
                                  supportedZones,
                                  OpenMetadataType.SERVER_DEPLOYMENT_TYPE_GUID,
                                  OpenMetadataType.SERVER_DEPLOYMENT_TYPE_NAME,
                                  relationshipProperties,
                                  effectiveFrom,
                                  effectiveTo,
                                  effectiveTime,
                                                                         ...
                                                                         PropertyServerException
    {
        this.unlinkElementFromElement(userId,
                                      ...
                                      softwareServerGUID,
                                      softwareServerGUIDParameterName,
                                      OpenMetadataType.SOFTWARE_SERVER_TYPE_GUID,
                                      OpenMetadataType.SOFTWARE_SERVER_TYPE_NAME,
                                      forLineage,
                                      forDuplicateProcessing,
                                      OpenMetadataType.SERVER_DEPLOYMENT_TYPE_GUID,
                                                                            ...
                                                                            PropertyServerException
    {
        ...
        this.linkElementToElement(userId,
                                  ...
                                  forDuplicateProcessing,
                                  supportedZones,
                                  OpenMetadataType.SUPPORTED_CAPABILITY_TYPE_GUID,
                                  OpenMetadataType.SUPPORTED_CAPABILITY_TYPE_NAME,
                                  relationshipProperties,
                                  effectiveFrom,
                                  effectiveTo,
                                  effectiveTime,
                                                            ...
                                                            PropertyServerException
    {
        this.linkElementToElement(userId,
                                  ...
                                  forDuplicateProcessing,
                                  supportedZones,
                                  OpenMetadataType.HOST_NETWORK_TYPE_GUID,
                                  OpenMetadataType.HOST_NETWORK_TYPE_NAME,
                                  null,
                                  effectiveFrom,
                                  effectiveTo,
                                  effectiveTime,
                                                                   ...
                                                                   PropertyServerException
    {
        this.linkElementToElement(userId,
                                  ...
                                  OpenMetadataType.NETWORK_GATEWAY_TYPE_NAME,
                                  networkGUID,
                                  networkGUIDParameterName,
                                  OpenMetadataType.NETWORK_TYPE_NAME,
                                  forLineage,
                                  forDuplicateProcessing,
                                  supportedZones,
                                  OpenMetadataType.NETWORK_GATEWAY_LINK_TYPE_GUID,
                                  OpenMetadataType.NETWORK_GATEWAY_LINK_TYPE_NAME,
                                  null,
                                  effectiveFrom,
                                  effectiveTo,
                                  effectiveTime,
                                                                           ...
                                                                           PropertyServerException
    {
        ...
        this.setClassificationInRepository(userId,
                                           ...
                                           softwareServerPlatformGUIDParameterName,
                                           OpenMetadataType.SOFTWARE_SERVER_PLATFORM_TYPE_NAME,
                                           OpenMetadataType.CLOUD_PLATFORM_CLASSIFICATION_GUID,
                                           OpenMetadataType.CLOUD_PLATFORM_CLASSIFICATION_NAME,
                                                                         ...
                                                                         PropertyServerException
    {
        ...
        this.setClassificationInRepository(userId,
                                           ...
                                           softwareServerGUIDParameterName,
                                           OpenMetadataType.SOFTWARE_SERVER_TYPE_NAME,
                                           OpenMetadataType.CLOUD_TENANT_CLASSIFICATION_GUID,
                                           OpenMetadataType.CLOUD_TENANT_CLASSIFICATION_NAME,
                                                                          ...
                                                                          PropertyServerException
    {
        ...
        this.setClassificationInRepository(userId,
                                           ...
                                           softwareCapabilityGUIDParameterName,
                                           OpenMetadataType.SOFTWARE_CAPABILITY_TYPE_NAME,
                                           OpenMetadataType.CLOUD_SERVICE_CLASSIFICATION_GUID,
                                           OpenMetadataType.CLOUD_SERVICE_CLASSIFICATION_NAME,
