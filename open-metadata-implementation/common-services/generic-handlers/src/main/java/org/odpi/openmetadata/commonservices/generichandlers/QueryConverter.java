 ...
 */
public class QueryConverter<B> extends OMFConverter<B>
{
    /**
     * Constructor
     *
        ...
        try
        {
            ...
            if (returnBean instanceof QueryElement bean)
            {
                ...
                if (entity != null)
                {
                    ...
                    queryProperties.setResourceName(this.removeResourceName(instanceProperties));
                    queryProperties.setVersionIdentifier(this.removeVersionIdentifier(instanceProperties));
                    queryProperties.setResourceDescription(this.removeDescription(instanceProperties));
