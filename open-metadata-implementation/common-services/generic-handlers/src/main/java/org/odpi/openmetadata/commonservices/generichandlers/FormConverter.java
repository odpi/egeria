 ...
 */
public class FormConverter<B> extends OMFConverter<B>
{
    /**
     * Constructor
     *
        ...
        try
        {
            ...
            if (returnBean instanceof FormElement bean)
            {
                ...
                if (entity != null)
                {
                    ...
                    formProperties.setResourceName(this.removeResourceName(instanceProperties));
                    formProperties.setVersionIdentifier(this.removeVersionIdentifier(instanceProperties));
                    formProperties.setResourceDescription(this.removeDescription(instanceProperties));
