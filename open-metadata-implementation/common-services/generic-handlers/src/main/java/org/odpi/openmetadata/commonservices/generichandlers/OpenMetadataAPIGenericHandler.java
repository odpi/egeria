...
public class OpenMetadataAPIGenericHandler<B>
{
    ...
    /**
     * Return the list of entities that have a specific value for a certain given property
     *
     * @param userId the name of the calling user
     ...
     * @throws UserNotAuthorizedException the requesting user is not authorized to issue this request.
     */
    public List<EntityDetail> getEntitiesByProperty(String       userId,
                                                    String       searchString,
                                                    String       searchStringParameterName,
                                                    String       resultTypeGUID,
                                                    String       resultTypeName,
         ...
         */
        List<EntityDetail> results = new ArrayList<>();
        String entityParameterName = "Entity from byProperty search of " + searchString;
        int skippedValues = 0;
