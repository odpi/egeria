...
/**
 * RelatedAssetBuilder returns details of an asset and the relationship that connects it.
 */
public class RelatedAssetBuilder extends ReferenceableBuilder
{
     ...
     */
    public RelatedAssetBuilder(OMRSRepositoryHelper repositoryHelper,
                               String               serviceName,
                               String               serverName)
    {
     ...
     * @param serverName name of local server
     */
    public RelatedAssetBuilder(String               qualifiedName,
                               String               displayName,
                               String               description,
                              ...
                              String       methodName) throws InvalidParameterException
    {
        try
        {
            Classification classification = repositoryHelper.getNewClassification(serviceName,
                                                                                  ...
                                                                                  null,
                                                                                  getZoneMembershipProperties(zoneMembership,
                                                                                                              methodName));
