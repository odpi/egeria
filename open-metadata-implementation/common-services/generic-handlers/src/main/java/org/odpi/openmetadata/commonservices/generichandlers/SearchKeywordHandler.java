...
public class SearchKeywordHandler<B> extends OpenMetadataAPIGenericHandler<B>
{
                                                           ...
                                                           UserNotAuthorizedException
    {
        ...
        return this.createBeanInRepository(userId,
                                           externalSourceGUID,
                                           externalSourceName,
                                           OpenMetadataType.SEARCH_KEYWORD_TYPE_GUID,
                                                           ...
                                                           UserNotAuthorizedException
    {
        ...
        if (keyword != null)
        {
            if (repositoryHandler.countAttachedRelationshipsByType(userId,
                                                                   keywordGUID,
                                                                   OpenMetadataType.SEARCH_KEYWORD_TYPE_NAME,
                                                                   OpenMetadataType.REFERENCEABLE_TO_SEARCH_KEYWORD_TYPE_GUID,
                                                                   OpenMetadataType.REFERENCEABLE_TO_SEARCH_KEYWORD_TYPE_NAME,
                                                                   2,
                                                                   forLineage,
                                                                   forDuplicateProcessing,
                                                                   effectiveTime,
                                                                     ...
                                                                     UserNotAuthorizedException
    {
        ...
        propertyNames.add(OpenMetadataType.KEYWORD_PROPERTY_NAME);
