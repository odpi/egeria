...
import org.odpi.openmetadata.frameworks.openmetadata.metadataelements.ValidValueAssignmentDefinitionElement;
...
public class ValidValueAssignmentDefinitionConverter<B> extends ValidValueConverter<B>
{
                        ...
                        String       methodName) throws PropertyServerException
    {
        try
        {
            ...
            if (returnBean instanceof ValidValueAssignmentDefinitionElement bean)
            {
