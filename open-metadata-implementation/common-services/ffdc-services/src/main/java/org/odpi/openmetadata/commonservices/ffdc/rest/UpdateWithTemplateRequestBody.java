...
import org.odpi.openmetadata.frameworks.openmetadata.search.UpdateWithTemplateOptions;
...
public class UpdateWithTemplateRequestBody extends UpdateWithTemplateOptions
{
     ...
     * Default constructor
     */
    public UpdateWithTemplateRequestBody()
    {
    }
     ...
     */
    public UpdateWithTemplateRequestBody(UpdateWithTemplateRequestBody template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (! (objectToCompare instanceof UpdateWithTemplateRequestBody that))
        {
            return false;
        }
