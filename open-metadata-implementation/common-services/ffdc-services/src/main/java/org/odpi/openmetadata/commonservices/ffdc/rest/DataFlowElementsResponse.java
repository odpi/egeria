...
public class DataFlowElementsResponse extends FFDCResponseBase
{
    private List<DataFlowElement> elements = null;


    /**
     * Default constructor
     */
    public DataFlowElementsResponse()
    {
    }
     ...
     */
    public DataFlowElementsResponse(DataFlowElementsResponse template)
    {
        super(template);
     ...
     */
    public void setElements(List<DataFlowElement> elements)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        DataFlowElementsResponse that = (DataFlowElementsResponse) objectToCompare;
