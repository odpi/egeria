...
/**
 * ReportResponse is a response object for passing back a single report
 * element or an exception if the request failed.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class ReportResponse extends FFDCResponseBase
{
     ...
     */
    public ReportResponse(ReportResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ReportResponse that = (ReportResponse) objectToCompare;
