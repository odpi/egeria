...
public class APIOperationsResponse extends FFDCResponseBase
{
    private List<APIOperationElement> elements = null;
     ...
     */
    public List<APIOperationElement> getElements()
    {
        return elements;
    }
     ...
     */
    public void setElements(List<APIOperationElement> elements)
    {
