...
public class ValidValuesImplDefinitionsResponse extends FFDCResponseBase
{
    private List<ValidValueImplDefinitionElement> elements = null;
     ...
     */
    public List<ValidValueImplDefinitionElement> getElements()
    {
        return elements;
    }
     ...
     */
    public void setElements(List<ValidValueImplDefinitionElement> elements)
    {
