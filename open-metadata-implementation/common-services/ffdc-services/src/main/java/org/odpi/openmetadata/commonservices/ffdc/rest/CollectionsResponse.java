...
/**
 * CollectionsResponse is the response structure used on the OMAS REST API calls that return
 * a list of collection elements.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class CollectionsResponse extends FFDCResponseBase
{
     ...
     */
    public CollectionsResponse(CollectionsResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof CollectionsResponse that))
        {
            return false;
        }
