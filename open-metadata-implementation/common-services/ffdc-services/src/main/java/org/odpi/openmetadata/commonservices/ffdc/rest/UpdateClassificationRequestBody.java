...
public class UpdateClassificationRequestBody extends UpdateOptions
{
     ...
     */
    public UpdateClassificationRequestBody(UpdateClassificationRequestBody template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        UpdateClassificationRequestBody that = (UpdateClassificationRequestBody) objectToCompare;
