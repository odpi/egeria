...
public class GovernanceMetricsResponse extends FFDCResponseBase
{
     ...
     */
    public GovernanceMetricsResponse(GovernanceMetricsResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof GovernanceMetricsResponse that))
        {
            return false;
        }
