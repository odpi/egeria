...
/**
 * QueryDataFieldRequestBody describes the properties of the data field plus the optional identifiers for an
 * owning software server capability.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class QueryDataFieldRequestBody extends QueryDataFieldProperties
{
     ...
     * Default constructor
     */
    public QueryDataFieldRequestBody()
    {
        super();
    }
     ...
     */
    public QueryDataFieldRequestBody(QueryDataFieldRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public QueryDataFieldRequestBody(QueryDataFieldProperties template)
    {
        super(template);
    }
    ...
    {
        return "QueryDataFieldRequestBody{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        QueryDataFieldRequestBody that = (QueryDataFieldRequestBody) objectToCompare;
