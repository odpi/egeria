...
public class DatabasesResponse extends FFDCResponseBase
{
    private List<DatabaseElement> elements = null;
     ...
     */
    public void setElements(List<DatabaseElement> elements)
    {
