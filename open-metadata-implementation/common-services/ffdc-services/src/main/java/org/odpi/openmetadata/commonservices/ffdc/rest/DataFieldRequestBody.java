...
/**
 * DataFieldRequestBody describes the properties of the data field plus the optional identifiers for an
 * owning software server capability.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class DataFieldRequestBody extends DataFieldProperties
{
     ...
     */
    public DataFieldRequestBody(DataFieldRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public DataFieldRequestBody(DataFieldProperties template)
    {
        super(template);
    }
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        DataFieldRequestBody that = (DataFieldRequestBody) objectToCompare;
