...
public class LiteralSchemaTypeRequestBody extends LiteralSchemaTypeProperties
{
     ...
     * Default constructor
     */
    public LiteralSchemaTypeRequestBody()
    {
        super();
    }
     ...
     */
    public LiteralSchemaTypeRequestBody(LiteralSchemaTypeRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public LiteralSchemaTypeRequestBody(LiteralSchemaTypeProperties template)
    {
        super(template);
    }
    ...
    {
        return "LiteralSchemaTypeRequestBody{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        LiteralSchemaTypeRequestBody that = (LiteralSchemaTypeRequestBody) objectToCompare;
