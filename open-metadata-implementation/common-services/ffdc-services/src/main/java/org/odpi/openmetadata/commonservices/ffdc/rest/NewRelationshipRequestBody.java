...
public class NewRelationshipRequestBody extends MakeAnchorOptions
{
     ...
     * Default constructor
     */
    public NewRelationshipRequestBody()
    {
        super();
    }
     ...
     */
    public NewRelationshipRequestBody(NewRelationshipRequestBody template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        NewRelationshipRequestBody that = (NewRelationshipRequestBody) objectToCompare;
