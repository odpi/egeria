...
/**
 * EventTypeRequestBody describes the properties of the event type plus the optional identifiers for an
...
public class EventTypeRequestBody extends EventTypeProperties
{
     ...
     */
    public EventTypeRequestBody(EventTypeRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public EventTypeRequestBody(EventTypeProperties template)
    {
        super(template);
    }
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        EventTypeRequestBody that = (EventTypeRequestBody) objectToCompare;
