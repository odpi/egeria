...
{
    private ElementStatus glossaryTermStatus = null;
     ...
     * @return enum object
     */
    public ElementStatus getGlossaryTermStatus()
    {
     ...
     */
    public void setGlossaryTermStatus(ElementStatus glossaryTermStatus)
    {
