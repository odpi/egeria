...
public class TopicsResponse extends FFDCResponseBase
{
    private List<TopicElement> elements = null;
     ...
     */
    public List<TopicElement> getElements()
    {
        return elements;
    }
     ...
     */
    public void setElements(List<TopicElement> elements)
    {
