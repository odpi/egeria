...
public class ProjectGraphResponse extends FFDCResponseBase
{
    private ProjectGraph element = null;


    /**
     * Default constructor
     */
    public ProjectGraphResponse()
    {
        super();
    }
     ...
     */
    public ProjectGraphResponse(ProjectGraphResponse template)
    {
        super(template);
     ...
     */
    public ProjectGraph getElement()
    {
        return element;
    }
     ...
     */
    public void setElement(ProjectGraph element)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ProjectGraphResponse))
        {
            return false;
        }
        ...
        ProjectGraphResponse that = (ProjectGraphResponse) objectToCompare;
