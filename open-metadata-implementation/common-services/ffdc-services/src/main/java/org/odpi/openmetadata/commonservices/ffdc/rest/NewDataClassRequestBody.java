...
public class NewDataClassRequestBody extends NewElementOptionsRequestBody
{
    ...
    /**
     * Return the properties for the data class.
     *
     * @return properties
     */
    ...
    /**
     * Set up the properties for the data class.
     *
    ...
    {
        return "NewDataClassRequestBody{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (! (objectToCompare instanceof NewDataClassRequestBody that))
        {
            return false;
        }
