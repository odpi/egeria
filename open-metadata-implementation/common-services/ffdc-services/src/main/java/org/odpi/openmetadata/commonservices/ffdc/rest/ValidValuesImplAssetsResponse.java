...
public class ValidValuesImplAssetsResponse extends FFDCResponseBase
{
    private List<ValidValueImplAssetElement> elements = null;
     ...
     */
    public List<ValidValueImplAssetElement> getElements()
    {
        return elements;
    }
     ...
     */
    public void setElements(List<ValidValueImplAssetElement> elements)
    {
