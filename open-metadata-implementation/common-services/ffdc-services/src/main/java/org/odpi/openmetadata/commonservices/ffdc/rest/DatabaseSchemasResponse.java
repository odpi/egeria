...
public class DatabaseSchemasResponse extends FFDCResponseBase
{
    private List<DatabaseSchemaElement> elements = null;
     ...
     */
    public List<DatabaseSchemaElement> getElements()
    {
        return elements;
    }
     ...
     */
    public void setElements(List<DatabaseSchemaElement> elements)
    {
