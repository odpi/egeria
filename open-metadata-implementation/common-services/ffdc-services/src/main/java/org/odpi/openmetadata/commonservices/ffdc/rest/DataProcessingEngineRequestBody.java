...
public class DataProcessingEngineRequestBody extends DataProcessingEngineProperties
{
     ...
     * Default constructor
     */
    public DataProcessingEngineRequestBody()
    {
        super();
    }
     ...
     */
    public DataProcessingEngineRequestBody(DataProcessingEngineRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public DataProcessingEngineRequestBody(DataProcessingEngineProperties template)
    {
        super(template);
    }
    ...
    {
        return "DataProcessingEngineRequestBody{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        DataProcessingEngineRequestBody that = (DataProcessingEngineRequestBody) objectToCompare;
