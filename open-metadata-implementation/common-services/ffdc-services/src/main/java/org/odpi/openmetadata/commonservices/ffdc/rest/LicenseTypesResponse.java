...
/**
 * LicenseTypesResponse is the response structure used on the OMAS REST API calls that return a
 * list of license types as a response.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class LicenseTypesResponse extends FFDCResponseBase
{
     ...
     */
    public LicenseTypesResponse(LicenseTypesResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof LicenseTypesResponse that))
        {
            return false;
        }
