...
/**
 * GovernanceRolesResponse is the response structure used on the OMAS REST API calls that return a
 * list of governance roles as a response.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class GovernanceRolesResponse extends FFDCResponseBase
{
     ...
     * Default constructor
     */
    public GovernanceRolesResponse()
    {
        super();
    }
     ...
     */
    public GovernanceRolesResponse(GovernanceRolesResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof GovernanceRolesResponse that))
        {
            return false;
        }
