...
/**
 * GovernanceStatusIdentifierSetsResponse is the response structure used on the OMAS REST API calls that return a
 * list of governance classification level identifier sets as a response.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class GovernanceStatusIdentifierSetsResponse extends FFDCResponseBase
{
     ...
     */
    public GovernanceStatusIdentifierSetsResponse(GovernanceStatusIdentifierSetsResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof GovernanceStatusIdentifierSetsResponse that))
        {
            return false;
        }
