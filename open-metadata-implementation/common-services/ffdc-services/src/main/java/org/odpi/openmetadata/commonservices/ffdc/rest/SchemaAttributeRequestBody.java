...
/**
 * SchemaAttributeRequestBody describes the properties of the schema attribute plus the optional identifiers for an
...
public class SchemaAttributeRequestBody extends SchemaAttributeProperties
{
     ...
     * @param template object to copy
     */
    public SchemaAttributeRequestBody(SchemaAttributeProperties template)
    {
        super(template);
    }
