...
public class QueriesResponse extends FFDCResponseBase
{
     ...
     */
    public QueriesResponse(QueriesResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        QueriesResponse that = (QueriesResponse) objectToCompare;
