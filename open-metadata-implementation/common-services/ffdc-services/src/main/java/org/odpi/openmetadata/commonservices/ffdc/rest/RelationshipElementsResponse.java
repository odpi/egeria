...
public class RelationshipElementsResponse extends FFDCResponseBase
{

    private List<RelationshipElement> elements = null;
     ...
     */
    public List<RelationshipElement> getElements()
    {
        return elements;
    }
     ...
     */
    public void setElements(List<RelationshipElement> elements)
    {
