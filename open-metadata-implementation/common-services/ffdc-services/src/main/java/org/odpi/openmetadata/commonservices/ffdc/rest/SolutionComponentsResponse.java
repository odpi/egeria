...
public class SolutionComponentsResponse extends FFDCResponseBase
{
    private List<SolutionComponentElement> elements = null;

    /**
     * Default constructor
     */
    public SolutionComponentsResponse()
    {
        super();
    }
     ...
     */
    public SolutionComponentsResponse(SolutionComponentsResponse template)
    {
        super(template);
     ...
     */
    public List<SolutionComponentElement> getElements()
    {
        return elements;
    }
     ...
     */
    public void setElements(List<SolutionComponentElement> elements)
    {
    ...
    {
        return "SolutionComponentsResponse{" +
                "elements=" + elements +
                "} " + super.toString();
    }
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        SolutionComponentsResponse that = (SolutionComponentsResponse) objectToCompare;
