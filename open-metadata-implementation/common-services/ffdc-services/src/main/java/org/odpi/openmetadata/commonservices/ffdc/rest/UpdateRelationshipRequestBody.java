...
public class UpdateRelationshipRequestBody extends UpdateOptions
{
     ...
     * Default constructor
     */
    public UpdateRelationshipRequestBody()
    {
        super();
    }
     ...
     */
    public UpdateRelationshipRequestBody(UpdateRelationshipRequestBody template)
    {
        super(template);
    ...
    {
        return "UpdateRelationshipRequestBody{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        UpdateRelationshipRequestBody that = (UpdateRelationshipRequestBody) objectToCompare;
