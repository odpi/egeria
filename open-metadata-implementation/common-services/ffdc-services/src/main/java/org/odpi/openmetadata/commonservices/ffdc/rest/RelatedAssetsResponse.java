...
/**
 * RelatedAssetsResponse is a response object for passing back a list of related assets with te properties from the relationship
 * or an exception if the request failed.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class RelatedAssetsResponse extends FFDCResponseBase
{
    private List<RelatedAssetElement> elements = null;
     ...
     */
    public List<RelatedAssetElement> getElements()
    {
        return elements;
    }
     ...
     */
    public void setElements(List<RelatedAssetElement> elements)
    {
