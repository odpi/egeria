...
public class UpdateGovernanceDefinitionRequestBody extends MetadataSourceRequestBody
{
    ...
    {
        return "UpdateGovernanceDefinitionRequestBody{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (! (objectToCompare instanceof UpdateGovernanceDefinitionRequestBody that))
        {
            return false;
        }
