...
/**
 * ActorRoleResponse is the response structure used on the OMAS REST API calls that return a
 * ActorRoleElement object as a response.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class ActorRoleResponse extends FFDCResponseBase
{
     ...
     */
    public ActorRoleResponse(ActorRoleResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ActorRoleResponse that))
        {
            return false;
        }
