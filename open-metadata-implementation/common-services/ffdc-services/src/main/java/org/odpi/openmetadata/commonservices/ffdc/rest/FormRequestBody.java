...
/**
 * FormRequestBody describes the properties of the form plus the optional identifiers for an
 * owning software server capability.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class FormRequestBody extends FormProperties
{
     ...
     */
    public FormRequestBody(FormRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public FormRequestBody(FormProperties template)
    {
        super(template);
    }
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        FormRequestBody that = (FormRequestBody) objectToCompare;
