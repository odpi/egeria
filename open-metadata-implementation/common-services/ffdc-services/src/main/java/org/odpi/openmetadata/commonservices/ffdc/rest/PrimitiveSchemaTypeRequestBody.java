...
/**
 * PrimitiveSchemaTypeRequestBody describes the properties of the schema type plus the optional identifiers for an
 * owning software server capability.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class PrimitiveSchemaTypeRequestBody extends PrimitiveSchemaTypeProperties
{
     ...
     * Default constructor
     */
    public PrimitiveSchemaTypeRequestBody()
    {
        super();
    }
     ...
     */
    public PrimitiveSchemaTypeRequestBody(PrimitiveSchemaTypeRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public PrimitiveSchemaTypeRequestBody(PrimitiveSchemaTypeProperties template)
    {
        super(template);
    }
    ...
    {
        return "PrimitiveSchemaTypeRequestBody{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        PrimitiveSchemaTypeRequestBody that = (PrimitiveSchemaTypeRequestBody) objectToCompare;
