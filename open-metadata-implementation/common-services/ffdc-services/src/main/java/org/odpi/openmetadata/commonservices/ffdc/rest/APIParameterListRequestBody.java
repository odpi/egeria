...
/**
 * APIParameterListRequestBody describes the properties of the API parameter list plus the optional identifiers for an
 * owning software server capability.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class APIParameterListRequestBody extends APIParameterListProperties
{
     ...
     * Default constructor
     */
    public APIParameterListRequestBody()
    {
        super();
    }
     ...
     */
    public APIParameterListRequestBody(APIParameterListRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public APIParameterListRequestBody(APIParameterListProperties template)
    {
        super(template);
    }
    ...
    {
        return "APIParameterListRequestBody{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        APIParameterListRequestBody that = (APIParameterListRequestBody) objectToCompare;
