...
public class RatingsResponse extends FFDCResponseBase
{
    private List<Rating> elements = null;
     ...
     */
    public List<Rating> getElements()
    {
        return elements;
    }
     ...
     */
    public void setElements(List<Rating> elements)
    {
