...
/**
 * Validate that the BooleanResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class BooleanResponseTest
{
     ...
     */
    private BooleanResponse getTestObject()
    {
     ...
     */
    private void validateResultObject(BooleanResponse  resultObject)
    {
    ...
    {
        BooleanResponse    nullObject = new BooleanResponse();
    ...
    @Test public void testExceptionProperties()
    {
        ...
        propertyMap = null;
        testObject = new BooleanResponse();
    ...
    @Test public void testEquals()
    {
        ...
        BooleanResponse  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        BooleanResponse  differentObject = getTestObject();
    ...
    {
        validateResultObject(new BooleanResponse(getTestObject()));
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, BooleanResponse.class));
        }
        catch (Exception  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(getTestObject().toString().contains("BooleanResponse"));
    }
}
