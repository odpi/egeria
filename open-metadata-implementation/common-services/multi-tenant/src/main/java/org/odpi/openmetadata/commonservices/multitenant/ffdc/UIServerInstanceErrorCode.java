 ...
 * </ul>
 */
public enum UIServerInstanceErrorCode
{
    ...
    private static final Logger log = LoggerFactory.getLogger(UIServerInstanceErrorCode.class);
     ...
     */
    UIServerInstanceErrorCode(int  newHTTPErrorCode, String newErrorMessageId, String newErrorMessage, String newSystemAction, String newUserAction)
    {
