...
public class NextGovernanceActionTypeElementsResponse extends GovernanceEngineOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<NextGovernanceActionTypeElement> elements = null;

    /**
     * Default constructor
     */
    public NextGovernanceActionTypeElementsResponse()
    {
        super();
    }
     ...
     */
    public NextGovernanceActionTypeElementsResponse(NextGovernanceActionTypeElementsResponse template)
    {
        super(template);
     ...
     */
    public List<NextGovernanceActionTypeElement> getElements()
    {
        if (elements == null)
        {
            return null;
     ...
     */
    public void setElements(List<NextGovernanceActionTypeElement> elements)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        NextGovernanceActionTypeElementsResponse that = (NextGovernanceActionTypeElementsResponse) objectToCompare;
