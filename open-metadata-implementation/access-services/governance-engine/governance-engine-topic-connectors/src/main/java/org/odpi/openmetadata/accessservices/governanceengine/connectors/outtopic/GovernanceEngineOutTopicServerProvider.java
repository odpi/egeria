 ...
 */
public class GovernanceEngineOutTopicServerProvider extends ConnectorProviderBase
{
    static final String  connectorTypeGUID = "734290fd-10eb-4a4b-9e36-93aae7fff539";
    static final String  connectorTypeName = "Governance Engine Out Topic Server Connector";
    static final String  connectorTypeDescription = "Connector supports the sending of events on the Governance Engine OMAS Out Topic.";

    /**
     * Constructor used to initialize the ConnectorProviderBase with the Java class name of the specific
     * governance service implementation.
     */
    public GovernanceEngineOutTopicServerProvider()
    {
        Class<?> connectorClass = GovernanceEngineOutTopicServerConnector.class;
