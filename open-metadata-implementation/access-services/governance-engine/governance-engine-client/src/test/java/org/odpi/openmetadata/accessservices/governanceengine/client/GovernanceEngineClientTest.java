...
public class GovernanceEngineClientTest {
    ...
    public void testGetGovernedAssetList() throws RESTServerException, InvalidParameterException, PropertyServerException, UserNotAuthorizedException {
        ...
        List<GovernedAsset> governedAssetList = governanceEngine.getGovernedAssetList(USER_ID,
                SECURITY_TAGS,
    ...
    public void testGetGovernedAsset()
        ...
        GovernedAsset governedAsset = governanceEngine.getGovernedAsset(USER_ID, RELATIONSHIP_COLUMN_GUID);
    ...
    public void testGetSoftwareServerCapabilityByGUID()
        ...
        SoftwareServerCapability softwareServerCapability = governanceEngine.getSoftwareServerCapabilityByGUID(USER_ID, SOFTWARE_SERVER_GUID);
    ...
    public void testCreateSoftwareServerCapability() throws RESTServerException, InvalidParameterException, PropertyServerException, UserNotAuthorizedException {
        ...
        String softwareServerCapabilityGUID = governanceEngine.createSoftwareServerCapability(USER_ID, body);
