...
public class GovernanceActionElementsResponse extends GovernanceEngineOMASAPIResponse
{
    private List<GovernanceActionElement> elements = null;

    /**
     * Default constructor
     */
    public GovernanceActionElementsResponse()
    {
        super();
    }
     ...
     */
    public GovernanceActionElementsResponse(GovernanceActionElementsResponse template)
    {
        super(template);
     ...
     */
    public List<GovernanceActionElement> getElements()
    {
        if (elements == null)
        {
            return null;
     ...
     */
    public void setElements(List<GovernanceActionElement> elements)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        GovernanceActionElementsResponse that = (GovernanceActionElementsResponse) objectToCompare;
