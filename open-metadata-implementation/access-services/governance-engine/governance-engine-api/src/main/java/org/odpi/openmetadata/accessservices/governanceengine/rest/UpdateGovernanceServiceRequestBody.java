...
public class UpdateGovernanceServiceRequestBody extends NewGovernanceServiceRequestBody
{
     ...
     * Default constructor
     */
    public UpdateGovernanceServiceRequestBody()
    {
        super();
    }
     ...
     */
    public UpdateGovernanceServiceRequestBody(UpdateGovernanceServiceRequestBody template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        UpdateGovernanceServiceRequestBody that = (UpdateGovernanceServiceRequestBody) objectToCompare;
    ...
    public int hashCode()
    {
        return Objects.hash(super.hashCode(), getAdditionalProperties(), getExtendedProperties());
    }
}
