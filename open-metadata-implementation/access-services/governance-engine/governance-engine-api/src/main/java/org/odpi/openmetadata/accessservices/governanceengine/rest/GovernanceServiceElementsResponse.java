...
public class GovernanceServiceElementsResponse extends GovernanceEngineOMASAPIResponse
{
     ...
     * Default constructor
     */
    public GovernanceServiceElementsResponse()
    {
        super();
    }
     ...
     */
    public GovernanceServiceElementsResponse(GovernanceServiceElementsResponse template)
    {
        super(template);
     ...
     */
    public void setElements(List<GovernanceServiceElement> elements)
    {
