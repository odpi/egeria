...
/**
 * OwnerCategory defines the identifier used in a governance owner property.
 * <ul>
 ...
 * </ul>
 * Being able to use a profile guid in this field allows for governance activity to be owned by Teams and Engines as well
 * as people.
 */
...
public enum OwnerCategory implements Serializable
{
    ...
    public static final String ENUM_TYPE_GUID  = "5ce92a70-b86a-4e0d-a9d7-fc961121de97";
    public static final String ENUM_TYPE_NAME  = "OwnerType";
