...
public enum GovernanceEngineErrorCode {
    ...
    BAD_USER_ID(400, "OMAS-GOVERNANCEENGINE-400-003 ",
    ...
    USER_NOT_AUTHORIZED(400, "OMAS-GOVERNANCEENGINE-400-008 ",
            "User {0} is not authorized to issue the {1} request for Access Service {3} on handlers {4}",
    ...
    NO_METADATA_COLLECTION(404, "OMAS-GOVERNANCEENGINE-404-004 ",
            ...
            "Check that the connection name and the open metadata handlers URL is correct.  Retry the request when the connection is available in the OMAS Service"),
