...
public enum GovernanceEngineErrorCode {
    SERVER_URL_NOT_SPECIFIED(400, "OMAS-GOVERNANCE-ENGINE-400-001 ",
    ...
    INVALID_EVENT_FORMAT(400, "OMAS-GOVERNANCE-ENGINE-400-006 ",
    ...
    USER_NOT_AUTHORIZED(400, "OMAS-GOVERNANCE-ENGINE-400-008 ",
            "User {0} is not authorized to invoke {1}",
            "The system is unable to process the request.",
            "Verify the access rights of the user."),
    PROPERTY_SERVER_ERROR(400, "OMAS-GOVERNANCE-ENGINE-400-009 ",
            ...
            "The system is unable to process the request.",
            "Verify the access rights of the user."),
    NULL_TEXT(400, "OMAS-GOVERNANCE-ENGINE-400-011 ",
    ...
    OMRS_NOT_AVAILABLE(404, "OMAS-GOVERNANCE-ENGINE-404-002 ",
