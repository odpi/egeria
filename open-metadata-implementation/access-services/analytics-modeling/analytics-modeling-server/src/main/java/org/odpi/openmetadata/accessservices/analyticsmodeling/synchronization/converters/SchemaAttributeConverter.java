...
public class SchemaAttributeConverter extends OpenMetadataAPIGenericConverter<SchemaAttribute> {
     ...
     */
    @Override
    public SchemaAttribute getNewBean(Class<SchemaAttribute>     beanClass,
                        EntityDetail entity,
                        String       methodName) throws PropertyServerException
    {
        ...
        SchemaAttribute bean = new SchemaAttribute();
