...
public enum OpenIntegrationAuditCode implements AuditLogMessageSet
{
     ...
     */
    CONTEXT_INITIALIZING("OPEN-INTEGRATION-SERVICE-0021",
                         AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    CONNECTOR_CONTEXT_INITIALIZING("OPEN-INTEGRATION-SERVICE-0022",
                                   AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    PERMITTED_SYNCHRONIZATION("OPEN-INTEGRATION-SERVICE-0023",
                              AuditLogRecordSeverityLevel.STARTUP,
     ...
     */
    NULL_CONTEXT("OPEN-INTEGRATION-SERVICE-0025",
                 AuditLogRecordSeverityLevel.ERROR,
