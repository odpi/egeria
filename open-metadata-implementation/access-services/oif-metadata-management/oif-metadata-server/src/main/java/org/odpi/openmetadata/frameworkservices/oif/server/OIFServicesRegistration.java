...
import org.odpi.openmetadata.frameworkservices.oif.admin.OIFOperationalServices;
 ...
 */
public class OIFServicesRegistration
{
    /**
    ...
    {
        AccessServiceDescription myDescription = AccessServiceDescription.OIF_METADATA_MANAGEMENT;

        AccessServiceRegistrationEntry myRegistration = new AccessServiceRegistrationEntry(myDescription,
                                                                                           ServiceOperationalStatus.ENABLED,
                                                                                           OIFOperationalServices.class.getName());
