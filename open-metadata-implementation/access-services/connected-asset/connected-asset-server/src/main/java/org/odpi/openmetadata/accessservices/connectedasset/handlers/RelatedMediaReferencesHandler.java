...
import org.odpi.openmetadata.accessservices.connectedasset.mappers.RelatedMediaReferenceMapper;
...
/**
 * RelatedMediaReferencesHandler is responsible for retrieving a list of RelatedMediaReferences from the open metadata repositories
 * taking into account the paging requirements.
 */
public class RelatedMediaReferencesHandler
{
    List<RelatedMediaReference>  returnedList = null;
     ...
     */
    public RelatedMediaReferencesHandler(String                  serviceName,
                                         String                  serverName,
                                                                          ...
                                                                          UserNotAuthorizedException
    {
        ...
        try
        {
            List<Relationship>   retrievedRelationships = repositoryHandler.retrieveRelationships(userId, AssetMapper.TYPE_NAME, assetGUID, RelatedMediaReferenceMapper.RELATIONSHIP_TYPE_NAME, elementStart, maxElements);
