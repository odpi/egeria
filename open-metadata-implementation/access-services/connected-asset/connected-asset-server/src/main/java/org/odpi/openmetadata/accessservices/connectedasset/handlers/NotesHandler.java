...
import org.odpi.openmetadata.accessservices.connectedasset.mappers.NoteMapper;
...
/**
 * NotesHandler is responsible for retrieving a list of Notes from the open metadata repositories
 * taking into account the paging requirements.
 */
public class NotesHandler
{
    List<Note>  returnedList = null;
     ...
     */
    public NotesHandler(String                  serviceName,
                        String                  serverName,
                                                                          ...
                                                                          UserNotAuthorizedException
    {
        ...
        try
        {
            List<Relationship>   retrievedRelationships = repositoryHandler.retrieveRelationships(userId, AssetMapper.TYPE_NAME, noteLogGUID, NoteMapper.RELATIONSHIP_TYPE_NAME, elementStart, maxElements);
