...
import org.odpi.openmetadata.accessservices.connectedasset.mappers.RatingMapper;
...
/**
 * RatingsHandler is responsible for retrieving a list of Ratings from the open metadata repositories
...
public class RatingsHandler
{
     ...
     */
    public RatingsHandler(String                  serviceName,
                          String                  serverName,
                                                                          ...
                                                                          UserNotAuthorizedException
    {
        ...
        try
        {
            List<Relationship>   retrievedRelationships = repositoryHandler.retrieveRelationships(userId, AssetMapper.TYPE_NAME, assetGUID, RatingMapper.RELATIONSHIP_TYPE_NAME, elementStart, maxElements);
