...
import org.odpi.openmetadata.accessservices.connectedasset.mappers.InformalTagMapper;
...
/**
 * InformalTagsHandler is responsible for retrieving a list of InformalTags from the open metadata repositories
 * taking into account the paging requirements.
 */
public class InformalTagsHandler
{
    List<InformalTag>  returnedList = null;
     ...
     */
    public InformalTagsHandler(String                  serviceName,
                               String                  serverName,
                                                                          ...
                                                                          UserNotAuthorizedException
    {
        ...
        try
        {
            List<Relationship>   retrievedRelationships = repositoryHandler.retrieveRelationships(userId, AssetMapper.TYPE_NAME, assetGUID, InformalTagMapper.RELATIONSHIP_TYPE_NAME, elementStart, maxElements);
