...
public class ElementType extends PropertyBase
{
    ...
    public ElementType(ElementType templateType)
    {
        ...
        this.elementAccessServiceURL = templateType.getElementSourceServerURL();
     ...
     */
    public String getElementSourceServerURL()
    {
     ...
     */
    public void setElementSourceServerURL(String    elementAccessServiceURL)
    {
