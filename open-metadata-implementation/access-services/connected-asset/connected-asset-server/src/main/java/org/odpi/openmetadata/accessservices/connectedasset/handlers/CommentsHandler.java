...
public class CommentsHandler
{
     ...
     */
    public CommentsHandler(String                  serviceName,
                           String                  serverName,
                                                                          ...
                                                                          UserNotAuthorizedException
    {
        ...
        try
        {
            List<Relationship>   retrievedRelationships = repositoryHandler.retrieveRelationships(userId, AssetMapper.TYPE_NAME, assetGUID, CommentMapper.RELATIONSHIP_TYPE_NAME, elementStart, maxElements);
