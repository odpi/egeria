...
import org.odpi.openmetadata.accessservices.connectedasset.mappers.ExternalReferenceMapper;
...
/**
 * ExternalReferencesHandler is responsible for retrieving a list of ExternalReferences from the open metadata repositories
 * taking into account the paging requirements.
 */
public class ExternalReferencesHandler
{
    List<ExternalReference>  returnedList = null;
                                                                          ...
                                                                          UserNotAuthorizedException
    {
        ...
        try
        {
            List<Relationship>   retrievedRelationships = repositoryHandler.retrieveRelationships(userId, AssetMapper.TYPE_NAME, assetGUID, ExternalReferenceMapper.RELATIONSHIP_TYPE_NAME, elementStart, maxElements);
