 ...
 */
public class CommentRepliesHandler
{
    List<CommentResponse>  returnedList = null;
     ...
     */
    public CommentRepliesHandler(String                  serviceName,
                                 String                  serverName,
                                                                          ...
                                                                          UserNotAuthorizedException
    {
        ...
        try
        {
            List<Relationship>   retrievedRelationships = repositoryHandler.retrieveRelationships(userId, AssetMapper.TYPE_NAME, commentGUID, CommentMapper.RELATIONSHIP_TYPE_NAME, elementStart, maxElements);
