...
/**
 * ExternalReferenceMapper provides property name mapping for ExternalReferences.
 */
public class ExternalReferenceMapper
{
    public static final String TYPE_NAME                                = "ExternalReference";    /* from ExternalReference entity */
