...
import org.odpi.openmetadata.accessservices.connectedasset.mappers.LocationMapper;
...
/**
 * LocationsHandler is responsible for retrieving a list of Locations from the open metadata repositories
 * taking into account the paging requirements.
 */
public class LocationsHandler
{
    List<Location> returnedList = null;
     ...
     */
    public LocationsHandler(String                  serviceName,
                            String                  serverName,
                                                                          ...
                                                                          UserNotAuthorizedException
    {
        ...
        try
        {
            List<Relationship>   retrievedRelationships = repositoryHandler.retrieveRelationships(userId, AssetMapper.TYPE_NAME, assetGUID, LocationMapper.RELATIONSHIP_TYPE_NAME, elementStart, maxElements);
