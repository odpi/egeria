...
import org.odpi.openmetadata.accessservices.connectedasset.mappers.ConnectionMapper;
...
/**
 * ConnectionsHandler is responsible for retrieving a list of Connections from the open metadata repositories
 * taking into account the paging requirements.
 */
public class ConnectionsHandler
{
    List<Connection>  returnedList = null;
     ...
     */
    public ConnectionsHandler(String                  serviceName,
                              String                  serverName,
                                                                          ...
                                                                          UserNotAuthorizedException
    {
        ...
        try
        {
            List<Relationship>   retrievedRelationships = repositoryHandler.retrieveRelationships(userId, AssetMapper.TYPE_NAME, assetGUID, ConnectionMapper.RELATIONSHIP_TYPE_NAME, elementStart, maxElements);
