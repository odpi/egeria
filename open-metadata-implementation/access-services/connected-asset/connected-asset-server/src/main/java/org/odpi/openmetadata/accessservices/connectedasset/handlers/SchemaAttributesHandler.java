...
import org.odpi.openmetadata.accessservices.connectedasset.mappers.CommentMapper;
...
/**
 * CommentsHandler is responsible for retrieving a list of Comments from the open metadata repositories
 * taking into account the paging requirements.
 */
public class SchemaAttributesHandler
{
    List<SchemaAttribute> returnedList = null;
     ...
     */
    public SchemaAttributesHandler(String                  serviceName,
                                   String                  serverName,
                                                                          ...
                                                                          UserNotAuthorizedException
    {
        ...
        try
        {
            List<Relationship>   retrievedRelationships = repositoryHandler.retrieveRelationships(userId, AssetMapper.TYPE_NAME, schemaTypeGUID, CommentMapper.RELATIONSHIP_TYPE_NAME, elementStart, maxElements);
     ...
     * @return list
     */
    public List<SchemaAttribute> getList()
    {
