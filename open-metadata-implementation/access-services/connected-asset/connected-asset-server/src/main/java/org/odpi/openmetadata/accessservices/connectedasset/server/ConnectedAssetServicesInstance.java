...
import org.odpi.openmetadata.accessservices.connectedasset.ffdc.exceptions.NewInstanceException;
 ...
 */
public class ConnectedAssetServicesInstance
{
     ...
     */
    public ConnectedAssetServicesInstance(OMRSRepositoryConnector repositoryConnector) throws NewInstanceException
    {
        ...
        if (repositoryConnector != null)
        {
            try
            {
                ...
                ConnectedAssetServicesInstanceMap.setNewInstanceForJVM(serverName, this);
            }
    ...
    public void shutdown() {
        ConnectedAssetServicesInstanceMap.removeInstanceForJVM(serverName);
    }
}
