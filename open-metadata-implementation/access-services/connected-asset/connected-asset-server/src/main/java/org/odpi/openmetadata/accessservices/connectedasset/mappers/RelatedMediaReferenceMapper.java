...
/**
 * RelatedMediaReferenceMapper provides property name mapping for RelatedMediaReferences.
 */
public class RelatedMediaReferenceMapper
{
    public static final String TYPE_NAME                                = "RelatedMediaReference";           /* from RelatedMediaReference entity */
