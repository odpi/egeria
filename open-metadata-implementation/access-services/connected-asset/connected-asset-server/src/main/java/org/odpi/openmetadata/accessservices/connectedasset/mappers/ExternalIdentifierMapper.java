...
/**
 * ExternalIdentifierMapper provides property name mapping for ExternalIdentifiers.
 */
public class ExternalIdentifierMapper
{
    public static final String TYPE_NAME                                = "ExternalIdentifier";   /* from ExternalIdentifier entity */
