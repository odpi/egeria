...
import org.odpi.openmetadata.accessservices.connectedasset.mappers.NoteLogMapper;
...
/**
 * NoteLogsHandler is responsible for retrieving a list of NoteLogs from the open metadata repositories
 * taking into account the paging requirements.
 */
public class NoteLogsHandler
{
    List<NoteLogResponse> returnedList = null;
     ...
     */
    public NoteLogsHandler(String                  serviceName,
                           String                  serverName,
                                                                          ...
                                                                          UserNotAuthorizedException
    {
        ...
        try
        {
            List<Relationship>   retrievedRelationships = repositoryHandler.retrieveRelationships(userId, AssetMapper.TYPE_NAME, assetGUID, NoteLogMapper.RELATIONSHIP_TYPE_NAME, elementStart, maxElements);
     ...
     * @return list
     */
    public List<NoteLogResponse> getList()
    {
