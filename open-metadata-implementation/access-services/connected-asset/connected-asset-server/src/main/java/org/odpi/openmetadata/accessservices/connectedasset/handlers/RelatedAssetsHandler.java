...
/**
 * RelatedAssetsHandler is responsible for retrieving a list of RelatedAssets from the open metadata repositories
 * taking into account the paging requirements.
 */
public class RelatedAssetsHandler
{
    List<Asset>  returnedList = null;
     ...
     */
    public RelatedAssetsHandler(String                  serviceName,
                                String                  serverName,
                                                                          ...
                                                                          UserNotAuthorizedException
    {
        ...
        try
        {
            List<Relationship>   retrievedRelationships = repositoryHandler.retrieveRelationships(userId, AssetMapper.TYPE_NAME, assetGUID, AssetMapper.RELATIONSHIP_TYPE_NAME, elementStart, maxElements);
