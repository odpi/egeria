...
import org.odpi.openmetadata.accessservices.connectedasset.mappers.ExternalIdentifierMapper;
...
/**
 * ExternalIdentifiersHandler is responsible for retrieving a list of ExternalIdentifiers from the open metadata repositories
 * taking into account the paging requirements.
 */
public class ExternalIdentifiersHandler
{
    List<ExternalIdentifier>  returnedList = null;
     ...
     */
    public ExternalIdentifiersHandler(String                  serviceName,
                                      String                  serverName,
                                                                          ...
                                                                          UserNotAuthorizedException
    {
        ...
        try
        {
            List<Relationship>   retrievedRelationships = repositoryHandler.retrieveRelationships(userId, AssetMapper.TYPE_NAME, assetGUID, ExternalIdentifierMapper.RELATIONSHIP_TYPE_NAME, elementStart, maxElements);
