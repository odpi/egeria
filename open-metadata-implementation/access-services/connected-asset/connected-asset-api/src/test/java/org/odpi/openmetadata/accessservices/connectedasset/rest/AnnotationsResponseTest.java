...
/**
 * Validate that the AnnotationsResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class AnnotationsResponseTest
{
    private Map<String, Object> exceptionProperties = new HashMap<>();
    private List<Annotation>    responseList        = new ArrayList<>();
    private Annotation          responseObject      = new Annotation();


    /**
     * Default constructor
     */
    public AnnotationsResponseTest()
    {
     ...
     */
    private AnnotationsResponse getTestObject()
    {
        AnnotationsResponse testObject = new AnnotationsResponse();
     ...
     */
    private void validateResultObject(AnnotationsResponse  resultObject)
    {
    ...
    {
        AnnotationsResponse    nullObject = new AnnotationsResponse();
        ...
        nullObject = new AnnotationsResponse(null);
    ...
    @Test public void testExceptionProperties()
    {
        ...
        propertyMap = null;
        testObject = new AnnotationsResponse();
    ...
    @Test public void testEquals()
    {
        ...
        AnnotationsResponse  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        AnnotationsResponse  differentObject = getTestObject();
    ...
    {
        validateResultObject(new AnnotationsResponse(getTestObject()));
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, AnnotationsResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((AnnotationsResponse) objectMapper.readValue(jsonString, ConnectedAssetOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(getTestObject().toString().contains("AnnotationsResponse"));
    }
}
