...
/**
 * Validate that the ConnectedAssetRuntimeException is properly populated and supports toString, hashCode and
 * equals.
 */
public class RuntimeExceptionTest
{
    ...
    {
        ConnectedAssetRuntimeException exception = new ConnectedAssetRuntimeException(reportedHTTPCode,
                                                                                      reportingClassName,
    ...
    @Test public void testHashCode()
    {
        ...
        ConnectedAssetRuntimeException exception2 = new ConnectedAssetRuntimeException(reportedHTTPCode,
                                                                                       reportingClassName,
                                                                                       reportingActionDescription,
                                                                                       reportedErrorMessage,
                                                                                       reportedSystemAction,
        ...
        assertTrue(exception.toString().contains("ConnectedAssetRuntimeException"));
