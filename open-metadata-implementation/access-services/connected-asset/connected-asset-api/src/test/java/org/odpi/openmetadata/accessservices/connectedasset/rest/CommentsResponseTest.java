...
/**
 * Validate that the CommentsResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class CommentsResponseTest
{
     ...
     */
    private CommentsResponse getTestObject()
    {
        CommentsResponse testObject = new CommentsResponse();
     ...
     */
    private void validateResultObject(CommentsResponse  resultObject)
    {
    ...
    {
        CommentsResponse    nullObject = new CommentsResponse();
        ...
        nullObject = new CommentsResponse(null);
    ...
    @Test public void testExceptionProperties()
    {
        ...
        propertyMap = null;
        testObject = new CommentsResponse();
    ...
    @Test public void testEquals()
    {
        ...
        CommentsResponse  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        CommentsResponse  differentObject = getTestObject();
    ...
    {
        validateResultObject(new CommentsResponse(getTestObject()));
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, CommentsResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((CommentsResponse) objectMapper.readValue(jsonString, ConnectedAssetOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(getTestObject().toString().contains("CommentsResponse"));
    }
}
