...
/**
 * Validate that the MeaningsResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class MeaningsResponseTest
{
    private Map<String, Object> exceptionProperties = new HashMap<>();
    private List<Meaning>       responseList        = new ArrayList<>();
    private Meaning             responseObject      = new Meaning();


    /**
     * Default constructor
     */
    public MeaningsResponseTest()
    {
     ...
     */
    private MeaningsResponse getTestObject()
    {
        MeaningsResponse testObject = new MeaningsResponse();
     ...
     */
    private void validateResultObject(MeaningsResponse  resultObject)
    {
    ...
    {
        MeaningsResponse    nullObject = new MeaningsResponse();
        ...
        nullObject = new MeaningsResponse(null);
    ...
    @Test public void testExceptionProperties()
    {
        ...
        propertyMap = null;
        testObject = new MeaningsResponse();
    ...
    @Test public void testEquals()
    {
        ...
        MeaningsResponse  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        MeaningsResponse  differentObject = getTestObject();
    ...
    {
        validateResultObject(new MeaningsResponse(getTestObject()));
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, MeaningsResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((MeaningsResponse) objectMapper.readValue(jsonString, ConnectedAssetOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(getTestObject().toString().contains("MeaningsResponse"));
    }
}
