...
/**
 * Validate that the NoteLogsResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class NoteLogsResponseTest
{
     ...
     */
    private NoteLogsResponse getTestObject()
    {
        NoteLogsResponse testObject = new NoteLogsResponse();
     ...
     */
    private void validateResultObject(NoteLogsResponse  resultObject)
    {
    ...
    {
        NoteLogsResponse    nullObject = new NoteLogsResponse();
        ...
        nullObject = new NoteLogsResponse(null);
    ...
    @Test public void testExceptionProperties()
    {
        ...
        propertyMap = null;
        testObject = new NoteLogsResponse();
    ...
    @Test public void testEquals()
    {
        ...
        NoteLogsResponse  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        NoteLogsResponse  differentObject = getTestObject();
    ...
    {
        validateResultObject(new NoteLogsResponse(getTestObject()));
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, NoteLogsResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((NoteLogsResponse) objectMapper.readValue(jsonString, ConnectedAssetOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(getTestObject().toString().contains("NoteLogsResponse"));
    }
}
