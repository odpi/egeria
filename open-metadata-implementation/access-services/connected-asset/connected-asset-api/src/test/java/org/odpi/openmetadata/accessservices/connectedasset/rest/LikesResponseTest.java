...
/**
 * Validate that the LikesResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class LikesResponseTest
{
    private Map<String, Object> exceptionProperties = new HashMap<>();
    private List<Like>          responseList        = new ArrayList<>();
    private Like                responseObject      = new Like();


    /**
     * Default constructor
     */
    public LikesResponseTest()
    {
     ...
     */
    private LikesResponse getTestObject()
    {
        LikesResponse testObject = new LikesResponse();
     ...
     */
    private void validateResultObject(LikesResponse  resultObject)
    {
    ...
    {
        LikesResponse    nullObject = new LikesResponse();
        ...
        nullObject = new LikesResponse(null);
    ...
    @Test public void testEquals()
    {
        ...
        LikesResponse  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        LikesResponse  differentObject = getTestObject();
    ...
    {
        validateResultObject(new LikesResponse(getTestObject()));
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, LikesResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((LikesResponse) objectMapper.readValue(jsonString, ConnectedAssetOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(getTestObject().toString().contains("LikesResponse"));
    }
}
