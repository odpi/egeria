...
/**
 * Validate that the LicensesResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class LicensesResponseTest
{
    private Map<String, Object> exceptionProperties = new HashMap<>();
    private List<License>       responseList        = new ArrayList<>();
    private License             responseObject      = new License();


    /**
     * Default constructor
     */
    public LicensesResponseTest()
    {
     ...
     */
    private LicensesResponse getTestObject()
    {
        LicensesResponse testObject = new LicensesResponse();
     ...
     */
    private void validateResultObject(LicensesResponse  resultObject)
    {
    ...
    {
        LicensesResponse    nullObject = new LicensesResponse();
        ...
        nullObject = new LicensesResponse(null);
    ...
    @Test public void testExceptionProperties()
    {
        ...
        propertyMap = null;
        testObject = new LicensesResponse();
    ...
    @Test public void testEquals()
    {
        ...
        LicensesResponse  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        LicensesResponse  differentObject = getTestObject();
    ...
    {
        validateResultObject(new LicensesResponse(getTestObject()));
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, LicensesResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((LicensesResponse) objectMapper.readValue(jsonString, ConnectedAssetOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(getTestObject().toString().contains("LicensesResponse"));
    }
}
