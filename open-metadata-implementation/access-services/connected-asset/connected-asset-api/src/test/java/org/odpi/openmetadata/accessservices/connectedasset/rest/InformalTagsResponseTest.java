...
/**
 * Validate that the InformalTagsResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class InformalTagsResponseTest
{
    private Map<String, Object> exceptionProperties = new HashMap<>();
    private List<InformalTag>   responseList        = new ArrayList<>();
    private InformalTag         responseObject      = new InformalTag();


    /**
     * Default constructor
     */
    public InformalTagsResponseTest()
    {
     ...
     */
    private InformalTagsResponse getTestObject()
    {
        InformalTagsResponse testObject = new InformalTagsResponse();
     ...
     */
    private void validateResultObject(InformalTagsResponse  resultObject)
    {
    ...
    {
        InformalTagsResponse    nullObject = new InformalTagsResponse();
        ...
        nullObject = new InformalTagsResponse(null);
    ...
    @Test public void testExceptionProperties()
    {
        ...
        propertyMap = null;
        testObject = new InformalTagsResponse();
    ...
    @Test public void testEquals()
    {
        ...
        InformalTagsResponse  sameObject = getTestObject();
        assertTrue(sameObject.equals(sameObject));

        InformalTagsResponse  differentObject = getTestObject();
    ...
    {
        validateResultObject(new InformalTagsResponse(getTestObject()));
    }
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            validateResultObject(objectMapper.readValue(jsonString, InformalTagsResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
        ...
        try
        {
            validateResultObject((InformalTagsResponse) objectMapper.readValue(jsonString, ConnectedAssetOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(getTestObject().toString().contains("InformalTagsResponse"));
    }
}
