...
/**
 * InformalTagsResponse is the response structure used on the OMAS REST API calls that return a
 * list of InformalTag objects as a response.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class InformalTagsResponse extends ConnectedAssetOMASAPIResponse
{
    private List<InformalTag> responseObjects = null;
     ...
     */
    public List<InformalTag> getList()
    {
     ...
     */
    public void setList(List<InformalTag> responseObjects)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof InformalTagsResponse))
        {
            return false;
        }
