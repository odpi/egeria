 ...
 * list of License objects as a response.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class LicensesResponse extends ConnectedAssetOMASAPIResponse
{
    private List<License> responseObjects = null;
     ...
     */
    public void setList(List<License> responseObjects)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof LicensesResponse))
        {
            return false;
        }
        ...
        LicensesResponse that = (LicensesResponse) objectToCompare;
