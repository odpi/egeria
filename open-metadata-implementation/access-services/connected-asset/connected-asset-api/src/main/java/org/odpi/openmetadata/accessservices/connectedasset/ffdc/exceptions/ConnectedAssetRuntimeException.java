...
public class ConnectedAssetRuntimeException extends RuntimeException
{
     ...
     */
    public ConnectedAssetRuntimeException(int                 httpCode,
                                          String              className,
    ...
    {
        return "ConnectedAssetRuntimeException{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ConnectedAssetRuntimeException))
        {
            return false;
        }
        ConnectedAssetRuntimeException that = (ConnectedAssetRuntimeException) objectToCompare;
