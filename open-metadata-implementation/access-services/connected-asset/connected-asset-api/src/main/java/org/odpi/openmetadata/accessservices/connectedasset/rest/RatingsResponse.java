...
/**
 * RatingsResponse is the response structure used on the OMAS REST API calls that return a
 * list of Rating objects as a response.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class RatingsResponse extends ConnectedAssetOMASAPIResponse
{
    private List<Rating> responseObjects = null;
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof RatingsResponse))
        {
            return false;
        }
        ...
        RatingsResponse that = (RatingsResponse) objectToCompare;
