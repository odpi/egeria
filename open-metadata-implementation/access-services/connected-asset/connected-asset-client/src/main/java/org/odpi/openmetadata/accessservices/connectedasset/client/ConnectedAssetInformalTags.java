...
/**
 * ConnectedAssetInformalTags provides the open metadata concrete implementation of the
 * Open Connector Framework (OCF) AssetInformalTags abstract class.
...
public class ConnectedAssetInformalTags extends AssetInformalTags
{
     ...
     */
    ConnectedAssetInformalTags(String              userId,
     ...
     */
    private ConnectedAssetInformalTags(ConnectedAsset   parentAsset, ConnectedAssetInformalTags template)
    {
                                                     ...
                                                     int  maximumSize) throws PropertyServerException
    {
        ...
        final String   urlTemplate = "/open-metadata/access-services/connected-asset/users/{0}/assets/{1}/informal-tags?elementStart={2}&maxElements={3}";

        connectedAsset.validateOMASServerURL(methodName);

        try
        {
            InformalTagsResponse restResult = (InformalTagsResponse)connectedAsset.callGetRESTCall(methodName,
                                                                                                   InformalTagsResponse.class,
            ...
            else
            {
                ...
                for (InformalTag  bean : beans)
                {
                    if (bean != null)
                    {
                        resultList.add(new AssetInformalTag(connectedAsset, bean));
                    }
                }
