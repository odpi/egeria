...
public class ConnectedAssetRatings extends AssetRatings
{
     ...
     */
    ConnectedAssetRatings(String              userId,
                                                     ...
                                                     int  maximumSize) throws PropertyServerException
    {
        ...
        final String   urlTemplate = "/open-metadata/access-services/connected-asset/users/{0}/assets/{1}/ratings?elementStart={2}&maxElements={3}";
