...
/**
 * ConnectedAssetAnnotations provides the open metadata concrete implementation of the
 * Open Connector Framework (OCF) AssetAnnotations abstract class.
 * Its role is to query the property servers (metadata repository cohort) to extract annotations
...
public class ConnectedAssetAnnotations extends AssetAnnotations
{
    ...
    {
        return new ConnectedAssetAnnotations(connectedAsset, this);
    }
                                                     ...
                                                     int  maximumSize) throws PropertyServerException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                for (Annotation  bean : beans)
                {
                    if (bean != null)
                    {
                        resultList.add(new AssetAnnotation(connectedAsset, bean));
                    }
                }
