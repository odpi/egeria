...
public class ConnectedAssetMeanings extends AssetMeanings
{
     ...
     */
    ConnectedAssetMeanings(String              serverName,
                           String              userId,
                                                     ...
                                                     int  maximumSize) throws PropertyServerException
    {
        ...
        final String   urlTemplate = "/servers/{0}/open-metadata/access-services/connected-asset/users/{1}/assets/{2}/meanings?elementStart={3}&maxElements={4}";
