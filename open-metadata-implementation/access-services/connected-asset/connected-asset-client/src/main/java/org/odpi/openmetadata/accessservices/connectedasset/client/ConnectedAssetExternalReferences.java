...
public class ConnectedAssetExternalReferences extends AssetExternalReferences
{
     ...
     */
    ConnectedAssetExternalReferences(String              userId,
                                                     ...
                                                     int  maximumSize) throws PropertyServerException
    {
        ...
        final String   urlTemplate = "/open-metadata/access-services/connected-asset/users/{0}/assets/{1}/external-references?elementStart={2}&maxElements={3}";
