...
public class ConnectedAssetLicenses extends AssetLicenses
{
     ...
     */
    ConnectedAssetLicenses(String              userId,
                                                     ...
                                                     int  maximumSize) throws PropertyServerException
    {
        ...
        final String   urlTemplate = "/open-metadata/access-services/connected-asset/users/{0}/assets/{1}/licenses?elementStart={2}&maxElements={3}";

        connectedAsset.validateOMASServerURL(methodName);

        try
        {
            LicensesResponse restResult = (LicensesResponse)connectedAsset.callGetRESTCall(methodName,
