...
public class ConnectedAssetExternalIdentifiers extends AssetExternalIdentifiers
{
     ...
     */
    ConnectedAssetExternalIdentifiers(String              userId,
                                                     ...
                                                     int  maximumSize) throws PropertyServerException
    {
        ...
        final String   urlTemplate = "/open-metadata/access-services/connected-asset/users/{0}/assets/{1}/external-identifiers?elementStart={2}&maxElements={3}";
