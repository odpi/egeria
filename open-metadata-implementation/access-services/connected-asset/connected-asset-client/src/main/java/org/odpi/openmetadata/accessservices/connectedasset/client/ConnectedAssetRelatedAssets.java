...
public class ConnectedAssetRelatedAssets extends RelatedAssets
{
     ...
     */
    ConnectedAssetRelatedAssets(String              userId,
                                                     ...
                                                     int  maximumSize) throws PropertyServerException
    {
        ...
        final String   urlTemplate = "/open-metadata/access-services/connected-asset/users/{0}/assets/{1}/related-assets?elementStart={2}&maxElements={3}";
        ...
        try
        {
            ...
            else
            {
                ...
                for (Asset  bean : beans)
                {
                    if (bean != null)
                    {
                        resultList.add(new RelatedAsset(connectedAsset, bean, new ConnectedAssetRelatedAssetProperties(userId,
                                                                                                                       omasServerURL,
                                                                                                                       assetGUID)));
                    }
                }
