...
import org.odpi.openmetadata.frameworks.connectors.properties.AssetLike;
...
public class ConnectedAssetLikes extends AssetLikes
{
     ...
     */
    ConnectedAssetLikes(String              userId,
     ...
     */
    private ConnectedAssetLikes(ConnectedAsset   parentAsset, ConnectedAssetLikes template)
    {
                                                     ...
                                                     int  maximumSize) throws PropertyServerException
    {
        ...
        final String   urlTemplate = "/open-metadata/access-services/connected-asset/users/{0}/assets/{1}/likes?elementStart={2}&maxElements={3}";
        ...
        try
        {
            ...
            else
            {
                ...
                for (Like  bean : beans)
                {
                    if (bean != null)
                    {
                        resultList.add(new AssetLike(connectedAsset, bean));
                    }
                }
