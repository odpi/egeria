...
public class EntityPropertiesUtils {
    ...
    public static PrimitivePropertyValue createPrimitiveBooleanPropertyValue(Boolean value) {
        PrimitivePropertyValue propertyValue = new PrimitivePropertyValue();
        propertyValue.setPrimitiveDefCategory(PrimitiveDefCategory.OM_PRIMITIVE_TYPE_BOOLEAN);
        propertyValue.setTypeGUID(PrimitiveDefCategory.OM_PRIMITIVE_TYPE_BOOLEAN.getGUID());
        propertyValue.setTypeName(PrimitiveDefCategory.OM_PRIMITIVE_TYPE_BOOLEAN.getName());
        propertyValue.setPrimitiveValue(value);
        return propertyValue;
    }

    public static MapPropertyValue createMapPropertyValue() {
