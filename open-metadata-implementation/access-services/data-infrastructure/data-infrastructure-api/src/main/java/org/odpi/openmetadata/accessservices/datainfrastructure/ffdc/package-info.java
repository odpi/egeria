...
/**
 * This package provides the first failure data capture support for the Data Infrastructure OMAS module.
 ...
 *
 * The error code enum (DataInfrastructureErrorCode) has an entry for each unique situation
