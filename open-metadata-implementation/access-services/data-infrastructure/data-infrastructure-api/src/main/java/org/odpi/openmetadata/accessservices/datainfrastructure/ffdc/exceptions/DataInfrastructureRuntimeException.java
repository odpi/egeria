...
/**
 * DataInfrastructureRuntimeException is used for all runtime exceptions generated by the Data Infrastructure OMAS.
 * It is used in conjunction with the DataInfrastructureErrorCode to provide first failure data capture for these errors.
 */
public class DataInfrastructureRuntimeException extends RuntimeException
{
     ...
     */
    public DataInfrastructureRuntimeException(int                 httpCode,
                                              String              className,
    ...
    {
        return "DataInfrastructureRuntimeException{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof DataInfrastructureRuntimeException))
        {
            return false;
        }
        DataInfrastructureRuntimeException that = (DataInfrastructureRuntimeException) objectToCompare;
