...
/**
 * DataInfrastructureOMASAPIResponse provides a common header for Data Infrastructure OMAS managed responses to its REST API.
...
public abstract class DataInfrastructureOMASAPIResponse implements java.io.Serializable
{
     ...
     * Default constructor
     */
    public DataInfrastructureOMASAPIResponse()
    {
    }
     ...
     */
    public DataInfrastructureOMASAPIResponse(DataInfrastructureOMASAPIResponse  template)
    {
        if (template !=null)
        {
    ...
    {
        return "DataInfrastructureOMASAPIResponse{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof DataInfrastructureOMASAPIResponse))
        {
            return false;
        }
        DataInfrastructureOMASAPIResponse that = (DataInfrastructureOMASAPIResponse) objectToCompare;
