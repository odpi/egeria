...
/**
 * DataInfrastructureCheckedExceptionBase provides a checked exception for reporting errors found when using
 * the Data Infrastructure OMAS services.
 *
 ...
 * The DataInfrastructureErrorCode can be used with this exception to populate it with standard messages.
 * The aim is to be able to uniquely identify the cause and remedy for the error.
 */
public abstract class DataInfrastructureCheckedExceptionBase extends Exception
{
     ...
     */
    public DataInfrastructureCheckedExceptionBase(int    httpCode,
                                                  String className,
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof DataInfrastructureCheckedExceptionBase))
        {
            return false;
        }
        DataInfrastructureCheckedExceptionBase that = (DataInfrastructureCheckedExceptionBase) objectToCompare;
