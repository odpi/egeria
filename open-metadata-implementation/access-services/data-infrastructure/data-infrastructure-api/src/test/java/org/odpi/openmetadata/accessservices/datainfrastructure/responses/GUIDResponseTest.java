...
public class GUIDResponseTest
{
    ...
    @Test public void testJSON()
    {
         ...
         * Through superclass
         */
        DataInfrastructureOMASAPIResponse superObject = getTestObject();
        ...
        try
        {
            validateResultObject((GUIDResponse) objectMapper.readValue(jsonString, DataInfrastructureOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
