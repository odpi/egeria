...
public class InformationViewInTopicListener implements InformationViewListener {
    ...
    /**
     * @param event contains all the information needed to build information view like connection details, database
     *              name, schema name, table name, derived columns details
     */
    @Override
    public void processEvent(InformationViewEvent event) {
