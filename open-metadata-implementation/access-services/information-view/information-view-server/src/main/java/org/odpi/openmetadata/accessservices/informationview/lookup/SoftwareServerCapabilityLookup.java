...
public class SoftwareServerCapabilityLookup extends EntityLookup<SoftwareServerCapabilitySource>{
    ...
    protected InstanceProperties getMatchingProperties(SoftwareServerCapabilitySource softwareServerCapabilitySource) {
        ...
        matchProperties = enterpriseConnector.getRepositoryHelper().addStringPropertyToInstance(Constants.INFORMATION_VIEW_OMAS_NAME, matchProperties, Constants.QUALIFIED_NAME, softwareServerCapabilitySource.getName(), "getMatchingProperties");
