...
public class ReportElementCreationException extends InformationViewUncheckedExceptionBase{

    public ReportElementCreationException(String className, String errorMessage, String systemAction,
                                          String userAction, Throwable caughtError) {
        super(className, errorMessage, systemAction, userAction, caughtError);
    }

    public ReportElementCreationException(int httpErrorCode, String reportingClassName,
