...
/**
 * GAFOutTopicServerConnector is the java implementation of the
 * the server side connector that send events to the Open Metadata Store's OutTopic.
 */
public class GAFOutTopicServerConnector extends OpenMetadataTopicSenderConnectorBase
{
    ...
    public void sendEvent(OpenMetadataOutTopicEvent event) throws InvalidParameterException, ConnectorCheckedException
    {
        ...
        {
            throw new ConnectorCheckedException(OMFServicesErrorCode.UNABLE_TO_SEND_EVENT.getMessageDefinition(connectionName,
                                                                                                               event.toString(),
