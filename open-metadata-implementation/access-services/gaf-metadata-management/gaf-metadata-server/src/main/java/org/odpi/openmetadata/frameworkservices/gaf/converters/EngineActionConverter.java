        ...
        try
        {
            ...
            if (returnBean instanceof EngineActionElement bean)
            {
                if (primaryEntity != null)
                {
                    ...
                    bean.setActionStatus(this.removeActivityStatus(OpenMetadataProperty.ACTIVITY_STATUS.name, instanceProperties));
                    bean.setRequestedStartTime(this.removeRequestedStartDate(instanceProperties));
                    bean.setStartTime(this.removeStartTime(instanceProperties));
                        ...
                        for (Relationship relationship : relationships)
                        {
                            if ((relationship != null) && (relationship.getType() != null))
                            {
                                ...
                                else if (repositoryHelper.isTypeOf(serviceName, actualTypeName, OpenMetadataType.ACTION_TARGET_RELATIONSHIP.typeName))
                                {
                                    ...
                                    actionTargetElement.setStatus(this.removeActivityStatus(OpenMetadataProperty.ACTIVITY_STATUS.name, instanceProperties));
                                    actionTargetElement.setStartDate(this.removeStartTime(instanceProperties));
