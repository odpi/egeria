...
import org.odpi.openmetadata.frameworkservices.gaf.admin.GAFOperationalServices;
 ...
 */
public class GAFServicesRegistration
{
    /**
    ...
    {
        AccessServiceDescription myDescription = AccessServiceDescription.GAF_METADATA_MANAGEMENT;

        AccessServiceRegistrationEntry myRegistration = new AccessServiceRegistrationEntry(myDescription,
                                                                                           ServiceOperationalStatus.ENABLED,
                                                                                           GAFOperationalServices.class.getName());
