...
public class NewGovernanceActionProcessRequestBody
{
    private ElementStatus                     processStatus = null;
     ...
     * @return status enum
     */
    public ElementStatus getProcessStatus()
    {
     ...
     */
    public void setProcessStatus(ElementStatus processStatus)
    {
