...
public class GovernanceActionTypesResponse extends OMAGGAFAPIResponse
{
     ...
     * Default constructor
     */
    public GovernanceActionTypesResponse()
    {
        super();
    }
     ...
     */
    public GovernanceActionTypesResponse(GovernanceActionTypesResponse template)
    {
        super(template);
    ...
    {
        return "GovernanceActionTypesResponse{" +
                "elements=" + elements +
                "} " + super.toString();
    }
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        GovernanceActionTypesResponse that = (GovernanceActionTypesResponse) objectToCompare;
