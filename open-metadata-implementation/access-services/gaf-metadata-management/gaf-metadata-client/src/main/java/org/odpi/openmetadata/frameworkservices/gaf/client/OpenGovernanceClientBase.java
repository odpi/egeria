...
public class OpenGovernanceClientBase extends OpenGovernanceClient
{
                                                                               ...
                                                                               PropertyServerException
    {
        ...
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/engine-actions?startFrom={3}&pageSize={4}";
                                                                                               ...
                                                                                               PropertyServerException
    {
        ...
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-types";
                                                                                             ...
                                                                                             PropertyServerException
    {
        ...
        final String propertiesParameterName = "properties";
        final String qualifiedNameParameterName = "properties.getQualifiedName";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-types/{3}/update";
                                                                                   ...
                                                                                   PropertyServerException
    {
        ...
        final String guidParameterName = "governanceActionTypeGUID";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-types/{3}/remove";
                                                                                                           ...
                                                                                                           PropertyServerException
    {
        ...
        final String searchStringParameterName = "searchString";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-types/by-search-string";
                                                                                                              ...
                                                                                                              PropertyServerException
    {
        ...
        final String nameParameterName = "name";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-types/by-name";
                                                                                                             ...
                                                                                                             PropertyServerException
    {
        ...
        final String guidParameterName = "governanceActionTypeGUID";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-types/{3}";
                                                                                    ...
                                                                                    PropertyServerException
    {
        ...
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-processes";
                                                                                                          ...
                                                                                                          PropertyServerException
    {
        ...
        final String propertiesParameterName = "processProperties";
        final String qualifiedNameParameterName = "processProperties.getQualifiedName";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-processes/{3}/update";
                                                                          ...
                                                                          PropertyServerException
    {
        ...
        final String guidParameterName = "processGUID";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-processes/{3}/publish";
                                                                           ...
                                                                           PropertyServerException
    {
        ...
        final String guidParameterName = "processGUID";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-processes/{3}/withdraw";
                                                                         ...
                                                                         PropertyServerException
    {
        ...
        final String guidParameterName = "processGUID";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-processes/{3}/remove";
                                                                                                                  ...
                                                                                                                  PropertyServerException
    {
        ...
        final String searchStringParameterName = "searchString";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-processes/by-search-string";
                                                                                                                ...
                                                                                                                PropertyServerException
    {
        ...
        final String nameParameterName = "name";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-processes/by-name";
                                                                                                      ...
                                                                                                      PropertyServerException
    {
        ...
        final String guidParameterName = "processGUID";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-processes/{3}";
                                                                                                                        ...
                                                                                                                        PropertyServerException
    {
        ...
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-process-steps";
                                                                                                                      ...
                                                                                                                      PropertyServerException
    {
        ...
        final String propertiesParameterName = "processStepProperties";
        final String qualifiedNameParameterName = "processStepProperties.getQualifiedName";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-process-steps/{3}/update";
                                                                                 ...
                                                                                 PropertyServerException
    {
        ...
        final String guidParameterName = "processStepGUID";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-process-steps/{3}/remove";
                                                                                                                         ...
                                                                                                                         PropertyServerException
    {
        ...
        final String searchStringParameterName = "searchString";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-process-steps/by-search-string";
                                                                                                                            ...
                                                                                                                            PropertyServerException
    {
        ...
        final String nameParameterName = "name";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-process-steps/by-name";
                                                                                                                  ...
                                                                                                                  PropertyServerException
    {
        ...
        final String guidParameterName = "processStepGUID";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-process-steps/{3}";
                                                                 ...
                                                                 PropertyServerException
    {
        ...
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-processes/{3}/first-action-process-step/{4}";
                                                                                                        ...
                                                                                                        PropertyServerException
    {
        ...
        final String guidParameterName = "processGUID";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-processes/{3}/first-action-process-step";
                                                                        ...
                                                                        PropertyServerException
    {
        ...
        final String guidParameterName = "processGUID";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-processes/{3}/first-action-process-step/remove";
                                                                                    ...
                                                                                    PropertyServerException
    {
        ...
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-process-steps/{3}/next-process-steps/{4}";
                                                                           ...
                                                                           PropertyServerException
    {
        ...
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-process-steps/next-process-steps/{3}/update";
                                                                                                                    ...
                                                                                                                    PropertyServerException
    {
        ...
        final String guidParameterName = "processStepGUID";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-process-steps/{3}/next-process-step?startFrom={4}&pageSize={5}";
                                                                               ...
                                                                               PropertyServerException
    {
        final String methodName = "removeFirstActionProcessStep";
        final String guidParameterName = "processGUID";
        final String urlTemplate = serverPlatformURLRoot + "/servers/{0}/open-metadata/access-services/{1}/open-governance-service/users/{2}/governance-action-process-steps/next-process-step/{3}/remove";
