...
public class GlossaryManagementClient implements GlossaryManagementInterface
{
    ...
    public String createGlossaryCategory(String                       userId,
                                         ...
                                         boolean                      forDuplicateProcessing) throws InvalidParameterException,
                                                                                                     ...
                                                                                                     PropertyServerException
    {
        return client.createGlossaryCategory(userId, null, null, false, glossaryGUID, null, glossaryCategoryProperties, effectiveTime, forLineage, forDuplicateProcessing);
    }
    ...
    public List<GlossaryTermElement>    getTermsForGlossary(String  userId,
                                                            ...
                                                            boolean forDuplicateProcessing) throws InvalidParameterException,
                                                                                                   ...
                                                                                                   PropertyServerException
    {
        return client.getTermsForGlossary(userId, null, null, glossaryGUID, startFrom, pageSize, effectiveTime, forLineage, forDuplicateProcessing);
    }
    ...
    public List<GlossaryTermElement>    getTermsForGlossaryCategory(String  userId,
                                                                    ...
                                                                    boolean forDuplicateProcessing) throws InvalidParameterException,
                                                                                                           ...
                                                                                                           PropertyServerException
    {
        return client.getTermsForGlossaryCategory(userId, null, null, glossaryCategoryGUID, startFrom, pageSize, effectiveTime, forLineage, forDuplicateProcessing);
    }
    ...
    public String createExternalGlossaryLink(String                         userId,
                                             ExternalGlossaryLinkProperties linkProperties) throws InvalidParameterException,
                                                                                                   ...
                                                                                                   PropertyServerException
    {
        return client.createExternalGlossaryLink(userId, null, null, linkProperties);
    }
    ...
    public void updateExternalGlossaryLink(String                         userId,
                                           ...
                                           boolean                        forDuplicateProcessing) throws InvalidParameterException,
                                                                                                         ...
                                                                                                         PropertyServerException
    {
        client.updateExternalGlossaryLink(userId, null, null, externalLinkGUID, isMergeUpdate, linkProperties, effectiveTime, forLineage, forDuplicateProcessing);
    }
    ...
    public void removeExternalGlossaryLink(String  userId,
                                           ...
                                           boolean forDuplicateProcessing) throws InvalidParameterException,
                                                                                  ...
                                                                                  PropertyServerException
    {
        client.removeExternalGlossaryLink(userId, null, null, externalLinkGUID, effectiveTime, forLineage, forDuplicateProcessing);
    }
    ...
    public void attachExternalLinkToGlossary(String  userId,
                                             ...
                                             boolean forDuplicateProcessing) throws InvalidParameterException,
                                                                                    ...
                                                                                    PropertyServerException
    {
        client.attachExternalLinkToGlossary(userId, null, null, externalLinkGUID, glossaryGUID, effectiveTime, forLineage, forDuplicateProcessing);
    }
    ...
    public void detachExternalLinkFromGlossary(String  userId,
                                               ...
                                               boolean forDuplicateProcessing) throws InvalidParameterException,
                                                                                      ...
                                                                                      PropertyServerException
    {
        client.detachExternalLinkFromGlossary(userId, null, null, externalLinkGUID, glossaryGUID, effectiveTime, forLineage, forDuplicateProcessing);
    }
    ...
    public List<ExternalGlossaryLinkElement> getExternalLinksForGlossary(String  userId,
                                                                         ...
                                                                         boolean forDuplicateProcessing) throws InvalidParameterException,
                                                                                                                ...
                                                                                                                PropertyServerException
    {
        return client.getExternalLinksForGlossary(userId, null, null, glossaryGUID, startFrom, pageSize, effectiveTime, forLineage, forDuplicateProcessing);
    }
    ...
    public List<GlossaryElement> getGlossariesForExternalLink(String  userId,
                                                              ...
                                                              boolean forDuplicateProcessing) throws InvalidParameterException,
                                                                                                     ...
                                                                                                     PropertyServerException
    {
        return client.getGlossariesForExternalLink(userId, null, null, externalLinkGUID, startFrom, pageSize, effectiveTime, forLineage, forDuplicateProcessing);
    }
    ...
    public void attachExternalCategoryLink(String                                userId,
                                           ...
                                           boolean                               forDuplicateProcessing) throws InvalidParameterException,
                                                                                                                ...
                                                                                                                PropertyServerException
    {
        client.attachExternalCategoryLink(userId, null, null, externalLinkGUID, glossaryCategoryGUID, linkProperties, effectiveTime, forLineage, forDuplicateProcessing);
    }
    ...
    public void detachExternalCategoryLink(String  userId,
                                           ...
                                           boolean forDuplicateProcessing) throws InvalidParameterException,
                                                                                  ...
                                                                                  PropertyServerException
    {
        client.detachExternalCategoryLink(userId, null, null, externalLinkGUID, glossaryCategoryGUID, effectiveTime, forLineage, forDuplicateProcessing);
    }
    ...
    public void attachExternalTermLink(String                                userId,
                                       ...
                                       boolean                               forDuplicateProcessing) throws InvalidParameterException,
                                                                                                            ...
                                                                                                            PropertyServerException
    {
        client.attachExternalTermLink(userId, null, null, externalLinkGUID, glossaryTermGUID, linkProperties, effectiveTime, forLineage, forDuplicateProcessing);
    }
    ...
    public void detachExternalTermLink(String  userId,
                                       ...
                                       boolean forDuplicateProcessing) throws InvalidParameterException,
                                                                              ...
                                                                              PropertyServerException
    {
        client.detachExternalTermLink(userId, null, null, externalLinkGUID, glossaryTermGUID, effectiveTime, forLineage, forDuplicateProcessing);
    }
}
