...
public class ExternalGlossaryLinkElement implements Serializable
{
    private static final long     serialVersionUID = 1L;

    private ElementHeader                  elementHeader  = null;
    private ExternalGlossaryLinkProperties linkProperties = null;
    ...
    {
        return "ExternalGlossaryLinkElement{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ExternalGlossaryLinkElement that = (ExternalGlossaryLinkElement) objectToCompare;
