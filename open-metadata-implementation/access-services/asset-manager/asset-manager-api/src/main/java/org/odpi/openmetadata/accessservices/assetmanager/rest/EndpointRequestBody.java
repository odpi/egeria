...
public class EndpointRequestBody extends UpdateRequestBody
{
    private static final long    serialVersionUID = 1L;

    private EndpointProperties elementProperties = null;
     ...
     */
    public EndpointProperties getElementProperties()
    {
     ...
     */
    public void setElementProperties(EndpointProperties elementProperties)
    {
