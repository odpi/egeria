...
public class NoteElementResponse extends AssetManagerOMASAPIResponse
{
    @Serial
     ...
     */
    public NoteElementResponse(NoteElementResponse template)
    {
        super(template);
     ...
     * @param element  bean
     */
    public void setElement(NoteElement element)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof NoteElementResponse))
        {
            return false;
        }
        ...
        NoteElementResponse that = (NoteElementResponse) objectToCompare;
