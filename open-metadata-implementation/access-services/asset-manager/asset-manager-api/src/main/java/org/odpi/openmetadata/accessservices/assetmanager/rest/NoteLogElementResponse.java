...
public class NoteLogElementResponse extends AssetManagerOMASAPIResponse
{
    @Serial
     ...
     */
    public NoteLogElementResponse(NoteLogElementResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof NoteLogElementResponse))
        {
            return false;
        }
        ...
        NoteLogElementResponse that = (NoteLogElementResponse) objectToCompare;
