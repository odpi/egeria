...
public class GovernanceActionProcessElementsResponse extends AssetManagerOMASAPIResponse
{
    @Serial
    private static final long serialVersionUID = 1L;

    private List<GovernanceActionProcessElement> elements = null;

    /**
     * Default constructor
     */
    public GovernanceActionProcessElementsResponse()
    {
        super();
    }
     ...
     */
    public GovernanceActionProcessElementsResponse(GovernanceActionProcessElementsResponse template)
    {
        super(template);
     ...
     */
    public List<GovernanceActionProcessElement> getElements()
    {
        if (elements == null)
        {
            return null;
     ...
     */
    public void setElements(List<GovernanceActionProcessElement> elements)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        GovernanceActionProcessElementsResponse that = (GovernanceActionProcessElementsResponse) objectToCompare;
