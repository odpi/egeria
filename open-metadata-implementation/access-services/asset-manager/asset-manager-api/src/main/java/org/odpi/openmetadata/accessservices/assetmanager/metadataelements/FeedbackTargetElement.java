...
public class FeedbackTargetElement implements Serializable
{
    @Serial
     ...
     */
    public FeedbackTargetElement(FeedbackTargetElement template)
    {
        if (template != null)
        {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (! (objectToCompare instanceof FeedbackTargetElement))
        {
            return false;
        }

        FeedbackTargetElement that = (FeedbackTargetElement) objectToCompare;
