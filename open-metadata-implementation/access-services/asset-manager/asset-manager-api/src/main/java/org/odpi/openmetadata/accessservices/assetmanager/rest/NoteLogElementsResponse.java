...
public class NoteLogElementsResponse extends AssetManagerOMASAPIResponse
{
     ...
     * Default constructor
     */
    public NoteLogElementsResponse()
    {
    }
     ...
     */
    public NoteLogElementsResponse(NoteLogElementsResponse template)
    {
        super(template);
    ...
    {
        return "NoteLogElementsResponse{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        NoteLogElementsResponse that = (NoteLogElementsResponse) objectToCompare;
