...
public class ProcessCallElementsResponse extends AssetManagerOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<ProcessCallElement> elementList = null;
     ...
     */
    public ProcessCallElementsResponse(ProcessCallElementsResponse template)
    {
        super(template);
     ...
     */
    public List<ProcessCallElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<ProcessCallElement> elementList)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ProcessCallElementsResponse that = (ProcessCallElementsResponse) objectToCompare;
