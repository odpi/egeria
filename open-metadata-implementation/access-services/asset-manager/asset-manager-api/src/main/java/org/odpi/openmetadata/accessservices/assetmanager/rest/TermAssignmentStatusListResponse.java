...
public class TermAssignmentStatusListResponse extends AssetManagerOMASAPIResponse
{
     ...
     * Default constructor
     */
    public TermAssignmentStatusListResponse()
    {
    }
     ...
     */
    public TermAssignmentStatusListResponse(TermAssignmentStatusListResponse template)
    {
        super(template);
    ...
    {
        return "TermAssignmentStatusListResponse{" +
                       "statuses=" + statuses +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        TermAssignmentStatusListResponse that = (TermAssignmentStatusListResponse) objectToCompare;
