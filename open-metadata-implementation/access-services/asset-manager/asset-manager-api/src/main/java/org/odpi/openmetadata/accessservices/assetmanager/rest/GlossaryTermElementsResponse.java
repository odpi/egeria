...
public class GlossaryTermElementsResponse extends AssetManagerOMASAPIResponse
{
    @Serial
     ...
     * Default constructor
     */
    public GlossaryTermElementsResponse()
    {
    }
     ...
     */
    public GlossaryTermElementsResponse(GlossaryTermElementsResponse template)
    {
        super(template);
