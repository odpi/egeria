...
/**
 * SchemaAttributeRelationship describes a relationship between two schema attributes. For example,
 * a foreign key relationship.  The foreign key shows where the primary key of one table is used in another
...
public class SchemaAttributeRelationship implements Serializable
{
