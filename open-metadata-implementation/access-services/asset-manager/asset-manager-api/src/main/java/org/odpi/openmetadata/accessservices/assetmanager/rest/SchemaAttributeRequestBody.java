...
public class SchemaAttributeRequestBody extends UpdateRequestBody
{
    private static final long    serialVersionUID = 1L;

    private SchemaAttributeProperties elementProperties = null;
     ...
     */
    public SchemaAttributeProperties getElementProperties()
    {
     ...
     */
    public void setElementProperties(SchemaAttributeProperties elementProperties)
    {
