...
public class AssetManagerOMRSTopicListener extends OMRSTopicListenerBase
{
                                      ...
                                      EntityDetail entity)
    {
        ...
        if (eventEntity != null)
        {
            ...
            eventPublisher.publishEntityEvent(eventEntity, AssetManagerEventType.NEW_ELEMENT_CREATED);
        }
    }
                                               ...
                                               Classification classification)
    {
        ...
        if (eventEntity != null)
        {
            ...
            eventPublisher.publishEntityEvent(AssetManagerEventType.ELEMENT_RECLASSIFIED,
                                              eventEntity,
                                              null,
                                              classification,
                                              originalClassification);
                                          ...
                                          EntityDetail entity)
    {
        ...
        if (eventEntity != null)
        {
            ...
            eventPublisher.publishEntityEvent(eventEntity, AssetManagerEventType.ELEMENT_DELETED);
        }
    }
                                           ...
                                           EntityDetail entity)
    {
        ...
        if (eventEntity != null)
        {
            ...
            eventPublisher.publishEntityEvent(eventEntity, AssetManagerEventType.ELEMENT_RESTORED);
        }
    }
                                               ...
                                               EntityDetail entity)
    {
        ...
        if (eventEntity != null)
        {
            ...
            eventPublisher.publishEntityEvent(eventEntity, AssetManagerEventType.ELEMENT_GUID_CHANGED);
        }
    }
                                          ...
                                          EntityDetail   entity)
    {
        ...
        if (eventEntity != null)
        {
            ...
            eventPublisher.publishEntityEvent(eventEntity, AssetManagerEventType.ELEMENT_TYPE_CHANGED);
        }
    }
                                          ...
                                          EntityDetail entity)
    {
        ...
        if (eventEntity != null)
        {
            ...
            eventPublisher.publishEntityEvent(eventEntity, AssetManagerEventType.ELEMENT_HOME_CHANGED);
        }
    }
                                          ...
                                          EntityDetail entity)
    {
        ...
        if (eventEntity != null)
        {
            ...
            eventPublisher.publishEntityEvent(eventEntity, AssetManagerEventType.REFRESH_ELEMENT_EVENT);
        }
    }
     ...
     */
    private void processRelationshipEvent(AssetManagerEventType eventType,
                                          Relationship          relationship,
