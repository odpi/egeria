...
package org.odpi.openmetadata.accessservices.dataprivacy.listener;
...
{
    private static final Logger log = LoggerFactory.getLogger(DataPrivacyOMRSTopicListener.class);
     ...
     *
     * @param dataPrivacyOutTopic  connection to the out topic
     ...
     */
    public DataPrivacyOMRSTopicListener(Connection              dataPrivacyOutTopic,
