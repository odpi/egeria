...
package org.odpi.openmetadata.accessservices.dataprivacy.auditlog;
...
public enum DataPrivacyAuditCode
{
    ...
    private static final Logger log = LoggerFactory.getLogger(DataPrivacyAuditCode.class);
    ...
    public String getFormattedLogMessage(String... params)
    {
        ...
        {
            log.debug(String.format("<== DataPrivacy Audit Code.getMessage(%s)", Arrays.toString(params)));
        }
        ...
        if (log.isDebugEnabled())
        {
            log.debug(String.format("==> DataPrivacy Audit Code.getMessage(%s): %s", Arrays.toString(params), result));
        }
