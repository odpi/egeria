...
{
    /**
     * OMAS-DATA-PRIVACY-0001 - The Data Privacy Open Metadata Access Service (OMAS) is initializing a new server instance
     */
    ...
    /**
     * OMAS-DATA-PRIVACY-0003 - The Data Privacy Open Metadata Access Service (OMAS) has initialized a new instance for server {0}
     */
    ...
    /**
     * OMAS-DATA-PRIVACY-0004 - The Data Privacy Open Metadata Access Service (OMAS) is shutting down its instance for server {0}
     */
    ...
    /**
     * OMAS-DATA-PRIVACY-0005 - The Data Privacy Open Metadata Access Service (OMAS) is unable to initialize a new instance; error message is {0}
     */
