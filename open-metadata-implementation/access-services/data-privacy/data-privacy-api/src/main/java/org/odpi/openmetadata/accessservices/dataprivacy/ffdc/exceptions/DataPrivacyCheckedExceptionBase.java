...
package org.odpi.openmetadata.accessservices.dataprivacy.ffdc.exceptions;

import java.util.Objects;

/**
 * DataPrivacyCheckedExceptionBase provides a checked exception for reporting errors found when using
 * the Data Privacy OMAS services.
 *
 ...
 * The DataPrivacyErrorCode can be used with this exception to populate it with standard messages.
 * The aim is to be able to uniquely identify the cause and remedy for the error.
 */
public abstract class DataPrivacyCheckedExceptionBase extends Exception
{
     ...
     */
    public DataPrivacyCheckedExceptionBase(int    httpCode,
                                           String className,
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof DataPrivacyCheckedExceptionBase))
        {
            return false;
        }
        DataPrivacyCheckedExceptionBase that = (DataPrivacyCheckedExceptionBase) objectToCompare;
