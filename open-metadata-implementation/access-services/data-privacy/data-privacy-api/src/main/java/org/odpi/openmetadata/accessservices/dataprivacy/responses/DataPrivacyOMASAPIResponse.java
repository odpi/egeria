...
/**
 * DataPrivacyOMASAPIResponse provides a common header for Data Privacy OMAS managed responses to its REST API.
...
public abstract class DataPrivacyOMASAPIResponse implements java.io.Serializable
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof DataPrivacyOMASAPIResponse))
        {
            return false;
        }
        DataPrivacyOMASAPIResponse that = (DataPrivacyOMASAPIResponse) objectToCompare;
