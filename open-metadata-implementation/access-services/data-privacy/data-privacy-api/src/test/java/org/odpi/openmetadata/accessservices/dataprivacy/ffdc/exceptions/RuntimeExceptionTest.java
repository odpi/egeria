...
/**
 * Validate that the DataPrivacyRuntimeException is properly populated and supports toString, hashCode and
 * equals.
 */
public class RuntimeExceptionTest
{
    ...
    {
        DataPrivacyRuntimeException exception = new DataPrivacyRuntimeException(reportedHTTPCode,
                                                                                reportingClassName,
    ...
    @Test public void testHashCode()
    {
        ...
        DataPrivacyRuntimeException exception2 = new DataPrivacyRuntimeException(reportedHTTPCode,
                                                                                 reportingClassName,
                                                                                 reportingActionDescription,
                                                                                 reportedErrorMessage,
                                                                                 reportedSystemAction,
        ...
        assertTrue(exception.toString().contains("DataPrivacyRuntimeException"));
