...
public class VoidResponseTest
{
    ...
    @Test public void testJSON()
    {
         ...
         * Through superclass
         */
        DataPrivacyOMASAPIResponse superObject = getTestObject();
        ...
        try
        {
            validateResultObject((VoidResponse) objectMapper.readValue(jsonString, DataPrivacyOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
