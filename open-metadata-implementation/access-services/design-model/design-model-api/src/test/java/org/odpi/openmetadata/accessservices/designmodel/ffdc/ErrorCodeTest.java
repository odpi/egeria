...
{
    final static String  messageIdPrefix = "DESIGN-MODEL";
    ...
    private void testSingleErrorCodeValues(DesignModelErrorCode  testValue)
    {
        String                  testInfo;
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            jsonString = objectMapper.writeValueAsString(DesignModelErrorCode.UNKNOWN_ASSET);
        }
        catch (Throwable  exc)
        {
        ...
        try
        {
            assertTrue(objectMapper.readValue(jsonString, DesignModelErrorCode.class) == DesignModelErrorCode.UNKNOWN_ASSET);
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(DesignModelErrorCode.OMRS_NOT_INITIALIZED.toString().contains("DesignModelErrorCode"));
    }
    ...
    {
        assertTrue(DesignModelErrorCode.ASSET_NOT_FOUND.equals(DesignModelErrorCode.ASSET_NOT_FOUND));
        assertFalse(DesignModelErrorCode.MULTIPLE_ASSETS_FOUND.equals(DesignModelErrorCode.ASSET_NOT_FOUND));
    }
    ...
    {
        assertTrue(DesignModelErrorCode.ASSET_NOT_FOUND.hashCode() == DesignModelErrorCode.ASSET_NOT_FOUND.hashCode());
        assertFalse(DesignModelErrorCode.MULTIPLE_ASSETS_FOUND.hashCode() == DesignModelErrorCode.ASSET_NOT_FOUND.hashCode());
    }
}
