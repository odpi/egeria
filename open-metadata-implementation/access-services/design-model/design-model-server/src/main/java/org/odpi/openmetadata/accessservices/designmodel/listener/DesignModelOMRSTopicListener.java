...
package org.odpi.openmetadata.accessservices.designmodel.listener;
...
/**
 * DesignModelOMRSTopicListener received details of each OMRS event from the cohorts that the local server
...
{
    private static final Logger log = LoggerFactory.getLogger(DesignModelOMRSTopicListener.class);
     ...
     */
    public DesignModelOMRSTopicListener(Connection              stewardshipActionOutTopic,
