...
package org.odpi.openmetadata.accessservices.designmodel.auditlog;
 ...
 * </ul>
 */
public enum DesignModelAuditCode
{
    ...
    private static final Logger log = LoggerFactory.getLogger(DesignModelAuditCode.class);
    ...
    public String getFormattedLogMessage(String... params)
    {
        ...
        {
            log.debug(String.format("<== DesignModel Audit Code.getMessage(%s)", Arrays.toString(params)));
        }
        ...
        if (log.isDebugEnabled())
        {
            log.debug(String.format("==> DesignModel Audit Code.getMessage(%s): %s", Arrays.toString(params), result));
        }
