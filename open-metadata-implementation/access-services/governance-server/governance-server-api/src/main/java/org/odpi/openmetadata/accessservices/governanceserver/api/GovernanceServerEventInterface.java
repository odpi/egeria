...
/**
 * GovernanceServerEventInterface defines how a client gets access to the
 * configuration events produced by the Governance Server OMAS.
 */
public interface GovernanceServerEventInterface
{
    /**
