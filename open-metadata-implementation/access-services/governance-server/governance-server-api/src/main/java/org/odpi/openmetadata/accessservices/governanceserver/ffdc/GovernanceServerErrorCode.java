 ...
 * the Governance Server Access Service.  It is used in conjunction with both Checked and Runtime (unchecked) exceptions.
 ...
 * </ul>
 */
public enum GovernanceServerErrorCode implements ExceptionMessageSet
{
    /**
     * OMAS-GOVERNANCE-SERVER-400-017 - A null topic listener has been passed by user {0} on method {1}
     */
    NULL_LISTENER(500, "OMAS-GOVERNANCE-SERVER-400-017",
                  "A null topic listener has been passed by user {0} on method {1}",
                  "There is a coding error in the caller to the Governance Server OMAS.",
     ...
     */
    OMRS_NOT_INITIALIZED(404, "OMAS-GOVERNANCE-SERVER-404-002",
                         "The open metadata repository services are not initialized for the {0} operation",
                         "The system is unable to connect to the open metadata property server.",
                         "Check that the server where the Governance Server OMAS is running initialized correctly.  " +
                                 "Correct any errors discovered and retry the request when the open metadata services are available."),

    /**
     * OMAS-GOVERNANCE-SERVER-500-004 - An unexpected exception occurred when sending an event through connector {0} to the Governance
     * Engine OMAS out topic.  The failing event was {1}, the exception was {2} with message {2}
     */
    UNABLE_TO_SEND_EVENT(500, "OMAS-GOVERNANCE-SERVER-500-004",
                         "An unexpected exception occurred when sending an event through connector {0} to the Governance Server OMAS out topic.  The failing " +
    ...
    /**
     * OMAS-GOVERNANCE-SERVER-503-005 - A {0} exception was caught during start up of service {1} for server {2}. The error message was: {3}
     */
    UNEXPECTED_INITIALIZATION_EXCEPTION(503, "OMAS-GOVERNANCE-SERVER-503-005",
     ...
     */
    GovernanceServerErrorCode(int httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
