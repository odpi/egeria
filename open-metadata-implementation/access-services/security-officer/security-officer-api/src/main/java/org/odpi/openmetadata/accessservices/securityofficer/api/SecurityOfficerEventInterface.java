...
/**
 * SecurityOfficerEventInterface defines how a client gets access to the
 * configuration events produced by the Security Officer OMAS.
 */
public interface SecurityOfficerEventInterface
{
    /**
