...
/**
 * The MetadataServerException is thrown by the Security Officer OMAS when it is not able to communicate with the
 * property handlers.
 */
public class MetadataServerException extends SecurityOfficerException {
    /**
