...
/**
 * SecurityOfficerException provides a checked exception for reporting errors found when using
 * the Security Officer OMAS services.
 * Typically these errors are either configuration or operational errors that can be fixed by an administrator
 * or power Security Officer Interface.  However, there may be the odd bug that surfaces here.
 * The SecurityOfficerErrorCode can be used with this exception to populate it with standard messages.
 * The aim is to be able to uniquely identify the cause and remedy for the error.
 */
public class SecurityOfficerException extends Exception {
     ...
     */
    public SecurityOfficerException(int httpCode,
                                    String className,
