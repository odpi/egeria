...
/**
 * Thrown if the access service is not able to register a new instance of itself in instance map.
 */
public class GlossaryViewOMASNewInstanceException extends GlossaryViewException {
     ...
     */
    public GlossaryViewOMASNewInstanceException(int httpCode, String className, String actionDescription, String errorMessage,
