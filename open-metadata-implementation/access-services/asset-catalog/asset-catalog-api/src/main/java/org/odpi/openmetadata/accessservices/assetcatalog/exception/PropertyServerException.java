...
/**
 * The PropertyServerException is thrown by the Asset Catalog OMAS when it is not able to communicate with the
 * property server.
 */
public class PropertyServerException extends AssetCatalogException {
    /**
