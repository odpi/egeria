...
/**
 * Validate that the AssetConsumerRuntimeException is properly populated and supports toString, hashCode and
 * equals.
 */
public class RuntimeExceptionTest
{
    ...
    {
        AssetConsumerRuntimeException exception = new AssetConsumerRuntimeException(reportedHTTPCode,
                                                                                    reportingClassName,
    ...
    @Test public void testHashCode()
    {
        ...
        AssetConsumerRuntimeException exception2 = new AssetConsumerRuntimeException(reportedHTTPCode,
                                                                                     reportingClassName,
                                                                                     reportingActionDescription,
                                                                                     reportedErrorMessage,
                                                                                     reportedSystemAction,
        ...
        assertTrue(exception.toString().contains("AssetConsumerRuntimeException"));
