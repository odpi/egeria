...
public class UnrecognizedConnectionNameException extends AssetConsumerCheckedExceptionBase
{
     ...
     */
    public UnrecognizedConnectionNameException(int    httpCode,
                                               String className,
    ...
    {
        return "UnrecognizedConnectionNameException{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof UnrecognizedConnectionNameException))
        {
            return false;
        }
        ...
        UnrecognizedConnectionNameException that = (UnrecognizedConnectionNameException) objectToCompare;
