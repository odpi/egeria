 ...
 */
public abstract class AssetConsumerCheckedExceptionBase extends Exception
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof AssetConsumerCheckedExceptionBase))
        {
            return false;
        }
        AssetConsumerCheckedExceptionBase that = (AssetConsumerCheckedExceptionBase) objectToCompare;
