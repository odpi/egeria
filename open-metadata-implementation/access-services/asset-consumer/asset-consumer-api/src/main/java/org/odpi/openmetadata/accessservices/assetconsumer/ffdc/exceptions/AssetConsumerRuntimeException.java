...
public class AssetConsumerRuntimeException extends RuntimeException
{
     ...
     */
    public AssetConsumerRuntimeException(int                 httpCode,
                                         String              className,
    ...
    {
        return "AssetConsumerRuntimeException{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof AssetConsumerRuntimeException))
        {
            return false;
        }
        AssetConsumerRuntimeException that = (AssetConsumerRuntimeException) objectToCompare;
