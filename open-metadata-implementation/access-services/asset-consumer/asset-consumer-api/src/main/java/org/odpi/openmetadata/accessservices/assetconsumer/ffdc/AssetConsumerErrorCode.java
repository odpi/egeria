...
{
    SERVER_URL_NOT_SPECIFIED(400, "OMAS-ASSET-CONSUMER-400-001 ",
    ...
    SERVER_URL_MALFORMED(400, "OMAS-ASSET-CONSUMER-400-002 ",
            "The OMAS Server URL {0} is not in a recognized format",
            "The system is unable to connect to the OMAS Server to retrieve metadata properties.",
            "Ensure a valid OMAS Server URL is passed to the AssetConsumer when it is created."),
    NULL_USER_ID(400, "OMAS-ASSET-CONSUMER-400-003 ",
    ...
    NULL_GUID(400, "OMAS-ASSET-CONSUMER-400-004 ",
    ...
    NULL_NAME(400, "OMAS-ASSET-CONSUMER-400-005 ",
    ...
    NO_ASSET_PROPERTIES(400, "OMAS-ASSET-CONSUMER-400-006 ",
    ...
    PROPERTY_SERVER_ERROR(400, "OMAS-ASSET-CONSUMER-400-009 ",
            ...
            "The system is unable to process the request.",
            "Verify the access rights of the user."),
    NULL_ENUM(400, "OMAS-ASSET-CONSUMER-400-010 ",
            ...
            "Correct the code in the caller to provide the name."),
    NULL_TEXT(400, "OMAS-ASSET-CONSUMER-400-011 ",
    ...
    BAD_CONFIG(400, "OMAS-ASSET-CONSUMER-400-014",
             "The Asset Consumer Open Metadata Access Service (OMAS) has been passed an invalid value of {0} in the {1} property.  The resulting exception of {2} included the following message: {3}",
             "The access service has not been passed valid configuration.",
             "Correct the configuration and restart the service."),
    BAD_OUT_TOPIC_CONNECTION(400, "OMAS-ASSET-CONSUMER-400-015",
    ...
    OMRS_NOT_AVAILABLE(404, "OMAS-ASSET-CONSUMER-404-003 ",
            "The open metadata repository services are not available for the {0} operation",
            "The system is unable to connect to the open metadata property server.",
            "Check that the server where the Asset Consumer OMAS is running initialized correctly.  " +
                       "Correct any errors discovered and retry the request when the open metadata services are available."),
    NO_METADATA_COLLECTION(404, "OMAS-ASSET-CONSUMER-404-004 ",
    ...
    TERM_NOT_FOUND(404, "OMAS-ASSET-CONSUMER-404-013 ",
            "The requested glossary term {0} is not found in OMAS Server {1}, optional error message {2}",
            "The system is unable to populate the requested glossary object.",
            "Check that the term name and the OMAS Server URL are correct.  Retry the request when the term is available in the OMAS Service"),
    PROXY_TERM_FOUND(404, "OMAS-ASSET-CONSUMER-404-014 ",
            "Only an entity proxy for requested glossary term {0} is found in the open metadata server {1}, error message was: {2}",
            "The system is unable to populate the requested glossary term object.",
            "Check that the term name and the OMAS Server URL are correct.  Retry the request when the term is available in the OMAS Service"),
    ...
    NULL_CONNECTOR_RETURNED(500, "OMAS-ASSET-CONSUMER-500-002 ",
    ...
    CLIENT_SIDE_REST_API_ERROR(503, "OMAS-ASSET-CONSUMER-503-002 ",
