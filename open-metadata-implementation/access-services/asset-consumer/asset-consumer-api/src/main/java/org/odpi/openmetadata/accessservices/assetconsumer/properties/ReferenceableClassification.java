...
/**
 * The ReferenceableClassification bean defines a single classification for an asset.  This can be used for REST calls and other
 * JSON based functions.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class ReferenceableClassification extends AssetConsumerElementHeader
{
     ...
     * Default constructor
     */
    public ReferenceableClassification()
    {
        super();
    }
     ...
     */
    public ReferenceableClassification(ReferenceableClassification templateClassification)
    {
    ...
    {
        return "ReferenceableClassification{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ReferenceableClassification))
        {
            return false;
        }
        ReferenceableClassification that = (ReferenceableClassification) objectToCompare;
