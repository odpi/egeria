...
package org.odpi.openmetadata.accessservices.assetconsumer.responses;
...
public abstract class AssetConsumerOMASAPIResponse implements java.io.Serializable
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof AssetConsumerOMASAPIResponse))
        {
            return false;
        }
        AssetConsumerOMASAPIResponse that = (AssetConsumerOMASAPIResponse) objectToCompare;
