...
public class TagUpdateRequestBody implements Serializable
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (! (objectToCompare instanceof TagUpdateRequestBody))
        {
            return false;
        }

        TagUpdateRequestBody that = (TagUpdateRequestBody) objectToCompare;
