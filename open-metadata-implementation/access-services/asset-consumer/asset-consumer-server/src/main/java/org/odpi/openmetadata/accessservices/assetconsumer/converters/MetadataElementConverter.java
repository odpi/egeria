 ...
 * EntityDetail object into a MetadataElement bean.
 */
public class MetadataElementConverter<B> extends OCFConverter<B>
{
    /**
     * Constructor
     *
                        ...
                        String       methodName) throws PropertyServerException
    {
        try
        {
            ...
            if (returnBean instanceof MetadataElement bean)
            {
                /*
