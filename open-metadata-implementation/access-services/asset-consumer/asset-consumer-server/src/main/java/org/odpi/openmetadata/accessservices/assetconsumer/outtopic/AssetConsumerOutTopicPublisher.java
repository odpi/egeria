...
{
    private final AssetConsumerOutTopicServerConnector  outTopicServerConnector;
     ...
     */
    public AssetConsumerOutTopicPublisher(AssetConsumerOutTopicServerConnector outTopicServerConnector,
                                          String                               outTopicName,
     ...
     */
    public void publishEntityEvent(AssetConsumerEventType eventType,
                                   EntityDetail              entity,
        ...
        if (outTopicServerConnector != null)
        {
            ...
            catch (Exception error)
            {
                outTopicAuditLog.logException(methodName,
                                              AssetConsumerAuditCode.PROCESS_EVENT_EXCEPTION.getMessageDefinition(event.toString(),
