...
package org.odpi.openmetadata.accessservices.digitalservice.listener;
...
/**
 * DigitalServiceOMRSTopicListener received details of each OMRS event from the cohorts that the local server
 * is connected to.  It passes NEW_ENTITY_EVENTs to the publisher.
 */
public class DigitalServiceOMRSTopicListener extends OMRSTopicListenerBase
{
    private static final Logger log = LoggerFactory.getLogger(DigitalServiceOMRSTopicListener.class);
     ...
     *
     * @param digitalServiceOutTopic  connection to the out topic
     ...
     */
    public DigitalServiceOMRSTopicListener(Connection              digitalServiceOutTopic,
