...
public class EntityPropertiesBuilder {
    ...
    public EntityPropertiesBuilder withLongProperty(String key, long value) {
        instanceProperties.setProperty(key, EntityPropertiesUtils.createPrimitiveLongPropertyValue(value));
        return this;
    }
}
