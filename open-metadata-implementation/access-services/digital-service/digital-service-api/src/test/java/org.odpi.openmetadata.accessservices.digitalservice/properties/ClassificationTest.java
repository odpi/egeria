...
public class ClassificationTest
{
    ...
    @Test public void testJSON()
    {
         ...
         * Through superclass
         */
        DigitalServiceElementHeader propertyBase = getTestObject();
        ...
        try
        {
            validateResultObject((Classification) objectMapper.readValue(jsonString, DigitalServiceElementHeader.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
