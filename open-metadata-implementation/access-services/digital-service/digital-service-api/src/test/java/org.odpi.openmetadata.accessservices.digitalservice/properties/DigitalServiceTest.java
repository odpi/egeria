...
public class DigitalServiceTest
{
    ...
    @Test public void testJSON()
    {
         ...
         * Through superclass
         */
        DigitalServiceElementHeader superObject = getTestObject();
        ...
        try
        {
            validateResultObject((DigitalService) objectMapper.readValue(jsonString, DigitalServiceElementHeader.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
