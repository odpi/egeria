...
/**
 * The StewardshipActionErrorCode is used to define first failure data capture (FFDC) for errors that occur when working with
 * the Stewardship Action OMAS Services.  It is used in conjunction with both Checked and Runtime (unchecked) exceptions.
 *
 ...
 * </ul>
 */
public enum StewardshipActionErrorCode
{
    BAD_OUT_TOPIC_CONNECTION(400, "OMAS-STEWARDSHIP-ACTION-400-001 ",
             "The Stewardship Action Open Metadata Access Service (OMAS) has been passed an invalid connection for publishing events.  The connection was {0}.  The resulting exception of {1} included the following message: {2}",
    ...
    OMRS_NOT_INITIALIZED(404, "OMAS-STEWARDSHIP-ACTION-404-002 ",
    ...
    CONNECTION_NOT_FOUND(404, "OMAS-STEWARDSHIP-ACTION-404-005 ",
    ...
    PROXY_CONNECTION_FOUND(404, "OMAS-STEWARDSHIP-ACTION-404-006 ",
            "Only an entity proxy for requested connection {0} is found in the open metadata server {1}, error message was: {2}",
            "The system is unable to populate the requested connection object.",
            "Check that the connection name and the OMAS Server URL are correct.  Retry the request when the connection is available in the OMAS Service"),
    ASSET_NOT_FOUND(404, "OMAS-STEWARDSHIP-ACTION-404-007 ",
    ...
    MULTIPLE_ASSETS_FOUND(404, "OMAS-STEWARDSHIP-ACTION-404-008 ",
    ...
    UNKNOWN_ASSET(404, "OMAS-STEWARDSHIP-ACTION-404-009 ",
    ...
    private static final Logger log = LoggerFactory.getLogger(StewardshipActionErrorCode.class);
     ...
     *
     *     StewardshipActionErrorCode   errorCode = StewardshipActionErrorCode.ASSET_NOT_FOUND;
     *
     ...
     */
    StewardshipActionErrorCode(int  newHTTPErrorCode, String newErrorMessageId, String newErrorMessage, String newSystemAction, String newUserAction)
    {
    ...
    {
        log.debug(String.format("<== StewardshipActionErrorCode.getMessage(%s)", Arrays.toString(params)));

        MessageFormat mf = new MessageFormat(errorMessage);
        String result = mf.format(params);

        log.debug(String.format("==> StewardshipActionErrorCode.getMessage(%s): %s", Arrays.toString(params), result));
