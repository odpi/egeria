...
import org.odpi.openmetadata.accessservices.stewardshipaction.metadataelements.ValidValueElement;
...
public class DuplicatesResponse extends StewardshipActionOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<DuplicateElement> elementList = null;
     ...
     */
    public List<DuplicateElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<DuplicateElement> elementList)
    {
