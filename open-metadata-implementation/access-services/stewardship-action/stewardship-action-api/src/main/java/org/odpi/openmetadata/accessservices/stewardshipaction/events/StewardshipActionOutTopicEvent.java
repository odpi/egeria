...
public class StewardshipActionOutTopicEvent
{
     ...
     * Default Constructor
     */
    public StewardshipActionOutTopicEvent()
    {
    }
     ...
     */
    public StewardshipActionOutTopicEvent(StewardshipActionOutTopicEvent template)
    {
        if (template != null)
        {
     ...
     */
    public StewardshipActionEventType getEventType()
    {
        return eventType;
    }
     ...
     */
    public void setEventType(StewardshipActionEventType eventType)
    {
    ...
    {
        return "StewardshipActionOutTopicEvent{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        StewardshipActionOutTopicEvent that = (StewardshipActionOutTopicEvent) objectToCompare;
