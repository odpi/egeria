 ...
 * passed to the Stewardship Action OMAS at start up (a null value here means all zones).
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public enum StewardshipActionEventType
{
    /**
     ...
     */
    StewardshipActionEventType(int eventTypeCode, String eventTypeName, String eventTypeDescription)
    {
    ...
    {
        return "StewardshipActionEventType{" +
