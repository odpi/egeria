 ...
 */
public class QueryConverter<B> extends DataManagerOMASConverter<B>
{
    /**
     * Constructor
     *
     ...
     */
    public QueryConverter(OMRSRepositoryHelper repositoryHelper,
                          String               serviceName,
                          String               serverName)
    {
        ...
        try
        {
            ...
            if (returnBean instanceof QueryElement)
            {
                ...
                if (entity != null)
                {
                     ...
                     */
                    queryProperties.setTypeName(bean.getElementHeader().getType().getTypeName());
                    queryProperties.setExtendedProperties(this.getRemainingExtendedProperties(instanceProperties));

                    bean.setProperties(queryProperties);
                }
                else
                {
