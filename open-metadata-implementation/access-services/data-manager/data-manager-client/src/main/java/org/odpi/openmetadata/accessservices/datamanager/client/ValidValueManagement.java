 ...
 */
public class ValidValueManagement extends DataManagerBaseClient implements ValidValueManagementInterface
{
    private static final String validValueURLTemplatePrefix = "/servers/{0}/open-metadata/access-services/data-manager/users/{1}/valid-values";
