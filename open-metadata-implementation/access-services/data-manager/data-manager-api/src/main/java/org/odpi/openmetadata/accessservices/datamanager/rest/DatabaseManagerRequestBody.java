...
public class DatabaseManagerRequestBody extends DatabaseManagerProperties
{
     ...
     * Default constructor
     */
    public DatabaseManagerRequestBody()
    {
        super();
    }
     ...
     */
    public DatabaseManagerRequestBody(DatabaseManagerRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public DatabaseManagerRequestBody(DatabaseManagerProperties template)
    {
        super(template);
    }
    ...
    {
        return "DatabaseManagerRequestBody{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        DatabaseManagerRequestBody that = (DatabaseManagerRequestBody) objectToCompare;
