...
/**
 * APIOperationResponse is a response object for passing back a single APIOperation
 * element or an exception if the request failed.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class APIOperationResponse extends DataManagerOMASAPIResponse
{
    private APIOperationElement element = null;
     ...
     */
    public APIOperationElement getElement()
    {
        return element;
    }
     ...
     */
    public void setElement(APIOperationElement element)
    {
