...
/**
 * QueryRequestBody describes the properties of the query plus the optional identifiers for an
 * owning software server capability.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class QueryRequestBody extends QueryProperties
{
     ...
     */
    public QueryRequestBody(QueryRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public QueryRequestBody(QueryProperties template)
    {
        super(template);
    }
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        QueryRequestBody that = (QueryRequestBody) objectToCompare;
