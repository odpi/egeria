...
/**
 * APIOperationsResponse is a response object for passing back a a list of APIOperations
 * or an exception if the request failed.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class APIOperationsResponse extends DataManagerOMASAPIResponse
{
    private List<APIOperationElement> elementList = null;
     ...
     */
    public List<APIOperationElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<APIOperationElement> elementList)
    {
