...
public class QueriesResponse extends DataManagerOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<QueryElement> elementList = null;
     ...
     */
    public List<QueryElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<QueryElement> elementList)
    {
