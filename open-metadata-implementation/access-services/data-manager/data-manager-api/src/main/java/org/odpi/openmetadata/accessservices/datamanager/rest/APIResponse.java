...
/**
 * APIResponse is a response object for passing back a single API
 * element or an exception if the request failed.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class APIResponse extends DataManagerOMASAPIResponse
{
     ...
     */
    public APIResponse(APIResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        APIResponse that = (APIResponse) objectToCompare;
