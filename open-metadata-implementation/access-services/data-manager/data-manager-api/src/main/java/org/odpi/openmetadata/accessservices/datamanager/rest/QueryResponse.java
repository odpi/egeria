...
/**
 * QueryResponse is a response object for passing back a single query
 * element or an exception if the request failed.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class QueryResponse extends DataManagerOMASAPIResponse
{
    private QueryElement element = null;
     ...
     */
    public QueryResponse(QueryResponse template)
    {
        super(template);
     ...
     */
    public void setElement(QueryElement element)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        QueryResponse that = (QueryResponse) objectToCompare;
