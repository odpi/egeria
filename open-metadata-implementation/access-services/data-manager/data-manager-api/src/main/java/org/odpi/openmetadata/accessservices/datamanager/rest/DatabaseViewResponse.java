...
public class DatabaseViewResponse extends DataManagerOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private DatabaseViewElement element = null;


    /**
     * Default constructor
     */
    public DatabaseViewResponse()
    {
    }
     ...
     */
    public DatabaseViewResponse(DatabaseViewResponse template)
    {
        super(template);
     ...
     */
    public DatabaseViewElement getElement()
    {
        return element;
    }
     ...
     */
    public void setElement(DatabaseViewElement element)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        DatabaseViewResponse that = (DatabaseViewResponse) objectToCompare;
