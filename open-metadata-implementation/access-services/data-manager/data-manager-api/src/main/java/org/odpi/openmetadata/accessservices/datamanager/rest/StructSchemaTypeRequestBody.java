...
public class StructSchemaTypeRequestBody extends StructSchemaTypeProperties
{
     ...
     * Default constructor
     */
    public StructSchemaTypeRequestBody()
    {
        super();
    }
     ...
     */
    public StructSchemaTypeRequestBody(StructSchemaTypeRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public StructSchemaTypeRequestBody(StructSchemaTypeProperties template)
    {
        super(template);
    }
    ...
    {
        return "StructSchemaTypeRequestBody{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        StructSchemaTypeRequestBody that = (StructSchemaTypeRequestBody) objectToCompare;
