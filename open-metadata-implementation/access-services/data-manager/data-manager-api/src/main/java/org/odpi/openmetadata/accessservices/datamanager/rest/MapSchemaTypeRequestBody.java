...
/**
 * MapSchemaTypeRequestBody describes the properties of the schema type plus the optional identifiers for an
 * owning software server capability.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class MapSchemaTypeRequestBody extends MapSchemaTypeProperties
{
     ...
     * Default constructor
     */
    public MapSchemaTypeRequestBody()
    {
        super();
    }
     ...
     */
    public MapSchemaTypeRequestBody(MapSchemaTypeRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public MapSchemaTypeRequestBody(MapSchemaTypeProperties template)
    {
        super(template);
    }
    ...
    {
        return "MapSchemaTypeRequestBody{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        MapSchemaTypeRequestBody that = (MapSchemaTypeRequestBody) objectToCompare;
