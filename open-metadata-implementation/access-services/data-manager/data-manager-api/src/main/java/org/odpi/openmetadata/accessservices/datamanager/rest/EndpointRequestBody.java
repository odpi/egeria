 ...
 * The external source identifiers are used if the endpoint was created using the external source identifiers.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class EndpointRequestBody extends EndpointProperties
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        EndpointRequestBody that = (EndpointRequestBody) objectToCompare;
