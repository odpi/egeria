...
/**
 * APIOperationRequestBody describes the properties of the API operation plus the optional identifiers for an
 * owning software server capability.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class APIOperationRequestBody extends APIOperationProperties
{
     ...
     * Default constructor
     */
    public APIOperationRequestBody()
    {
        super();
    }
     ...
     */
    public APIOperationRequestBody(APIOperationRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public APIOperationRequestBody(APIOperationProperties template)
    {
        super(template);
    }
    ...
    {
        return "APIOperationRequestBody{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        APIOperationRequestBody that = (APIOperationRequestBody) objectToCompare;
