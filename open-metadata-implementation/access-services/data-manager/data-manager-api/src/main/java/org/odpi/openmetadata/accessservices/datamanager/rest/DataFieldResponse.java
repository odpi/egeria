...
/**
 * DataFieldResponse is a response object for passing back a single data field
 * element or an exception if the request failed.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class DataFieldResponse extends DataManagerOMASAPIResponse
{
    private DataFieldElement element = null;
     ...
     */
    public DataFieldElement getElement()
    {
        return element;
    }
     ...
     */
    public void setElement(DataFieldElement element)
    {
