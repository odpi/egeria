...
public class ApplicationRequestBody extends ApplicationProperties
{
     ...
     */
    public ApplicationRequestBody(ApplicationRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public ApplicationRequestBody(ApplicationProperties template)
    {
        super(template);
    }
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ApplicationRequestBody that = (ApplicationRequestBody) objectToCompare;
