...
/**
 * SchemaTypeRequestBody describes the properties of the schema type plus the optional identifiers for an
...
public class SchemaTypeRequestBody extends SchemaTypeProperties
{
     ...
     * @param template object to copy
     */
    public SchemaTypeRequestBody(SchemaTypeProperties template)
    {
        super(template);
    }
