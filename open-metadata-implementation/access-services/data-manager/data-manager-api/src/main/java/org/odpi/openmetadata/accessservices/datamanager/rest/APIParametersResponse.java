...
public class APIParametersResponse extends DataManagerOMASAPIResponse
{
    private List<APIParameterElement> elementList = null;
     ...
     */
    public List<APIParameterElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<APIParameterElement> elementList)
    {
