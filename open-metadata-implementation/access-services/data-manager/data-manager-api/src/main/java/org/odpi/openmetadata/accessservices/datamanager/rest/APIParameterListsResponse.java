...
public class APIParameterListsResponse extends DataManagerOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<APIParameterListElement> elementList = null;


    /**
     * Default constructor
     */
    public APIParameterListsResponse()
    {
    }
     ...
     */
    public APIParameterListsResponse(APIParameterListsResponse template)
    {
        super(template);
     ...
     */
    public List<APIParameterListElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<APIParameterListElement> elementList)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        APIParameterListsResponse that = (APIParameterListsResponse) objectToCompare;
