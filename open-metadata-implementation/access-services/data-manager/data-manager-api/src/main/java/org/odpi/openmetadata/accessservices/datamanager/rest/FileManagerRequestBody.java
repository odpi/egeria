...
/**
 * FileManagerProperties describes the root node of a file system.  FileManagerRequestBody extends these properties
 * with details of the metadata source.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class FileManagerRequestBody extends FileManagerProperties
{
     ...
     */
    public FileManagerRequestBody(FileManagerRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public FileManagerRequestBody(FileManagerProperties template)
    {
        super(template);
    }
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        FileManagerRequestBody that = (FileManagerRequestBody) objectToCompare;
