...
/**
 * SchemaAttributesResponse is a response object for passing back a a list of schema attributes
 * or an exception if the request failed.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class SchemaAttributesResponse extends DataManagerOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<SchemaAttributeElement> elementList = null;
     ...
     */
    public List<SchemaAttributeElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<SchemaAttributeElement> elementList)
    {
