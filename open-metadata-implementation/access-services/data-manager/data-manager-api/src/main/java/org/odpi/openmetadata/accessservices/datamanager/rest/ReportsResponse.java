...
/**
 * ReportsResponse is a response object for passing back a a list of reports
 * or an exception if the request failed.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class ReportsResponse extends DataManagerOMASAPIResponse
{
    private List<ReportElement> elementList = null;
     ...
     */
    public ReportsResponse(ReportsResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ReportsResponse that = (ReportsResponse) objectToCompare;
