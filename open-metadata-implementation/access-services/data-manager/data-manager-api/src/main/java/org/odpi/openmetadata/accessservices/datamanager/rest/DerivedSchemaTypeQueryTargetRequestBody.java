...
/**
 * DerivedSchemaTypeQueryTargetRequestBody describes the properties of a query target plus the optional identifiers for an
 * owning software server capability.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class DerivedSchemaTypeQueryTargetRequestBody extends DerivedSchemaTypeQueryTargetProperties
{
     ...
     * Default constructor
     */
    public DerivedSchemaTypeQueryTargetRequestBody()
    {
        super();
    }
     ...
     */
    public DerivedSchemaTypeQueryTargetRequestBody(DerivedSchemaTypeQueryTargetRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public DerivedSchemaTypeQueryTargetRequestBody(DerivedSchemaTypeQueryTargetProperties template)
    {
        super(template);
    }
    ...
    {
        return "DerivedSchemaTypeQueryTargetRequestBody{" +
                       "externalSourceGUID='" + externalSourceGUID + '\'' +
                       ", externalSourceName='" + externalSourceName + '\'' +
                       ", queryId='" + getQueryId() + '\'' +
                       ", query='" + getQuery() + '\'' +
                       ", queryTargetGUID='" + getQueryTargetGUID() + '\'' +
                       '}';
    }
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        DerivedSchemaTypeQueryTargetRequestBody that = (DerivedSchemaTypeQueryTargetRequestBody) objectToCompare;
