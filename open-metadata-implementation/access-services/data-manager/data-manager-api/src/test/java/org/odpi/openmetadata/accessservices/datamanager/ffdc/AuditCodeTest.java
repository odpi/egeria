...
/**
 * Verify the DataManagerAuditCode enum contains unique message ids, non-null names and descriptions and can be
...
public class AuditCodeTest extends AuditLogMessageSetTest
{
    ...
    {
        for (DataManagerAuditCode auditCode : DataManagerAuditCode.values())
        {
