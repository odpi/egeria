...
package org.odpi.openmetadata.accessservices.softwaredeveloper.listener;
...
/**
 * SoftwareDeveloperOMRSTopicListener received details of each OMRS event from the cohorts that the local server
 * is connected to.  It passes NEW_ENTITY_EVENTs to the publisher.
 */
public class SoftwareDeveloperOMRSTopicListener extends OMRSTopicListenerBase
{
    private static final Logger log = LoggerFactory.getLogger(SoftwareDeveloperOMRSTopicListener.class);
     ...
     *
     * @param softwareDeveloperOutTopic  connection to the out topic
     ...
     */
    public SoftwareDeveloperOMRSTopicListener(Connection              softwareDeveloperOutTopic,
