...
package org.odpi.openmetadata.accessservices.softwaredeveloper.auditlog;
...
public enum SoftwareDeveloperAuditCode
{
    ...
    private static final Logger log = LoggerFactory.getLogger(SoftwareDeveloperAuditCode.class);
    ...
    public String getFormattedLogMessage(String... params)
    {
        ...
        {
            log.debug(String.format("<== SoftwareDeveloper Audit Code.getMessage(%s)", Arrays.toString(params)));
        }
        ...
        if (log.isDebugEnabled())
        {
            log.debug(String.format("==> SoftwareDeveloper Audit Code.getMessage(%s): %s", Arrays.toString(params), result));
        }
