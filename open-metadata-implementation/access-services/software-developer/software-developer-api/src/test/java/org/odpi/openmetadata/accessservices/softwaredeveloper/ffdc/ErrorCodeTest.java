...
{
    final static String  messageIdPrefix = "SOFTWARE-DEVELOPER";
    ...
    private void testSingleErrorCodeValues(SoftwareDeveloperErrorCode  testValue)
    {
        String                  testInfo;
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            jsonString = objectMapper.writeValueAsString(SoftwareDeveloperErrorCode.UNKNOWN_ASSET);
        }
        catch (Throwable  exc)
        {
        ...
        try
        {
            assertTrue(objectMapper.readValue(jsonString, SoftwareDeveloperErrorCode.class) == SoftwareDeveloperErrorCode.UNKNOWN_ASSET);
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(SoftwareDeveloperErrorCode.OMRS_NOT_INITIALIZED.toString().contains("SoftwareDeveloperErrorCode"));
    }
    ...
    {
        assertTrue(SoftwareDeveloperErrorCode.ASSET_NOT_FOUND.equals(SoftwareDeveloperErrorCode.ASSET_NOT_FOUND));
        assertFalse(SoftwareDeveloperErrorCode.MULTIPLE_ASSETS_FOUND.equals(SoftwareDeveloperErrorCode.ASSET_NOT_FOUND));
    }
    ...
    {
        assertTrue(SoftwareDeveloperErrorCode.ASSET_NOT_FOUND.hashCode() == SoftwareDeveloperErrorCode.ASSET_NOT_FOUND.hashCode());
        assertFalse(SoftwareDeveloperErrorCode.MULTIPLE_ASSETS_FOUND.hashCode() == SoftwareDeveloperErrorCode.ASSET_NOT_FOUND.hashCode());
    }
}
