 ...
 * @param <B> bean class
 */
public abstract class ProjectManagementConverterBase<B> extends OpenMetadataConverterBase<B>
{
    /**
     * Constructor
     *
     ...
     */
    public ProjectManagementConverterBase(PropertyHelper propertyHelper,
                                          String               serviceName,
                                          String               serverName)
    {
