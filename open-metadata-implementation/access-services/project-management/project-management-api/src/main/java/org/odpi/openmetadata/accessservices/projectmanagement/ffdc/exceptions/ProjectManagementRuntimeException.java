...
/**
 * ProjectManagementRuntimeException is used for all runtime exceptions generated by the Project Management OMAS.
 * It is used in conjunction with the ProjectManagementErrorCode to provide first failure data capture for these errors.
 */
public class ProjectManagementRuntimeException extends RuntimeException
{
     ...
     */
    public ProjectManagementRuntimeException(int                 httpCode,
                                             String              className,
    ...
    {
        return "ProjectManagementRuntimeException{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ProjectManagementRuntimeException))
        {
            return false;
        }
        ProjectManagementRuntimeException that = (ProjectManagementRuntimeException) objectToCompare;
