...
/**
 * ProjectManagementCheckedExceptionBase provides a checked exception for reporting errors found when using
 * the Project Management OMAS services.
 *
 ...
 * The ProjectManagementErrorCode can be used with this exception to populate it with standard messages.
 * The aim is to be able to uniquely identify the cause and remedy for the error.
 */
public abstract class ProjectManagementCheckedExceptionBase extends Exception
{
     ...
     */
    public ProjectManagementCheckedExceptionBase(int    httpCode,
                                                 String className,
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ProjectManagementCheckedExceptionBase))
        {
            return false;
        }
        ProjectManagementCheckedExceptionBase that = (ProjectManagementCheckedExceptionBase) objectToCompare;
