...
/**
 * ProjectManagementOMASAPIResponse provides a common header for Project Management OMAS managed responses to its REST API.
...
public abstract class ProjectManagementOMASAPIResponse implements java.io.Serializable
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ProjectManagementOMASAPIResponse))
        {
            return false;
        }
        ProjectManagementOMASAPIResponse that = (ProjectManagementOMASAPIResponse) objectToCompare;
