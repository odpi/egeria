...
public class PersonRoleResponse extends ProjectManagementOMASAPIResponse
{
     ...
     */
    public PersonRoleResponse(PersonRoleResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof PersonRoleResponse))
        {
            return false;
        }
        ...
        PersonRoleResponse that = (PersonRoleResponse) objectToCompare;
