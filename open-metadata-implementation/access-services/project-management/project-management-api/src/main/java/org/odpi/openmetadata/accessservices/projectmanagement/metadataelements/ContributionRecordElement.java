...
public class ContributionRecordElement implements MetadataElement, Serializable
{
     ...
     * Default constructor
     */
    public ContributionRecordElement()
    {
        super();
    }
     ...
     */
    public ContributionRecordElement(ContributionRecordElement template)
    {
        if (template != null)
        {
    ...
    {
        return "ContributionRecordElement{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ContributionRecordElement that = (ContributionRecordElement) objectToCompare;
