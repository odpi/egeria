...
public class VoidResponseTest
{
    ...
    @Test public void testJSON()
    {
         ...
         * Through superclass
         */
        ProjectManagementOMASAPIResponse superObject = getTestObject();
        ...
        try
        {
            validateResultObject((VoidResponse) objectMapper.readValue(jsonString, ProjectManagementOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
