...
/**
 * Validate that the ProjectManagementRuntimeException is properly populated and supports toString, hashCode and
 * equals.
 */
public class RuntimeExceptionTest
{
    ...
    {
        ProjectManagementRuntimeException exception = new ProjectManagementRuntimeException(reportedHTTPCode,
                                                                                            reportingClassName,
    ...
    @Test public void testHashCode()
    {
        ...
        ProjectManagementRuntimeException exception2 = new ProjectManagementRuntimeException(reportedHTTPCode,
                                                                                             reportingClassName,
                                                                                             reportingActionDescription,
                                                                                             reportedErrorMessage,
                                                                                             reportedSystemAction,
        ...
        assertTrue(exception.toString().contains("ProjectManagementRuntimeException"));
