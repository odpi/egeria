...
public class ErrorCodeTest
{
    ...
    private void testSingleErrorCodeValues(ProjectManagementErrorCode  testValue)
    {
        String                  testInfo;
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            jsonString = objectMapper.writeValueAsString(ProjectManagementErrorCode.CLIENT_SIDE_REST_API_ERROR);
        }
        catch (Throwable  exc)
        {
        ...
        try
        {
            assertTrue(objectMapper.readValue(jsonString, ProjectManagementErrorCode.class) == ProjectManagementErrorCode.CLIENT_SIDE_REST_API_ERROR);
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(ProjectManagementErrorCode.OMRS_NOT_INITIALIZED.toString().contains("ProjectManagementErrorCode"));
    }
    ...
    {
        assertTrue(ProjectManagementErrorCode.SERVER_URL_NOT_SPECIFIED.equals(ProjectManagementErrorCode.SERVER_URL_NOT_SPECIFIED));
        assertFalse(ProjectManagementErrorCode.SERVER_URL_NOT_SPECIFIED.equals(ProjectManagementErrorCode.SERVICE_NOT_INITIALIZED));
    }
    ...
    {
        assertTrue(ProjectManagementErrorCode.SERVER_URL_NOT_SPECIFIED.hashCode() == ProjectManagementErrorCode.SERVER_URL_NOT_SPECIFIED.hashCode());
        assertFalse(ProjectManagementErrorCode.SERVER_URL_NOT_SPECIFIED.hashCode() == ProjectManagementErrorCode.SERVICE_NOT_INITIALIZED.hashCode());
    }
}
