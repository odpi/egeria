...
/**
 * The ElementClassification bean defines a single classification for an asset.  This can be used for REST calls and other
...
public class ElementClassification implements Serializable
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ElementClassification))
        {
            return false;
        }
