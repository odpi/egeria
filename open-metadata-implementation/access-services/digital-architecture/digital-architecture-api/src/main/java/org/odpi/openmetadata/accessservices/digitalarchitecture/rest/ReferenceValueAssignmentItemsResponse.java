...
public class ReferenceValueAssignmentItemsResponse extends DigitalArchitectureOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<ReferenceValueAssignmentItemElement> elementList = null;
     ...
     */
    public List<ReferenceValueAssignmentItemElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<ReferenceValueAssignmentItemElement> elementList)
    {
