 ...
 * </ul>
 */
public enum DigitalArchitectureErrorCode implements ExceptionMessageSet
{
    NULL_LISTENER(400, "OMAS-DIGITAL-ARCHITECTURE-400-017",
                  "A null topic listener has been passed by user {0} on method {1}",
                  "There is a coding error in the caller to the Digital Architecture OMAS.",
                  "Correct the caller logic and retry the request."),

    OMRS_NOT_INITIALIZED(404, "OMAS-DIGITAL-ARCHITECTURE-404-001",
    ...
    UNABLE_TO_SEND_EVENT(500, "OMAS-DIGITAL-ARCHITECTURE-500-004",
                         "An unexpected exception occurred when sending an event through connector {0} to the Digital Architecture OMAS out topic.  The failing " +
    ...
    NULL_CONNECTOR_RETURNED(500, "OMAS-DIGITAL-ARCHITECTURE-500-006",
    ...
    WRONG_TYPE_OF_CONNECTOR(500, "OMAS-DIGITAL-ARCHITECTURE-500-007",
     ...
     * DigitalArchitectureErrorCode above.   For example:
     *
     *     DigitalArchitectureErrorCode   errorCode = DigitalArchitectureErrorCode.SERVER_NOT_AVAILABLE;
     *
     ...
     */
    DigitalArchitectureErrorCode(int  httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
