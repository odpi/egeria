...
public abstract class DigitalArchitectureOMASAPIResponse implements java.io.Serializable
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof DigitalArchitectureOMASAPIResponse))
        {
            return false;
        }
        DigitalArchitectureOMASAPIResponse that = (DigitalArchitectureOMASAPIResponse) objectToCompare;
