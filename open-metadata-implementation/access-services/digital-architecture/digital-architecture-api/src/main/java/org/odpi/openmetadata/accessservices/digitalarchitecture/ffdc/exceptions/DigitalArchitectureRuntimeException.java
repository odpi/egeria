 ...
 * It is used in conjunction with the DigitalArchitectureErrorCode to provide first failure data capture for these errors.
 */
public class DigitalArchitectureRuntimeException extends RuntimeException
{
     ...
     */
    public DigitalArchitectureRuntimeException(int                 httpCode,
                                               String              className,
