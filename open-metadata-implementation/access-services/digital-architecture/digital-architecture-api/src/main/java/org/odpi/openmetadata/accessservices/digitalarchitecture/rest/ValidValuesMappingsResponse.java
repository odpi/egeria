...
public class ValidValuesMappingsResponse extends DigitalArchitectureOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<ValidValuesMappingElement> elementList = null;
     ...
     */
    public List<ValidValuesMappingElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<ValidValuesMappingElement> elementList)
    {
