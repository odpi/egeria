...
public class ValidValueAssignmentConsumersResponse extends DigitalArchitectureOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<ValidValueAssignmentConsumerElement> elementList = null;
     ...
     */
    public List<ValidValueAssignmentConsumerElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<ValidValueAssignmentConsumerElement> elementList)
    {
