 ...
 * The DigitalArchitectureErrorCode can be used with this exception to populate it with standard messages.
 * The aim is to be able to uniquely identify the cause and remedy for the error.
 */
public abstract class DigitalArchitectureCheckedExceptionBase extends Exception
{
     ...
     */
    public DigitalArchitectureCheckedExceptionBase(int    httpCode,
                                                   String className,
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof DigitalArchitectureCheckedExceptionBase))
        {
            return false;
        }
        DigitalArchitectureCheckedExceptionBase that = (DigitalArchitectureCheckedExceptionBase) objectToCompare;
