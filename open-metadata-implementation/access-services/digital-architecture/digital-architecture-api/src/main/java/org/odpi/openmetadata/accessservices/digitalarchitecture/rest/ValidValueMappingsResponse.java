...
public class ValidValueMappingsResponse extends DigitalArchitectureOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<ValidValueMappingElement> elementList = null;


    /**
     * Default constructor
     */
    public ValidValueMappingsResponse()
    {
    }
     ...
     */
    public ValidValueMappingsResponse(ValidValueMappingsResponse template)
    {
        super(template);
     ...
     */
    public List<ValidValueMappingElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<ValidValueMappingElement> elementList)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ValidValueMappingsResponse that = (ValidValueMappingsResponse) objectToCompare;
