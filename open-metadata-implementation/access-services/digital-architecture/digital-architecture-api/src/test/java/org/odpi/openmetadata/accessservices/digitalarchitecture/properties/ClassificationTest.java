...
public class ClassificationTest
{
    ...
    @Test public void testJSON()
    {
         ...
         * Through superclass
         */
        DigitalArchitectureElementHeader propertyBase = getTestObject();
        ...
        try
        {
            validateResultObject((Classification) objectMapper.readValue(jsonString, DigitalArchitectureElementHeader.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
