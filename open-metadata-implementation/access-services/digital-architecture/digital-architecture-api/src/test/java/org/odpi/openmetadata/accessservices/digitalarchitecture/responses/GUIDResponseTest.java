...
/**
 * Validate that the GUIDResponse bean can be cloned, compared, serialized, deserialized and printed as a String.
 */
public class GUIDResponseTest
{
    ...
    @Test public void testJSON()
    {
         ...
         * Through superclass
         */
        DigitalArchitectureOMASAPIResponse superObject = getTestObject();
        ...
        try
        {
            validateResultObject((GUIDResponse) objectMapper.readValue(jsonString, DigitalArchitectureOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
