...
/**
 * Validate that the DigitalArchitectureRuntimeException is properly populated and supports toString, hashCode and
 * equals.
 */
public class RuntimeExceptionTest
{
    ...
    {
        DigitalArchitectureRuntimeException exception = new DigitalArchitectureRuntimeException(reportedHTTPCode,
                                                                                                reportingClassName,
    ...
    @Test public void testHashCode()
    {
        ...
        DigitalArchitectureRuntimeException exception2 = new DigitalArchitectureRuntimeException(reportedHTTPCode,
                                                                                                 reportingClassName,
                                                                                                 reportingActionDescription,
                                                                                                 reportedErrorMessage,
                                                                                                 reportedSystemAction,
        ...
        assertTrue(exception.toString().contains("DigitalArchitectureRuntimeException"));
