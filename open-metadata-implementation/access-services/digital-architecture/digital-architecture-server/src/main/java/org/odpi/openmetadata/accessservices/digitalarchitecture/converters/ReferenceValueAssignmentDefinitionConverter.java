...
public class ReferenceValueAssignmentDefinitionConverter<B> extends ValidValueConverter<B>
{
                        ...
                        String       methodName) throws PropertyServerException
    {
        try
        {
            ...
            if (returnBean instanceof ReferenceValueAssignmentDefinitionElement)
            {
                ReferenceValueAssignmentDefinitionElement bean = (ReferenceValueAssignmentDefinitionElement) returnBean;
