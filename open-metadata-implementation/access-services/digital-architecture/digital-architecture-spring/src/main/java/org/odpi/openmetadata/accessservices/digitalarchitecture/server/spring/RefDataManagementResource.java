...
/**
 * The RefDataManagementResource provides the server-side implementation of the Digital Architecture Open Metadata
 * Assess Service (OMAS).
 */
@RestController
...
public class RefDataManagementResource
{
     ...
     * Default constructor
     */
    public RefDataManagementResource()
    {
    }
