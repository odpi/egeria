...
import org.odpi.openmetadata.accessservices.dataplatform.api.DataPlatformLoggingInterface;
 ...
 */
public class LoggingHandler implements DataPlatformLoggingInterface
{
                                      ...
                                      String      message)
    {
        ...
        auditCode = DataPlatformAuditCode.ASSET_AUDIT_LOG;
