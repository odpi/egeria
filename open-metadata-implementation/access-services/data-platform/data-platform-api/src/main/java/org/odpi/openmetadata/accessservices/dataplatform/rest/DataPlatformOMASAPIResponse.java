...
@JsonSubTypes(
        {
                ...
                @JsonSubTypes.Type(value = DatabaseDerivedColumnResponse.class, name = "DatabaseDerivedColumnResponse"),
                @JsonSubTypes.Type(value = DatabaseDerivedColumnsResponse.class, name = "DatabaseDerivedColumnsResponse"),
...
public abstract class DataPlatformOMASAPIResponse extends FFDCResponseBase
{
     ...
     * Default constructor
     */
    public DataPlatformOMASAPIResponse()
    {
    }
     ...
     */
    public DataPlatformOMASAPIResponse(DataPlatformOMASAPIResponse template)
    {
        super(template);
    }
