...
/**
 * DataPlatformCheckedExceptionBase provides a checked exception for reporting errors found when using
 * the Data Platform OMAS services.
 *
 ...
 * The DataPlatformErrorCode can be used with this exception to populate it with standard messages.
 * The aim is to be able to uniquely identify the cause and remedy for the error.
 */
public abstract class DataPlatformCheckedExceptionBase extends Exception
{
     ...
     */
    public DataPlatformCheckedExceptionBase(int    httpCode,
                                            String className,
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof DataPlatformCheckedExceptionBase))
        {
            return false;
        }
        DataPlatformCheckedExceptionBase that = (DataPlatformCheckedExceptionBase) objectToCompare;
