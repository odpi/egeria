...
/**
 * The DataPlatformAuditCode is used to define the message content for the OMRS Audit Log.
 *
...
public enum DataPlatformAuditCode implements AuditLogMessageSet
{
    ...
    SERVICE_INITIALIZING("OMAS-DATA-PLATFORM-0001",
                         ...
                         "The local server has started up a new instance of the Data Platform OMAS.  This service " +
                                 "supports the exchange of metadata between data platforms.",
                         "No action is required if the Data Platform OMAS service is expected to be started in this server.  If " +
    ...
    SERVICE_PUBLISHING("OMAS-DATA-PLATFORM-0002",
                       OMRSAuditLogRecordSeverity.STARTUP,
                       "The Data Platform Open Metadata Access Service (OMAS) is ready to publish data platform notifications to topic {0}",
                       "The local server has started up the event publisher for the Data Platform OMAS.  " +
                               "It will begin publishing data platform metadata changes to its out topic.",
    ...
    SERVICE_INITIALIZED("OMAS-DATA-PLATFORM-0005",
            ...
            "The Data Platform OMAS has completed initialization of a new instance.",
    ...
    PUBLISHING_SHUTDOWN("OMAS-DATA-PLATFORM-0007",
                        OMRSAuditLogRecordSeverity.SHUTDOWN,
                        "The Data Platform Open Metadata Access Service (OMAS) is no longer publishing events to topic {0}",
                        "The local administrator has requested shut down of an Data Platform OMAS instance.  " +
    ...
    PUBLISHING_SHUTDOWN_ERROR("OMAS-DATA-PLATFORM-0008",
                              OMRSAuditLogRecordSeverity.SHUTDOWN,
                              "The Data Platform Open Metadata Access Service (OMAS) caught an unexpected {0} exception whilst shutting down the out " +
    ...
    SERVICE_INSTANCE_FAILURE("OMAS-DATA-PLATFORM-0011",
    ...
    OUT_TOPIC_EVENT("OMAS-DATA-PLATFORM-0013",
                    ...
                    "The Data Platform Open Metadata Access Service (OMAS) has sent event: {0}",
                    "The access service sends out notifications about changes to assets located on " +
                            "data platforms.  This message is to create a record of the events that are being published.",
                    "This event indicates that one of the assets within a data platform has changed."),
    ...
    PARSE_EVENT_EXCEPTION("OMAS-DATA-PLATFORM-0015",
          OMRSAuditLogRecordSeverity.EXCEPTION,
          "Inbound event {0} could not be parsed. IOException included the following message: {1}",
          "The system is unable to process the event received on the Data Platform OMAS in topic.",
    ...
    /**
     * The constructor for DataPlatformAuditCode expects to be passed one of the enumeration rows defined in
     * DataPlatformAuditCode above.   For example:
     *
     *     DataPlatformAuditCode   auditCode = DataPlatformAuditCode.SERVER_NOT_AVAILABLE;
     *
     ...
     */
    DataPlatformAuditCode(String                     messageId,
