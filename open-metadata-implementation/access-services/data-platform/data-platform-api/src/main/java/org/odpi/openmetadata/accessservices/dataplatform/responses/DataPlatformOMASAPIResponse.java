...
/**
 * DataPlatformOMASAPIResponse provides a common header for Data Platform OMAS managed responses to its REST API.
...
public abstract class DataPlatformOMASAPIResponse implements java.io.Serializable
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof DataPlatformOMASAPIResponse))
        {
            return false;
        }
        DataPlatformOMASAPIResponse that = (DataPlatformOMASAPIResponse) objectToCompare;
