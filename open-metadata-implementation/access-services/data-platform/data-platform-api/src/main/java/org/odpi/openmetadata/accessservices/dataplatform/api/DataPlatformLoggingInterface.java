...
/**
 * DataPlatformLoggingInterface supports the ability to add log messages to the local server's audit log about an asset.
 */
public interface DataPlatformLoggingInterface
{
    /**
