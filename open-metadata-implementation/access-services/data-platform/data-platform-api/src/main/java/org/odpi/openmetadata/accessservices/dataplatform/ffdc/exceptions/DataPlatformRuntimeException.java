 ...
 * It is used in conjunction with the DataPlatformErrorCode to provide first failure data capture for these errors.
 */
public class DataPlatformRuntimeException extends RuntimeException
{
     ...
     */
    public DataPlatformRuntimeException(int                 httpCode,
                                        String              className,
    ...
    {
        return "DataPlatformRuntimeException{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof DataPlatformRuntimeException))
        {
            return false;
        }
        DataPlatformRuntimeException that = (DataPlatformRuntimeException) objectToCompare;
