...
/**
 * DatabaseDerivedColumnProperties is a class for representing a column in a database table or view
 * that is derived from other data via a formula.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class DatabaseDerivedColumnProperties extends DerivedSchemaAttributeProperties
{
     ...
     * Default constructor
     */
    public DatabaseDerivedColumnProperties()
    {
        super();
    }
     ...
     */
    public DatabaseDerivedColumnProperties(DatabaseDerivedColumnProperties template)
    {
        super(template);
    }
