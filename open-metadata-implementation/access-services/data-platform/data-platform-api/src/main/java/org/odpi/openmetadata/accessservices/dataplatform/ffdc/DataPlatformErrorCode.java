 ...
 * </ul>
 */
public enum DataPlatformErrorCode implements ExceptionMessageSet
{
    ADD_ENTITY_EXCEPTION(400, "OMAS-DATA-PLATFORM-400-001",
    ...
    ADD_RELATIONSHIP_EXCEPTION(400, "OMAS-DATA-PLATFORM-400-002",
    ...
    GET_ENTITY_EXCEPTION(400, "OMAS-DATA-PLATFORM-400-003",
    ...
    GET_RELATIONSHIP_EXCEPTION(400, "OMAS-DATA-PLATFORM-400-004",
            "Relationship {0} could not be fetched. Error: {1}",
            "The system is unable to process the request.",
            "Verify the topic event related to the relationship."),

    ADD_CLASSIFICATION_EXCEPTION(400, "OMAS-DATA-PLATFORM-400-005",
    ...
    OMRS_NOT_INITIALIZED(404, "OMAS-DATA-PLATFORM-404-001",
    ...
    NULL_LISTENER(500, "OMAS-DATA-PLATFORM-500-001",
                  "A null topic listener has been passed by user {0} on method {1}",
                  "There is a coding error in the caller to the Data Platform OMAS.",
                  "Correct the caller logic and retry the request."),

    UNABLE_TO_SEND_EVENT(500, "OMAS-DATA-PLATFORM-500-004",
                         "An unexpected exception occurred when sending an event through connector {0} to the Data Platform OMAS out topic.  The failing " +
    ...
    UNEXPECTED_INITIALIZATION_EXCEPTION(503, "OMAS-DATA-PLATFORM-503-005",
     ...
     * DataPlatformErrorCode above.   For example:
     *
     *     DataPlatformErrorCode   errorCode = DataPlatformErrorCode.UNKNOWN_ENDPOINT;
     *
     ...
     */
    DataPlatformErrorCode(int  httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
