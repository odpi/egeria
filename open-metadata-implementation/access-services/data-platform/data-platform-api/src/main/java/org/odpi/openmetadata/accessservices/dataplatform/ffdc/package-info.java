...
/**
 * This package provides the first failure data capture support for the Data Platform OMAS module.
 ...
 *
 * The error code enum (DataPlatformErrorCode) has an entry for each unique situation
