...
public class VoidResponseTest
{
    ...
    @Test public void testJSON()
    {
         ...
         * Through superclass
         */
        DataPlatformOMASAPIResponse superObject = getTestObject();
        ...
        try
        {
            validateResultObject((VoidResponse) objectMapper.readValue(jsonString, DataPlatformOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
