...
/**
 * AssetLineageRuntimeException is used for all runtime exceptions generated by the Asset Lineage OMAS.
 * It is used in conjunction with the AssetLineageErrorCode to provide first failure data capture for these errors.
 */
public class AssetLineageRuntimeException extends RuntimeException
{
     ...
     */
    public AssetLineageRuntimeException(int                 httpCode,
                                        String              className,
    ...
    {
        return "AssetLineageRuntimeException{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof AssetLineageRuntimeException))
        {
            return false;
        }
        AssetLineageRuntimeException that = (AssetLineageRuntimeException) objectToCompare;
