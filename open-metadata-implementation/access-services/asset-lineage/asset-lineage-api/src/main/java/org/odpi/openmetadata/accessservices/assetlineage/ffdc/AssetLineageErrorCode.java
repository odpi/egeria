...
{
    SERVER_URL_NOT_SPECIFIED(400, "OMAS-ASSET-LINEAGE-400-001 ",
    ...
    SERVER_URL_MALFORMED(400, "OMAS-ASSET-LINEAGE-400-002 ",
            "The OMAS Server URL {0} is not in a recognized format",
            "The system is unable to connect to the OMAS Server to retrieve metadata properties.",
            "Ensure a valid OMAS Server URL is passed to the client when it is created."),
    NULL_USER_ID(400, "OMAS-ASSET-LINEAGE-400-003 ",
    ...
    NULL_GUID(400, "OMAS-ASSET-LINEAGE-400-004 ",
    ...
    NULL_NAME(400, "OMAS-ASSET-LINEAGE-400-005 ",
    ...
    OBJECT_LOCKED_AS_REFERENCE(400, "OMAS-ASSET-LINEAGE-400-007 ",
    ...
    USER_NOT_AUTHORIZED(400, "OMAS-ASSET-LINEAGE-400-008 ",
    ...
    PROPERTY_SERVER_ERROR(400, "OMAS-ASSET-LINEAGE-400-009 ",
            ...
            "The system is unable to process the request.",
            "Verify the access rights of the user."),
    NULL_ENUM(400, "OMAS-ASSET-LINEAGE-400-010 ",
            ...
            "Correct the code in the caller to provide the name."),
    NULL_TEXT(400, "OMAS-ASSET-LINEAGE-400-011 ",
            ...
            "Correct the code in the caller to provide the name."),
    NEGATIVE_START_FROM(400, "OMAS-ASSET-LINEAGE-400-012 ",
    ...
    NEGATIVE_PAGE_SIZE(400, "OMAS-ASSET-LINEAGE-400-013 ",
    ...
    WRONG_TYPE_OF_OBJECT(400, "OMAS-ASSET-LINEAGE-400-014 ",
    ...
    SERVER_NOT_AVAILABLE(404, "OMAS-ASSET-LINEAGE-404-001 ",
    ...
    OMRS_NOT_AVAILABLE(404, "OMAS-ASSET-LINEAGE-404-003 ",
            "The open metadata repository services are not available for the {0} operation",
            "The system is unable to connect to the open metadata property server.",
            "Check that the server where the Asset Lineage OMAS is running initialized correctly.  " +
                       "Correct any errors discovered and retry the request when the open metadata services are available."),
    MULTIPLE_INSTANCES_FOUND(404, "OMAS-ASSET-LINEAGE-404-008 ",
    ...
    INSTANCE_NOT_FOUND_BY_GUID(404, "OMAS-ASSET-LINEAGE-404-010 ",
    ...
    MULTIPLE_USER_IDENTITIES_FOUND(404, "OMAS-ASSET-LINEAGE-404-011 ",
    ...
    NO_PROFILE_FOR_USER(404, "OMAS-ASSET-LINEAGE-404-012 ",
    ...
    INSTANCE_WRONG_TYPE_FOR_GUID(404, "OMAS-ASSET-LINEAGE-404-013 ",
            ...
            "Check that the unique identifier is correct and the property server(s) supporting the asset lineage is/are running."),
    INSTANCE_NOT_DELETED(404, "OMAS-ASSET-LINEAGE-404-010 ",
    ...
    OMRS_NOT_INITIALIZED(500, "OMAS-ASSET-LINEAGE-500-001 ",
            "The open metadata repository services are not initialized for the {0} operation",
            "The system is unable to connect to the open metadata property server.",
            "Check that the server where the Asset Lineage OMAS is running has initialized correctly.  " +
                "Correct any errors discovered and retry the request when the open metadata services are available."),
    NO_METADATA_COLLECTION(500, "OMAS-ASSET-LINEAGE-500-002 ",
    ...
    NULL_END2_RETURNED(500, "OMAS-ASSET-LINEAGE-500-003 ",
    ...
    UNABLE_TO_CREATE_USER_IDENTITY(500, "OMAS-ASSET-LINEAGE-500-004 ",
    ...
    NULL_RESPONSE_FROM_API(503, "OMAS-ASSET-LINEAGE-503-001 ",
    ...
    CLIENT_SIDE_REST_API_ERROR(503, "OMAS-ASSET-LINEAGE-503-002 ",
    ...
    SERVICE_NOT_INITIALIZED(503, "OMAS-ASSET-LINEAGE-503-003 ",
    ...
    EXCEPTION_RESPONSE_FROM_API(503, "OMAS-ASSET-LINEAGE-503-004 ",
