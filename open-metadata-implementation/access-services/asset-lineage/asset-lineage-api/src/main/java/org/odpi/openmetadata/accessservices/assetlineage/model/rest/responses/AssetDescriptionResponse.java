...
import org.odpi.openmetadata.accessservices.assetlineage.model.AssetDescription;
...
/**
 * AssetDescriptionResponse is the response structure used on the Asset Lineage OMAS REST API calls that returns a
 * asset description object as a response.
 */
@JsonAutoDetect(getterVisibility = PUBLIC_ONLY, setterVisibility = PUBLIC_ONLY, fieldVisibility = NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
public class AssetDescriptionResponse extends AssetLineageOMASAPIResponse implements Serializable {
