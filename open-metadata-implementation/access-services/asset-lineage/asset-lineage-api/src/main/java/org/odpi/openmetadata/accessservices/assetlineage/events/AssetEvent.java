...
/**
 * AssetEvent describes the structure of the events emitted by the Asset Lineage OMAS that are about assets.
 */
...
public class AssetEvent extends AssetLineageEventHeader {
