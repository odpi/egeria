...
/**
 * AssetLineageEventHeader provides a common base for all events from the access service.
...
public abstract class AssetLineageEventHeader implements Serializable {
    ...
    private AssetLineageEventType eventType = null;
     ...
     */
    AssetLineageEventHeader(AssetLineageEventHeader template) {
        if (template != null) {
     ...
     */
    public AssetLineageEventType getEventType() {
        return eventType;
    }
     ...
     */
    public void setEventType(AssetLineageEventType eventType) {
    ...
    public boolean equals(Object objectToCompare) {
        ...
        AssetLineageEventHeader that = (AssetLineageEventHeader) objectToCompare;
