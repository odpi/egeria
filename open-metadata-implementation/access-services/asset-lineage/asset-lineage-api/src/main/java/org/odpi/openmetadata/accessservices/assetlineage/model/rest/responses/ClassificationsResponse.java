...
/**
 * ClassificationsResponse is the response structure used on the Asset Lineage OMAS REST API calls that
 * returns a classification object as a response.
 */
@JsonAutoDetect(getterVisibility = PUBLIC_ONLY, setterVisibility = PUBLIC_ONLY, fieldVisibility = NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
public class ClassificationsResponse extends AssetLineageOMASAPIResponse implements Serializable {
