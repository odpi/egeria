...
public class AssetLineageCheckedExceptionBase extends Exception {
     ...
     */
    public AssetLineageCheckedExceptionBase(String reportingClassName, String reportingActionDescription, String reportedErrorMessage, String reportedSystemAction, String reportedUserAction) {
     ...
     */
    public AssetLineageCheckedExceptionBase(
            String className,
