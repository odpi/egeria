...
public class GeneratorUtilities {
    ...
    /**
     * change the types from the json so that they are all valid Java Objects.
     * Note we do not write out java primitives as they would require different logic in the equals ( they would not like
     * the check for null.
     *
     * @param type
     * @return
     */
//    public static String prepareTypeForGeneration(String type) {
//        if (type == AttributeTypeDefCategory.PRIMITIVE) {
//
//        }
//        if (type.equals(AtlasBaseTypeDef.ATLAS_TYPE_BIGDECIMAL)) {
//            return "Float";
//        } else if (type.equals(AtlasBaseTypeDef.ATLAS_TYPE_INT) || type.equals(AtlasBaseTypeDef.ATLAS_TYPE_BIGINTEGER)) {
//            return "Integer";
//        } else {
//            return GeneratorUtilities.uppercase1stLetter(type);
//        }
//    }
}
