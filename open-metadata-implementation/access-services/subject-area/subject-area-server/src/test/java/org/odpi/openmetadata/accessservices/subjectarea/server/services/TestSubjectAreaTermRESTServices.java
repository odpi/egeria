...
import org.odpi.openmetadata.accessservices.subjectarea.server.properties.term.Term;
...
public class TestSubjectAreaTermRESTServices {
    ...
    public void testCreateTerm() throws Exception {
        ...
        Term returnedTerm = subjectAreaTermOmasREST.createTerm(testuserid, requestedTerm);
    ...
    public void testCreateTermNoName() throws Exception {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains("OMAS-SUBJECTAREA-400-016"));
        }
    ...
    public void testCreateTermNoGlossaryName() throws Exception {
        ...
        try {
            ...
            System.err.println(e.getMessage());
            assertTrue(e.getMessage().contains("OMAS-SUBJECTAREA-400-015"));
        }
        // check with an empty string
    ...
    public void testCreateTermNonExistantglossary() throws Exception {
        ...
        try {
            ...
            System.err.println(e.getMessage());
            assertTrue(e.getMessage().contains("OMAS-SUBJECTAREA-400-025"));
        }
    }
    ...
    public void testCreateTermWithInvalidRelationships() throws Exception {
        ...
        try {
            subjectAreaTermOmasREST.createTerm(testuserid, requestedTerm);
            fail();
        } catch (Exception e) {
            System.err.println(e.getMessage());
            assertTrue(e.getMessage().contains("OMAS-SUBJECTAREA-400-019"));
        }
        ...
        try {
            ...
            System.err.println(e.getMessage());
            assertTrue(e.getMessage().contains("OMAS-SUBJECTAREA-400-026"));
        }
    }
    @Test
    public void testUpdateTermName() throws Exception {
        ...
        Term returnedTerm = subjectAreaTermOmasREST.updateTermName(testuserid,testguid1, newName);
    ...
    public void testUpdateTermDescription() throws Exception {
        ...
        Term returnedTerm = subjectAreaTermOmasREST.updateTermDescription(testuserid,testguid1, newDescription);
    ...
    public void testDeleteTerm() throws Exception {
        ...
        SubjectAreaTermRESTServices subjectAreaTermOmasREST = new SubjectAreaTermRESTServices();
        subjectAreaTermOmasREST.setOMRSAPIHelper(oMRSAPIHelper);
        subjectAreaTermOmasREST.deleteTerm(testuserid, testguid1,false);
    }
    ...
    public void testGetTerm() throws Exception {
        ...
        Term returnedTerm = subjectAreaTermOmasREST.getTermByGuid(testuserid, testguid1);
