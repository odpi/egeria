...
public enum SubjectAreaAuditCode {
    SERVICE_INITIALIZING("OMAS-SUBJECT-AREA-0001",
            ...
            "The local org.apache.atlas.OMAS.subjectarea.server has started up the Subject Area OMAS.",
    ...
    SERVICE_REGISTERED_WITH_TOPIC("OMAS-SUBJECT-AREA-0002",
            ...
            "The Subject Area OMAS is registering to receive events from the connected open metadata repositories.",
            "No action is required. This is part of the normal operation of the  Subject Area Omas."),
    ...
    SERVICE_SHUTDOWN("OMAS-SUBJECT-AREA-0004",
            ...
            "The local org.apache.atlas.OMAS.subjectarea.server has requested shut down of the Subject Area OMAS.",
            "No action is required. This is part of the normal operation of the  Subject Area Omas."),
