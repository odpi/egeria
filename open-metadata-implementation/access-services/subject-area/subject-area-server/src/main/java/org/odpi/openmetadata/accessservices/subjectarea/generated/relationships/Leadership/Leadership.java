...
public class Leadership extends Line {
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public Leadership() {
        super("Leadership");
        super.entity1Name = "leads";
        super.entity1Type = "ActorProfile";
        super.entity2Name = "follows";
    ...
    public Leadership(Relationship omrsRelationship) {
        ...
        if (!omrsRelationship.getEntityOnePropertyName().equals("leads")){
            //error
        }
        if (!omrsRelationship.getEntityTwoPropertyName().equals("follows")){
            //error
        }
