...
import org.odpi.openmetadata.accessservices.subjectarea.generated.relationships.PreferredTerm.PreferredTerm;
import org.odpi.openmetadata.accessservices.subjectarea.generated.relationships.PreferredTerm.PreferredTermMapper;
import org.odpi.openmetadata.accessservices.subjectarea.generated.references.GlossaryTermToExternalGlossaryLink.ExternalGlossaryLinksReference;
            ...
            for (int i=0;i< RELATIONSHIP_NAMES_SET_VALUES.length; i++) {
               if (relationship.getName().equals(RELATIONSHIP_NAMES_SET_VALUES[i])) {
                    ...
                    if ("externalGlossaryLinks".equals(referenceName)) {
                         IsTaxonomy isTaxonomy_relationship = (IsTaxonomy)relationship;
                         ExternalGlossaryLinksReference externalGlossaryLinksReference = new ExternalGlossaryLinksReference(entityGuid,isTaxonomy_relationship);
