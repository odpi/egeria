...
import org.odpi.openmetadata.accessservices.subjectarea.generated.enums.MediaUsageType;
...
public class SubjectAreaUtils {
    ...
    public static String getIcon(@PathVariable String userId, Set<RelatedMediaReference> relatedMediaReferenceSet) throws Exception {
        String iconUrl =null;
