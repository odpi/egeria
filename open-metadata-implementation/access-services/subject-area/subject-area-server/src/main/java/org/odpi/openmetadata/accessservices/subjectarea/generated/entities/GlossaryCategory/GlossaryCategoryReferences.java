...
import org.odpi.openmetadata.accessservices.subjectarea.generated.references.GlossaryCategoryToExternalGlossaryLink.ExternalGlossaryLinksReference;
         ...
         for (Line relationship: lines) {
            for (int i=0;i< RELATIONSHIP_NAMES_SET_VALUES.length; i++) {
               if (relationship.getName().equals(RELATIONSHIP_NAMES_SET_VALUES[i])) {
                    ...
                    if ("externalGlossaryLinks".equals(referenceName)) {
                         LibraryCategoryReference libraryCategoryReference_relationship = (LibraryCategoryReference)relationship;
                         ExternalGlossaryLinksReference externalGlossaryLinksReference = new ExternalGlossaryLinksReference(entityGuid,libraryCategoryReference_relationship);
                         if ( externalGlossaryLinks== null ) {
                              externalGlossaryLinks = new HashSet();
                         }
                          externalGlossaryLinks.add(externalGlossaryLinksReference);
                    }
...
// Set properties
    ...
    private Set<ExternalGlossaryLinksReference> externalGlossaryLinks;
...
// Sets
    public Set<ExternalGlossaryLinksReference> getExternalGlossaryLinksReferences() {
        return externalGlossaryLinks;
    }

    public void setExternalGlossaryLinksReferences(Set<ExternalGlossaryLinksReference> externalGlossaryLinks) {
        this.externalGlossaryLinks =externalGlossaryLinks;
    }
...
// Lists
 ...
 public StringBuilder toString(StringBuilder sb) {
        ...
        sb.append("externalGlossaryLinksReference='").append(externalGlossaryLinks.toString());
    ...
    public boolean equals(Object o) {
      ...
      // compare single cardinality attributes
         if (this.externalGlossaryLinks != null && !Objects.equals(this.externalGlossaryLinks,typedThat.externalGlossaryLinks)) {
                            return false;
                 }
