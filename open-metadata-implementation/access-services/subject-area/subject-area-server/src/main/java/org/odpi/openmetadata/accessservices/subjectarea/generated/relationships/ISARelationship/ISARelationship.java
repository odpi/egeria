...
public class ISARelationship extends Line {
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public ISARelationship() {
        super("ISARelationship");
        super.entity1Name = "classifies";
        super.entity1Type = "GlossaryTerm";
        super.entity2Name = "isA";
    ...
    public ISARelationship(Relationship omrsRelationship) {
        ...
        if (!omrsRelationship.getEntityOnePropertyName().equals("classifies")){
            //error
        }
        if (!omrsRelationship.getEntityTwoPropertyName().equals("isA")){
            //error
        }
