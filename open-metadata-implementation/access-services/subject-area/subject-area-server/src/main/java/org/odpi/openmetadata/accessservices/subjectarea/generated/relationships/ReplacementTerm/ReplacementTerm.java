...
public class ReplacementTerm extends Line {
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public ReplacementTerm() {
        super("ReplacementTerm");
        super.entity1Name = "replacedTerms";
        super.entity1Type = "GlossaryTerm";
        super.entity2Name = "replacementTerms";
    ...
    public ReplacementTerm(Relationship omrsRelationship) {
        ...
        if (!omrsRelationship.getEntityOnePropertyName().equals("replacedTerms")){
            //error
        }
        if (!omrsRelationship.getEntityTwoPropertyName().equals("replacementTerms")){
            //error
        }
