...
/**
 * SubjectAreaPublisher is responsible for publishing events about glossary artifacts.  It is called
 * when an interesting OMRS Event is added to the Enterprise OMRS Topic.  It adds events to the Subject Area OMAS
 * out topic.
 */
