                       ...
                       switch (value.getInstancePropertyCategory()) {
                                               case PRIMITIVE:
                                                   ...
                                                   if (TermHASARelationship.ATTRIBUTE_NAMES_SET.contains(name)) {
                                                      if (name.equals("description")) {
                                                          termHASARelationship.setDescription(actualValue);
                                                      }
                                                      if (name.equals("steward")) {
                                                          termHASARelationship.setSteward(actualValue);
                                                      }
                                                      if (name.equals("source")) {
                                                          termHASARelationship.setSource(actualValue);
                                                      }
                                                   } else {
                                               ...
                                               case MAP:
                                                    ...
                                                    if (TermHASARelationship.MAP_NAMES_SET.contains(name)) {
                                                      ...
                                                      termHASARelationship.getExtraAttributes().put(name, mapPropertyValue);
                                                    }
                                                       break;
                                               case ARRAY:
                                               case STRUCT:
