...
import org.odpi.openmetadata.accessservices.subjectarea.generated.references.BusinessCapabilityToGovernanceResponsibility.SupportingResponsibilitiesReference;
...
import org.odpi.openmetadata.accessservices.subjectarea.generated.references.BusinessCapabilityToTeam.SupportingTeamsReference;
...
public class BusinessCapabilityReferences implements Serializable {
    private static final Logger log = LoggerFactory.getLogger(BusinessCapabilityReferences.class);
    private static final String className = BusinessCapabilityReferences.class.getName();
    ...
    public static final String[] REFERENCE_NAMES_SET_VALUES = new String[] {
     ...
     public static final String[] RELATIONSHIP_NAMES_SET_VALUES = new String[] {
             "BusinessCapabilityResponsibility",
     ...
     /**
       * We are passed a set of omrs relationships that are associated with a entity BusinessCapability
       * Each of these relationships should map to a reference (a uniquely named attribute in BusinessCapability).
       *
       ...
       */
     public BusinessCapabilityReferences(String entityGuid, List<Line> lines) throws InvalidParameterException {
         for (Line relationship: lines) {
            for (int i=0;i< RELATIONSHIP_NAMES_SET_VALUES.length; i++) {
               if (relationship.getName().equals(RELATIONSHIP_NAMES_SET_VALUES[i])) {
                    ...
                    if ("supportingResponsibilities".equals(referenceName)) {
                         BusinessCapabilityResponsibility businessCapabilityResponsibility_relationship = (BusinessCapabilityResponsibility)relationship;
                         SupportingResponsibilitiesReference supportingResponsibilitiesReference = new SupportingResponsibilitiesReference(entityGuid,businessCapabilityResponsibility_relationship);
                         if ( supportingResponsibilities== null ) {
                              supportingResponsibilities = new HashSet();
                         }
                          supportingResponsibilities.add(supportingResponsibilitiesReference);
                    }
                    if ("supportingTeams".equals(referenceName)) {
                         OrganizationalCapability organizationalCapability_relationship = (OrganizationalCapability)relationship;
                         SupportingTeamsReference supportingTeamsReference = new SupportingTeamsReference(entityGuid,organizationalCapability_relationship);
...
// Set properties
    ...
    private Set<SupportingResponsibilitiesReference> supportingResponsibilities;
...
// Sets
    public Set<SupportingResponsibilitiesReference> getSupportingResponsibilitiesReferences() {
        return supportingResponsibilities;
    }

    public void setSupportingResponsibilitiesReferences(Set<SupportingResponsibilitiesReference> supportingResponsibilities) {
        this.supportingResponsibilities =supportingResponsibilities;
    }
...
// Lists
 ...
 public StringBuilder toString(StringBuilder sb) {
        ...
        sb.append("BusinessCapabilityReferences{");
        sb.append("supportingResponsibilitiesReference='").append(supportingResponsibilities.toString());
    ...
    public boolean equals(Object o) {
        ...
        if (!super.equals(o)) { return false; }
         BusinessCapabilityReferences typedThat = (BusinessCapabilityReferences) o;
      // compare single cardinality attributes
         if (this.supportingResponsibilities != null && !Objects.equals(this.supportingResponsibilities,typedThat.supportingResponsibilities)) {
                            return false;
                 }
    ...
    ,this.supportingResponsibilities
