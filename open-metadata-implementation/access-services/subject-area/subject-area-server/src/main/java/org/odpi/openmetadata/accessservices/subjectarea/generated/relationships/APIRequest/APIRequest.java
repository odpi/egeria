...
public class APIRequest extends Line {
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public APIRequest() {
        super("APIRequest");
        super.entity1Name = "usedAsAPIRequest";
        super.entity1Type = "APIOperation";
        super.entity2Name = "apiRequest";
    ...
    public APIRequest(Relationship omrsRelationship) {
        ...
        if (!omrsRelationship.getEntityOnePropertyName().equals("usedAsAPIRequest")){
            //error
        }
        if (!omrsRelationship.getEntityTwoPropertyName().equals("apiRequest")){
            //error
        }
