                       ...
                       switch (value.getInstancePropertyCategory()) {
                                               case PRIMITIVE:
                                                   ...
                                                   if (PreferredTerm.ATTRIBUTE_NAMES_SET.contains(name)) {
                                                      if (name.equals("description")) {
                                                          preferredTerm.setDescription(actualValue);
                                                      }
                                                      if (name.equals("expression")) {
                                                          preferredTerm.setExpression(actualValue);
                                                      }
                                                      if (name.equals("steward")) {
                                                          preferredTerm.setSteward(actualValue);
                                                      }
                                                      if (name.equals("source")) {
                                                          preferredTerm.setSource(actualValue);
                                                      }
                                                   } else {
                                               ...
                                               case MAP:
                                                    ...
                                                    if (PreferredTerm.MAP_NAMES_SET.contains(name)) {
                                                      ...
                                                      preferredTerm.getExtraAttributes().put(name, mapPropertyValue);
                                                    }
                                                       break;
                                               case ARRAY:
                                               case STRUCT:
