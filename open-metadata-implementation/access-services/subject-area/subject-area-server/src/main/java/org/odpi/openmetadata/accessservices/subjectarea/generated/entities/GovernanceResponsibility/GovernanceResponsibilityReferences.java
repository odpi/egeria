...
import org.odpi.openmetadata.accessservices.subjectarea.generated.references.GovernanceResponsibilityToBusinessCapability.AffectedBusinessCapabilitiesReference;
...
import org.odpi.openmetadata.accessservices.subjectarea.generated.references.GovernanceResponsibilityToActorProfile.AssignedStaffReference;
...
public class GovernanceResponsibilityReferences implements Serializable {
    ...
    public static final String[] REFERENCE_NAMES_SET_VALUES = new String[] {
     ...
     /**
       ...
       */
     public GovernanceResponsibilityReferences(String entityGuid, List<Line> lines) throws InvalidParameterException {
            ...
            for (int i=0;i< RELATIONSHIP_NAMES_SET_VALUES.length; i++) {
               if (relationship.getName().equals(RELATIONSHIP_NAMES_SET_VALUES[i])) {
                    ...
                    if ("affectedBusinessCapabilities".equals(referenceName)) {
                         ...
                         AffectedBusinessCapabilitiesReference affectedBusinessCapabilitiesReference = new AffectedBusinessCapabilitiesReference(entityGuid,businessCapabilityResponsibility_relationship);
