 ...
 */
package org.odpi.openmetadata.accessservices.subjectarea.generated.classifications.PrimaryKey;
...
public class PrimaryKey extends Classification {
    ...
    protected String classificationName = "PrimaryKey";
 ...
 public static final String[] PROPERTY_NAMES_SET_VALUES = new String[] {
    ...
    public InstanceProperties obtainInstanceProperties() {
        ...
        instanceProperties.setProperty("keyPattern",primitivePropertyValue);
        if (log.isDebugEnabled()) {
               log.debug("<== Method: " + methodName);
        }
       ...
       public void setKeyPattern(Object keyPattern) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.

           final String methodName = "obtainInstanceProperties";
           try {
                 this.keyPattern = (KeyPattern)keyPattern;
