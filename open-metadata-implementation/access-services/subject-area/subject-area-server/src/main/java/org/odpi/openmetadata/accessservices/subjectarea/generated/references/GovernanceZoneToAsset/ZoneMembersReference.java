...
package org.odpi.openmetadata.accessservices.subjectarea.generated.references.GovernanceZoneToAsset;
 ...
 * and references.
 *
 * This Reference is called ZoneMembersReference. It is used in type GovernanceZone to represent a
...
public class ZoneMembersReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(ZoneMembersReference.class);
    private static final String className = ZoneMembersReference.class.getName();

    protected String relationship_Type = "ZoneMembership";
    protected String name = "zoneMembers";
    ...
    public ZoneMembersReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public ZoneMembersReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public ZoneMembersReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public ZoneMembersReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public ZoneMembersReference(String relatedEndType, final String attrName, final Object attrValue) {
        this(null, relatedEndType, new HashMap<String, Object>() {{
            put(attrName, attrValue);
        }});
    }

    public ZoneMembersReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public ZoneMembersReference(Reference other) {
        if (other != null) {
       ...
       * @param line Line
       */
    public ZoneMembersReference(String entityGuid, Line line) {
    ...
    public ZoneMembersReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        ZoneMembersReference typedThat =(ZoneMembersReference)that;
