...
public class FileSystem extends Classification {
    ...
    protected String classificationName = "FileSystem";
 ...
 public static final String[] PROPERTY_NAMES_SET_VALUES = new String[] {
    ...
    public InstanceProperties obtainInstanceProperties() {
       ...
       public void setEncryption(Object encryption) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.

           final String methodName = "obtainInstanceProperties";
           try {
                 this.encryption = (String)encryption;
           } catch (ClassCastException e) {
                  SubjectAreaErrorCode errorCode    = SubjectAreaErrorCode.SET_ATTRIBUTE_WRONG_TYPE;
                  String errorMessage = errorCode.getErrorMessageId()
                          + errorCode.getFormattedErrorMessage(className,
