...
/**
 * OperatingPlatform entity in the Subject Area OMAS.
...
public class  OperatingPlatform implements Serializable {
    ...
    InstanceProperties obtainInstanceProperties() {
       ...
       private String name;
       /**
        * Name of the operating platform.
        * @return String
        */
       ...
       /**
        * Description of the operating platform.
        * @return String
        */
       ...
       public void setOperatingSystem(Object operatingSystem) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.
       ...
       public void setEndianness(Object endianness) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.

           final String methodName = "obtainInstanceProperties";
           try {
                 this.endianness = (String)endianness;
           } catch (ClassCastException e) {
                  SubjectAreaErrorCode errorCode    = SubjectAreaErrorCode.SET_ATTRIBUTE_WRONG_TYPE;
                  String errorMessage = errorCode.getErrorMessageId()
                          + errorCode.getFormattedErrorMessage(className,
