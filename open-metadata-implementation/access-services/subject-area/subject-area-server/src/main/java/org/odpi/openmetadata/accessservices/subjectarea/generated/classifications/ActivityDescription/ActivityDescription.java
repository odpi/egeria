 ...
 */
package org.odpi.openmetadata.accessservices.subjectarea.generated.classifications.ActivityDescription;
...
public class ActivityDescription extends Classification {
    ...
    protected String classificationName = "ActivityDescription";
 ...
 public static final String[] PROPERTY_NAMES_SET_VALUES = new String[] {
    ...
    public InstanceProperties obtainInstanceProperties() {
        ...
        instanceProperties.setProperty("activityType",primitivePropertyValue);
        if (log.isDebugEnabled()) {
               log.debug("<== Method: " + methodName);
        }
       ...
       public void setActivityType(Object activityType) throws InvalidParameterException {
