...
public class SoftwareServerMapper {
   ...
   static public org.odpi.openmetadata.accessservices.subjectarea.generated.entities.SoftwareServer.SoftwareServer mapOmrsEntityDetailToSoftwareServer(EntityDetail omrsEntityDetail) throws InvalidParameterException{
                    ...
                    switch (value.getInstancePropertyCategory()) {
                        case PRIMITIVE:
                            ...
                            if (softwareServer.ATTRIBUTE_NAMES_SET.contains(name)) {
                               if (name.equals("type")) {
                                   softwareServer.setType(actualValue);
                               }
                               if (name.equals("version")) {
                                   softwareServer.setVersion(actualValue);
                               }
                               if (name.equals("source")) {
                                   softwareServer.setSource(actualValue);
                               }
                               if (name.equals("userId")) {
                                   softwareServer.setUserId(actualValue);
                               }
                               if (name.equals("name")) {
                                   softwareServer.setName(actualValue);
                               }
                               if (name.equals("description")) {
                                   softwareServer.setDescription(actualValue);
                               }
                               if (name.equals("owner")) {
                                   softwareServer.setOwner(actualValue);
                               }
                               if (name.equals("qualifiedName")) {
                                   softwareServer.setQualifiedName(actualValue);
                               }
                            } else {
    ...
    static public EntityDetail mapSoftwareServerToOmrsEntityDetail(org.odpi.openmetadata.accessservices.subjectarea.generated.entities.SoftwareServer.SoftwareServer softwareServer) {
            ...
            populateOmrsEntityWithOmasClassifications(omrsEntityDetail,(List<org.odpi.openmetadata.accessservices.subjectarea.common.Classification>)softwareServer.getClassifications());
