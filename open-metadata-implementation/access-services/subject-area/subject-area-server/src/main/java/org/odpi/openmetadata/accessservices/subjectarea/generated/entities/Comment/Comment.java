 ...
 */
package org.odpi.openmetadata.accessservices.subjectarea.generated.entities.Comment;
...
public class  Comment implements Serializable {
    ...
    InstanceProperties obtainInstanceProperties() {
        ...
        // TODO  description + change null to value
        primitivePropertyValue.setPrimitiveValue(null);
        instanceProperties.setProperty("commentType",primitivePropertyValue);
        primitivePropertyValue = new PrimitivePropertyValue();
        // TODO  description + change null to value
        primitivePropertyValue.setPrimitiveValue(null);
       ...
       public void setComment(Object comment) throws InvalidParameterException {
       ...
       public void setCommentType(Object commentType) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.

           final String methodName = "obtainInstanceProperties";
           try {
                 this.commentType = (CommentType)commentType;
           } catch (ClassCastException e) {
                  SubjectAreaErrorCode errorCode    = SubjectAreaErrorCode.SET_ATTRIBUTE_WRONG_TYPE;
                  String errorMessage = errorCode.getErrorMessageId()
                          + errorCode.getFormattedErrorMessage(className,
