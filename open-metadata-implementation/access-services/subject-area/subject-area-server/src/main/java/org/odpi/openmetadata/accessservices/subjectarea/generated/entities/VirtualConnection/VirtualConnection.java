...
public class  VirtualConnection implements Serializable {
    ...
    InstanceProperties obtainInstanceProperties() {
        ...
        // TODO  description + change null to value
        primitivePropertyValue.setPrimitiveValue(null);
        instanceProperties.setProperty("securedProperties",primitivePropertyValue);
        primitivePropertyValue = new PrimitivePropertyValue();
        // TODO  description + change null to value
        primitivePropertyValue.setPrimitiveValue(null);
       ...
       /**
        * Consumable name for the connection, suitable for reports and user interfaces.
        * @return String
        */
       ...
       public void setSecuredProperties(Object securedProperties) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.

           final String methodName = "obtainInstanceProperties";
           try {
                 this.securedProperties = (Map<String,String>)securedProperties;
           } catch (ClassCastException e) {
                  SubjectAreaErrorCode errorCode    = SubjectAreaErrorCode.SET_ATTRIBUTE_WRONG_TYPE;
                  String errorMessage = errorCode.getErrorMessageId()
                          + errorCode.getFormattedErrorMessage(className,
    ...
    public StringBuilder toString(StringBuilder sb) {
        ...
        sb.append("VirtualConnection Attributes{");
    ...
    public boolean equals(Object o) {
        ...
        VirtualConnection that = (VirtualConnection) o;
        ...
        // We view virtualConnections as logically equal by checking the properties that the OMAS knows about - i.e. without accounting for extra attributes and references from the org.odpi.openmetadata.accessservices.subjectarea.server.
