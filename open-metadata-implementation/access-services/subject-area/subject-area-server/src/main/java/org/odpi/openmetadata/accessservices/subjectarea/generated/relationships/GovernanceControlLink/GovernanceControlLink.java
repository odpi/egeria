...
/**
 * GovernanceControlLink is a relationship between an entity of type GovernanceControl and an entity of type GovernanceControl.
 ...
 */
public class GovernanceControlLink extends Line {
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public GovernanceControlLink() {
        super("GovernanceControlLink");
        super.entity1Name = "linkingControls";
        super.entity1Type = "GovernanceControl";
        super.entity2Name = "linkedControls";
    ...
    public GovernanceControlLink(Relationship omrsRelationship) {
        ...
        if (!omrsRelationship.getEntityOnePropertyName().equals("linkingControls")){
            //error
        }
        if (!omrsRelationship.getEntityTwoPropertyName().equals("linkedControls")){
            //error
        }
        if (!omrsRelationship.getEntityOneProxy().getType().getTypeDefName().equals("GovernanceControl")){
            //error
        }
