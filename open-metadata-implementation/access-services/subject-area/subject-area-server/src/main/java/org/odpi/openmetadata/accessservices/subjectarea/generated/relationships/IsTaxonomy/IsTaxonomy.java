...
/**
 * IsTaxonomy is a relationship between an entity of type GlossaryTerm and an entity of type ExternalGlossaryLink.
 ...
 */
public class IsTaxonomy extends Line {
    private static final Logger log = LoggerFactory.getLogger(IsTaxonomy.class);
    private static final String className = IsTaxonomy.class.getName();
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public IsTaxonomy() {
        super("IsTaxonomy");
        super.entity1Name = "localTerms";
        super.entity1Type = "GlossaryTerm";
        super.entity2Name = "externalGlossaryLinks";
        super.entity2Type = "ExternalGlossaryLink";
    }

    public IsTaxonomy(Relationship omrsRelationship) {
        super(omrsRelationship);

        if (!omrsRelationship.getEntityOnePropertyName().equals("localTerms")){
            //error
        }
