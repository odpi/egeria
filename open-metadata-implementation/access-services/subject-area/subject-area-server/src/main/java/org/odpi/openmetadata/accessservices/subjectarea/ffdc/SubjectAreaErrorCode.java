...
public enum SubjectAreaErrorCode {
    ...
    SET_ATTRIBUTE_WRONG_TYPE(400, "OMAS-SUBJECTAREA-400-008 ",
            "Error attempting to set Attribute {0} on {1}, with value {2}, which had an incorrect type. Expected type is {3}.",
    ...
    PROPERTY_SERVER_ERROR(400, "OMAS-SUBJECTAREA-400-010 ",
    ...
    GLOSSARY_TERM_CREATE_WITHOUT_GLOSSARY(400, "OMAS-SUBJECTAREA-400-015 ",
            "Cannot create a GlossaryTerm without a glossary",
            "The system is unable to process the request.",
            "Correct the code in the caller to create a GlossaryTerm with a glossary."),
    ...
    GLOSSARY_CATEGORY_CREATE_WITHOUT_GLOSSARY(400, "OMAS-SUBJECTAREA-400-017 ",
            "Cannot create a GlossaryCategory without a glossary",
            "The system is unable to process the request.",
            "Correct the code in the caller to create a GlossaryCategory with a glossary."),
    ...
    GLOSSARY_TERM_CREATE_WITH_NON_EXISTANT_GLOSSARY(400, "OMAS-SUBJECTAREA-400-025 ",
            "Glossary with name {0} does not exist. Cannot create a GlossaryTerm without a glossary",
            "The system is unable to process the request.",
            "Correct the code in the caller to create a GlossaryTerm with a valid glossaryName."),
    GLOSSARY_TERM_CREATE_WITH_PROJECTS(400, "OMAS-SUBJECTAREA-400-026 ",
            "Cannot create a Glossary Term {0} with projects",
            "The system is unable to process the request.",
            "Correct the code in the caller to remove the categories. Knit the term into a project after the term has been created."),
    GLOSSARY_CATEGORY_CREATE_WITH_NON_EXISTANT_GLOSSARY(400, "OMAS-SUBJECTAREA-400-027 ",
    ...
    GLOSSARY_CREATE_WITHOUT_NAME(400, "OMAS-SUBJECTAREA-400-028 ",
            "Cannot create a Glossary without a name",
            "The system is unable to process the request.",
            "Correct the code in the caller to create a Glossary with a name."),
    GLOSSARY_TERM_CREATE_FAILED_KNITTING_TO_GLOSSARY(400, "OMAS-SUBJECTAREA-400-029 ",
    ...
    GLOSSARY_CATEGORY_CREATE_WITH_NON_EXISTANT_PARENT(400, "OMAS-SUBJECTAREA-400-037 ",
    ...
    TYPEDEF_ERROR(400, "OMAS-SUBJECTAREA-400-042 ",
    ...
    ENTITY_NOT_KNOWN_ERROR(400, "OMAS-SUBJECTAREA-400-043 ",
            "An error occurred when processing a request involving entity {0} .",
            "The system is unable to process the request.",
            "Retry the request with a known entity."),
    RELATIONSHIP_NOT_KNOWN_ERROR(400, "OMAS-SUBJECTAREA-400-044 ",
            "An error occurred when processing a request involving relationship {0} .",
            "The system is unable to process the request.",
            "Retry the request with a known relationship."),
    GUID_NOT_PURGED_ERROR(400, "OMAS-SUBJECTAREA-400-045 ",
            "Guid {0} was not deleted.",
            "The system is unable to process the request.",
            "Contact your administrator to review the audit log to find the cause of the error."),

    // The following Excpetiosn are not descriptive enough - they need more informaiton from the OMRS Exception
...
//
    ...
    SERVICE_NOT_INITIALIZED(503, "OMAS-SUBJECTAREA-503-003 ",
