                       ...
                       switch (value.getInstancePropertyCategory()) {
                                               case PRIMITIVE:
                                                   ...
                                                   if (ExternalIdLink.ATTRIBUTE_NAMES_SET.contains(name)) {
                                                      if (name.equals("description")) {
                                                          externalIdLink.setDescription(actualValue);
                                                      }
                                                      if (name.equals("usage")) {
                                                          externalIdLink.setUsage(actualValue);
                                                      }
                                                      if (name.equals("source")) {
                                                          externalIdLink.setSource(actualValue);
                                                      }
                                                   } else {
                                               ...
                                               case MAP:
                                                    ...
                                                    if (ExternalIdLink.MAP_NAMES_SET.contains(name)) {
                                                      ...
                                                      externalIdLink.getExtraAttributes().put(name, mapPropertyValue);
                                                    }
                                                       break;
                                               case ARRAY:
                                               case STRUCT:
