                       ...
                       switch (value.getInstancePropertyCategory()) {
                                               case PRIMITIVE:
                                                   ...
                                                   if (TermTYPEDBYRelationship.ATTRIBUTE_NAMES_SET.contains(name)) {
                                                      if (name.equals("description")) {
                                                          termTYPEDBYRelationship.setDescription(actualValue);
                                                      }
                                                      if (name.equals("steward")) {
                                                          termTYPEDBYRelationship.setSteward(actualValue);
                                                      }
                                                      if (name.equals("source")) {
                                                          termTYPEDBYRelationship.setSource(actualValue);
                                                      }
                                                   } else {
                                               ...
                                               case MAP:
                                                    ...
                                                    if (TermTYPEDBYRelationship.MAP_NAMES_SET.contains(name)) {
                                                      ...
                                                      termTYPEDBYRelationship.getExtraAttributes().put(name, mapPropertyValue);
                                                    }
                                                       break;
                                               case ARRAY:
                                               case STRUCT:
