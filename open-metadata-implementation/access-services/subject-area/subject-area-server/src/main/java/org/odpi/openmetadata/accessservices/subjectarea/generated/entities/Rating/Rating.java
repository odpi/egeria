...
/**
 * Rating entity in the Subject Area OMAS.
...
public class  Rating implements Serializable {
    ...
    InstanceProperties obtainInstanceProperties() {
        ...
        instanceProperties.setProperty("stars",primitivePropertyValue);
        primitivePropertyValue = new PrimitivePropertyValue();
        // TODO  description + change null to value
        primitivePropertyValue.setPrimitiveValue(null);
       ...
       public void setStars(Object stars) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.

           final String methodName = "obtainInstanceProperties";
           try {
                 this.stars = (StarRating)stars;
       ...
       public void setReview(Object review) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.
