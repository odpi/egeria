...
public class ValidValue extends Line {
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public ValidValue() {
        super("ValidValue");
        super.entity1Name = "validValueFor";
        super.entity1Type = "GlossaryTerm";
        super.entity2Name = "validValues";
    ...
    public ValidValue(Relationship omrsRelationship) {
        ...
        if (!omrsRelationship.getEntityOnePropertyName().equals("validValueFor")){
            //error
        }
        if (!omrsRelationship.getEntityTwoPropertyName().equals("validValues")){
            //error
        }
