...
public class  Endpoint implements Serializable {
    ...
    InstanceProperties obtainInstanceProperties() {
       ...
       public void setNetworkAddress(Object networkAddress) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.

           final String methodName = "obtainInstanceProperties";
           try {
                 this.networkAddress = (String)networkAddress;
           } catch (ClassCastException e) {
                  SubjectAreaErrorCode errorCode    = SubjectAreaErrorCode.SET_ATTRIBUTE_WRONG_TYPE;
                  String errorMessage = errorCode.getErrorMessageId()
                          + errorCode.getFormattedErrorMessage(className,
       ...
       public void setProtocol(Object protocol) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.
       ...
       public void setEncryptionMethod(Object encryptionMethod) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.

           final String methodName = "obtainInstanceProperties";
           try {
                 this.encryptionMethod = (String)encryptionMethod;
           } catch (ClassCastException e) {
                  SubjectAreaErrorCode errorCode    = SubjectAreaErrorCode.SET_ATTRIBUTE_WRONG_TYPE;
                  String errorMessage = errorCode.getErrorMessageId()
                          + errorCode.getFormattedErrorMessage(className,
