...
public class UnrecognizedGUIDException extends SubjectAreaCheckedExceptionBase {
     ...
     */
    public UnrecognizedGUIDException(int httpCode, String className, String actionDescription, String errorMessage, String systemAction,String guid, String userAction) {
