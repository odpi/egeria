...
public class TermTYPEDBYRelationship extends Line {
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public TermTYPEDBYRelationship() {
        super("TermTYPEDBYRelationship");
        super.entity1Name = "attributesTypedBy";
        super.entity1Type = "GlossaryTerm";
        super.entity2Name = "types";
    ...
    public TermTYPEDBYRelationship(Relationship omrsRelationship) {
        ...
        if (!omrsRelationship.getEntityOnePropertyName().equals("attributesTypedBy")){
            //error
        }
        if (!omrsRelationship.getEntityTwoPropertyName().equals("types")){
            //error
        }
