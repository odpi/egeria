...
/**
 * SchemaLinkElement entity in the Subject Area OMAS.
...
public class  SchemaLinkElement implements Serializable {
    ...
    InstanceProperties obtainInstanceProperties() {
        ...
        // TODO  description + change null to value
        primitivePropertyValue.setPrimitiveValue(null);
        instanceProperties.setProperty("linkProperties",primitivePropertyValue);
        primitivePropertyValue = new PrimitivePropertyValue();
        // TODO  description + change null to value
        primitivePropertyValue.setPrimitiveValue(null);
       ...
       /**
        * Name for the element that bridges between two schemas.
        * @return String
        */
       ...
       public void setLinkName(Object linkName) throws InvalidParameterException {
       ...
       public void setLinkProperties(Object linkProperties) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.

           final String methodName = "obtainInstanceProperties";
           try {
                 this.linkProperties = (Map<String,String>)linkProperties;
           } catch (ClassCastException e) {
                  SubjectAreaErrorCode errorCode    = SubjectAreaErrorCode.SET_ATTRIBUTE_WRONG_TYPE;
                  String errorMessage = errorCode.getErrorMessageId()
                          + errorCode.getFormattedErrorMessage(className,
