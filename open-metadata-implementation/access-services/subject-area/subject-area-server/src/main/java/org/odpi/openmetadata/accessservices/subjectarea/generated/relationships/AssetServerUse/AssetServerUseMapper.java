                       ...
                       switch (value.getInstancePropertyCategory()) {
                                               case PRIMITIVE:
                                                   ...
                                                   if (AssetServerUse.ATTRIBUTE_NAMES_SET.contains(name)) {
                                                      if (name.equals("description")) {
                                                          assetServerUse.setDescription(actualValue);
                                                      }
                                                   } else {
                                               ...
                                               case ENUM:
                                                   ...
                                                   if (AssetServerUse.ENUM_NAMES_SET.contains(name)) {
                                                        if (name.equals("useType")) {
                                                              org.odpi.openmetadata.accessservices.subjectarea.generated.enums.ServerAssetUse useType = org.odpi.openmetadata.accessservices.subjectarea.generated.enums.ServerAssetUse.valueOf(symbolicName);
                                               ...
                                               case MAP:
                                                    ...
                                                    if (AssetServerUse.MAP_NAMES_SET.contains(name)) {
                                                      ...
                                                      assetServerUse.getExtraAttributes().put(name, mapPropertyValue);
                                                    }
                                                       break;
                                               case ARRAY:
                                               case STRUCT:
