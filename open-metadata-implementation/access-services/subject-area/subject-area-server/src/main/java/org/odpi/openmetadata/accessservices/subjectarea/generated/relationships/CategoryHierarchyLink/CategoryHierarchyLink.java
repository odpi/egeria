...
package org.odpi.openmetadata.accessservices.subjectarea.generated.relationships.CategoryHierarchyLink;
...
public class CategoryHierarchyLink extends Line {
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public CategoryHierarchyLink() {
        super("CategoryHierarchyLink");
        super.entity1Name = "superCategory";
        super.entity1Type = "GlossaryCategory";
        super.entity2Name = "subcategories";
        super.entity2Type = "GlossaryCategory";
    }

    public CategoryHierarchyLink(Relationship omrsRelationship) {
        super(omrsRelationship);

        if (!omrsRelationship.getEntityOnePropertyName().equals("superCategory")){
            //error
        }
        if (!omrsRelationship.getEntityTwoPropertyName().equals("subcategories")){
            //error
        }
        if (!omrsRelationship.getEntityOneProxy().getType().getTypeDefName().equals("GlossaryCategory")){
            //error
        }
        if (!omrsRelationship.getEntityTwoProxy().getType().getTypeDefName().equals("GlossaryCategory")){
            //error
        }
    }
