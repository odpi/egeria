...
/**
 * MediaFile entity in the Subject Area OMAS.
...
public class  MediaFile implements Serializable {
    ...
    InstanceProperties obtainInstanceProperties() {
        ...
        instanceProperties.setProperty("embeddedMetadata",primitivePropertyValue);
        primitivePropertyValue = new PrimitivePropertyValue();
        // TODO  description + change null to value
        primitivePropertyValue.setPrimitiveValue(null);
       ...
       public void setEmbeddedMetadata(Object embeddedMetadata) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.

           final String methodName = "obtainInstanceProperties";
           try {
                 this.embeddedMetadata = (Map<String,String>)embeddedMetadata;
