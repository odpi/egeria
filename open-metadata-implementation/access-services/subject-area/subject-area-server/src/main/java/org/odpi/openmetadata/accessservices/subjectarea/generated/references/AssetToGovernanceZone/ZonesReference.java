...
package org.odpi.openmetadata.accessservices.subjectarea.generated.references.AssetToGovernanceZone;
 ...
 * and references.
 *
 * This Reference is called ZonesReference. It is used in type Asset to represent a
 * reference to an OMAS entity of type governanceZone. The reference also contains information
...
public class ZonesReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(ZonesReference.class);
    private static final String className = ZonesReference.class.getName();

    protected String relationship_Type = "ZoneMembership";
    protected String name = "zones";
    protected GovernanceZone governanceZone =null;
    ...
    public ZonesReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public ZonesReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public ZonesReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public ZonesReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public ZonesReference(String relatedEndType, final String attrName, final Object attrValue) {
        this(null, relatedEndType, new HashMap<String, Object>() {{
            put(attrName, attrValue);
        }});
    }

    public ZonesReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public ZonesReference(Reference other) {
        if (other != null) {
       ...
       * @param line Line
       */
    public ZonesReference(String entityGuid, Line line) {
    ...
    public ZonesReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        ZonesReference typedThat =(ZonesReference)that;
