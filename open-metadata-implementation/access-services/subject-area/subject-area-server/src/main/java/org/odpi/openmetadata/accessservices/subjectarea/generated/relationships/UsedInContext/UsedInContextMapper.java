                       ...
                       switch (value.getInstancePropertyCategory()) {
                                               case PRIMITIVE:
                                                   ...
                                                   if (UsedInContext.ATTRIBUTE_NAMES_SET.contains(name)) {
                                                      if (name.equals("description")) {
                                                          usedInContext.setDescription(actualValue);
                                                      }
                                                      if (name.equals("expression")) {
                                                          usedInContext.setExpression(actualValue);
                                                      }
                                                      if (name.equals("steward")) {
                                                          usedInContext.setSteward(actualValue);
                                                      }
                                                      if (name.equals("source")) {
                                                          usedInContext.setSource(actualValue);
                                                      }
                                                   } else {
                                               ...
                                               case MAP:
                                                    ...
                                                    if (UsedInContext.MAP_NAMES_SET.contains(name)) {
                                                      ...
                                                      usedInContext.getExtraAttributes().put(name, mapPropertyValue);
                                                    }
                                                       break;
                                               case ARRAY:
                                               case STRUCT:
