...
public class PreferredTerm extends Line {
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public PreferredTerm() {
        super("PreferredTerm");
        super.entity1Name = "alternateTerms";
        super.entity1Type = "GlossaryTerm";
        super.entity2Name = "preferredTerms";
    ...
    public PreferredTerm(Relationship omrsRelationship) {
        ...
        if (!omrsRelationship.getEntityOnePropertyName().equals("alternateTerms")){
            //error
        }
        if (!omrsRelationship.getEntityTwoPropertyName().equals("preferredTerms")){
            //error
        }
