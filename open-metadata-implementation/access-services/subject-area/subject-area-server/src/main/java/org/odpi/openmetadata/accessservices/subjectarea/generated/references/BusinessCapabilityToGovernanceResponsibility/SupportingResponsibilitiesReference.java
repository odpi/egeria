...
package org.odpi.openmetadata.accessservices.subjectarea.generated.references.BusinessCapabilityToGovernanceResponsibility;
 ...
 * and references.
 *
 * This Reference is called SupportingResponsibilitiesReference. It is used in type BusinessCapability to represent a
 * reference to an OMAS entity of type governanceResponsibility. The reference also contains information
...
public class SupportingResponsibilitiesReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(SupportingResponsibilitiesReference.class);
    private static final String className = SupportingResponsibilitiesReference.class.getName();

    protected String relationship_Type = "BusinessCapabilityResponsibility";
    protected String name = "supportingResponsibilities";
    protected GovernanceResponsibility governanceResponsibility =null;
    ...
    public SupportingResponsibilitiesReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public SupportingResponsibilitiesReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public SupportingResponsibilitiesReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public SupportingResponsibilitiesReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public SupportingResponsibilitiesReference(String relatedEndType, final String attrName, final Object attrValue) {
        this(null, relatedEndType, new HashMap<String, Object>() {{
            put(attrName, attrValue);
        }});
    }

    public SupportingResponsibilitiesReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public SupportingResponsibilitiesReference(Reference other) {
        if (other != null) {
       ...
       * @param line Line
       */
    public SupportingResponsibilitiesReference(String entityGuid, Line line) {
    ...
    public SupportingResponsibilitiesReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        SupportingResponsibilitiesReference typedThat =(SupportingResponsibilitiesReference)that;
