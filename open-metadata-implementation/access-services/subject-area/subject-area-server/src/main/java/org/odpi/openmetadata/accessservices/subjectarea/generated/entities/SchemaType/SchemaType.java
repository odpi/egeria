...
public class  SchemaType implements Serializable {
    ...
    InstanceProperties obtainInstanceProperties() {
       ...
       public void setVersionNumber(Object versionNumber) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.
       ...
       public void setAuthor(Object author) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.
       ...
       public void setEncodingStandard(Object encodingStandard) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.

           final String methodName = "obtainInstanceProperties";
           try {
                 this.encodingStandard = (String)encodingStandard;
           } catch (ClassCastException e) {
                  SubjectAreaErrorCode errorCode    = SubjectAreaErrorCode.SET_ATTRIBUTE_WRONG_TYPE;
                  String errorMessage = errorCode.getErrorMessageId()
                          + errorCode.getFormattedErrorMessage(className,
