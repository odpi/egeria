...
public class GlossaryTermMapper {
   ...
   static public org.odpi.openmetadata.accessservices.subjectarea.generated.entities.GlossaryTerm.GlossaryTerm mapOmrsEntityDetailToGlossaryTerm(EntityDetail omrsEntityDetail) throws InvalidParameterException{
                        ...
                        case PRIMITIVE:
                            ...
                            if (glossaryTerm.ATTRIBUTE_NAMES_SET.contains(name)) {
                               if (name.equals("displayName")) {
                                   glossaryTerm.setDisplayName(actualValue);
                               }
                               if (name.equals("summary")) {
                                   glossaryTerm.setSummary(actualValue);
                               }
                               if (name.equals("description")) {
                                   glossaryTerm.setDescription(actualValue);
                               }
                               if (name.equals("examples")) {
                                   glossaryTerm.setExamples(actualValue);
                               }
                               if (name.equals("abbreviation")) {
                                   glossaryTerm.setAbbreviation(actualValue);
                               }
                               if (name.equals("usage")) {
                                   glossaryTerm.setUsage(actualValue);
                               }
                               if (name.equals("glossaryName")) {
                                   glossaryTerm.setGlossaryName(actualValue);
                               }
                               if (name.equals("qualifiedName")) {
                                   glossaryTerm.setQualifiedName(actualValue);
                               }
                            } else {
                        ...
                        if (omasClassification !=null) {
                            ...
                            while (omrsClassification.getProperties().getPropertyNames().hasNext()) {
                                ...
                                if (SubjectAreaUtils.isGovernanceActionClassification(omrsClassificationName)) {
                                    GovernanceActions governanceActions = glossaryTerm.getGovernanceActions();
                                    ...
                                    switch (omrsClassificationName){
                                        case "Confidence":
                                            ...
                                            glossaryTerm.setGovernanceActions(governanceActions);
                                            break;
    ...
    static public EntityDetail mapGlossaryTermToOmrsEntityDetail(org.odpi.openmetadata.accessservices.subjectarea.generated.entities.GlossaryTerm.GlossaryTerm glossaryTerm) {
            ...
            populateOmrsEntityWithOmasClassifications(omrsEntityDetail,(List<org.odpi.openmetadata.accessservices.subjectarea.common.Classification>)glossaryTerm.getClassifications());
