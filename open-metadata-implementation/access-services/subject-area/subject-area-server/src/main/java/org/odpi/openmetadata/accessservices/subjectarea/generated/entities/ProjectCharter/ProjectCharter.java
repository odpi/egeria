...
/**
 * ProjectCharter entity in the Subject Area OMAS.
...
public class  ProjectCharter implements Serializable {
    ...
    InstanceProperties obtainInstanceProperties() {
       ...
       public void setProjectType(Object projectType) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.
       ...
       /**
        * List of purposes for having the project.
        * @return List<String>
        */
       ...
       public void setPurposes(Object purposes) throws InvalidParameterException {
           // accept an object and cast to the appropriate type.

           final String methodName = "obtainInstanceProperties";
           try {
                 this.purposes = (List<String>)purposes;
           } catch (ClassCastException e) {
                  SubjectAreaErrorCode errorCode    = SubjectAreaErrorCode.SET_ATTRIBUTE_WRONG_TYPE;
                  String errorMessage = errorCode.getErrorMessageId()
                          + errorCode.getFormattedErrorMessage(className,
