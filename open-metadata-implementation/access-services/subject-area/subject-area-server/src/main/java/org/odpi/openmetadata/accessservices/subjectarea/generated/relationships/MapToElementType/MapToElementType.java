...
package org.odpi.openmetadata.accessservices.subjectarea.generated.relationships.MapToElementType;
...
public class MapToElementType extends Line {
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public MapToElementType() {
        super("MapToElementType");
        super.entity1Name = "parentMapTo";
        super.entity1Type = "MapSchemaType";
        super.entity2Name = "mapToElement";
    ...
    public MapToElementType(Relationship omrsRelationship) {
        ...
        if (!omrsRelationship.getEntityOnePropertyName().equals("parentMapTo")){
            //error
        }
        if (!omrsRelationship.getEntityTwoPropertyName().equals("mapToElement")){
            //error
        }
