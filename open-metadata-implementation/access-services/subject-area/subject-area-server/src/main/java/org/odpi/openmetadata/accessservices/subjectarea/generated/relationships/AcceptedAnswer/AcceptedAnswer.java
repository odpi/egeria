...
package org.odpi.openmetadata.accessservices.subjectarea.generated.relationships.AcceptedAnswer;
...
public class AcceptedAnswer extends Line {
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public AcceptedAnswer() {
        super("AcceptedAnswer");
        super.entity1Name = "answeredQuestions";
        super.entity1Type = "Comment";
        super.entity2Name = "acceptedAnswers";
        super.entity2Type = "Comment";
    }

    public AcceptedAnswer(Relationship omrsRelationship) {
        super(omrsRelationship);

        if (!omrsRelationship.getEntityOnePropertyName().equals("answeredQuestions")){
            //error
        }
        if (!omrsRelationship.getEntityTwoPropertyName().equals("acceptedAnswers")){
            //error
        }
        if (!omrsRelationship.getEntityOneProxy().getType().getTypeDefName().equals("Comment")){
            //error
        }
        if (!omrsRelationship.getEntityTwoProxy().getType().getTypeDefName().equals("Comment")){
            //error
        }
    }
