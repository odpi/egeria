...
public class AttachedComment extends Line {
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public AttachedComment() {
        super("AttachedComment");
        super.entity1Name = "commentOnElement";
        super.entity1Type = "Referenceable";
        super.entity2Name = "comments";
    ...
    public AttachedComment(Relationship omrsRelationship) {
        ...
        if (!omrsRelationship.getEntityOnePropertyName().equals("commentOnElement")){
            //error
        }
        if (!omrsRelationship.getEntityTwoPropertyName().equals("comments")){
            //error
        }
