...
public class RelatedMediaMapper {
   ...
   static public org.odpi.openmetadata.accessservices.subjectarea.generated.entities.RelatedMedia.RelatedMedia mapOmrsEntityDetailToRelatedMedia(EntityDetail omrsEntityDetail) throws InvalidParameterException{
                        ...
                        case PRIMITIVE:
                            ...
                            if (relatedMedia.ATTRIBUTE_NAMES_SET.contains(name)) {
                               if (name.equals("guidance")) {
                                   relatedMedia.setGuidance(actualValue);
                               }
                               if (name.equals("displayName")) {
                                   relatedMedia.setDisplayName(actualValue);
                               }
                               if (name.equals("url")) {
                                   relatedMedia.setUrl(actualValue);
                               }
                               if (name.equals("version")) {
                                   relatedMedia.setVersion(actualValue);
                               }
                               if (name.equals("description")) {
                                   relatedMedia.setDescription(actualValue);
                               }
                               if (name.equals("qualifiedName")) {
                                   relatedMedia.setQualifiedName(actualValue);
                               }
                            } else {
    ...
    static public EntityDetail mapRelatedMediaToOmrsEntityDetail(org.odpi.openmetadata.accessservices.subjectarea.generated.entities.RelatedMedia.RelatedMedia relatedMedia) {
            ...
            if (relatedMedia.getGuidance()!=null) {
                PrimitivePropertyValue primitivePropertyValue = new PrimitivePropertyValue();
                primitivePropertyValue.setPrimitiveDefCategory(PrimitiveDefCategory.OM_PRIMITIVE_TYPE_STRING);
                primitivePropertyValue.setPrimitiveValue(relatedMedia.getGuidance());
            ...
            populateOmrsEntityWithOmasClassifications(omrsEntityDetail,(List<org.odpi.openmetadata.accessservices.subjectarea.common.Classification>)relatedMedia.getClassifications());
