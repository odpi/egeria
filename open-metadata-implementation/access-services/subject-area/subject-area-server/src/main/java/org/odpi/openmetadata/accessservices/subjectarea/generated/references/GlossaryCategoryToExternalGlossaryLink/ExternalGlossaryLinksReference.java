...
package org.odpi.openmetadata.accessservices.subjectarea.generated.references.GlossaryCategoryToExternalGlossaryLink;
 ...
 * and references.
 *
 * This Reference is called ExternalGlossaryLinksReference. It is used in type GlossaryCategory to represent a
 * reference to an OMAS entity of type externalGlossaryLink. The reference also contains information
...
public class ExternalGlossaryLinksReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(ExternalGlossaryLinksReference.class);
    private static final String className = ExternalGlossaryLinksReference.class.getName();

    protected String relationship_Type = "LibraryCategoryReference";
    protected String name = "externalGlossaryLinks";
    protected ExternalGlossaryLink externalGlossaryLink =null;
    ...
    public ExternalGlossaryLinksReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public ExternalGlossaryLinksReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public ExternalGlossaryLinksReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public ExternalGlossaryLinksReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public ExternalGlossaryLinksReference(String relatedEndType, final String attrName, final Object attrValue) {
        this(null, relatedEndType, new HashMap<String, Object>() {{
            put(attrName, attrValue);
        }});
    }

    public ExternalGlossaryLinksReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public ExternalGlossaryLinksReference(Reference other) {
        if (other != null) {
       ...
       * @param line Line
       */
    public ExternalGlossaryLinksReference(String entityGuid, Line line) {
    ...
    public ExternalGlossaryLinksReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        ExternalGlossaryLinksReference typedThat =(ExternalGlossaryLinksReference)that;
