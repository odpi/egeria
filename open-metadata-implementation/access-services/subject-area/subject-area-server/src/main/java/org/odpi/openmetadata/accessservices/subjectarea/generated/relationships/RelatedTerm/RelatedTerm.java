...
public class RelatedTerm extends Line {
   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    public RelatedTerm() {
        super("RelatedTerm");
        super.entity1Name = "seeAlso";
        super.entity1Type = "GlossaryTerm";
        super.entity2Name = "seeAlso";
    ...
    public RelatedTerm(Relationship omrsRelationship) {
        ...
        if (!omrsRelationship.getEntityOnePropertyName().equals("seeAlso")){
            //error
        }
        if (!omrsRelationship.getEntityTwoPropertyName().equals("seeAlso")){
            //error
        }
