                                               ...
                                               case PRIMITIVE:
                                                   ...
                                                   if (EmbeddedConnection.ATTRIBUTE_NAMES_SET.contains(name)) {
                                                      if (name.equals("displayName")) {
                                                          embeddedConnection.setDisplayName(actualValue);
                                                      }
                                                   } else {
                                               ...
                                               case MAP:
                                                    ...
                                                    if (EmbeddedConnection.MAP_NAMES_SET.contains(name)) {
                                                       if (name.equals("arguments")) {
                                                          embeddedConnection.setArguments(mapInstanceProperties);
                                                       }
                                                       // put out the omrs value object
                                                      if (embeddedConnection.getExtraAttributes() ==null) {
                                                           Map<String, Object> extraAttributes = new HashMap();
                                                      ...
                                                      embeddedConnection.getExtraAttributes().put(name, mapPropertyValue);
                                                    }
                                                       break;
                                               case ARRAY:
                                               case STRUCT:
