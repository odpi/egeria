                       ...
                       switch (value.getInstancePropertyCategory()) {
                                               case PRIMITIVE:
                                                   ...
                                                   if (LibraryCategoryReference.ATTRIBUTE_NAMES_SET.contains(name)) {
                                                      if (name.equals("identifier")) {
                                                          libraryCategoryReference.setIdentifier(actualValue);
                                                      }
                                                      if (name.equals("description")) {
                                                          libraryCategoryReference.setDescription(actualValue);
                                                      }
                                                      if (name.equals("steward")) {
                                                          libraryCategoryReference.setSteward(actualValue);
                                                      }
                                                      if (name.equals("lastVerified")) {
                                                          libraryCategoryReference.setLastVerified(actualValue);
                                                      }
                                                   } else {
                                               ...
                                               case MAP:
                                                    ...
                                                    if (LibraryCategoryReference.MAP_NAMES_SET.contains(name)) {
                                                      ...
                                                      libraryCategoryReference.getExtraAttributes().put(name, mapPropertyValue);
                                                    }
                                                       break;
                                               case ARRAY:
                                               case STRUCT:
