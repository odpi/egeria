...
import org.odpi.openmetadata.accessservices.subjectarea.generated.references.CollectionToCommunity.CommunityUsesReference;
...
import org.odpi.openmetadata.accessservices.subjectarea.generated.references.CollectionToReferenceable.MembersReference;
...
import org.odpi.openmetadata.accessservices.subjectarea.generated.references.CollectionToProject.ProjectsImpactingAssetsReference;
...
import org.odpi.openmetadata.accessservices.subjectarea.generated.references.CollectionToProject.ProjectUseReference;
...
public class CollectionReferences implements Serializable {
    ...
    public static final String[] REFERENCE_NAMES_SET_VALUES = new String[] {
     ...
     /**
       ...
       */
     public CollectionReferences(String entityGuid, List<Line> lines) throws InvalidParameterException {
            ...
            for (int i=0;i< RELATIONSHIP_NAMES_SET_VALUES.length; i++) {
               if (relationship.getName().equals(RELATIONSHIP_NAMES_SET_VALUES[i])) {
                    ...
                    if ("communityUses".equals(referenceName)) {
                         ...
                         if ( communityUses== null ) {
                              communityUses = new HashSet();
                         }
                          communityUses.add(communityUsesReference);
                    }
                    if ("members".equals(referenceName)) {
                         CollectionMember collectionMember_relationship = (CollectionMember)relationship;
                         MembersReference membersReference = new MembersReference(entityGuid,collectionMember_relationship);
                         if ( members== null ) {
                              members = new HashSet();
                         }
                          members.add(membersReference);
                    }
                    if ("projectsImpactingAssets".equals(referenceName)) {
                         ...
                         if ( projectsImpactingAssets== null ) {
                              projectsImpactingAssets = new HashSet();
                         }
                          projectsImpactingAssets.add(projectsImpactingAssetsReference);
                    }
                    if ("consumingActors".equals(referenceName)) {
                         ...
                         if ( consumingActors== null ) {
                              consumingActors = new HashSet();
                         }
                          consumingActors.add(consumingActorsReference);
                    }
                    if ("projectUse".equals(referenceName)) {
                         ...
                         if ( projectUse== null ) {
                              projectUse = new HashSet();
                         }
                          projectUse.add(projectUseReference);
                    }
...
// Set properties
    ...
    private Set<MembersReference> members;
...
// Lists
 ...
 public StringBuilder toString(StringBuilder sb) {
        ...
        sb.append("communityUsesReference='").append(communityUses.toString());
        sb.append("membersReference='").append(members.toString());
        sb.append("projectsImpactingAssetsReference='").append(projectsImpactingAssets.toString());
        sb.append("consumingActorsReference='").append(consumingActors.toString());
        sb.append("projectUseReference='").append(projectUse.toString());
    ...
    public boolean equals(Object o) {
      ...
      // compare single cardinality attributes
         ...
         if (this.members != null && !Objects.equals(this.members,typedThat.members)) {
                            return false;
                 }
    ...
    ,this.communityUses
    ,this.members
    ,this.projectsImpactingAssets
    ,this.consumingActors
    ,this.projectUse
    ,this.meetings
    ,this.tags
    ,this.alsoKnownAs
