...
public class TermAnchor extends Line {
     ...
     * Set up end 1.
     */
     protected static final String END_1_NODE_TYPE = "Glossary";
     protected static final String END_1_ATTRIBUTE_NAME = "anchor";
     protected static final String END_1_ATTRIBUTE_DESCRIPTION = "Owning glossary.";
     ...
     */
     ...
     protected static final String END_2_ATTRIBUTE_NAME = "terms";
     protected static final String END_2_ATTRIBUTE_DESCRIPTION = "Terms owned by this glossary.";
