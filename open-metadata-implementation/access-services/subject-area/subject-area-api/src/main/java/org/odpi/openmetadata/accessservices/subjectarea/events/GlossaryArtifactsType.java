...
public enum GlossaryArtifactsType implements Serializable
{
    UNKNOWN         (0,  "Unknown",           "Unknown."),

    GLOSSARY        (1,  "Glossary",          "Glossary."),
    GLOSSARYCATEGORY(2,  "GlossaryCategory",               "GlossaryCategory."),
    GLOSSARYTERM    (3,  "Node",               "Node.");
     ...
     */
    GlossaryArtifactsType(int eventTypeCode, String eventTypeName, String eventTypeDescription)
    {
