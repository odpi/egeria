...
public class TypedBy extends Relationship {
     ...
     */
     ...
     private static final String END_1_ATTRIBUTE_NAME = "attributesTypedBy";
     private static final String END_1_ATTRIBUTE_DESCRIPTION = "Attributes of this type.";
     ...
     */
     ...
     private static final String END_2_ATTRIBUTE_NAME = "types";
     private static final String END_2_ATTRIBUTE_DESCRIPTION = "Types for this attribute.";
    ...
    public TypedBy() {
        super(RelationshipType.TypedBy.name(), RELATIONSHIP_END_1, RELATIONSHIP_END_2);
    }
