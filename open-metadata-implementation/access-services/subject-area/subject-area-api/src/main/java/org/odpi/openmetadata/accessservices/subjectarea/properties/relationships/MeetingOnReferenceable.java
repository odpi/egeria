   ...
   //public java.util.Set<String> propertyNames = new HashSet<>();
    ...
    private void initialise()
    {
       ...
       try {
        ...
        entity1Name = "meetings";
        entity1Type = "Meeting";
        entity2Name = "relatedReferenceables";
        entity2Type = "Referenceable";
        typeDefGuid = "a05f918e-e7e2-419d-8016-5b37406df63a";
    }

    public MeetingOnReferenceable(Line template) {
        super(template);
        initialise();
    }
    ...
    InstanceProperties obtainInstanceProperties() {
      ...
      @Override
         public StringBuilder toString(StringBuilder sb)
         {
             ...
             sb.append(" MeetingOnReferenceable=");
             sb.append(super.toString(sb));
             sb.append(" MeetingOnReferenceable Attributes{");
             sb.append("}");
             return sb;
         }
         @Override
