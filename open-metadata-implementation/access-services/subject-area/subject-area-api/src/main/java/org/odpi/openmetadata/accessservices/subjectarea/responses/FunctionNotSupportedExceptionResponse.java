...
/**
 * FunctionNotSupportedExceptionResponse is the response that wraps aFunctionNotSupportedException
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class FunctionNotSupportedExceptionResponse extends SubjectAreaOMASAPIExceptionResponse
{
    /**
     * Default constructor
     */
