...
public class HasA extends Line {
    ...
    protected final static String END_1_ATTRIBUTE_NAME = "objects";
    protected final static String END_1_ATTRIBUTE_DESCRIPTION = "Objects where this attribute may occur.";
    ...
    protected final static String END_2_ATTRIBUTE_NAME = "attributes";
    protected final static String END_2_ATTRIBUTE_DESCRIPTION = "Typical attributes for this object.";
