...
public class UsedInContext extends Line {
   private String description = "Link between glossary terms where on describes the context where the other one is valid to use.";
     ...
     */
     ...
     protected static final String END_1_ATTRIBUTE_NAME = "contextRelevantTerms";
     protected static final String END_1_ATTRIBUTE_DESCRIPTION = "Glossary terms used in this specific context.";
     ...
     */
     ...
     protected static final String END_2_ATTRIBUTE_NAME = "usedInContexts";
     protected static final String END_2_ATTRIBUTE_DESCRIPTION = "Glossary terms describing the contexts where this term is used.";
