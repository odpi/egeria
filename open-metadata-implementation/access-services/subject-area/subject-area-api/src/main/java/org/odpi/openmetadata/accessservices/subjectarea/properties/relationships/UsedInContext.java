...
public class UsedInContext extends Relationship {
   private String description = "Link between glossary terms where on describes the context where the other one is valid to use.";
     ...
     */
     ...
     private static final String END_1_ATTRIBUTE_NAME = "contextRelevantTerms";
     private static final String END_1_ATTRIBUTE_DESCRIPTION = "Glossary terms used in this specific context.";
     ...
     */
     ...
     private static final String END_2_ATTRIBUTE_NAME = "usedInContexts";
     private static final String END_2_ATTRIBUTE_DESCRIPTION = "Glossary terms describing the contexts where this term is used.";
    ...
    public UsedInContext() {
        super(RelationshipType.UsedInContext.name(), RELATIONSHIP_END_1, RELATIONSHIP_END_2);
    }
