...
public class RelatedTerm extends Relationship {
    private String description = "Link between similar glossary terms.";

    /*
     * Set up end 1.
     */
     private static final String END_1_NODE_TYPE = "Term";
     private static final String END_1_ATTRIBUTE_NAME = "seeAlso";
     private static final String END_1_ATTRIBUTE_DESCRIPTION = "Related glossary terms.";
     ...
     */
     ...
     private static final String END_2_ATTRIBUTE_NAME = "seeAlso";
     private static final String END_2_ATTRIBUTE_DESCRIPTION = "Related glossary terms.";
