...
/**
 *EntityNotDeletedExceptionResponse is the response that wraps aEntityNotDeletedException
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class EntityNotDeletedExceptionResponse extends SubjectAreaOMASAPIExceptionResponse
{
