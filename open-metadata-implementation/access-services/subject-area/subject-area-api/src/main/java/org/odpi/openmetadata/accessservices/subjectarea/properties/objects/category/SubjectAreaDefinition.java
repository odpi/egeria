 ...
 * For a category to be in a subject area - it would be with in the children category hierarchies under
...
public class SubjectAreaDefinition extends Category{
    ...
    public SubjectAreaDefinition(Category category) {
        ...
        // assume that the SubjectArea classification has been removed by the caller.
