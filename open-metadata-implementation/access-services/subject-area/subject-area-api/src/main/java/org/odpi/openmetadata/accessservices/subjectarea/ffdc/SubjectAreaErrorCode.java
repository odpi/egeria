...
public enum SubjectAreaErrorCode {
    ...
    GOVERNNCE_CLASSIFICATION_SUPPLIED_IN_CLASSIFICATIONS(400, "OMAS-SUBJECTAREA-400-053 ",
            "The goverance action classificaiton {0} has been supplied with classifications",
