...
public class Antonym extends Relationship {
    private String description = "Link between glossary terms that have the opposite meaning.";

    /*
     * Set up end 1.
     */
    private static final String END_1_NODE_TYPE = "Term";
    private static final String END_1_ATTRIBUTE_NAME = "antonyms";
    private static final String END_1_ATTRIBUTE_DESCRIPTION = "Glossary terms with the opposite meaning.";
    ...
    private static final String END_2_ATTRIBUTE_NAME = "antonyms";
    private static final String END_2_ATTRIBUTE_DESCRIPTION = "Glossary terms with the opposite meaning.";
    ...
    public Antonym() {
        super(RelationshipType.Antonym.name(), RELATIONSHIP_END_1, RELATIONSHIP_END_2);
    }
