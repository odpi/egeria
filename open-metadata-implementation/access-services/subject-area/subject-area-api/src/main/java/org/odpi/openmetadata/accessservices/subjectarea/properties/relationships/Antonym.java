...
public class Antonym extends Line {
    ...
    protected static final String END_1_ATTRIBUTE_NAME = "antonyms";
    protected static final String END_1_ATTRIBUTE_DESCRIPTION = "Glossary terms with the opposite meaning.";
    ...
    protected static final String END_2_ATTRIBUTE_NAME = "antonyms";
    protected static final String END_2_ATTRIBUTE_DESCRIPTION = "Glossary terms with the opposite meaning.";
