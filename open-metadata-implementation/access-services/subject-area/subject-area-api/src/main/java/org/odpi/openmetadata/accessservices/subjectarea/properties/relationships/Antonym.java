...
public class Antonym extends Line {
    ...
    protected final static String END_1_ATTRIBUTE_NAME = "antonyms";
    protected final static String END_1_ATTRIBUTE_DESCRIPTION = "Glossary terms with the opposite meaning.";
    ...
    protected final static String END_2_ATTRIBUTE_NAME = "antonyms";
    protected final static String END_2_ATTRIBUTE_DESCRIPTION = "Glossary terms with the opposite meaning.";
