...
package org.odpi.openmetadata.accessservices.itinfrastructure.auditlog;
 ...
 * </ul>
 */
public enum ITInfrastructureAuditCode
{
    SERVICE_INITIALIZING("OMAS-IT-INFRASTRUCTURE-0001",
             ...
             "The local server has started up a new instance of the IT Infrastructure OMAS.",
    ...
    private static final Logger log = LoggerFactory.getLogger(ITInfrastructureAuditCode.class);
    ...
    public String getFormattedLogMessage(String... params)
    {
        ...
        {
            log.debug(String.format("<== ITInfrastructure Audit Code.getMessage(%s)", Arrays.toString(params)));
        }
        ...
        if (log.isDebugEnabled())
        {
            log.debug(String.format("==> ITInfrastructure Audit Code.getMessage(%s): %s", Arrays.toString(params), result));
        }
