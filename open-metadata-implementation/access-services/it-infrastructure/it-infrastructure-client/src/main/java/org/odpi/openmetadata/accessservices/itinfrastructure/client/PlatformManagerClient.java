 ...
 */
public class PlatformManagerClient extends ITInfrastructureClientBase implements SoftwareServerPlatformManagerInterface
{
     ...
     */
    @Override
    public List<SoftwareServerPlatformElement> getSoftwareServerPlatformsByDeployedImplType(String userId,
                                                                                            String name,
                                                                                            Date   effectiveTime,
                                                                                            int    startFrom,
                                                                                            int    pageSize) throws InvalidParameterException,
    ...
    {
        final String methodName = "getSoftwareServerPlatformsByDeployedImplType";

        return this.convertAssetElements(super.getAssetsByDeployedImplementationType(userId, name, platformEntityType, effectiveTime, startFrom, pageSize, methodName));
    }
