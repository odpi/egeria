...
{
    SERVER_URL_NOT_SPECIFIED(400, "OMAS-IT-INFRASTRUCTURE-400-001 ",
    ...
    SERVER_URL_MALFORMED(400, "OMAS-IT-INFRASTRUCTURE-400-002 ",
            "The OMAS Server URL {0} is not in a recognized format",
            "The system is unable to connect to the OMAS Server to retrieve metadata properties.",
            "Ensure a valid OMAS Server URL is passed to the AssetConsumer when it is created."),
    NULL_USER_ID(400, "OMAS-IT-INFRASTRUCTURE-400-003 ",
    ...
    NULL_GUID(400, "OMAS-IT-INFRASTRUCTURE-400-004 ",
    ...
    NULL_NAME(400, "OMAS-IT-INFRASTRUCTURE-400-005 ",
    ...
    USER_NOT_AUTHORIZED(400, "OMAS-IT-INFRASTRUCTURE-400-008 ",
    ...
    PROPERTY_SERVER_ERROR(400, "OMAS-IT-INFRASTRUCTURE-400-009 ",
            ...
            "The system is unable to process the request.",
            "Verify the access rights of the user."),
    NULL_ENUM(400, "OMAS-IT-INFRASTRUCTURE-400-010 ",
            ...
            "Correct the code in the caller to provide the name."),
    SERVER_NOT_AVAILABLE(404, "OMAS-IT-INFRASTRUCTURE-404-001 ",
    ...
    OMRS_NOT_INITIALIZED(404, "OMAS-IT-INFRASTRUCTURE-404-002 ",
    ...
    OMRS_NOT_AVAILABLE(404, "OMAS-IT-INFRASTRUCTURE-404-003 ",
            ...
            "Check that the server where the Asset Consumer OMAS is running initialized correctly.  " +
                    "Correct any errors discovered and retry the request when the open metadata services are available."),
    NO_METADATA_COLLECTION(404, "OMAS-IT-INFRASTRUCTURE-404-004 ",
    ...
    NULL_RESPONSE_FROM_API(503, "OMAS-IT-INFRASTRUCTURE-503-001 ",
    ...
    CLIENT_SIDE_REST_API_ERROR(503, "OMAS-IT-INFRASTRUCTURE-503-002 ",
    ...
    SERVICE_NOT_INITIALIZED(503, "OMAS-IT-INFRASTRUCTURE-503-003 ",
    ...
    private static final Logger log = LoggerFactory.getLogger(ITInfrastructureErrorCode.class);
     ...
     *
     *     ITInfrastructureErrorCode   errorCode = ITInfrastructureErrorCode.SERVER_URL_NOT_SPECIFIED;
     *
     ...
     */
    ITInfrastructureErrorCode(int  newHTTPErrorCode, String newErrorMessageId, String newErrorMessage, String newSystemAction, String newUserAction)
    {
    ...
    {
        log.debug(String.format("<== ITInfrastructureErrorCode.getMessage(%s)", Arrays.toString(params)));

        MessageFormat mf = new MessageFormat(errorMessage);
        String result = mf.format(params);

        log.debug(String.format("==> ITInfrastructureErrorCode.getMessage(%s): %s", Arrays.toString(params), result));
