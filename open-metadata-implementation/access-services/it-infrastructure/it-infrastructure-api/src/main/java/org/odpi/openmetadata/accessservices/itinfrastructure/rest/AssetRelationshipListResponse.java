...
public class AssetRelationshipListResponse extends ITInfrastructureOMASAPIResponse
{
    private List<AssetRelationshipElement> elementList = null;


    /**
     * Default constructor
     */
    public AssetRelationshipListResponse()
    {
    }
     ...
     */
    public AssetRelationshipListResponse(AssetRelationshipListResponse template)
    {
        super(template);
     ...
     */
    public List<AssetRelationshipElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<AssetRelationshipElement> elementList)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        AssetRelationshipListResponse that = (AssetRelationshipListResponse) objectToCompare;
