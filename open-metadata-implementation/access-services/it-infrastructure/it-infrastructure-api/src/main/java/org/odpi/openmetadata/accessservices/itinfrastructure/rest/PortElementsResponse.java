...
public class PortElementsResponse extends ITInfrastructureOMASAPIResponse
{
    private List<PortElement> elementList = null;
     ...
     */
    public PortElementsResponse(PortElementsResponse template)
    {
        super(template);
     ...
     */
    public List<PortElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<PortElement> elementList)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        PortElementsResponse that = (PortElementsResponse) objectToCompare;
