...
public class ProcessElementResponse extends ITInfrastructureOMASAPIResponse
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ProcessElementResponse))
        {
            return false;
        }
        ...
        ProcessElementResponse that = (ProcessElementResponse) objectToCompare;
