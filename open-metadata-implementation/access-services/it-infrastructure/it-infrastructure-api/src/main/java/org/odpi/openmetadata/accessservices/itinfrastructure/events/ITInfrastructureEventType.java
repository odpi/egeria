...
public enum ITInfrastructureEventType implements Serializable
{
     ...
     */
    ITInfrastructureEventType(int eventTypeCode, String eventTypeName, String eventTypeDescription)
    {
    ...
    {
        return "ITInfrastructureEventType{" +
