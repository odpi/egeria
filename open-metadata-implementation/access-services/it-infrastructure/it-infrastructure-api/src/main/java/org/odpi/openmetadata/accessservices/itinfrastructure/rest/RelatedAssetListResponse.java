...
public class RelatedAssetListResponse extends ITInfrastructureOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<RelatedAssetElement> elementList = null;


    /**
     * Default constructor
     */
    public RelatedAssetListResponse()
    {
    }
     ...
     */
    public RelatedAssetListResponse(RelatedAssetListResponse template)
    {
        super(template);
     ...
     */
    public List<RelatedAssetElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<RelatedAssetElement> elementList)
    {
    ...
    {
        return "RelatedAssetListResponse{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        RelatedAssetListResponse that = (RelatedAssetListResponse) objectToCompare;
