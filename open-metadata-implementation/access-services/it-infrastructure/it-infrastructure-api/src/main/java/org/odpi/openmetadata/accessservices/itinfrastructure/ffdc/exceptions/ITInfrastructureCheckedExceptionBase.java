...
package org.odpi.openmetadata.accessservices.itinfrastructure.ffdc.exceptions;

import java.util.Objects;

/**
 * ITInfrastructureCheckedExceptionBase provides a checked exception for reporting errors found when using
 ...
 * The ITInfrastructureErrorCode can be used with this exception to populate it with standard messages.
 * The aim is to be able to uniquely identify the cause and remedy for the error.
 */
public abstract class ITInfrastructureCheckedExceptionBase extends Exception
{
     ...
     */
    public ITInfrastructureCheckedExceptionBase(int    httpCode,
                                                String className,
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ITInfrastructureCheckedExceptionBase))
        {
            return false;
        }
        ITInfrastructureCheckedExceptionBase that = (ITInfrastructureCheckedExceptionBase) objectToCompare;
