...
public class OperatingPlatformElement implements MetadataElement, Serializable
{
     ...
     * Default constructor
     */
    public OperatingPlatformElement()
    {
        super();
    }
     ...
     */
    public OperatingPlatformElement(OperatingPlatformElement template)
    {
        if (template != null)
        {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        OperatingPlatformElement that = (OperatingPlatformElement) objectToCompare;
