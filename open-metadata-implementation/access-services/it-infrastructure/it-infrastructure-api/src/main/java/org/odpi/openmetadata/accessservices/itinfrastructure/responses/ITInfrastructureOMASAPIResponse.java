...
public abstract class ITInfrastructureOMASAPIResponse implements java.io.Serializable
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ITInfrastructureOMASAPIResponse))
        {
            return false;
        }
        ITInfrastructureOMASAPIResponse that = (ITInfrastructureOMASAPIResponse) objectToCompare;
