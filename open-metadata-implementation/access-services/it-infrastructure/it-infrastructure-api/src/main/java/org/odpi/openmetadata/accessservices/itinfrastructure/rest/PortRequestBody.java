...
public class PortRequestBody extends MetadataSourceRequestBody
{
    private PortProperties                elementProperties = null;
     ...
     */
    public PortRequestBody(PortRequestBody template)
    {
        super(template);
     ...
     */
    public void setElementProperties(PortProperties elementProperties)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        PortRequestBody that = (PortRequestBody) objectToCompare;
