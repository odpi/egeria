...
/**
 * ITInfrastructureOutTopicEvent provides the structure of the IT Infrastructure OMAS's OutTopic events.  The values for elements and their classifications
...
public class ITInfrastructureOutTopicEvent
{
     ...
     * Default Constructor
     */
    public ITInfrastructureOutTopicEvent()
    {
    }
     ...
     */
    public ITInfrastructureOutTopicEvent(ITInfrastructureOutTopicEvent template)
    {
        if (template != null)
        {
     ...
     */
    public ITInfrastructureEventType getEventType()
    {
        return eventType;
    }
     ...
     */
    public void setEventType(ITInfrastructureEventType eventType)
    {
    ...
    {
        return "ITInfrastructureOutTopicEvent{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ITInfrastructureOutTopicEvent that = (ITInfrastructureOutTopicEvent) objectToCompare;
