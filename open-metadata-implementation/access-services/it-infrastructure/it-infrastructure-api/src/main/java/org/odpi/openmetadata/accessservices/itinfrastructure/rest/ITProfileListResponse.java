...
public class ITProfileListResponse extends ITInfrastructureOMASAPIResponse
{
     ...
     */
    public ITProfileListResponse(ITProfileListResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ITProfileListResponse))
        {
            return false;
        }
        ...
        ITProfileListResponse that = (ITProfileListResponse) objectToCompare;
