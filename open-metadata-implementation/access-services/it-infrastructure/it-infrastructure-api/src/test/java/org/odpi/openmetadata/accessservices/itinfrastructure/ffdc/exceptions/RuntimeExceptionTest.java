...
/**
 * Validate that the ITInfrastructureRuntimeException is properly populated and supports toString, hashCode and
 * equals.
 */
public class RuntimeExceptionTest
{
    ...
    {
        ITInfrastructureRuntimeException exception = new ITInfrastructureRuntimeException(reportedHTTPCode,
                                                                                          reportingClassName,
    ...
    @Test public void testHashCode()
    {
        ...
        ITInfrastructureRuntimeException exception2 = new ITInfrastructureRuntimeException(reportedHTTPCode,
                                                                                           reportingClassName,
                                                                                           reportingActionDescription,
                                                                                           reportedErrorMessage,
                                                                                           reportedSystemAction,
        ...
        assertTrue(exception.toString().contains("ITInfrastructureRuntimeException"));
