...
public class VoidResponseTest
{
    ...
    @Test public void testJSON()
    {
         ...
         * Through superclass
         */
        ITInfrastructureOMASAPIResponse superObject = getTestObject();
        ...
        try
        {
            validateResultObject((VoidResponse) objectMapper.readValue(jsonString, ITInfrastructureOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
