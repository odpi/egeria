...
package org.odpi.openmetadata.accessservices.discoveryengine.ffdc.exceptions;

import java.util.Objects;

/**
 * DiscoveryEngineCheckedExceptionBase provides a checked exception for reporting errors found when using
 * the Discovery Engine OMAS services.
 *
 ...
 * The DiscoveryEngineErrorCode can be used with this exception to populate it with standard messages.
 * The aim is to be able to uniquely identify the cause and remedy for the error.
 */
public abstract class DiscoveryEngineCheckedExceptionBase extends Exception
{
     ...
     */
    public DiscoveryEngineCheckedExceptionBase(int    httpCode,
                                               String className,
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof DiscoveryEngineCheckedExceptionBase))
        {
            return false;
        }
        DiscoveryEngineCheckedExceptionBase that = (DiscoveryEngineCheckedExceptionBase) objectToCompare;
