...
public abstract class DiscoveryEngineOMASAPIResponse implements java.io.Serializable
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof DiscoveryEngineOMASAPIResponse))
        {
            return false;
        }
        DiscoveryEngineOMASAPIResponse that = (DiscoveryEngineOMASAPIResponse) objectToCompare;
