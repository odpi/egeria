...
import org.odpi.openmetadata.accessservices.discoveryengine.rest.DiscoveryEngineOMASAPIResponse;
...
class RESTExceptionHandler
{
    ...
    void detectAndThrowInvalidParameterException(String                         methodName,
                                                 DiscoveryEngineOMASAPIResponse restResult) throws InvalidParameterException
    {
    ...
    void detectAndThrowPropertyServerException(String                       methodName,
                                               DiscoveryEngineOMASAPIResponse restResult) throws PropertyServerException
    {
    ...
    void detectAndThrowUserNotAuthorizedException(String                       methodName,
                                                  DiscoveryEngineOMASAPIResponse restResult) throws UserNotAuthorizedException
    {
