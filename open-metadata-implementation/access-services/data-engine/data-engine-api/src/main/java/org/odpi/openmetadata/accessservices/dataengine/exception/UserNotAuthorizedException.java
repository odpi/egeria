...
/**
 * The UserNotAuthorizedException is thrown by the Data Engine OMAS when a userId passed on a request is not
...
public class UserNotAuthorizedException extends DataEngineException {
     ...
     */
    public UserNotAuthorizedException(int httpCode, String className, String actionDescription, String errorMessage,
