...
class DataEngineCommonHandlerTest {
    ...
    void createExternalEntity() throws InvalidParameterException, PropertyServerException, UserNotAuthorizedException {
        ...
        when(repositoryHandler.createExternalEntity(USER, ENTITY_TYPE_GUID, ENTITY_TYPE_NAME, EXTERNAL_SOURCE_DE_GUID,
    ...
    void createExternalEntity_throwsUserNotAuthorizedException() throws PropertyServerException, UserNotAuthorizedException,
        ...
        when(repositoryHandler.createExternalEntity(USER, ENTITY_TYPE_GUID, ENTITY_TYPE_NAME, EXTERNAL_SOURCE_DE_GUID,
                EXTERNAL_SOURCE_DE_QUALIFIED_NAME, instanceProperties, InstanceStatus.ACTIVE, methodName)).thenThrow(mockedException);
    ...
    @Test
    void updateEntity() throws UserNotAuthorizedException, PropertyServerException {
        dataEngineCommonHandler.updateEntity(USER, GUID, instanceProperties, ENTITY_TYPE_NAME);

        verify(repositoryHandler, times(1)).updateEntity(USER, GUID, ENTITY_TYPE_GUID, ENTITY_TYPE_NAME, instanceProperties, "updateEntity");
    }
    ...
    void updateEntity_throwsUserNotAuthorizedException() throws UserNotAuthorizedException, PropertyServerException, InvocationTargetException,
        ...
        UserNotAuthorizedException mockedException = mockException(UserNotAuthorizedException.class, methodName);
        doThrow(mockedException).when(repositoryHandler).updateEntity(USER, GUID, ENTITY_TYPE_GUID, ENTITY_TYPE_NAME, instanceProperties,
                "updateEntity");
        ...
        UserNotAuthorizedException thrown = assertThrows(UserNotAuthorizedException.class, () -> dataEngineCommonHandler.updateEntity(USER, GUID,
                instanceProperties, ENTITY_TYPE_NAME));
    ...
    void removeEntity() throws InvalidParameterException, PropertyServerException, UserNotAuthorizedException {
        ...
        dataEngineCommonHandler.removeEntity(USER, GUID, ENTITY_TYPE_NAME);

        verify(invalidParameterHandler, times(1)).validateUserId(USER, methodName);
        verify(invalidParameterHandler, times(1)).validateGUID(GUID, CommonMapper.GUID_PROPERTY_NAME, methodName);
        verify(repositoryHandler, times(1)).removeEntity(USER, GUID, ENTITY_TYPE_GUID, ENTITY_TYPE_NAME, null, null, methodName);
    }
    ...
    void removeEntity_throwsUserNotAuthorizedException() throws InvalidParameterException, PropertyServerException, UserNotAuthorizedException,
        ...
        UserNotAuthorizedException mockedException = mockException(UserNotAuthorizedException.class, methodName);
        doThrow(mockedException).when(repositoryHandler).removeEntity(USER, GUID, ENTITY_TYPE_GUID, ENTITY_TYPE_NAME, null, null, methodName);
