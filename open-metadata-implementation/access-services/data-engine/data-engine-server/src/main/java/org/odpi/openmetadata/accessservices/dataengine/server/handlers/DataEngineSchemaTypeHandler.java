...
public class DataEngineSchemaTypeHandler {
    ...
    public String upsertSchemaType(String userId, SchemaType schemaType, String externalSourceName) throws InvalidParameterException,
        ...
        upsertSchemaAttributes(userId, schemaTypeGUID, schemaType.getAttributeList(), externalSourceName);
    ...
    public void removeSchemaType(String userId, String schemaTypeGUID, String externalSourceName) throws InvalidParameterException,
        ...
        for (String schemaAttributeGUID : schemaAttributeGUIDs) {
            dataEngineCommonHandler.removeEntity(userId, schemaAttributeGUID, SchemaElementMapper.TABULAR_COLUMN_TYPE_NAME,
                    externalSourceName);
        }
     ...
     * @throws PropertyServerException    problem accessing the property server
     */
    public void addAnchorGUID(String userId, Attribute attribute, String processGUID, String externalSourceName) throws InvalidParameterException, UserNotAuthorizedException,
            PropertyServerException {
    ...
    private void upsertSchemaAttributes(String userId, String schemaTypeGUID, List<Attribute> attributeList, String externalSourceName) throws
            InvalidParameterException,
            PropertyServerException,
            UserNotAuthorizedException {
        ...
        for (Attribute attribute : attributeList) {
            ...
            if (!schemaAttributeEntity.isPresent()) {
                createSchemaAttribute(userId, schemaTypeGUID, attribute, attribute.getDataType(), externalSourceName);
            } else {
    ...
    public SchemaAttributeBuilder getSchemaAttributeBuilder(Attribute attribute) {
        return new SchemaAttributeBuilder(attribute.getQualifiedName(),
                attribute.getDisplayName(), null,
                repositoryHelper, serviceName, serverName);
    }

    private void createSchemaAttribute(String userId, String schemaTypeGUID, Attribute attribute, String dataType,
                                       String externalSourceName) throws InvalidParameterException,
            UserNotAuthorizedException,
            PropertyServerException {
        ...
        String schemaAttributeGUID = schemaAttributeHandler.createNestedSchemaAttribute(userId, externalSourceGUID,
                externalSourceName, schemaTypeGUID, schemaTypeGUIDParameterName, OpenMetadataAPIMapper.SCHEMA_TYPE_TYPE_NAME,
    ...
    SchemaTypeBuilder getSchemaTypeBuilder(SchemaType schemaType) {
        return new SchemaTypeBuilder(schemaType.getQualifiedName(), schemaType.getDisplayName(), null,
                ...
                null, null, SchemaElementMapper.COMPLEX_SCHEMA_TYPE_TYPE_GUID,
                SchemaElementMapper.COMPLEX_SCHEMA_TYPE_TYPE_NAME, null, repositoryHelper, serviceName, serverName);
    }
