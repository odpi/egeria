...
import org.odpi.openmetadata.frameworkservices.ocf.metadatamanagement.admin.OCFOperationalServices;
 ...
 */
public class OCFServicesRegistration
{
    /**
    ...
    {
        AccessServiceDescription myDescription = AccessServiceDescription.OCF_METADATA_MANAGEMENT;

        AccessServiceRegistrationEntry myRegistration = new AccessServiceRegistrationEntry(myDescription,
                                                                                           ServiceOperationalStatus.ENABLED,
                                                                                           OCFOperationalServices.class.getName());
