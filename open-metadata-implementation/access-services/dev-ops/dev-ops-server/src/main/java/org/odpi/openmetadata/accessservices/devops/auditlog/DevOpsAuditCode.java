...
package org.odpi.openmetadata.accessservices.devops.auditlog;
...
public enum DevOpsAuditCode
{
    ...
    private static final Logger log = LoggerFactory.getLogger(DevOpsAuditCode.class);
    ...
    public String getFormattedLogMessage(String... params)
    {
        ...
        {
            log.debug(String.format("<== DevOps Audit Code.getMessage(%s)", Arrays.toString(params)));
        }
        ...
        if (log.isDebugEnabled())
        {
            log.debug(String.format("==> DevOps Audit Code.getMessage(%s): %s", Arrays.toString(params), result));
        }
