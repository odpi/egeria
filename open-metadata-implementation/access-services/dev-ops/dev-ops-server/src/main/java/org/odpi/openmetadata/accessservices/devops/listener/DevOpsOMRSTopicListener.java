...
/**
 * DevOpsOMRSTopicListener received details of each OMRS event from the cohorts that the local server
 * is connected to.  It passes NEW_ENTITY_EVENTs to the publisher.
 */
public class DevOpsOMRSTopicListener extends OMRSTopicListenerBase
{
    private static final Logger log = LoggerFactory.getLogger(DevOpsOMRSTopicListener.class);
     ...
     *
     * @param devOpsOutTopic  connection to the out topic
     ...
     */
    public DevOpsOMRSTopicListener(Connection              devOpsOutTopic,
