...
import org.odpi.openmetadata.accessservices.devops.metadataelements.HostElement;
...
public class HostListResponse extends DevOpsOMASAPIResponse
{
     ...
     */
    public HostListResponse(HostListResponse template)
    {
        super(template);
     ...
     */
    public List<HostElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<HostElement> elementList)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        HostListResponse that = (HostListResponse) objectToCompare;
