...
import org.odpi.openmetadata.accessservices.devops.properties.ConnectorTypeProperties;
 ...
 * The external source identifiers are used if the connector type was created using the external source identifiers.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class ConnectorTypeRequestBody extends ConnectorTypeProperties
{
     ...
     * @param template object to copy
     */
    public ConnectorTypeRequestBody(ConnectorTypeProperties template)
    {
        super(template);
    }
    ...
    public String toString()
    {
        return "ConnectorTypeRequestBody{" +
                       ...
                       ", connectorProviderClassName='" + getConnectorProviderClassName() + '\'' +
                       ", recognizedAdditionalProperties=" + getRecognizedAdditionalProperties() +
                       ", recognizedConfigurationProperties=" + getRecognizedConfigurationProperties() +
