...
{
    final static String  messageIdPrefix = "DEV-OPS";
    ...
    private void testSingleErrorCodeValues(DevOpsErrorCode  testValue)
    {
        String                  testInfo;
    ...
    @Test public void testJSON()
    {
        ...
        try
        {
            jsonString = objectMapper.writeValueAsString(DevOpsErrorCode.UNKNOWN_ASSET);
        }
        catch (Throwable  exc)
        {
        ...
        try
        {
            assertTrue(objectMapper.readValue(jsonString, DevOpsErrorCode.class) == DevOpsErrorCode.UNKNOWN_ASSET);
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
    ...
    {
        assertTrue(DevOpsErrorCode.OMRS_NOT_INITIALIZED.toString().contains("DevOpsErrorCode"));
    }
    ...
    {
        assertTrue(DevOpsErrorCode.ASSET_NOT_FOUND.equals(DevOpsErrorCode.ASSET_NOT_FOUND));
        assertFalse(DevOpsErrorCode.MULTIPLE_ASSETS_FOUND.equals(DevOpsErrorCode.ASSET_NOT_FOUND));
    }
    ...
    {
        assertTrue(DevOpsErrorCode.ASSET_NOT_FOUND.hashCode() == DevOpsErrorCode.ASSET_NOT_FOUND.hashCode());
        assertFalse(DevOpsErrorCode.MULTIPLE_ASSETS_FOUND.hashCode() == DevOpsErrorCode.ASSET_NOT_FOUND.hashCode());
    }
}
