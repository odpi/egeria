...
import org.odpi.openmetadata.accessservices.securitymanager.api.DatabaseManagerInterface;
...
public class DatabaseManagerClient implements DatabaseManagerInterface
{
    ...
    private final String editURLTemplatePrefix = "/servers/{0}/open-metadata/access-services/security-manager/users/{1}/database-managers/{2}/{3}/databases";
    private final String retrieveURLTemplatePrefix   = "/servers/{0}/open-metadata/access-services/security-manager/users/{1}/databases";
    private final String governanceURLTemplatePrefix = "/servers/{0}/open-metadata/access-services/security-manager/users/{1}/databases";
     ...
     * instance of the Security Manager OMAS).
     *
     * @param userId calling user
     ...
     * instance of the Security Manager OMAS.  This is the setting when the database is first created).
     *
     * @param userId calling user
