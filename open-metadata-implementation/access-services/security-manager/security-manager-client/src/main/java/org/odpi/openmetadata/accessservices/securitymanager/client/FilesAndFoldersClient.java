...
import org.odpi.openmetadata.accessservices.securitymanager.api.FilesAndFoldersInterface;
...
{
    private final String urlTemplatePrefix = "/servers/{0}/open-metadata/access-services/security-manager/users/{1}/filesystems";
