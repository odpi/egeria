...
import org.odpi.openmetadata.accessservices.securitymanager.properties.ArchiveProperties;
...
public class ArchiveRequestBody extends ArchiveProperties
{
    ...
    public String toString()
    {
        return "ArchiveRequestBody{" +
                       ...
                       ", archiveProcess='" + getArchiveProcess() + '\'' +
