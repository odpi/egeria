...
public class UserIdentitiesResponse extends SecurityManagerOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<UserIdentityElement> elementList = null;
     ...
     */
    public List<UserIdentityElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<UserIdentityElement> elementList)
    {
