...
import org.odpi.openmetadata.accessservices.securitymanager.metadataelements.DatabaseViewElement;
...
public class DataFilesResponse extends SecurityManagerOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<DataFileElement> elementList = null;


    /**
     * Default constructor
     */
    public DataFilesResponse()
    {
    }
     ...
     */
    public DataFilesResponse(DataFilesResponse template)
    {
        super(template);
     ...
     */
    public List<DataFileElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<DataFileElement> elementList)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        DataFilesResponse that = (DataFilesResponse) objectToCompare;
