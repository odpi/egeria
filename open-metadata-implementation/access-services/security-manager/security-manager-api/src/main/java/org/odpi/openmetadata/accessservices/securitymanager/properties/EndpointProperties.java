 ...
 * the the security manager's server and describes its network endpoint.  It is also linked to connection objects
 * that are used by clients to connect to the security manager.  A connection is linked to each asset
 * that is hosted on the security manager.
 */
