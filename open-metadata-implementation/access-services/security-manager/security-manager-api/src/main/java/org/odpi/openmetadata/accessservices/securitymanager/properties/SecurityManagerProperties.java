...
public class SecurityManagerProperties extends ReferenceableProperties
{
     ...
     * Default constructor.
     */
    public SecurityManagerProperties()
    {
        super();
    }
     ...
     */
    public SecurityManagerProperties(SecurityManagerProperties template)
    {
        super(template);
