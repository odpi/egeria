...
import org.odpi.openmetadata.accessservices.communityprofile.metadataelements.InformalTagElement;
 ...
 */
public class InformalTagConverter<B> extends CommunityProfileOMASConverter<B>
{
    /**
     * Constructor
     *
                        ...
                        String       methodName) throws PropertyServerException
    {
        try
        {
            ...
            if (returnBean instanceof InformalTagElement)
            {
                ...
                bean.setProperties(informalTagProperties);
            }
