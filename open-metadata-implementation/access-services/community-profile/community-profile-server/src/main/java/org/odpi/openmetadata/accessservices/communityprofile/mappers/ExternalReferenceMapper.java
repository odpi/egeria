...
/**
 * ExternalReferenceMapper provides the property name mapping for ExternalReferenceProperties beans.
...
public class ExternalReferenceMapper
{
    ...
    public static final String RESOURCE_DISPLAY_NAME_PROPERTY_NAME = "displayName";          /* from ExternalReferenceProperties entity */
    public static final String RESOURCE_DESCRIPTION_PROPERTY_NAME  = "description";          /* from ExternalReferenceProperties entity */
    public static final String RESOURCE_URL_PROPERTY_NAME          = "url";                  /* from ExternalReferenceProperties entity */
    public static final String RESOURCE_VERSION_PROPERTY_NAME      = "version";              /* from ExternalReferenceProperties entity */
    public static final String OWNING_ORGANIZATION_PROPERTY_NAME   = "organization";         /* from ExternalReferenceProperties entity */
