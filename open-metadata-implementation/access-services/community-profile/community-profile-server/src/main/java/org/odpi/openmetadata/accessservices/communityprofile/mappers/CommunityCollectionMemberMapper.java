...
public class CommunityCollectionMemberMapper
{
    ...
    public static final String NAME_PROPERTY_NAME                       = "name";                 /* from CommunityProperties entity */
    public static final String DESCRIPTION_PROPERTY_NAME                = "description";          /* from CommunityProperties entity */
    public static final String MISSION_PROPERTY_NAME                    = "mission";              /* from CommunityProperties entity */
