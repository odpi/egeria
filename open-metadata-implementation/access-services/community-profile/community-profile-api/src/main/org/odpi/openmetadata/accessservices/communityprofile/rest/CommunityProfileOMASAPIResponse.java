...
public abstract class CommunityProfileOMASAPIResponse implements java.io.Serializable
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof CommunityProfileOMASAPIResponse))
        {
            return false;
        }
        CommunityProfileOMASAPIResponse that = (CommunityProfileOMASAPIResponse) objectToCompare;
