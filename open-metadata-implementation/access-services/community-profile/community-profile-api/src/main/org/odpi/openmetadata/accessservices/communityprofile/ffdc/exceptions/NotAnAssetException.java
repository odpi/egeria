...
/**
 * The NotAnAssetException is thrown by the Community Profile OMAS when the unique identifier (guid)
 ...
 */
public class NotAnAssetException extends CommunityProfileCheckedExceptionBase
{
    private String guid;
