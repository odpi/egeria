...
public class CommunityResponse extends CommunityProfileOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private CommunityElement element = null;
     ...
     */
    public CommunityResponse(CommunityResponse template)
    {
        super(template);
     ...
     */
    public CommunityElement getElement()
    {
        return element;
    }
     ...
     */
    public void setElement(CommunityElement element)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof CommunityResponse))
        {
            return false;
        }
        ...
        CommunityResponse that = (CommunityResponse) objectToCompare;
