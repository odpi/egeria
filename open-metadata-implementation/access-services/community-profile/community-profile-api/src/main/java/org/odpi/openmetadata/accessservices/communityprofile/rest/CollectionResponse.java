...
public class CollectionResponse extends CommunityProfileOMASAPIResponse
{
     ...
     */
    public CollectionResponse(CollectionResponse template)
    {
        super(template);
     ...
     */
    public void setElement(CollectionElement element)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof CollectionResponse))
        {
            return false;
        }
        ...
        CollectionResponse that = (CollectionResponse) objectToCompare;
