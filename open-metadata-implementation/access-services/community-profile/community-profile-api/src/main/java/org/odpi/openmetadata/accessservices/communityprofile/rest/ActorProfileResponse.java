...
public class ActorProfileResponse extends CommunityProfileOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private ActorProfileElement element = null;


    /**
     * Default constructor
     */
    public ActorProfileResponse()
    {
        super();
    }
     ...
     */
    public ActorProfileResponse(ActorProfileResponse template)
    {
        super(template);
     ...
     */
    public ActorProfileElement getElement()
    {
        return element;
    }
     ...
     */
    public void setElement(ActorProfileElement element)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ActorProfileResponse))
        {
            return false;
        }
        ...
        ActorProfileResponse that = (ActorProfileResponse) objectToCompare;
