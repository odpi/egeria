...
public class SecurityGroupsResponse extends CommunityProfileOMASAPIResponse
{
    private static final long    serialVersionUID = 1L;

    private List<SecurityGroupElement> elementList = null;
     ...
     */
    public SecurityGroupsResponse(SecurityGroupsResponse template)
    {
        super(template);
     ...
     */
    public List<SecurityGroupElement> getElementList()
    {
        if (elementList == null)
        {
            return null;
     ...
     */
    public void setElementList(List<SecurityGroupElement> elementList)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        SecurityGroupsResponse that = (SecurityGroupsResponse) objectToCompare;
