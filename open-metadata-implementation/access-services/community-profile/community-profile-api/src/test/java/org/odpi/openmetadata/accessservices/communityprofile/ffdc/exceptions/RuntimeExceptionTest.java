...
public class RuntimeExceptionTest
{
    ...
    {
        CommunityProfileRuntimeException exception = new CommunityProfileRuntimeException(reportedHTTPCode,
                                                                                    reportingClassName,
    ...
    @Test public void testHashCode()
    {
        ...
        CommunityProfileRuntimeException exception2 = new CommunityProfileRuntimeException(reportedHTTPCode,
                                                                                     reportingClassName,
                                                                                     reportingActionDescription,
                                                                                     reportedErrorMessage,
                                                                                     reportedSystemAction,
        ...
        assertTrue(exception.toString().contains("CommunityProfileRuntimeException"));
