...
/**
 * ActorProfileManagement is the client for explicitly managing the actor profile entities and associating them with
 * profiles.  It is typically used when the relationship between user identities and profiles are many to one.
 */
public class ActorProfileManagement extends ActorProfileHandler
{
    /**
     ...
     *                                   REST API calls.
     */
    public ActorProfileManagement(String   localServerName,
                                  String   serverName,
