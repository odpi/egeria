 ...
 * @param <B> bean class
 */
public abstract class CommunityProfileConverterBase<B> extends OpenMetadataConverterBase<B>
{
    /**
     * Constructor
     *
     ...
     */
    public CommunityProfileConverterBase(PropertyHelper propertyHelper,
                                         String               serviceName,
                                         String               serverName)
    {
