...
import org.odpi.openmetadata.accessservices.datamodel.admin.DataModelAdmin;
...
/**
 * DataModelRegistration registers the access service with the OMAG Server administration services.
...
public class DataModelRegistration
{
    ...
    {
        AccessServiceDescription myDescription = AccessServiceDescription.DATA_MODEL_OMAS;

        AccessServiceRegistration myRegistration = new AccessServiceRegistration(myDescription,
                                                                                 AccessServiceOperationalStatus.ENABLED,
                                                                                 DataModelAdmin.class.getName());
