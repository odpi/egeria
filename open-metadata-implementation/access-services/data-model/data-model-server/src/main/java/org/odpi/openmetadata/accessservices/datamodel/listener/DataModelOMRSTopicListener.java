...
package org.odpi.openmetadata.accessservices.datamodel.listener;
...
/**
 * DataModelOMRSTopicListener received details of each OMRS event from the cohorts that the local server
 * is connected to.  It passes NEW_ENTITY_EVENTs to the publisher.
 */
public class DataModelOMRSTopicListener extends OMRSTopicListenerBase
{
    private static final Logger log = LoggerFactory.getLogger(DataModelOMRSTopicListener.class);
     ...
     */
    public DataModelOMRSTopicListener(Connection              stewardshipActionOutTopic,
