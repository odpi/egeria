...
/**
 * This package provides the first failure data capture support for the Data Model OMAS module.
 ...
 *
 * The error code enum (DataModelErrorCode) has an entry for each unique situation
