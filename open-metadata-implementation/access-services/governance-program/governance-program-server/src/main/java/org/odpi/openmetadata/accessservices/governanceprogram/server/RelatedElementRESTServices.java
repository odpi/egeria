...
public class RelatedElementRESTServices
{
     ...
     *  PropertyServerException    there is a problem reported in the open metadata server(s)
     */
    public GovernanceDefinitionsResponse getGovernanceDefinitionsForElement(String serverName,
                                                                            String userId,
                                                                            String elementGUID,
                                                                            int    startFrom,
                                                                            int    pageSize)
     ...
     *  PropertyServerException    there is a problem reported in the open metadata server(s)
     */
    public RelatedElementsResponse getGovernanceDefinitionScopes(String serverName,
                                                                 String userId,
                                                                 String governanceDefinitionGUID,
                                                                 int    startFrom,
                                                                 int    pageSize)
     ...
     *  PropertyServerException    there is a problem reported in the open metadata server(s)
     */
    public GovernanceDefinitionsResponse getScopedGovernanceDefinitions(String serverName,
                                                                        String userId,
                                                                        String scopeGUID,
                                                                        int    startFrom,
                                                                        int    pageSize)
     ...
     *  PropertyServerException    there is a problem reported in the open metadata server(s)
     */
    public GovernanceRolesResponse getResponsibleRoles(String serverName,
                                                       String userId,
                                                       String governanceResponsibilityGUID,
                                                       int    startFrom,
                                                       int    pageSize)
     ...
     *  PropertyServerException    there is a problem reported in the open metadata server(s)
     */
    public GovernanceDefinitionsResponse getRoleResponsibilities(String serverName,
                                                                 String userId,
                                                                 String personRoleGUID,
                                                                 int    startFrom,
                                                                 int    pageSize)
