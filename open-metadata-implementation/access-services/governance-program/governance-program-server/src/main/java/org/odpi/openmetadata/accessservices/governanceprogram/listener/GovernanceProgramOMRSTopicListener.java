...
package org.odpi.openmetadata.accessservices.governanceprogram.listener;

import org.odpi.openmetadata.accessservices.governanceprogram.outtopic.GovernanceProgramPublisher;
...
public class GovernanceProgramOMRSTopicListener implements OMRSTopicListener
{
    private static final Logger log = LoggerFactory.getLogger(GovernanceProgramOMRSTopicListener.class);

    private GovernanceProgramPublisher publisher;
     ...
     */
    public GovernanceProgramOMRSTopicListener(Connection              governanceProgramOutTopic,
                                              OMRSRepositoryHelper    repositoryHelper,
                                              OMRSRepositoryValidator repositoryValidator,
                                              String                  componentName)
    {
        publisher = new GovernanceProgramPublisher(governanceProgramOutTopic,
                                                   repositoryHelper,
                                                   repositoryValidator,
                                                   componentName);
    }
