...
public class ExternalReferenceListResponse extends GovernanceProgramOMASAPIResponse
{
     ...
     * Default constructor
     */
    public ExternalReferenceListResponse()
    {
        super();
    }
     ...
     */
    public ExternalReferenceListResponse(ExternalReferenceListResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ExternalReferenceListResponse))
        {
            return false;
        }
        ...
        ExternalReferenceListResponse that = (ExternalReferenceListResponse) objectToCompare;
