...
/**
 * The GovernanceStrategy defines how governance and related activities around data will deliver value to the organization.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class GovernanceStrategy extends GovernanceDriverProperties
{
     ...
     */
    public GovernanceStrategy(GovernanceStrategy template)
    {
        super(template);
    ...
    /**
     * Return the description of the business imperative(s) that is/are driving the governance strategy.
    ...
    /**
     * Set up the description of the business imperative(s) that is/are driving the governance strategy.
     * These may be specific outcomes of the business strategy, or specific challenges that the
     * organization faces.
     *
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        GovernanceStrategy that = (GovernanceStrategy) objectToCompare;
