...
public class GovernanceRoleAppointeeListResponse extends GovernanceProgramOMASAPIResponse
{
     ...
     * Default constructor
     */
    public GovernanceRoleAppointeeListResponse()
    {
        super();
    }
     ...
     */
    public GovernanceRoleAppointeeListResponse(GovernanceRoleAppointeeListResponse template)
    {
        super(template);
    ...
    {
        return "GovernanceOfficerAppointeeListResponse{" +
                "elements=" + elements +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof GovernanceRoleAppointeeListResponse))
        {
            return false;
        }
        ...
        GovernanceRoleAppointeeListResponse that = (GovernanceRoleAppointeeListResponse) objectToCompare;
