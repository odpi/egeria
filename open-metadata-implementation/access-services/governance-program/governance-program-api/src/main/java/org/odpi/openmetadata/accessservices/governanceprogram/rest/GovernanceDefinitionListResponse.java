...
public class GovernanceDefinitionListResponse extends GovernanceProgramOMASAPIResponse
{
     ...
     * Default constructor
     */
    public GovernanceDefinitionListResponse()
    {
        super();
    }
     ...
     */
    public GovernanceDefinitionListResponse(GovernanceDefinitionListResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof GovernanceDefinitionListResponse))
        {
            return false;
        }
        ...
        GovernanceDefinitionListResponse that = (GovernanceDefinitionListResponse) objectToCompare;
