...
public class GovernanceLevelIdentifierResponse extends GovernanceProgramOMASAPIResponse
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof GovernanceLevelIdentifierResponse))
        {
            return false;
        }
        ...
        GovernanceLevelIdentifierResponse that = (GovernanceLevelIdentifierResponse) objectToCompare;
