 ...
 * It is used in conjunction with the GovernanceProgramErrorCode to provide first failure data capture for these errors.
 */
public class GovernanceProgramRuntimeException extends RuntimeException
{
     ...
     */
    public GovernanceProgramRuntimeException(int                 httpCode,
                                             String              className,
    ...
    {
        return "GovernanceProgramRuntimeException{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof GovernanceProgramRuntimeException))
        {
            return false;
        }
        GovernanceProgramRuntimeException that = (GovernanceProgramRuntimeException) objectToCompare;
