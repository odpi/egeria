...
public class GovernanceDomainListResponse extends GovernanceProgramOMASAPIResponse
{
    private List<GovernanceDomainElement> elements = null;
     ...
     */
    public GovernanceDomainListResponse(GovernanceDomainListResponse template)
    {
        super(template);
     ...
     */
    public List<GovernanceDomainElement> getElements()
    {
        if (elements == null)
        {
            return null;
     ...
     */
    public void setElements(List<GovernanceDomainElement> elements)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof GovernanceDomainListResponse))
        {
            return false;
        }
        ...
        GovernanceDomainListResponse that = (GovernanceDomainListResponse) objectToCompare;
