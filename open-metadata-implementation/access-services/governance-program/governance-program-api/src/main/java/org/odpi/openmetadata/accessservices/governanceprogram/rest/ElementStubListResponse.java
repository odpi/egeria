...
public class ElementStubListResponse extends GovernanceProgramOMASAPIResponse
{
     ...
     * Default constructor
     */
    public ElementStubListResponse()
    {
        super();
    }
     ...
     */
    public ElementStubListResponse(ElementStubListResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof ElementStubListResponse))
        {
            return false;
        }
        ...
        ElementStubListResponse that = (ElementStubListResponse) objectToCompare;
