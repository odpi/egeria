...
public class SubjectAreaResponse extends GovernanceProgramOMASAPIResponse
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof SubjectAreaResponse))
        {
            return false;
        }
        ...
        SubjectAreaResponse that = (SubjectAreaResponse) objectToCompare;
