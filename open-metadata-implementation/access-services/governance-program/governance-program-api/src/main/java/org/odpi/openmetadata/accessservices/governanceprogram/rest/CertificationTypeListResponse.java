...
public class CertificationTypeListResponse extends GovernanceProgramOMASAPIResponse
{
     ...
     */
    public CertificationTypeListResponse(CertificationTypeListResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof CertificationTypeListResponse))
        {
            return false;
        }
        ...
        CertificationTypeListResponse that = (CertificationTypeListResponse) objectToCompare;
