...
public class GovernanceDomainSetResponse extends GovernanceProgramOMASAPIResponse
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof GovernanceDomainSetResponse))
        {
            return false;
        }
        ...
        GovernanceDomainSetResponse that = (GovernanceDomainSetResponse) objectToCompare;
