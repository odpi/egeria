...
public class LicenseTypeResponse extends GovernanceProgramOMASAPIResponse
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof LicenseTypeResponse))
        {
            return false;
        }
        ...
        LicenseTypeResponse that = (LicenseTypeResponse) objectToCompare;
