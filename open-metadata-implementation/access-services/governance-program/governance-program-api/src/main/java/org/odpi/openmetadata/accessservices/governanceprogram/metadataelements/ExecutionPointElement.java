...
import org.odpi.openmetadata.accessservices.governanceprogram.properties.ExecutionPointProperties;
...
public class ExecutionPointElement implements Serializable
{
     ...
     */
    public ExecutionPointElement(ExecutionPointElement template)
    {
        if (template != null)
        {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ExecutionPointElement that = (ExecutionPointElement) objectToCompare;
