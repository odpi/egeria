...
public class GovernanceLevelIdentifierSetListResponse extends GovernanceProgramOMASAPIResponse
{
     ...
     */
    public GovernanceLevelIdentifierSetListResponse(GovernanceLevelIdentifierSetListResponse template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof GovernanceLevelIdentifierSetListResponse))
        {
            return false;
        }
        ...
        GovernanceLevelIdentifierSetListResponse that = (GovernanceLevelIdentifierSetListResponse) objectToCompare;
