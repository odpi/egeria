...
/**
 * GovernanceProgramOMASAPIResponse provides a common header for Governance Program OMAS managed responses to its REST API.
...
public abstract class GovernanceProgramOMASAPIResponse implements java.io.Serializable
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof GovernanceProgramOMASAPIResponse))
        {
            return false;
        }
        GovernanceProgramOMASAPIResponse that = (GovernanceProgramOMASAPIResponse) objectToCompare;
