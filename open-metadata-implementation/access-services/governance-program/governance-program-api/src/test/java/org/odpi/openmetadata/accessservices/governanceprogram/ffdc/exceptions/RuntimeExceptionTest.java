...
/**
 * Validate that the GovernanceProgramRuntimeException is properly populated and supports toString, hashCode and
 * equals.
 */
public class RuntimeExceptionTest
{
    ...
    {
        GovernanceProgramRuntimeException exception = new GovernanceProgramRuntimeException(reportedHTTPCode,
                                                                                            reportingClassName,
    ...
    @Test public void testHashCode()
    {
        ...
        GovernanceProgramRuntimeException exception2 = new GovernanceProgramRuntimeException(reportedHTTPCode,
                                                                                             reportingClassName,
                                                                                             reportingActionDescription,
                                                                                             reportedErrorMessage,
                                                                                             reportedSystemAction,
        ...
        assertTrue(exception.toString().contains("GovernanceProgramRuntimeException"));
