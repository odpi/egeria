...
public class OpenMetadataStoreResource
{
    ...
    @Operation(summary="addTypeDef",
            description="Add a new type definition for an entity, relationship or classification.  The type definition is validated against the types already defined and stored in the local repository so that it survives a restart.",
            externalDocs=@ExternalDocumentation(description="Further Information",
                    url="https://egeria-project.org/types/"))
    ...
    {
        return restAPI.addTypeDef(serverName, userId, requestBody);
    }
    ...
    {
        return restAPI.updateTypeDef(serverName, userId, requestBody);
    }
    ...
    {
        return restAPI.deleteTypeDef(serverName, userId, typeDefGUID, typeDefName, requestBody);
    }
    ...
    @Operation(summary="addEnumDef",
            description="Add a new enum definition, which can then be used as the type of attributes in new type definitions.  It is stored in the local repository so that it survives a restart.",
            externalDocs=@ExternalDocumentation(description="Further Information",
                    url="https://egeria-project.org/types/"))
    ...
    {
        return restAPI.addEnumDef(serverName, userId, requestBody);
    }
    ...
    public VoidResponse deleteEnumDef(@PathVariable String          serverName,
                                      ...
                                      @RequestBody (required=false)
                                                    NullRequestBody requestBody)
    {
        return restAPI.deleteEnumDef(serverName, userId, enumDefGUID, enumDefName, requestBody);
    }
    ...
    {
        return restAPI.reIdentifyMetadataElementInStore(serverName, userId, metadataElementGUID, requestBody);
    }
    ...
    {
        return restAPI.reTypeMetadataElementInStore(serverName, userId, metadataElementGUID, requestBody);
    }
    ...
    {
        return restAPI.reHomeMetadataElementInStore(serverName, userId, metadataElementGUID, requestBody);
    }
    ...
    public VoidResponse reIdentifyRelationshipInStore(@PathVariable String                serverName,
                                                      ...
                                                      @RequestBody  ReIdentifyRequestBody requestBody)
    {
        return restAPI.reIdentifyRelationshipInStore(serverName, userId, relationshipGUID, requestBody);
    }
    ...
    public VoidResponse reTypeRelationshipInStore(@PathVariable String            serverName,
                                                  ...
                                                  @RequestBody  ReTypeRequestBody requestBody)
    {
        return restAPI.reTypeRelationshipInStore(serverName, userId, relationshipGUID, requestBody);
    }
    ...
    public VoidResponse reHomeRelationshipInStore(@PathVariable String            serverName,
                                                  ...
                                                  @RequestBody  ReHomeRequestBody requestBody)
    {
        return restAPI.reHomeRelationshipInStore(serverName, userId, relationshipGUID, requestBody);
    }
