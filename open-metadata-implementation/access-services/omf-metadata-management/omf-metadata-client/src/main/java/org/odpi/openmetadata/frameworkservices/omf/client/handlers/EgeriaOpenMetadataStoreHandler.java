...
/**
 * OpenMetadataClient provides an interface to the open metadata store.  This is part of the Governance Action Framework (GAF)
 ...
 */
public class EgeriaOpenMetadataStoreHandler extends OpenMetadataClientBase
{
    /**
     ...
     *                                   REST API calls.
     */
    public EgeriaOpenMetadataStoreHandler(String serverName,
