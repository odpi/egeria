...
import org.odpi.openmetadata.frameworkservices.omf.admin.OMFOperationalServices;
 ...
 */
public class OMFServicesRegistration
{
    /**
    ...
    {
        AccessServiceDescription myDescription = AccessServiceDescription.OMF_METADATA_MANAGEMENT;

        AccessServiceRegistrationEntry myRegistration = new AccessServiceRegistrationEntry(myDescription,
                                                                                           ServiceOperationalStatus.ENABLED,
                                                                                           OMFOperationalServices.class.getName());
