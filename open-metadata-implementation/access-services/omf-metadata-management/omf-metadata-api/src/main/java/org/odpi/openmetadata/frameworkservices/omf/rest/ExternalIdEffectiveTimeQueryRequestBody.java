...
public class ExternalIdEffectiveTimeQueryRequestBody extends OMAGOMFAPIResponse
{
     ...
     * Default constructor
     */
    public ExternalIdEffectiveTimeQueryRequestBody()
    {
        super();
    }
     ...
     */
    public ExternalIdEffectiveTimeQueryRequestBody(ExternalIdEffectiveTimeQueryRequestBody template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        ExternalIdEffectiveTimeQueryRequestBody that = (ExternalIdEffectiveTimeQueryRequestBody) objectToCompare;
