...
public class UniqueNameRequestBody extends GetOptions
{
     ...
     */
    public UniqueNameRequestBody(UniqueNameRequestBody template)
    {
        super(template);
     ...
     * @param template object to copy
     */
    public UniqueNameRequestBody(GetOptions template)
    {
        super(template);
    }
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        UniqueNameRequestBody that = (UniqueNameRequestBody) objectToCompare;
