...
public class AssetOwnerRESTServices
{
                                                                                   ...
                                                                                   PropertyServerException
    {
        ...
        if (assetGUID != null)
        {
            handler.setUpAnchorsClassificationFromAnchor(userId,
                                                         assetGUID,
                                                         assetGUIDParameterName,
                                                         null,
                                                         schemaTypeBuilder,
     ...
     * @param assetGUID anchor GUID for the new schema type (maybe null)
        ...
        if (schemaAttribute != null)
        {
            ...
            if (schemaAttribute.getSchemaType() != null)
            {
                ...
                SchemaTypeBuilder attributeSchemaTypeBuilder = new SchemaTypeBuilder(schemaTypeProperties.getQualifiedName(),
                                                                                     ...
                                                                                     schemaTypeProperties.getVersionIdentifier(),
