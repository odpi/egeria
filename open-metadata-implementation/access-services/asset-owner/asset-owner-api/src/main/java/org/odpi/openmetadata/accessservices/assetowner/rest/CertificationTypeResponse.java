...
public class CertificationTypeResponse extends AssetOwnerOMASAPIResponse
{
    private CertificationTypeElement element = null;


    /**
     * Default constructor
     */
    public CertificationTypeResponse()
    {
        super();
    }
     ...
     */
    public CertificationTypeResponse(CertificationTypeResponse template)
    {
        super(template);
     ...
     */
    public CertificationTypeElement getElement()
    {
        return element;
    }
     ...
     */
    public void setElement(CertificationTypeElement element)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof CertificationTypeResponse))
        {
            return false;
        }
        ...
        CertificationTypeResponse that = (CertificationTypeResponse) objectToCompare;
