...
public class SchemaTypeElementResponse extends AssetOwnerOMASAPIResponse
{
     ...
     */
    public SchemaTypeElementResponse(SchemaTypeElementResponse template)
    {
        super(template);
     ...
     * @return bean
     */
    public SchemaTypeElement getElement()
    {
        return element;
    }
     ...
     * @param element  bean
     */
    public void setElement(SchemaTypeElement element)
    {
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof SchemaTypeElementResponse))
        {
            return false;
        }
        ...
        SchemaTypeElementResponse that = (SchemaTypeElementResponse) objectToCompare;
