...
public class SurveyReportListResponse extends AssetOwnerOMASAPIResponse
{
     ...
     * Default constructor
     */
    public SurveyReportListResponse()
    {
        super();
    }
     ...
     */
    public SurveyReportListResponse(SurveyReportListResponse template)
    {
        super(template);
    ...
    {
        return "SurveyReportListResponse{" +
                "discoveryAnalysisReports=" + surveyReports +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        SurveyReportListResponse that = (SurveyReportListResponse) objectToCompare;
