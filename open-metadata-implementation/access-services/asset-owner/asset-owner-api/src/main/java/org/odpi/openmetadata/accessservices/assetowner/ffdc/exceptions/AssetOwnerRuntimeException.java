 ...
 * It is used in conjunction with the AssetOwnerErrorCode to provide first failure data capture for these errors.
 */
public class AssetOwnerRuntimeException extends RuntimeException
{
     ...
     */
    public AssetOwnerRuntimeException(int                 httpCode,
                                      String              className,
    ...
    {
        return "AssetOwnerRuntimeException{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof AssetOwnerRuntimeException))
        {
            return false;
        }
        AssetOwnerRuntimeException that = (AssetOwnerRuntimeException) objectToCompare;
