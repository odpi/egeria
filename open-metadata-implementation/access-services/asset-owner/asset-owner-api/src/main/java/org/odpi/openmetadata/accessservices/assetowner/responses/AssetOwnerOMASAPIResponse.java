...
/**
 * AssetOwnerOMASAPIResponse provides a common header for Asset Owner OMAS managed responses to its REST API.
...
public abstract class AssetOwnerOMASAPIResponse implements java.io.Serializable
{
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof AssetOwnerOMASAPIResponse))
        {
            return false;
        }
        AssetOwnerOMASAPIResponse that = (AssetOwnerOMASAPIResponse) objectToCompare;
