 ...
 * </ul>
 */
public interface AssetConnectionManagementInterface
{
    ...
    /*
     * The ConnectorType entity describes a specific connector implementation. There is no ability to maintain connector types since the
     * Asset Owner should only use approved connectors - connector types are defined in Digital Architecture OMAS.
     */
