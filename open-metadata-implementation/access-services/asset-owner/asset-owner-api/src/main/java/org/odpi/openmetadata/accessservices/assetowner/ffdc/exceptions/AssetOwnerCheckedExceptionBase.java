 ...
 * The AssetOwnerErrorCode can be used with this exception to populate it with standard messages.
 * The aim is to be able to uniquely identify the cause and remedy for the error.
 */
public abstract class AssetOwnerCheckedExceptionBase extends Exception
{
     ...
     */
    public AssetOwnerCheckedExceptionBase(int    httpCode,
                                          String className,
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof AssetOwnerCheckedExceptionBase))
        {
            return false;
        }
        AssetOwnerCheckedExceptionBase that = (AssetOwnerCheckedExceptionBase) objectToCompare;
