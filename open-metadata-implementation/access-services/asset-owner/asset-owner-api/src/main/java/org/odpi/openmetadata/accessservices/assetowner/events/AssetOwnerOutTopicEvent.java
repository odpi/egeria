...
public class AssetOwnerOutTopicEvent implements Serializable
{
     ...
     * Default Constructor
     */
    public AssetOwnerOutTopicEvent()
    {
    }
     ...
     */
    public AssetOwnerOutTopicEvent(AssetOwnerOutTopicEvent template)
    {
        if (template != null)
        {
    ...
    {
        return "AssetOwnerOutTopicEvent{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        AssetOwnerOutTopicEvent that = (AssetOwnerOutTopicEvent) objectToCompare;
