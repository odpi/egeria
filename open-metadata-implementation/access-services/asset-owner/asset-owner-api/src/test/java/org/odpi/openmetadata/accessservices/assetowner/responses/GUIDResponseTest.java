...
public class GUIDResponseTest
{
    ...
    @Test public void testJSON()
    {
         ...
         * Through superclass
         */
        AssetOwnerOMASAPIResponse superObject = getTestObject();
        ...
        try
        {
            validateResultObject((GUIDResponse) objectMapper.readValue(jsonString, AssetOwnerOMASAPIResponse.class));
        }
        catch (Throwable  exc)
        {
            assertTrue(false, "Exception: " + exc.getMessage());
