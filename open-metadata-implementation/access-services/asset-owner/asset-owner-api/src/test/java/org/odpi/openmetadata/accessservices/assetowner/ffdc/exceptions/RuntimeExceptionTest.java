...
/**
 * Validate that the AssetOwnerRuntimeException is properly populated and supports toString, hashCode and
 * equals.
 */
public class RuntimeExceptionTest
{
    ...
    {
        AssetOwnerRuntimeException exception = new AssetOwnerRuntimeException(reportedHTTPCode,
                                                                              reportingClassName,
    ...
    @Test public void testHashCode()
    {
        ...
        AssetOwnerRuntimeException exception2 = new AssetOwnerRuntimeException(reportedHTTPCode,
                                                                               reportingClassName,
                                                                               reportingActionDescription,
                                                                               reportedErrorMessage,
                                                                               reportedSystemAction,
        ...
        assertTrue(exception.toString().contains("AssetOwnerRuntimeException"));
