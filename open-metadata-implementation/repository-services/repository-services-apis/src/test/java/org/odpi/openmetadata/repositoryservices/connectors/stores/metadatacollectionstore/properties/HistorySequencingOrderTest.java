...
/**
 * Verify the HistorySequencingOrderTest enum contains unique ordinals, non-null names and descriptions and can be
 * serialized to JSON and back again.
 */
public class HistorySequencingOrderTest
{
    ...
    {
        assertTrue(HistorySequencingOrder.BACKWARDS.toString().contains("HistorySequencingOrder"));
    }
}
