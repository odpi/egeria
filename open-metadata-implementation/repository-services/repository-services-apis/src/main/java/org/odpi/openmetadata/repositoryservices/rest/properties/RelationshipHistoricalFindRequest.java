...
/**
 * RelationshipPropertyHistoricalFindRequest provides an extension to the search parameters to include the
...
public class RelationshipHistoricalFindRequest extends RelationshipFindRequest
{
     ...
     * Default constructor
     */
    public RelationshipHistoricalFindRequest()
    {
        super();
    }
     ...
     */
    public RelationshipHistoricalFindRequest(RelationshipHistoricalFindRequest template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof RelationshipHistoricalFindRequest that))
        {
            return false;
        }
