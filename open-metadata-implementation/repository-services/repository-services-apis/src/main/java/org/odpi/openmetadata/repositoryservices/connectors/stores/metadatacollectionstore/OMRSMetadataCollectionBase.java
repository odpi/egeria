...
public abstract class OMRSMetadataCollectionBase extends OMRSMetadataCollection
{
                                                                         ...
                                                                         UserNotAuthorizedException
    {
        ...
        /*
         * Perform operation - default implementation counts the results of the equivalent unrestricted find.
         */
    ...
    /**
     * Return a count of the relationships that match the requested conditions.  This default implementation calls
     * findRelationships() and counts the results.  Subclasses whose repository can answer a count more efficiently
     * (for example, with a database COUNT query) should override this method.
     *
     * @param userId unique identifier for requesting user.
     * @param relationshipTypeGUID unique identifier (guid) for the relationship's type.  Null means all types
