...
public class InvalidTypeDefException extends OMRSCheckedExceptionBase
{
     ...
     */
    public InvalidTypeDefException(ExceptionMessageDefinition messageDefinition,
                                   String                     className,
     ...
     * @param relatedProperties  arbitrary properties that may help with diagnosing the problem.
     */
    public InvalidTypeDefException(int                 httpCode,
                                   String              className,
                                   String              actionDescription,
                                   String              errorMessage,
     ...
     */
    @Deprecated
    public InvalidTypeDefException(int httpCode, String className, String  actionDescription, String errorMessage, String systemAction, String userAction, Exception caughtException)
    {
