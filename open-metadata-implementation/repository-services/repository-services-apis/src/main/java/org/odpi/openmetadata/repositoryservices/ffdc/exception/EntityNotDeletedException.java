...
public class EntityNotDeletedException extends OMRSCheckedExceptionBase
{
     ...
     * @param relatedProperties  arbitrary properties that may help with diagnosing the problem.
     */
    public EntityNotDeletedException(int                 httpCode,
                                     String              className,
                                     String              actionDescription,
                                     String              errorMessage,
     ...
     */
    @Deprecated
    public EntityNotDeletedException(int  httpCode, String className, String  actionDescription, String errorMessage, String systemAction, String userAction, Exception caughtError)
    {
