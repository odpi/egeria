...
public class RelationshipConflictException extends OMRSCheckedExceptionBase
{
     ...
     */
    public RelationshipConflictException(ExceptionMessageDefinition messageDefinition,
                                         String                     className,
     ...
     * @param relatedProperties  arbitrary properties that may help with diagnosing the problem.
     */
    public RelationshipConflictException(int                 httpCode,
                                         String              className,
                                         String              actionDescription,
                                         String              errorMessage,
     ...
     */
    @Deprecated
    public RelationshipConflictException(int httpCode, String className, String  actionDescription, String errorMessage, String systemAction, String userAction, Exception caughtException)
    {
