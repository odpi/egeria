...
public enum OMRSErrorCode
{
    ...
    NULL_AS_OF_TIME(400, "OMRS-REPOSITORY-400-057 ",
            ...
            "The system is unable continue processing the request because there is an error n the caller of the method.",
            "Correct the caller and retry the request."),
    ...
    DUPLICATE_INSTANCE_IN_ARCHIVE(400, "OMRS-ARCHIVEBUILDER-400-002 ",
    ...
    DUPLICATE_TYPENAME_IN_ARCHIVE(400, "OMRS-ARCHIVEBUILDER-400-003 ",
            "The same type name {0} has been added twice to an open metadata archive. First version was {1} and the second was {2}.",
            "The build of the archive terminates.",
            "Verify the definition of the types being added to the archive. Once the definitions have been corrected, rerun the request."),
    DUPLICATE_GUID_IN_ARCHIVE(400, "OMRS-ARCHIVEBUILDER-400-004 ",
    ...
    MISSING_TYPE_IN_ARCHIVE(400, "OMRS-ARCHIVEBUILDER-400-005 ",
            "The type {0} of category {1} is not found in an open metadata archive.",
            "The build of the archive terminates.",
            "Verify the definition of the elements being added to the archive. Once the definitions have been corrected, rerun the request."),
    MISSING_NAME_FOR_ARCHIVE(400, "OMRS-ARCHIVEBUILDER-400-006 ",
            "A request for a type from category {0} passed a null name.",
            "The build of the archive terminates.",
            "Verify the definition of the elements being added to the archive. Once the definitions have been corrected, rerun the request."),
    DUPLICATE_ENDDEF1_NAME_IN_ARCHIVE(400, "OMRS-ARCHIVEBUILDER-400-007 ",
            ...
            "The build of the archive terminates.",
            "Verify the definition of the types being added to the archive. Once the definitions have been corrected, rerun the request."),
    DUPLICATE_ENDDEF2_NAME_IN_ARCHIVE(400, "OMRS-ARCHIVEBUILDER-400-008 ",
            ...
            "The build of the archive terminates.",
            "Verify the definition of the types being added to the archive. Once the definitions have been corrected, rerun the request."),
    DUPLICATE_RELATIONSHIP_ATTR_IN_ARCHIVE(400, "OMRS-ARCHIVEBUILDER-400-009 ",
            "Duplicate attribute name {0} is defined in RelationshipDef {1}.",
            "The build of the archive terminates.",
            "Verify the definition of the types being added to the archive. Once the definitions have been corrected, rerun the request."),
    DUPLICATE_ENTITY_ATTR_IN_ARCHIVE(400, "OMRS-ARCHIVEBUILDER-400-010 ",
            "Duplicate attribute name {0} is defined in EntityDef {1}.",
            "The build of the archive terminates.",
            "Verify the definition of the types being added to the archive. Once the definitions have been corrected, rerun the request."),
    DUPLICATE_CLASSIFICATION_ATTR_IN_ARCHIVE(400, "OMRS-ARCHIVEBUILDER-400-011 ",
            "Duplicate attribute name {0} is defined in ClassificationDef {1}.",
            "The build of the archive terminates.",
            "Verify the definition of the types being added to the archive. Once the definitions have been corrected, rerun the request."),
    BLANK_TYPENAME_IN_ARCHIVE(400, "OMRS-ARCHIVEBUILDER-400-012 ",
    ...
    NULL_LOG_RECORD_ORIGINATOR(400, "OMRS-AUDITLOG-400-002 ",
    ...
    NO_REST_CLIENT(503, "OMRS-REST-API-503-003 ",
    ...
    CLIENT_SIDE_REST_API_ERROR(503, "OMRS-REST-API-503-004 ",
