...
public enum OMRSErrorCode
{
    ...
    HOME_REFRESH(400, "OMRS-REPOSITORY-400-062 ",
    ...
    UNKNOWN_GUID(400, "OMRS-REPOSITORY-400-063 ",
            ...
            "The system is unable to process the request.",
            "Review the error message and other diagnostics created at the same time."),
    UNSUPPORTED_TYPE_HEADER_VERSION(400, "OMRS-REPOSITORY-400-064 ",
    ...
    UNSUPPORTED_INSTANCE_HEADER_VERSION(400, "OMRS-REPOSITORY-400-065 ",
            ...
            "The system is unable to process the request.",
            "The repository is sharing metadata with a repository of greater capability and the local repository is unable to work with its types.  It may be time to upgrade the local repository."),
    INVALID_PATCH_VERSION(400, "OMRS-REPOSITORY-400-66 ",
    ...
    INCOMPATIBLE_PATCH_VERSION(400, "OMRS-REPOSITORY-400-067 ",
    ...
    NULL_MANDATORY_PATCH_FIELD(400, "OMRS-REPOSITORY-400-068 ",
            ...
            "The system is unable to process the patch because it is invalid.",
            "Correct the source of the patch and then try reloading it."),
    INCOMPATIBLE_PROPERTY_PATCH(400, "OMRS-REPOSITORY-400-069 ",
