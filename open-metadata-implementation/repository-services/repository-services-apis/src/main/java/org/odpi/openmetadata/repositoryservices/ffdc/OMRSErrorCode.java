...
public enum OMRSErrorCode implements ExceptionMessageSet
{
    ...
    INVALID_LIST_CONDITION(400, "OMRS-REPOSITORY-400-076",
            ...
            "Reivew the request payload and ensure that an ArrayPropertyValue is provided when using the IN operator."),
    INVALID_LIKE_CONDITION(400, "OMRS-REPOSITORY-400-077",
            ...
            "Reivew the request payload and ensure that a PrimitivePropertyValue of type OM_PRIMITIVE_TYPE_STRING is provided when using the LIKE operator."),
    INVALID_NUMERIC_CONDITION(400, "OMRS-REPOSITORY-400-078",
            ...
            "Reivew the request payload and ensure that a PrimitivePropertyValue of a date or numeric type is provided when using the provided operator."),
