...
class PlatformServicesRESTClient extends FFDCRESTClient
{
    ...
    /**
     * Issue a GET REST call that returns a list of names object.
     *
     * @param methodName  name of the method being called.
     * @param urlTemplate template of the URL for the REST API with place-holders for the parameters.
     * @param params      a list of parameters that are slotted into the url template.
    ...
    /**
     * Issue a GET REST call that returns a SecurityAccessControl object.
     *
     * @param methodName  name of the method being called.
     * @param urlTemplate template of the URL for the REST API with place-holders for the parameters.
     * @param params      a list of parameters that are slotted into the url template.
     ...
     * @throws PropertyServerException the repository is not available or not working properly.
     */
    SecurityAccessControlResponse callSecurityAccessControlResponseGetRESTCall(String    methodName,
                                                                               String    urlTemplate,
                                                                               Object... params) throws InvalidParameterException,
                                                                                                        UserNotAuthorizedException,
                                                                                                        PropertyServerException
    {
        SecurityAccessControlResponse restResult = this.callGetRESTCall(methodName, SecurityAccessControlResponse.class, urlTemplate, params);
