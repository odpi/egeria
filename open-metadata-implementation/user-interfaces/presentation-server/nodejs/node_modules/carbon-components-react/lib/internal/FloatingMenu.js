  ...
  _createClass(FloatingMenu, [{
    ...
    value: function render() {
      if (typeof document !== 'undefined') {
        ...
        return _reactDom.default.createPortal(_react.default.createElement(_react.default.Fragment, null, _react.default.createElement("span", {
          ref: this.startSentinel,
          tabIndex: "0",
          role: "link",
          className: "".concat(prefix, "--visually-hidden")
        }, "Focus sentinel"), this._getChildrenWithProps(), _react.default.createElement("span", {
