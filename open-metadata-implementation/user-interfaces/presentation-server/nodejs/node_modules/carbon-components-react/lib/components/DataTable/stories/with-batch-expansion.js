...
var _default = function _default(props) {
  return _react.default.createElement(_DataTable.default, _extends({
    ...
    render: function render(_ref) {
      ...
      }, getTableContainerProps()), _react.default.createElement(_DataTable.Table, getTableProps(), _react.default.createElement(_DataTable.TableHead, null, _react.default.createElement(_DataTable.TableRow, null, _react.default.createElement(_DataTable.TableExpandHeader, _extends({
        enableExpando: true
