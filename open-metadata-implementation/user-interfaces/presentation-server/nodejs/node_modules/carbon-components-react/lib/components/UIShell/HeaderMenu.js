...
var defaultRenderMenuContent = function defaultRenderMenuContent() {
  return _react.default.createElement(_iconsReact.ChevronDown16, {
...
function (_React$Component) {
  ...
  function HeaderMenu(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_subMenus", _react.default.createRef());
...
var HeaderMenuForwardRef = _react.default.forwardRef(function (props, ref) {
