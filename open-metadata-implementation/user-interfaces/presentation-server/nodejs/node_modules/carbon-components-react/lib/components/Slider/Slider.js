    ...
    _defineProperty(_assertThisInitialized(_this), "calcValue", function (evt, prevState, props) {
      ...
      if (evt) {
        ...
        if (type === 'keydown') {
          ...
          var multiplyStep = stepMuliplier || stepMultiplier;

          if (direction !== undefined) {
            var multiplier = evt.shiftKey === true ? range / step / multiplyStep : 1;
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: "".concat(prefix, "--slider__range-label")
      }, formatLabel(max, maxLabel)), !hideTextInput && _react.default.createElement("input", {
        type: inputType,
