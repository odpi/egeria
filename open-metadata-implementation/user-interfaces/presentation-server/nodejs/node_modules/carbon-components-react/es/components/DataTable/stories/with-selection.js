...
export default (function (props) {
  return React.createElement(DataTable, _extends({
    ...
    render: function render(_ref) {
      ...
      }, getTableContainerProps()), React.createElement(Table, getTableProps(), React.createElement(TableHead, null, React.createElement(TableRow, null, React.createElement(TableSelectAll, getSelectionProps()), headers.map(function (header) {
