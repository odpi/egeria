...
describe('Tile', function () {
  describe('Renders default tile as expected', function () {
    ...
    it('supports light version', function () {
      var wrapper = mount(React.createElement(Tile, null, "Test"));
  ...
  describe('Renders clickable tile as expected', function () {
    ...
    it('supports light version', function () {
      var wrapper = mount(React.createElement(ClickableTile, null, "Test"));
      expect(wrapper.props().light).toEqual(false);
      expect(wrapper.childAt(0).hasClass("".concat(prefix, "--tile--light"))).toEqual(false);
      wrapper.setProps({
        light: true
  ...
  describe('Renders selectable tile as expected', function () {
    ...
    var label;
    beforeEach(function () {
      wrapper = mount(React.createElement(SelectableTile, {
        className: "extra-class"
      }, React.createElement("div", {
        className: "child"
      }, "Test")));
    ...
    it('supports light version', function () {
      var wrapper = mount(React.createElement(SelectableTile, null, "Test"));
      expect(wrapper.props().light).toEqual(false);
  ...
  describe('Renders expandable tile as expected', function () {
    ...
    it('supports light version', function () {
      var wrapper = mount(React.createElement(ExpandableTile, null, "Test"));
      expect(wrapper.props().light).toEqual(false);
      expect(wrapper.childAt(0).hasClass("".concat(prefix, "--tile--light"))).toEqual(false);
      wrapper.setProps({
        light: true
