...
export default function EntityDisplay(props) {
    ...
    return (
      <div className="instance-details-container">
        ...
        <div className="instance-details-item"><InstancePropertiesDisplay properties={entity.properties} /></div>     
        <div className="instance-details-item">Classifications:</div>
        <div className="instance-details-item"><InstanceClassificationsDisplay classifications={entity.classifications} /></div>  
        ...
        <div className="instance-details-item">OMRS Control Properties:
          <ul className="details-sublist">
            ...
            <li className="details-sublist-item">maintainedBy : 
              <ul className="details-sublist">
                {entity.maintainedBy ? entity.maintainedBy.sort().map( (mtr) => <li className="details-sublist-item" key={mtr}> {mtr}</li> ) : <li>list is empty</li>}       
              </ul>
            </li>
