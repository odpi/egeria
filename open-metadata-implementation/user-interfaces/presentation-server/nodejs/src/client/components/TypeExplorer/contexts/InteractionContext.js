...
const InteractionContextProvider = (props) => {
   ...
   * TexViewServiceException. The main fields to note are (with example values):
   *  relatedHTTPCode                 :  400,
   *  exceptionClassName              : 'org.odpi.openmetadata.viewservices.tex.api.ffdc.TexViewServiceException',
   ...
   *  exceptionErrorMessageId         : 'OMVS-TYPE-EXPLORER-400-006',
