...
class AssetLineageView extends PolymerElement {
  static get template() {
    ...
    <div>
    <vaadin-radio-group id ="radioViews" class="select-option-group" name="radio-group" value="COLUMN_VIEW"  role="radiogroup" >
      <vaadin-radio-button value="COLUMN_VIEW" class="select-option" role="radio" type="radio">Column View</vaadin-radio-button>
      <vaadin-radio-button value="TABLE_VIEW" class="select-option" role="radio" type="radio">Table view</vaadin-radio-button>
    </vaadin-radio-group>
    </div>
