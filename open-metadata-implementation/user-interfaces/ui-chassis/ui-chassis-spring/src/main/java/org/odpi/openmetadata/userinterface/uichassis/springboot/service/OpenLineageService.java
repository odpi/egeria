...
import org.odpi.openmetadata.userinterface.uichassis.springboot.service.response.Response;
import org.odpi.openmetadata.userinterface.uichassis.springboot.service.response.Vertice;
...
public class OpenLineageService {
     ...
     * @return map of nodes and edges describing the end to end flow
     */
    private List<Edge> createEdges(String idRoot, String key, List<org.odpi.openmetadata.userinterface.uichassis.springboot.service.response.Edge> edges) {
