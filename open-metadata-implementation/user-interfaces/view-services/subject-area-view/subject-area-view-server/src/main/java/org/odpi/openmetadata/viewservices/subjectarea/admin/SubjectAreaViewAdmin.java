...
public class SubjectAreaViewAdmin extends ViewServiceAdmin
{
    ...
    protected void createViewServicesInstance(String serverName,
        ...
        try {
            ...
            String           errorMessage = errorCode.getErrorMessageId() + errorCode.getFormattedErrorMessage(ViewServiceDescription.SUBJECT_AREA.getViewServiceName(), e.getInvalidPropertyName());
    ...
    protected ViewServiceConfig validateAndExpandViewServicesConfigurationProperties(ViewServiceConfig viewServiceConfigurationProperties) throws OMAGConfigurationErrorException {
        return validateAndExpandViewServicesConfigurationProperties(viewServiceConfigurationProperties, ViewServiceDescription.SUBJECT_AREA);
