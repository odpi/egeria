...
public class ViewServiceConfig extends UIAdminServicesConfigHeader
{
    ...
    private ViewServiceOperationalStatus   viewOperationalStatus = null;
     ...
     */
    public void setViewServiceOperationalStatus(ViewServiceOperationalStatus viewOperationalStatus)
    {
    ...
    public int hashCode()
    {
        return Objects.hash(getViewServiceId(), getViewServiceAdminClass(), getViewServiceName(), getViewServiceURLMarker(),
