...
public enum UIAdminErrorCode
{
    ...
    NULL_SERVER_CONFIG(400, "UI-ADMIN-400-008 ",
    ...
    NULL_REPOSITORY_CONFIG(400, "UI-ADMIN-400-009 ",
    ...
    BAD_CONFIG_FILE(400, "UI-ADMIN-400-012 ",
    ...
    BAD_MAX_PAGE_SIZE(400, "UI-ADMIN-400-013 ",
    ...
    EMPTY_CONFIGURATION(400, "UI-ADMIN-400-018 ",
