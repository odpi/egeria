...
/**
 * The UserNotAuthorizedException is thrown by the UI when a userId passed on a request is not
 * authorized to perform the requested action.
 */
public class UserNotAuthorizedException extends UICheckedExceptionBase
{
