...
To run the resulting image from the command line, use `docker run -p 7443:7443 -p 9092:9092 odpi/egeria-platform:{tagName}`, again replacing `{tagName}` with your chosen tag.
