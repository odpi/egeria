...
//    }
    ...
    public EntitySummary callOMRSClassifyEntity(String userId,
                                               String entityGUID,
        ...
        EntitySummary entity =  getOMRSMetadataCollection().classifyEntity(userId, entityGUID, classificationName, instanceProperties);
