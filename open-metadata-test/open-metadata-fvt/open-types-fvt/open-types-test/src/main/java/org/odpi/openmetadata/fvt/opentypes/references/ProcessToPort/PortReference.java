...
package org.odpi.openmetadata.fvt.opentypes.references.ProcessToPort;
 ...
 * and references.
 *
 * This Reference is called PortReference. It is used in type Process to represent a
...
public class PortReference extends Reference implements Serializable {
    ...
    final static protected String relationship_Type = "ProcessPort";
