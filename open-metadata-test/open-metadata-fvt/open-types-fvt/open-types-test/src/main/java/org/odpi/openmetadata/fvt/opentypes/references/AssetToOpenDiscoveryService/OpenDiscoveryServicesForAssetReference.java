...
package org.odpi.openmetadata.fvt.opentypes.references.AssetToOpenDiscoveryService;
 ...
 * and references.
 *
 * This Reference is called OpenDiscoveryServicesForAssetReference. It is used in type Asset to represent a
 * reference to an OMAS entity of type openDiscoveryService. The reference also contains information
...
public class OpenDiscoveryServicesForAssetReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(OpenDiscoveryServicesForAssetReference.class);
    private static final String className = OpenDiscoveryServicesForAssetReference.class.getName();

    final static protected String relationship_Type = "AssetDiscoveryService";
    protected OpenDiscoveryService openDiscoveryService =null;



    public OpenDiscoveryService getOpenDiscoveryService() {
        return  openDiscoveryService;
    }
    public void setOpenDiscoveryService(OpenDiscoveryService openDiscoveryService) {
        this.openDiscoveryService = openDiscoveryService;
    }


    public OpenDiscoveryServicesForAssetReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public OpenDiscoveryServicesForAssetReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public OpenDiscoveryServicesForAssetReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public OpenDiscoveryServicesForAssetReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public OpenDiscoveryServicesForAssetReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public OpenDiscoveryServicesForAssetReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public OpenDiscoveryServicesForAssetReference(String entityGuid, OMRSLine line) {
    ...
    public OpenDiscoveryServicesForAssetReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        OpenDiscoveryServicesForAssetReference typedThat =(OpenDiscoveryServicesForAssetReference)that;
