...
package org.odpi.openmetadata.fvt.opentypes.references.SchemaLinkElementToSchemaType;
...
public class LinkedTypesReference extends Reference implements Serializable {
    ...
    final static protected String relationship_Type = "LinkedType";
    ...
    public LinkedTypesReference(Reference other) {
       ...
       * @param line OMRSLine
       */
    public LinkedTypesReference(String entityGuid, OMRSLine line) {
