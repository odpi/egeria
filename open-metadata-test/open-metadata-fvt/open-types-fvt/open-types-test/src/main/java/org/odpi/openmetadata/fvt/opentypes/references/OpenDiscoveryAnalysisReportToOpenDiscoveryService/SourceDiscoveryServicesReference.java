...
package org.odpi.openmetadata.fvt.opentypes.references.OpenDiscoveryAnalysisReportToOpenDiscoveryService;
 ...
 * and references.
 *
 * This Reference is called SourceDiscoveryServicesReference. It is used in type OpenDiscoveryAnalysisReport to represent a
...
public class SourceDiscoveryServicesReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(SourceDiscoveryServicesReference.class);
    private static final String className = SourceDiscoveryServicesReference.class.getName();

    final static protected String relationship_Type = "DiscoveryInvocationReport";
    ...
    public SourceDiscoveryServicesReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public SourceDiscoveryServicesReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public SourceDiscoveryServicesReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public SourceDiscoveryServicesReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public SourceDiscoveryServicesReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public SourceDiscoveryServicesReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public SourceDiscoveryServicesReference(String entityGuid, OMRSLine line) {
    ...
    public SourceDiscoveryServicesReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        SourceDiscoveryServicesReference typedThat =(SourceDiscoveryServicesReference)that;
