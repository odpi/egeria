 ...
 * and references.
 *
 * This Reference is called ConsumingProcessReference. It is used in type Process to represent a
...
public class ConsumingProcessReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(ConsumingProcessReference.class);
    private static final String className = ConsumingProcessReference.class.getName();
    ...
    public ConsumingProcessReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public ConsumingProcessReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public ConsumingProcessReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public ConsumingProcessReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public ConsumingProcessReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public ConsumingProcessReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public ConsumingProcessReference(String entityGuid, OMRSLine line) {
    ...
    public ConsumingProcessReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        ConsumingProcessReference typedThat =(ConsumingProcessReference)that;
