...
package org.odpi.openmetadata.fvt.opentypes.references.DeployedAPIToAsset;
 ...
 * and references.
 *
 * This Reference is called ImplementationResourceReference. It is used in type DeployedAPI to represent a
...
public class ImplementationResourceReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(ImplementationResourceReference.class);
    private static final String className = ImplementationResourceReference.class.getName();
    ...
    public ImplementationResourceReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public ImplementationResourceReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public ImplementationResourceReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public ImplementationResourceReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public ImplementationResourceReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public ImplementationResourceReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public ImplementationResourceReference(String entityGuid, OMRSLine line) {
    ...
    public ImplementationResourceReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        ImplementationResourceReference typedThat =(ImplementationResourceReference)that;
