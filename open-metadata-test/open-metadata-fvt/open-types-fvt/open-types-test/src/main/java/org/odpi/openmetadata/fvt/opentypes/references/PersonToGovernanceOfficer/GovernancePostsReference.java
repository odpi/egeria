...
package org.odpi.openmetadata.fvt.opentypes.references.PersonToGovernanceOfficer;
 ...
 * and references.
 *
 * This Reference is called GovernancePostsReference. It is used in type Person to represent a
 * reference to an OMAS entity of type governanceOfficer. The reference also contains information
...
public class GovernancePostsReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(GovernancePostsReference.class);
    private static final String className = GovernancePostsReference.class.getName();

    final static protected String relationship_Type = "GovernancePost";
    protected GovernanceOfficer governanceOfficer =null;
    ...
    public void setGovernanceOfficer(GovernanceOfficer governanceOfficer) {
        this.governanceOfficer = governanceOfficer;
    }


    public GovernancePostsReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public GovernancePostsReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public GovernancePostsReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public GovernancePostsReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public GovernancePostsReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public GovernancePostsReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public GovernancePostsReference(String entityGuid, OMRSLine line) {
    ...
    public GovernancePostsReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        GovernancePostsReference typedThat =(GovernancePostsReference)that;
