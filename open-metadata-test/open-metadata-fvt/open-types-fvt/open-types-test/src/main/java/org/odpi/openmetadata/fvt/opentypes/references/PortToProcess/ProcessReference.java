...
package org.odpi.openmetadata.fvt.opentypes.references.PortToProcess;
 ...
 * and references.
 *
 * This Reference is called ProcessReference. It is used in type Port to represent a
...
public class ProcessReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(ProcessReference.class);
    private static final String className = ProcessReference.class.getName();
    ...
    public ProcessReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public ProcessReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public ProcessReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public ProcessReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public ProcessReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public ProcessReference(String entityGuid, OMRSLine line) {
    ...
    public ProcessReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        ProcessReference typedThat =(ProcessReference)that;
