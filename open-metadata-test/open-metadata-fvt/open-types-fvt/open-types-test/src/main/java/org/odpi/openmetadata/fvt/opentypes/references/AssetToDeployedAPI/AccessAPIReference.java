...
package org.odpi.openmetadata.fvt.opentypes.references.AssetToDeployedAPI;
 ...
 * and references.
 *
 * This Reference is called AccessAPIReference. It is used in type Asset to represent a
...
public class AccessAPIReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(AccessAPIReference.class);
    private static final String className = AccessAPIReference.class.getName();

    final static protected String relationship_Type = "AssetWire";
    ...
    public AccessAPIReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public AccessAPIReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public AccessAPIReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public AccessAPIReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public AccessAPIReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public AccessAPIReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public AccessAPIReference(String entityGuid, OMRSLine line) {
    ...
    public AccessAPIReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        AccessAPIReference typedThat =(AccessAPIReference)that;
