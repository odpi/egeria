 ...
 * and references.
 *
 * This Reference is called SubPortReference. It is used in type Port to represent a
...
public class SubPortReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(SubPortReference.class);
    private static final String className = SubPortReference.class.getName();
    ...
    public SubPortReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public SubPortReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public SubPortReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public SubPortReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public SubPortReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public SubPortReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public SubPortReference(String entityGuid, OMRSLine line) {
    ...
    public SubPortReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        SubPortReference typedThat =(SubPortReference)that;
