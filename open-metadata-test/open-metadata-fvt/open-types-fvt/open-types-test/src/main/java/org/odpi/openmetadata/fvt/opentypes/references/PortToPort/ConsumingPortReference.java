 ...
 * and references.
 *
 * This Reference is called ConsumingPortReference. It is used in type Port to represent a
...
public class ConsumingPortReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(ConsumingPortReference.class);
    private static final String className = ConsumingPortReference.class.getName();

    final static protected String relationship_Type = "ParentPort";
    ...
    public ConsumingPortReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public ConsumingPortReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public ConsumingPortReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public ConsumingPortReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public ConsumingPortReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public ConsumingPortReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public ConsumingPortReference(String entityGuid, OMRSLine line) {
    ...
    public ConsumingPortReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        ConsumingPortReference typedThat =(ConsumingPortReference)that;
