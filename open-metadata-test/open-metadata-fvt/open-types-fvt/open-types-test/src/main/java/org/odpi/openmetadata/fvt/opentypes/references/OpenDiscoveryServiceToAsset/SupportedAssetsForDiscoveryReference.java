...
package org.odpi.openmetadata.fvt.opentypes.references.OpenDiscoveryServiceToAsset;
 ...
 * and references.
 *
 * This Reference is called SupportedAssetsForDiscoveryReference. It is used in type OpenDiscoveryService to represent a
 * reference to an OMAS entity of type asset. The reference also contains information
...
public class SupportedAssetsForDiscoveryReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(SupportedAssetsForDiscoveryReference.class);
    private static final String className = SupportedAssetsForDiscoveryReference.class.getName();
    ...
    public SupportedAssetsForDiscoveryReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public SupportedAssetsForDiscoveryReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public SupportedAssetsForDiscoveryReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public SupportedAssetsForDiscoveryReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public SupportedAssetsForDiscoveryReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public SupportedAssetsForDiscoveryReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public SupportedAssetsForDiscoveryReference(String entityGuid, OMRSLine line) {
    ...
    public SupportedAssetsForDiscoveryReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        SupportedAssetsForDiscoveryReference typedThat =(SupportedAssetsForDiscoveryReference)that;
