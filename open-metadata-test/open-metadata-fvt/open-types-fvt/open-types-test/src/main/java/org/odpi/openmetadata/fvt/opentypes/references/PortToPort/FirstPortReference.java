...
package org.odpi.openmetadata.fvt.opentypes.references.PortToPort;
 ...
 * and references.
 *
 * This Reference is called FirstPortReference. It is used in type Port to represent a
 * reference to an OMAS entity of type port. The reference also contains information
...
public class FirstPortReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(FirstPortReference.class);
    private static final String className = FirstPortReference.class.getName();

    final static protected String relationship_Type = "PortWire";
    ...
    public FirstPortReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public FirstPortReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public FirstPortReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public FirstPortReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public FirstPortReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public FirstPortReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public FirstPortReference(String entityGuid, OMRSLine line) {
    ...
    public FirstPortReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        FirstPortReference typedThat =(FirstPortReference)that;
