...
package org.odpi.openmetadata.fvt.opentypes.references.ProcessToProcess;
 ...
 * and references.
 *
 * This Reference is called SubProcessReference. It is used in type Process to represent a
...
public class SubProcessReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(SubProcessReference.class);
    private static final String className = SubProcessReference.class.getName();

    final static protected String relationship_Type = "ProcessHierarchy";
    ...
    public SubProcessReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public SubProcessReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public SubProcessReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public SubProcessReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public SubProcessReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public SubProcessReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public SubProcessReference(String entityGuid, OMRSLine line) {
    ...
    public SubProcessReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        SubProcessReference typedThat =(SubProcessReference)that;
