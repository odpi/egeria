...
package org.odpi.openmetadata.fvt.opentypes.references.ConnectionToOpenDiscoveryService;
 ...
 * and references.
 *
 * This Reference is called ImplementedDiscoveryServiceReference. It is used in type Connection to represent a
...
public class ImplementedDiscoveryServiceReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(ImplementedDiscoveryServiceReference.class);
    private static final String className = ImplementedDiscoveryServiceReference.class.getName();

    final static protected String relationship_Type = "DiscoveryServiceImplementation";
    ...
    public ImplementedDiscoveryServiceReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public ImplementedDiscoveryServiceReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public ImplementedDiscoveryServiceReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public ImplementedDiscoveryServiceReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public ImplementedDiscoveryServiceReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public ImplementedDiscoveryServiceReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public ImplementedDiscoveryServiceReference(String entityGuid, OMRSLine line) {
    ...
    public ImplementedDiscoveryServiceReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        ImplementedDiscoveryServiceReference typedThat =(ImplementedDiscoveryServiceReference)that;
