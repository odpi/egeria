 ...
 * and references.
 *
 * This Reference is called SecondPortReference. It is used in type Port to represent a
...
public class SecondPortReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(SecondPortReference.class);
    private static final String className = SecondPortReference.class.getName();
    ...
    public SecondPortReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public SecondPortReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public SecondPortReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public SecondPortReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public SecondPortReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public SecondPortReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public SecondPortReference(String entityGuid, OMRSLine line) {
    ...
    public SecondPortReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        SecondPortReference typedThat =(SecondPortReference)that;
