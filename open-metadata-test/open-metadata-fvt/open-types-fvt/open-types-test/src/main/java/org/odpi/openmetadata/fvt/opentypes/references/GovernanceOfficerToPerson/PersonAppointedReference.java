...
package org.odpi.openmetadata.fvt.opentypes.references.GovernanceOfficerToPerson;
 ...
 * and references.
 *
 * This Reference is called PersonAppointedReference. It is used in type GovernanceOfficer to represent a
 * reference to an OMAS entity of type person. The reference also contains information
...
public class PersonAppointedReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(PersonAppointedReference.class);
    private static final String className = PersonAppointedReference.class.getName();
    ...
    public PersonAppointedReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public PersonAppointedReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public PersonAppointedReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public PersonAppointedReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public PersonAppointedReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public PersonAppointedReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public PersonAppointedReference(String entityGuid, OMRSLine line) {
    ...
    public PersonAppointedReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        PersonAppointedReference typedThat =(PersonAppointedReference)that;
