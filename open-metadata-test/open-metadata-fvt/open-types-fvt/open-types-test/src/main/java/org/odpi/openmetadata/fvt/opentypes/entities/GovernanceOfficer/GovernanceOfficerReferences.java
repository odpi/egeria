...
package org.odpi.openmetadata.fvt.opentypes.entities.GovernanceOfficer;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import org.odpi.openmetadata.repositoryservices.connectors.stores.metadatacollectionstore.properties.instances.Relationship;

import  org.odpi.openmetadata.fvt.opentypes.references.GovernanceOfficerToPerson.PersonAppointedReference;
...
/**
 * References for entity  GovernanceOfficer. References are relationships represented as an attribute. Exposing relationships information
 * as references can make the relationships information more digestable.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class GovernanceOfficerReferences implements Serializable {
    private static final Logger log = LoggerFactory.getLogger(GovernanceOfficerReferences.class);
    private static final String className = GovernanceOfficerReferences.class.getName();
    ...
    public static final String[] REFERENCE_NAMES_SET_VALUES = new String[] {
     ...
     /**
       * We are passed a set of omrs relationships that are associated with a entity GovernanceOfficer
       * Each of these relationships should map to a reference (a uniquely named attribute in GovernanceOfficer).
       *
       ...
       */
     public GovernanceOfficerReferences(String entityGuid, Set<Line> lines)  {
         ...
         for (Line relationships: lines) {
            for (int i=0;i< RELATIONSHIP_NAMES_SET_VALUES.length; i++) {
               if (relationships.getName().equals(RELATIONSHIP_NAMES_SET_VALUES[i])) {
                    ...
                    if ("personAppointed".equals(referenceName)) {
                         GovernancePost governancePost_relationship = (GovernancePost)relationships;
                         PersonAppointedReference personAppointedReference = new PersonAppointedReference(entityGuid,governancePost_relationship);
                         if ( personAppointed== null ) {
                              personAppointed = new HashSet();
                         }
                          personAppointed.add(personAppointedReference);
                    }
...
// Set properties
    ...
    private Set<PersonAppointedReference> personAppointed;
...
// Sets
    public Set<PersonAppointedReference> getPersonAppointedReferences() {
        return personAppointed;
    }

    public void setPersonAppointedReferences(Set<PersonAppointedReference> personAppointed) {
        this.personAppointed =personAppointed;
    }
...
// Lists
 ...
 public StringBuilder toString(StringBuilder sb) {
        ...
        sb.append("GovernanceOfficerReferences{");
        sb.append("personAppointedReference='").append(personAppointed.toString());
    ...
    public boolean equals(Object o) {
        ...
        if (!super.equals(o)) { return false; }
         GovernanceOfficerReferences typedThat = (GovernanceOfficerReferences) o;
      // compare single cardinality attributes
         if (this.personAppointed != null && !Objects.equals(this.personAppointed,typedThat.personAppointed)) {
                            return false;
                 }
