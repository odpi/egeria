...
package org.odpi.openmetadata.fvt.opentypes.references.PortToDeployedAPI;
 ...
 * and references.
 *
 * This Reference is called DeployedAPIReference. It is used in type Port to represent a
...
public class DeployedAPIReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(DeployedAPIReference.class);
    private static final String className = DeployedAPIReference.class.getName();
    ...
    public DeployedAPIReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public DeployedAPIReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public DeployedAPIReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public DeployedAPIReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public DeployedAPIReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public DeployedAPIReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public DeployedAPIReference(String entityGuid, OMRSLine line) {
    ...
    public DeployedAPIReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        DeployedAPIReference typedThat =(DeployedAPIReference)that;
