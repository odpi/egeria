...
package org.odpi.openmetadata.fvt.opentypes.references.OpenDiscoveryServiceToConnection;
 ...
 * and references.
 *
 * This Reference is called DiscoveryServiceConnectionReference. It is used in type OpenDiscoveryService to represent a
...
public class DiscoveryServiceConnectionReference extends Reference implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(DiscoveryServiceConnectionReference.class);
    private static final String className = DiscoveryServiceConnectionReference.class.getName();
    ...
    public DiscoveryServiceConnectionReference() {
        this(null, null, (Map<String, Object>) null);
    }

    public DiscoveryServiceConnectionReference(String guid) {
        this(guid, null, (Map<String, Object>) null);
    }

    public DiscoveryServiceConnectionReference(String guid, String relatedEndType) {
        this(guid, relatedEndType, (Map<String, Object>) null);
    }

    public DiscoveryServiceConnectionReference(String relatedEndType, Map<String, Object> uniqueAttributes) {
        this(null, relatedEndType, uniqueAttributes);
    }

    public DiscoveryServiceConnectionReference(String guid, String relatedEndType, Map<String, Object> uniqueAttributes) {
        setRelationshipGuid(guid);
        setRelatedEndType(relatedEndType);
        setUniqueAttributes(uniqueAttributes);
    }

    public DiscoveryServiceConnectionReference(Reference other) {
        if (other != null) {
       ...
       * @param line OMRSLine
       */
    public DiscoveryServiceConnectionReference(String entityGuid, OMRSLine line) {
    ...
    public DiscoveryServiceConnectionReference(Map objIdMap) {
        if (objIdMap != null) {
...
//  AtlasBaseTypeDef.dumpObjects(uniqueAttributes, sb);
    ...
    public boolean equals(Object o) {
        ...
        DiscoveryServiceConnectionReference typedThat =(DiscoveryServiceConnectionReference)that;
