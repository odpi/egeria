...
System.out.println("=== Enabling Discovery Engine OMAS: " + serverMem + " ===");
post2 = new URL(baseURL + "/open-metadata/admin-services/users/" + user + "/servers/" + serverMem + "/access-services/discovery-engine/no-topics" ).openConnection()
...
// --- Enable OMAS - any errors here and we exit
System.out.println("=== Enabling Discovery Engine OMAS: " + serverGraph + " ===");
post2g = new URL(baseURL + "/open-metadata/admin-services/users/" + user + "/servers/" + serverGraph + "/access-services/discovery-engine/no-topics" ).openConnection()
