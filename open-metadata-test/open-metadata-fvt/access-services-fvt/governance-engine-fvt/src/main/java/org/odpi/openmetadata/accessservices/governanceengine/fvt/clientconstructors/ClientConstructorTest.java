...
package org.odpi.openmetadata.accessservices.governanceengine.fvt.clientconstructors;
...
public class ClientConstructorTest
{
    ...
    {
       GovernanceEngineRESTClient restClient = new GovernanceEngineRESTClient(serverName, serverPlatformRootURL);

        new GovernanceEngineEventClient(serverName, serverPlatformRootURL, restClient, maxPageSize, auditLog, callerId);
    }
}
