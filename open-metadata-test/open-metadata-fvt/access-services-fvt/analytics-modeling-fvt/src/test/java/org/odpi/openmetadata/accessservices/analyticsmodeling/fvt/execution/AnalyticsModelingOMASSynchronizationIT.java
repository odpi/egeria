...
/**
 * AnalyticsModelingOMASSynchronizationIT is the failsafe wrapper for SynchronizationTest.
 */
public class AnalyticsModelingOMASSynchronizationIT
{
    @BeforeAll
    ...
    public void testSynchronization(String serverName)
    {
