...
public class GraphFVT {
    ...
    public void run() throws SubjectAreaFVTCheckedException, InvalidParameterException, PropertyServerException, UserNotAuthorizedException {
        ...
        // we only go one level so we expect the glossary 3 terms and 3 termanchors
        graph = getGraph(glossaryGuid,
                         null,
                         null,
                         null,
        ...
        try {
            getGraph("unknownguid",
                     null,
                     null,
                     null,
                     null
                    );
            throw new SubjectAreaFVTCheckedException("Expected an exception for unknown guid");
