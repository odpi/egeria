...
public abstract class AbstractGlossaryAuthor<T> implements SubjectAreaClient<T>, ResponseParameterization<T> {
    public static final String GLOSSARY_AUTHOR_BASE_URL = "/servers/%s/open-metadata/view-services/glossary-author/users/%s/";
    public static final String BASE_RELATIONSHIPS_URL = GLOSSARY_AUTHOR_BASE_URL + "relationships";

    protected final String BASE_URL;
    protected final SubjectAreaRestClient client;

    protected AbstractGlossaryAuthor(SubjectAreaRestClient client, String baseUrl) {
