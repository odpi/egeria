 ...
 * be read without having to know that "anonymousUser" meant files-fvt.
 */
@Configuration
@EnableWebSecurity
public class FilesFvtSecurityConfig
{
    @Bean
    public SecurityFilterChain filesFvtSecurityFilterChain(HttpSecurity http) throws Exception
    {
