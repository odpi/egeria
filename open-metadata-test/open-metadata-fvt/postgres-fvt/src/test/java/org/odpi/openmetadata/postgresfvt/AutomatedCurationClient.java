 ...
 * from the security context rather than from the request - {@link PostgresFvtSecurityConfig} is what makes
...
class AutomatedCurationClient
{
    ...
    List<TechnologyTypeSummary> findTechnologyTypes(String searchString) throws Exception
    {
        ...
        requestBody.setPageSize(PostgresFvtTestSupport.MAX_PAGE_SIZE);
