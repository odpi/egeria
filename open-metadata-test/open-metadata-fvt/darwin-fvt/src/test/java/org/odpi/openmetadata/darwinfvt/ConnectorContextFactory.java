 ...
 * platform - so that the darwin-fvt tests can drive its connector context clients (the generic
 ...
 * <br>
 * This is deliberately the same route Darwin itself takes to open metadata, so a test that reads the
...
{
    static final int MAX_PAGE_SIZE = DarwinFvtTestSupport.MAX_PAGE_SIZE;


    /**
     * Create a new connector context pointed at the darwin-fvt metadata access store.
     *
