 ...
 * be read without having to know that "anonymousUser" meant openlineage-fvt.
 */
@Configuration
@EnableWebSecurity
public class OpenLineageFvtSecurityConfig
{
    @Bean
    public SecurityFilterChain openLineageFvtSecurityFilterChain(HttpSecurity http) throws Exception
    {
