 ...
 * platform - so that the client-fvt tests can drive its connector context clients (the generic
...
class ConnectorContextFactory
{
     ...
     * the client-fvt server, whose ordinary "delete" calls perform a soft delete (the element remains
    ...
    /**
     * Create a new connector context backed by a fresh {@link EgeriaOpenMetadataStoreClient} pointed at
     * the client-fvt server, using the supplied delete method for any "delete" call made through it.
     *
