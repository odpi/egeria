 ...
 * platform - so that the templates-fvt tests can drive its connector context clients (the generic
...
class ConnectorContextFactory
{
     ...
     * the templates-fvt server, whose ordinary "delete" calls perform a soft delete (the element remains
    ...
    /**
     * Create a new connector context backed by a fresh {@link EgeriaOpenMetadataStoreClient} pointed at
     * the templates-fvt server, using the supplied delete method for any "delete" call made through it.
     *
