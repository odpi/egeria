...
This directory documents 54 messages in 14 message sets.  Return to the [messages and codes index](../../README.md).
...
| [BaudotAuditCode](BaudotAuditCode.md) | Audit log messages | `BAUDOT-SUBSCRIPTION-MANAGER-` | 3 | <https://egeria-project.org/concepts/notification-type/> |
...
| [JacquardAuditCode](JacquardAuditCode.md) | Audit log messages | `JACQUARD-HARVESTER-` | 17 | <https://egeria-project.org/patterns/harvest-and-publish/overview/> |
