...
This directory documents 113 messages in 18 message sets.  Return to the [messages and codes index](../../README.md).
...
| [DarwinAuditCode](DarwinAuditCode.md) | Audit log messages | `DARWIN-PRODUCT-DEPENDENCY-MANAGER-` | 15 |  |
| [DarwinErrorCode](DarwinErrorCode.md) | Exception messages | `DARWIN-PRODUCT-DEPENDENCY-MANAGER-500-` | 1 | <https://egeria-project.org/concepts/digital-product/> |
...
| [JacquardAuditCode](JacquardAuditCode.md) | Audit log messages | `JACQUARD-HARVESTER-` | 23 |  |
