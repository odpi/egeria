...
This directory documents 78 messages in 16 message sets.  Return to the [messages and codes index](../../README.md).
...
| [JacquardAuditCode](JacquardAuditCode.md) | Audit log messages | `JACQUARD-HARVESTER-` | 18 |  |
