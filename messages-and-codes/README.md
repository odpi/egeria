...
| [Nanny Connectors](connectors/nanny-connectors) | 14 | 54 | The nanny connectors harvest observability data from the open metadata ecosystem into a database so that the operation of Egeria itself can be analysed. |
...
| `BAUDOT-SUBSCRIPTION-MANAGER-` | Audit log messages | 3 | [BaudotAuditCode](connectors/nanny-connectors/BaudotAuditCode.md) |
...
| `OMAG-GENERIC-HANDLERS-` | Audit log messages | 13 | [GenericHandlersAuditCode](common-services/GenericHandlersAuditCode.md) |
...
| `OPEN-WATCHDOG-ACTION-` | Audit log messages | 1 | [OWFAuditCode](frameworks/OWFAuditCode.md) |
