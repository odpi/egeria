...
| **Message identifiers begin** | `OMVS-MY-PROFILE-` |
| **Java class** | `org.odpi.openmetadata.viewservices.myprofile.ffdc.MyProfileAuditCode` |
...
| **Source** | [MyProfileAuditCode.java](../../open-metadata-implementation/view-services/my-profile/my-profile-server/src/main/java/org/odpi/openmetadata/viewservices/myprofile/ffdc/MyProfileAuditCode.java) |
...
|---|---|---|
| [OMVS-MY-PROFILE-0001](#omvs-my-profile-0001) | STARTUP | The My Profile Open Metadata View Service (OMVS) is initializing |
| [OMVS-MY-PROFILE-0002](#omvs-my-profile-0002) | STARTUP | The My Profile Open Metadata View Service (OMVS) is initialized |
| [OMVS-MY-PROFILE-0003](#omvs-my-profile-0003) | SHUTDOWN | The My Profile Open Metadata View Service (OMVS) is shutting down |
| [OMVS-MY-PROFILE-0004](#omvs-my-profile-0004) | EXCEPTION | The My Profile Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0} |
| [OMVS-MY-PROFILE-0005](#omvs-my-profile-0005) | SHUTDOWN | The My Profile Open Metadata View Service (OMVS) is shutting down server instance {0} |

----

### OMVS-MY-PROFILE-0001

> The My Profile Open Metadata View Service (OMVS) is initializing

|  |  |
|---|---|
| **Java constant** | `MyProfileAuditCode.SERVICE_INITIALIZING` |
...
### OMVS-MY-PROFILE-0002

> The My Profile Open Metadata View Service (OMVS) is initialized

|  |  |
|---|---|
| **Java constant** | `MyProfileAuditCode.SERVICE_INITIALIZED` |
| **Severity** | STARTUP - A new component is starting up. |
| **Message inserts** | none |
...
### OMVS-MY-PROFILE-0003

> The My Profile Open Metadata View Service (OMVS) is shutting down

|  |  |
|---|---|
| **Java constant** | `MyProfileAuditCode.SERVICE_SHUTDOWN` |
...
### OMVS-MY-PROFILE-0004

> The My Profile Open Metadata View Service (OMVS) cannot initialize a new instance; error message is {0}

|  |  |
|---|---|
| **Java constant** | `MyProfileAuditCode.SERVICE_INSTANCE_FAILURE` |
