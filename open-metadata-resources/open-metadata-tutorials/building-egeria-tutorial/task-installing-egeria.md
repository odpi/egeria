...
$ ls
ls
archive-tmp					egeria-3.2-sources.tar.gz
egeria-3.2-distribution		maven-archiver
egeria-3.2-distribution.tar.gz		open-metadata-assemblies-3.2.jar
egeria-3.2-omag-server			rat.txt
egeria-3.2-omag-server.tar.gz
```
...
$ cd ../../../../egeria-install
$ ls
egeria-3.2-distribution.tar.gz
```

It is now possible to unpack the tar file.

```bash
$ tar -xf egeria-3.2-distribution.tar.gz
$ ls
egeria-3.2-distribution.tar.gz	egeria-omag-3.2
```

A new directory is created called **egeria-omag-3.2**.  Change to this
