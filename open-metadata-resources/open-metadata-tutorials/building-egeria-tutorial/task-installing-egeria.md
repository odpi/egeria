...
$ ls
ls
archive-tmp					egeria-3.0-SNAPSHOT-sources.tar.gz
egeria-3.0-SNAPSHOT-distribution		maven-archiver
egeria-3.0-SNAPSHOT-distribution.tar.gz		open-metadata-assemblies-3.0-SNAPSHOT.jar
egeria-3.0-SNAPSHOT-omag-server			rat.txt
egeria-3.0-SNAPSHOT-omag-server.tar.gz
```
...
the release is **egeria-3.0-SNAPSHOT**.
...
$ cd ../../../../egeria-install
$ ls
egeria-3.0-SNAPSHOT-distribution.tar.gz
```

It is now possible to unpack the tar file.

```bash
$ tar -xf egeria-3.0-SNAPSHOT-distribution.tar.gz
$ ls
egeria-3.0-SNAPSHOT-distribution.tar.gz	egeria-omag-3.0-SNAPSHOT
```

A new directory is created called **egeria-omag-3.0-SNAPSHOT**.  Change to this
new directory and list its contents as shown below.

```bash
$ cd egeria-omag-3.0-SNAPSHOT
$ ls
...
$ cd server
$ ls
$ resources				server-chassis-spring-3.0-SNAPSHOT.jar
```
