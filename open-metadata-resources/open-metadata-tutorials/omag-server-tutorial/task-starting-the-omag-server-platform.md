...
depend on the release of ODPi Egeria that you have installed.  In this example, the release is **1.3**.
...
```bash
$ java -jar server-chassis-spring-1.3.jar -Dserver.port=8080
```
