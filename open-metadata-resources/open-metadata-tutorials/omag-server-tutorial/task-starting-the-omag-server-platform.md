...
depend on the release of ODPi Egeria that you have installed.  In this example, the release is **3.1-SNAPSHOT**.
...
```bash
$ java -Dserver.port=9443 -jar server/server-chassis-spring-3.1-SNAPSHOT.jar
```
