...
depend on the release of ODPi Egeria that you have installed.  In this example, the release is **1.8**.
...
```bash
$ java -Dserver.port=8080 -jar server-chassis-spring-1.8.jar
```
