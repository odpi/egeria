...
depend on the release of ODPi Egeria that you have installed.  In this example, the release is **2.0**.
...
```bash
$ java -Dserver.port=9443 -jar server-chassis-spring-2.0.jar
```
