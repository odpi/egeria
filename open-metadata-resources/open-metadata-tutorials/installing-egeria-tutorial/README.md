...
$ ls
ls
archive-tmp					egeria-3.3-sources.tar.gz
egeria-3.3-distribution		maven-archiver
egeria-3.3-distribution.tar.gz		open-metadata-assemblies-3.3.jar
egeria-3.3-omag-server			rat.txt
egeria-3.3-omag-server.tar.gz
```
...
$ cd ../../../../egeria-install
$ ls
egeria-3.3-distribution.tar.gz
```

It is now possible to unpack the tar file.

```bash
$ tar -xf egeria-3.3-distribution.tar.gz
$ ls
egeria-3.3-distribution.tar.gz	egeria-omag-3.3
```

A new directory is created called **egeria-omag-3.3**.  Change to this
...
$ resources				server-chassis-spring-3.3.jar
```
