...
$ ls
ls
archive-tmp					egeria-3.6-SNAPSHOT-sources.tar.gz
egeria-3.6-SNAPSHOT-distribution		maven-archiver
egeria-3.6-SNAPSHOT-distribution.tar.gz		open-metadata-assemblies-3.6-SNAPSHOT.jar
egeria-3.6-SNAPSHOT-omag-server			rat.txt
egeria-3.6-SNAPSHOT-omag-server.tar.gz
```
...
the release is **egeria-3.6-SNAPSHOT**.
...
```bash
$ tar -xf egeria-3.6-SNAPSHOT-distribution.tar.gz
$ ls
egeria-3.6-SNAPSHOT-distribution.tar.gz	egeria-omag-3.6-SNAPSHOT
```

A new directory is created called **egeria-omag-3.6-SNAPSHOT**.  Change to this
new directory and list its contents as shown below.

```bash
$ cd egeria-omag-3.6-SNAPSHOT
$ ls
...
$ resources				server-chassis-spring-3.6-SNAPSHOT.jar
```
