...
$ ls
ls
archive-tmp					egeria-1.8-sources.tar.gz
egeria-1.8-distribution		maven-archiver
egeria-1.8-distribution.tar.gz		open-metadata-assemblies-1.8.jar
egeria-1.8-omag-server			rat.txt
egeria-1.8-omag-server.tar.gz
```
...
$ cd ../../../../egeria-install
$ ls
egeria-1.8-distribution.tar.gz
```

It is now possible to unpack the tar file.

```bash
$ tar -xf egeria-1.8-distribution.tar.gz
$ ls
egeria-1.8-distribution.tar.gz	egeria-omag-1.8
```

A new directory is created called **egeria-omag-1.8**.  Change to this
...
$ resources				server-chassis-spring-1.8.jar
```
