...
$ ls
ls
archive-tmp					egeria-1.7-SNAPSHOT-sources.tar.gz
egeria-1.7-SNAPSHOT-distribution		maven-archiver
egeria-1.7-SNAPSHOT-distribution.tar.gz		open-metadata-assemblies-1.7-SNAPSHOT.jar
egeria-1.7-SNAPSHOT-omag-server			rat.txt
egeria-1.7-SNAPSHOT-omag-server.tar.gz
```
...
the release is **egeria-1.7-SNAPSHOT**.
...
$ cd ../../../../egeria-install
$ ls
egeria-1.7-SNAPSHOT-distribution.tar.gz
```

It is now possible to unpack the tar file.

```bash
$ tar -xf egeria-1.7-SNAPSHOT-distribution.tar.gz
$ ls
egeria-1.7-SNAPSHOT-distribution.tar.gz	egeria-omag-1.7-SNAPSHOT
```

A new directory is created called **egeria-omag-1.7-SNAPSHOT**.  Change to this
new directory and list its contents as shown below.

```bash
$ cd egeria-omag-1.7-SNAPSHOT
$ ls
