...
$ ls
ls
archive-tmp					egeria-2.6-sources.tar.gz
egeria-2.6-distribution		maven-archiver
egeria-2.6-distribution.tar.gz		open-metadata-assemblies-2.6.jar
egeria-2.6-omag-server			rat.txt
egeria-2.6-omag-server.tar.gz
```
...
$ cd ../../../../egeria-install
$ ls
egeria-2.6-distribution.tar.gz
```

It is now possible to unpack the tar file.

```bash
$ tar -xf egeria-2.6-distribution.tar.gz
$ ls
egeria-2.6-distribution.tar.gz	egeria-omag-2.6
```

A new directory is created called **egeria-omag-2.6**.  Change to this
