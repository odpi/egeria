...
/**
 * This package provides the first failure data capture support for the design model building module.
 ...
 *
 * The error code enum (DesignModelArchiveErrorCode) has an entry for each unique situation
