...
/**
 * A description of templates for simple data sets.  These templates include an asset that may or may not have a connection.
 * The connection is omitted if connectorTypeGUID is null.
 */
