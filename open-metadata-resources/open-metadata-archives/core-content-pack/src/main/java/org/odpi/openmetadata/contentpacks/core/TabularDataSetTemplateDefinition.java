...
public enum TabularDataSetTemplateDefinition implements TemplateDefinition
{
    POSTGRES_TABULAR_DATA_SET_TEMPLATE(PostgreSQLTemplateType.POSTGRES_TABULAR_DATA_SET_TEMPLATE.getTemplateGUID(),
                                       ...
                                       PostgresPlaceholderProperty.TABLE_DESCRIPTION.getPlaceholder(),
    ...
    MSSQL_TABULAR_DATA_SET_TEMPLATE(MSSQLTemplateType.MSSQL_TABULAR_DATA_SET_TEMPLATE.getTemplateGUID(),
                                    ...
                                    MSSQLPlaceholderProperty.TABLE_DESCRIPTION.getPlaceholder(),
    ...
    ORACLE_TABULAR_DATA_SET_TEMPLATE(OracleTemplateType.ORACLE_TABULAR_DATA_SET_TEMPLATE.getTemplateGUID(),
                                     ...
                                     OraclePlaceholderProperty.TABLE_DESCRIPTION.getPlaceholder(),
    ...
    DB2LUW_TABULAR_DATA_SET_TEMPLATE(DB2LUWTemplateType.DB2LUW_TABULAR_DATA_SET_TEMPLATE.getTemplateGUID(),
                                     ...
                                     DB2LUWPlaceholderProperty.TABLE_DESCRIPTION.getPlaceholder(),
