...
public class SubjectAreaDefinitionSample
{
    ...
    private SubjectAreaDefinition createTopSubjectAreaDefinition( String name,String glossaryName) throws ClassificationException, UnrecognizedGUIDException, UserNotAuthorizedException, FunctionNotSupportedException, UnexpectedResponseException, InvalidParameterException, MetadataServerUncontactableException
    {
        System.out.println("----------------------------");
    ...
    private Glossary createGlossary(String userid,String glossaryName,String glossaryDescription) throws ClassificationException, UnrecognizedGUIDException, UserNotAuthorizedException, FunctionNotSupportedException, UnexpectedResponseException, InvalidParameterException, MetadataServerUncontactableException
    {
