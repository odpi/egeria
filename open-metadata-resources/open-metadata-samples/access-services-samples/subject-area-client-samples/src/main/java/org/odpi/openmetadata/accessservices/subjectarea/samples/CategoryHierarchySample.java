...
/**
 * Sample to call subject area category client API to create a category hierarchy,
 * based on given DEPTH and WIDTH values.
 */
public class CategoryHierarchySample {
    ...
    private static final String DEFAULT_TEST_GLOSSARY_NAME  = "Test Glossary for category hierarchy sample";
    ...
    private static Set<Category> createTopCategories() throws SubjectAreaCheckedExceptionBase {
              ...
              for (int width_counter = 0; width_counter < WIDTH; width_counter++) {
                  ...
                  Category category = CategoryHierarchySample.createCategoryWithGlossaryName(categoryName, DEFAULT_TEST_GLOSSARY_NAME);
