 ...
 */
public enum CocoDataProcessingPurposeDefinition
{
    /**
     * Data is approved for processing that validates the efficacy of the treatments trialed.
     */
    CLINICAL_TRIAL_VALIDATION("CT_VALIDATION",
     ...
     */
    CROSS_CLINICAL_TRIAL_ANALYSIS("XCT_ANALYSIS",
     ...
     */
    CocoDataProcessingPurposeDefinition(String          identifier,
                                        String          displayName,
                                        String          summary,
                                        String          description,
                                        String          details,
    ...
    {
        return "DataProcessingPurpose:: " + identifier + ":: " + displayName;
    }
