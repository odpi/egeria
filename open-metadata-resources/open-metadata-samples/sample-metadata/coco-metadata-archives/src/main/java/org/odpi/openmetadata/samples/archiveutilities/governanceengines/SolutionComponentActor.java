...
public enum SolutionComponentActor implements SolutionComponentActorDefinition
{
    ...
    SPONSOR_TO_SET_UP_TRIAL(SolutionRoleDefinition.CLINICAL_TRIAL_SPONSOR,
                            SolutionComponent.SET_UP_CLINICAL_TRIAL,
                            "Initiator",
                            "Based on agreement with the executive board, initiates the set up of a new clinical trial."),
    ...
    MANAGER_TO_ASSEMBLE_REPORT(SolutionRoleDefinition.CLINICAL_TRIAL_MANAGER,
                               ...
                               "Reviewer",
                               "Reviews the assembled treatment efficacy evidence and process descriptions into the report."),
    RESEARCHER_TO_ASSEMBLE_REPORT(SolutionRoleDefinition.CLINICAL_TRIAL_RESEARCHER,
                               SolutionComponent.ASSEMBLE_REPORT,
                               "Author",
    ...
    SUSTAINABILITY_LEADER_TO_COMMUNITY(SolutionRoleDefinition.SUSTAINABILITY_LEADER,
                                       SolutionComponent.SUSTAINABILITY_COMMUNITY,
                                       "Participate",
                                       "Reviews current status of company's sustainability position and plan new initiatives."),
    ...
    SUSTAINABILITY_CHAMPION_TO_COMMUNITY(SolutionRoleDefinition.SUSTAINABILITY_CHAMPION,
                                         SolutionComponent.SUSTAINABILITY_COMMUNITY,
                                         "Participate",
                                         "Reviews current status of company's sustainability position and plan new initiatives.."),
    SUSTAINABILITY_LOCATION_OWNER_TO_COMMUNITY(SolutionRoleDefinition.SUSTAINABILITY_LOCATION_LEADER,
                                         SolutionComponent.SUSTAINABILITY_COMMUNITY,
                                         "Participate",
                                         "Reviews current status of company's sustainability position and plan new initiatives."),
