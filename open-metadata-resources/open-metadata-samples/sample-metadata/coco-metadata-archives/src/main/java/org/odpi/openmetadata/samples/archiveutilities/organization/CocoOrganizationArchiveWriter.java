...
public class CocoOrganizationArchiveWriter extends CocoBaseArchiveWriter
{
        ...
        for (PersonDefinition personDefinition : PersonDefinition.values())
        {
            ...
            if (personDefinition.getEmail() != null)
            {
                archiveHelper.addContactDetails(profileGUID,
                                                ...
                                                OpenMetadataTypesMapper.CONTACT_METHOD_TYPE_EMAIL,
    ...
    private void writeOrganizations()
    {
        ...
        {
            archiveHelper.addTeam(OpenMetadataTypesMapper.ORGANIZATION_TYPE_NAME,
    ...
    private void writeTeams()
    {
        for (DeptDefinition deptDefinition : DeptDefinition.values())
        {
            ...
            archiveHelper.addPersonRole(OpenMetadataTypesMapper.TEAM_LEADER_TYPE_NAME,
                                        leadershipRoleQName,
                                        leadershipRoleQName,
                                        null,
                                        null,
            ...
            archiveHelper.addPersonRole(OpenMetadataTypesMapper.TEAM_MEMBER_TYPE_NAME,
                                                                    membershipRoleQName,
                                                                    membershipRoleQName,
                                                                    null,
                                                                    null,
