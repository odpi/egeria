...
public enum CocoLicenseTypeDefinition
{
     ...
     */
    CocoLicenseTypeDefinition(String          identifier,
                              String          displayName,
                              String          summary,
                              String          description,
                              String          details,
    ...
    {
        return "License::" + identifier + "::" + displayName;
    }
