 ...
 */
public enum CocoProjectDefinition
{
    /**
    ...
    CLINICAL_TRIALS("Campaign:Clinical Trials Management",
                    ...
                    "Developing efficient ways to manage each the clinical trial.",
                    true,
                    false,
     ...
     * @return project
     */
    public CocoProjectDefinition getControllingProject()
    {
     ...
     */
    public List<CocoProjectDefinition> getDependentOn()
    {
        if (dependentOn != null)
        {
