 ...
 */
public abstract class AbstractCocoPharmaServerSecurityConnector extends OpenMetadataServerSecurityConnector implements OpenMetadataRepositorySecurity,
                                                                                                      ...
                                                                                                      OpenMetadataAssetSecurity
{
     ...
     */
    protected List<String>            allUsers;
    protected List<String>            assetOnboardingExit;
    protected List<String>            serverAdmins;
    protected List<String>            serverOperators;
    protected List<String>            serverInvestigators;
    protected List<String>            metadataArchitects;
    protected List<String>            npaAccounts;
    protected List<String>            externalUsers;
    ...
    protected List<String>            allEmployees;
    protected List<String>            assetOnboarding;
     ...
     */
    public AbstractCocoPharmaServerSecurityConnector()
    {
        /*
         * Calling methods from child class to insert users into hardcoded groups
         */

        CocoPharmaServerSecurityConnector groupMaker = new CocoPharmaServerSecurityConnector();
        groupMaker.addUsersToAllEmployeesGroup();
        groupMaker.addUsersToAllUsersGroup();
        groupMaker.addUsersToAssetOnboardingGroup();
        groupMaker.addUsersToExternalUsersGroup();
        groupMaker.addUsersToMetadataArchitectsGroup();
        groupMaker.addUsersToNpaAccountsGroup();
        groupMaker.addUsersToServerAdminsGroup();
        groupMaker.addUsersToServerOperatorsGroup();
        groupMaker.addUsersToServerInvestigatorsGroup();
        groupMaker.addUsersToAssetOnboardingExitGroup();
         ...
         */
        ownerZones.put(groupMaker.tanyaTidieUserId, clinicalTrialsZoneName);
        ...
        zoneSetUp.add(groupMaker.callieQuartileUserId);
        zoneSetUp.add(groupMaker.tessaTubeUserId);
        zoneAccess.put(researchZoneName, zoneSetUp);
        zoneSetUp.add(groupMaker.tanyaTidieUserId);
        zoneAccess.put(clinicalTrialsZoneName, zoneSetUp);
        zoneSetUp = new ArrayList<>();
        zoneSetUp.add(groupMaker.faithBrokerUserId);
        zoneAccess.put(hrZoneName, zoneSetUp);
        zoneSetUp = new ArrayList<>();
        zoneSetUp.add(groupMaker.reggieMintUserId);
        zoneSetUp.add(groupMaker.tomTallyUserId);
        zoneSetUp.add(groupMaker.sallyCounterUserId);
        zoneAccess.put(financeZoneName, zoneSetUp);
        zoneSetUp = new ArrayList<>();
        zoneSetUp.add(groupMaker.garyGeekeUserId);
        zoneAccess.put(infrastructureZoneName, zoneSetUp);
        zoneSetUp = new ArrayList<>();
        zoneSetUp.add(groupMaker.pollyTaskerUserId);
        zoneSetUp.add(groupMaker.bobNitterUserId);
        zoneSetUp.add(groupMaker.lemmieStageUserId);
        zoneSetUp.add(groupMaker.nancyNoahUserId);
        zoneSetUp.add(groupMaker.desSignaUserId);
        zoneAccess.put(developmentZoneName, zoneSetUp);
        zoneSetUp = new ArrayList<>();
        zoneSetUp.add(groupMaker.stewFasterUserId);
        zoneAccess.put(manufacturingZoneName, zoneSetUp);
        zoneSetUp = new ArrayList<>();
        zoneSetUp.add(groupMaker.garyGeekeUserId);
        zoneSetUp.add(groupMaker.erinOverviewUserId);
        zoneSetUp.add(groupMaker.ivorPadlockUserId);
        zoneSetUp.add(groupMaker.julesKeeperUserId);
        zoneSetUp.add(groupMaker.pollyTaskerUserId);
        zoneSetUp.add(groupMaker.faithBrokerUserId);
        zoneSetUp.add(groupMaker.reggieMintUserId);
    ...
    /**
     * Abstract declarations to CocoPharmaServerSecurityConnector class
     * Methods are used to add users to the in-memory groups
     */

    //Overide these?
    public abstract void addUsersToAllUsersGroup() throws NamingException;
    public abstract void addUsersToAllEmployeesGroup();
    public abstract void addUsersToAssetOnboardingGroup();
    public abstract void addUsersToAssetOnboardingExitGroup();
    public abstract void addUsersToServerAdminsGroup() throws NamingException;
    public abstract void addUsersToServerOperatorsGroup() throws NamingException;
    public abstract void addUsersToServerInvestigatorsGroup() throws NamingException;
    public abstract void addUsersToMetadataArchitectsGroup() throws NamingException;
    public abstract void addUsersToExternalUsersGroup() throws NamingException;
    public abstract void addUsersToNpaAccountsGroup();
