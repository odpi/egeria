...
{
    /**
     * GOVERNANCE-ACTION-SAMPLES-0001 - The {0} governance action service is copying source file {1} to destination file {2}
     */
    COPY_FILE("GOVERNANCE-ACTION-SAMPLES-0001",
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0002 - The {0} governance action service is moving source file {1} to destination file {2}
     */
    MOVE_FILE("GOVERNANCE-ACTION-SAMPLES-0002",
              AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0003 - The {0} governance action service is deleting file {1}
     */
    DELETE_FILE("GOVERNANCE-ACTION-SAMPLES-0003",
                AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0004 - The {0} governance action service has created lineage from source {1} to process {2} to destination {3}
     */
    CREATED_LINEAGE("GOVERNANCE-ACTION-SAMPLES-0004",
                    AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0005 - The {0} governance action service has been called without a source file name to work with
     */
    NO_SOURCE_FILE_NAME("GOVERNANCE-ACTION-SAMPLES-0005",
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0006 - The {0} governance action service is unable to provision file {1} 
     * to {2} destination folder using {3} file pattern
     */
    PROVISIONING_FAILURE("GOVERNANCE-ACTION-SAMPLES-0006",
                         AuditLogRecordSeverityLevel.ERROR,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0007 - The {0} governance action service encountered an {1} exception when provisioning file {2} to {3}
     * destination folder using the {4} file pattern.  The exception message included was {5}
     */
    PROVISIONING_EXCEPTION("GOVERNANCE-ACTION-SAMPLES-0007",
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0008 - The {0} governance action service encountered an {1} exception when attempting to retrieve the file 
     * path name from the attached endpoint.  The exception message included was {5}
     */
    ENDPOINT_EXCEPTION("GOVERNANCE-ACTION-SAMPLES-0008",
                       AuditLogRecordSeverityLevel.EXCEPTION,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0009 - The {0} governance action service is using the qualified name from the Folder asset as the path name: {1}
     */
    QUALIFIED_NAME_PATH_NAME("GOVERNANCE-ACTION-SAMPLES-0009",
                             AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0010 - The {0} governance action service detected that asset {1} has no linked connection
     */
    NO_LINKED_CONNECTION("GOVERNANCE-ACTION-SAMPLES-0010",
                         AuditLogRecordSeverityLevel.INFO,
                             ...
                             "The governance action service will next produce the GOVERNANCE-ACTION-SAMPLES-0006 message with the " +
                                     "qualified name.  Follow the instructions for this message."),

    /**
     * GOVERNANCE-ACTION-SAMPLES-0011 - The {0} governance action service detected that asset {1} has {2} linked connections for 
     * asset {3} and is not sure which one to use since they have inconsistent networkAddress properties in their endpoint
     */
    TOO_MANY_CONNECTIONS("GOVERNANCE-ACTION-SAMPLES-0011",
                         AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0012 - The context for {0} governance action service returned a RelatedMetadataElement with a
     * null related element: {1}
     */
    NO_RELATED_ASSET("GOVERNANCE-ACTION-SAMPLES-0012",
                     AuditLogRecordSeverityLevel.ERROR,
                     ...
                     "The governance action service stops attempting extract the path name from the connection and " +
                                 "will use the qualified name of the asset as the path name to work with.",
                     "The governance action service will write the GOVERNANCE-ACTION-SAMPLES-0006 message with the " +
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0013 - The {0} governance action service detected that asset {1} has no endpoint linked to connection {2}
     */
    NO_LINKED_ENDPOINT("GOVERNANCE-ACTION-SAMPLES-0013",
                       AuditLogRecordSeverityLevel.INFO,
                         ...
                         "Since the asset's connection has no endpoint, the governance action connector will use the qualified name of the " +
                                 "asset as the path name to work with.",
                         "The governance action service will next write out the GOVERNANCE-ACTION-SAMPLES-0006 message with the " +
                                 "qualified name.  Follow the instructions for this message."),

    /**
     * GOVERNANCE-ACTION-SAMPLES-0014 - The {0} governance action service detected that asset {1} has a linked connection {2} with {3} linked
     * endpoints which is not valid: {4}
     */
    TOO_MANY_ENDPOINTS("GOVERNANCE-ACTION-SAMPLES-0014",
                       AuditLogRecordSeverityLevel.ERROR,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0015 - The {0} governance action service detected that the endpoint {1} linked to connection {2}
     * for asset {3} has no networkAddressProperty
     */
    NO_NETWORK_ADDRESS("GOVERNANCE-ACTION-SAMPLES-0015",
                       AuditLogRecordSeverityLevel.INFO,
                       ...
                       "Since the asset's connection has no networkAddress in its endpoint, the governance action connector will use the qualified name of the " +
                               "asset as the path name to work with.",
                       "The governance action service will log the GOVERNANCE-ACTION-SAMPLES-0006 message with the " +
                               "qualified name.  Follow the instructions for this message."),

    /**
     * GOVERNANCE-ACTION-SAMPLES-0016 - The {0} governance action service received a {1} exception when it registered its completion status.  
     * The exception's message is: {2}
     */
    UNABLE_TO_SET_COMPLETION_STATUS("GOVERNANCE-ACTION-SAMPLES-0016",
                                    AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0017 - The {0} governance action service received a {1} exception when it registered a listener with the 
     * governance context.  The exception's message is: {2}
     */
    UNABLE_TO_REGISTER_LISTENER("GOVERNANCE-ACTION-SAMPLES-0017",
                                AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0018 - The {0} governance action service was passed a null value for {1}
     */
    MISSING_VALUE("GOVERNANCE-ACTION-SAMPLES-0018",
               AuditLogRecordSeverityLevel.ERROR,
               ...
               "This is an error in the way that the governance action service has been called, " +
                                        ...
                                        "or as part of a governance action process.  Identify which approach was used and add the required information as a request parameter to the invocation code.  Then rerun the request."),

    /**
     * GOVERNANCE-ACTION-SAMPLES-0019 - The {0} governance action service has publishZones set to null
     */
    MISSING_CATALOG("GOVERNANCE-ACTION-SAMPLES-0019",
                    AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0020 - The {0} governance action service is publishing asset {1} to the following zones: {2}
     */
    SETTING_ZONES("GOVERNANCE-ACTION-SAMPLES-0020",
                  AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0021 - The {0} governance action service is initiating governance action process {1} with request parameters 
     * {2} for action targets {3}
     */
    INITIATE_PROCESS("GOVERNANCE-ACTION-SAMPLES-0021",
                     AuditLogRecordSeverityLevel.INFO,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0022 - The {0} governance action service encountered an {1} exception initiating governance action process {2}
     * with request parameters {3} for action targets {4}.  The exception message included was {5}
     */
    INITIATE_PROCESS_EXCEPTION("GOVERNANCE-ACTION-SAMPLES-0022",
                               AuditLogRecordSeverityLevel.EXCEPTION,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0023 - The {0} governance action service is unable to retrieve the template {1} configured in property {2}.  
     * The asset {3} was created without a template
     */
    MISSING_TEMPLATE("GOVERNANCE-ACTION-SAMPLES-0023",
                     AuditLogRecordSeverityLevel.ERROR,
    ...
    /**
     * GOVERNANCE-ACTION-SAMPLES-0024 - {0}
     */
    BLANK_INFO_LOG_MESSAGE("GOVERNANCE-ACTION-SAMPLES-0024",
                     AuditLogRecordSeverityLevel.INFO,
                     "{0}",
