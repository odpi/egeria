 ...
 */
public enum CocoClinicalTrialGuard
{
    SET_UP_COMPLETE("set-up-complete", CompletionStatus.ACTIONED,  "The set up tasks have completed successfully."),
    MISSING_INFO("missing-information", CompletionStatus.INVALID, "One or more of the required request parameters is either not supplied, or an invalid value."),
    SET_UP_FAILED("set-up-failed", CompletionStatus.FAILED, "An unexpected exception occurred while performing the set up tasks."),
     ...
     */
    CocoClinicalTrialGuard(String name, CompletionStatus completionStatus, String description)
    {
        this.name             = name;
    ...
    public static List<GuardType> getGuardTypes()
    {
        ...
        for (CocoClinicalTrialGuard guard : CocoClinicalTrialGuard.values())
        {
