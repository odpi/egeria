 ...
 */
public enum SolutionComponentActorDefinition
{
    ...
    SolutionComponentActorDefinition(SolutionRoleDefinition solutionRole,
    ...
    {
        return "SolutionComponentActorDefinition{" +
