...
package org.apache.atlas.virtualiser.ffdc;

/**
 *  VirtualiserCheckedExceptionBase provides a checked exception for reporting errors found when using Virtualiser to update Gaian and send messages to Information View OMAS.
 */
public class VirtualiserCheckedExceptionBase extends Exception{
    /*
    ...
    */
    ...
    /**
     * This is the typical constructor used for creating a VirtualiserCheckedException.
     *
     ...
     */
    public VirtualiserCheckedExceptionBase(int  httpCode, String className, String  actionDescription, String errorMessage, String systemAction, String userAction)
    {
        super(errorMessage);
    ...
    /**
     * This is the constructor used for creating a VirtualiserCheckedException when an unexpected error has been caught.
     *
     * @param httpCode - http response code to use if this exception flows over a rest call
     * @param className - name of class reporting error
     * @param actionDescription - description of function it was performing when error detected
     ...
     */
    public VirtualiserCheckedExceptionBase(int  httpCode, String className, String  actionDescription, String errorMessage, String systemAction, String userAction, Throwable caughtError)
    {
