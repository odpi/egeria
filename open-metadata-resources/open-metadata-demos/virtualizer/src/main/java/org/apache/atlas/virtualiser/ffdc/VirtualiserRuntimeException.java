...
/**
 * VirtualiserRuntimeException is used for all runtime exceptions generated by Virtualiser. The VirtualiserErrorCode provides
 * first failure data capture information for this exception.
 */
public class VirtualiserRuntimeException extends RuntimeException{
    ...
    /**
     * This is the typical constructor used for creating an VirtualiserRuntimeException.
     *
     ...
     */
    public VirtualiserRuntimeException(int  httpCode, String className, String  actionDescription, String errorMessage, String systemAction, String userAction)
    {
        super(errorMessage);
    ...
    /**
     * This is the constructor used for creating a VirtualiserRuntimeException when an unexpected error has been caught.
     *
     * @param httpCode - http response code to use if this exception flows over a rest call
     * @param className - name of class reporting error
     * @param actionDescription - description of function it was performing when error detected
     ...
     */
    public VirtualiserRuntimeException(int  httpCode, String className, String  actionDescription, String errorMessage, String systemAction, String userAction, Throwable caughtError)
    {
